...
#Region " Methods"
        ...
        Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String)
            ...
            If Not m_blnGestartet Then
                ...
                Try
                    ...
                    S.AP.InitExecute("Z_M_Datenimport_Ohne_Briefe", "I_KNRZE, I_KONZS, I_KUNNR, I_VKORG",
                                     m_strFiliale, Right("0000000000" & m_objUser.KUNNR, 10), strKUNNR, "1510")
        ...
        Public Sub CreateOutPut(ByVal tblTemp As DataTable, ByVal AppId As String)
            ...
            Dim tbTranslation As DataTable
