...
Namespace Kernel.DocumentGeneration
    ...
    Public Class ExcelDocumentFactory
        ...
        '--------------------
        Public Sub CreateDocumentAndWriteToFilesystem(ByVal reportName As String, ByVal data As System.Data.DataTable, ByVal page As System.Web.UI.Page,
                                                        Optional ByVal useSmartMarker As Boolean = False, Optional ByVal excelTemplatePath As String = Nothing,
                                                        Optional ByVal colOffSet As Integer = 0, Optional ByVal rowOffSet As Integer = 0,
                                                        Optional ByVal blnExcelFormat As Boolean = True)
