...
#Region " Functions "
        ...
        Public Sub CheckForPendingAuthorization(ByVal AppID As Int32, ByVal OrganizationID As Int32, ByVal CustomerReference As String,
                                                ByVal ProcessReference As String, ByVal TestUser As Boolean, ByRef Initiator As String,
                                                ByRef AuthorizationID As Int32)
