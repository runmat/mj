...
Namespace Kernel.Common
    ' Taken from http://demos.telerik.com/aspnet-ajax/grid/examples/programming/savinggridsettingsonperuserbasis/defaultvb.aspx
    ...
    Public Class GridSettingsPersister
        ...
        Public Overridable Sub SaveForUser(user As Security.User, appID As String, Optional name As String = "")
            Common.SaveSetting(user, appID, Grid.ID, name, SaveSettings())
        End Sub
        ...
        Public Overridable Function LoadForUser(ByVal user As Security.User, ByVal appID As String, Optional name As String = "") As String
            Dim originalSettings = SaveSettings()

            Dim savedSettings = Common.GetSetting(user, appID, Grid.ID, name)
            If (Not String.IsNullOrEmpty(savedSettings)) Then
