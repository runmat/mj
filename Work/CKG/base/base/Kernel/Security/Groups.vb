...
#Region " Functions "
        ...
        Private Sub GetGroups(ByVal cn As SqlClient.SqlConnection)
            Dim gr As Group
            Dim cmdGetCustomer As New SqlClient.SqlCommand("SELECT * FROM vwWebGroupWebMember WHERE UserID=@UserID", cn)
