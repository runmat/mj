...
#Region " Public Methods"
        ...
        Public Function Show(ByVal sUserID As String, ByVal sKunnr As String) As Int32
            ...
            If Not m_blnGestartet Then
                ...
                Dim objSAP As New SAPProxy_Base.SAPProxy_Base()
                Dim tblSAP As New SAPProxy_Base.ZDADDISTRIKTETable()
                Dim tblSapDistrikte As New SAPProxy_Base.DD07TTable()
                ...
                Try
                    ...
                    objSAP.Z_Berechtigung_Anzeigen(sUserID, sKunnr, tblSapDistrikte, tblSAP)
                    objSAP.CommitWork()
                    If m_intIDSAP > -1 Then
                        m_objLogApp.WriteEndDataAccessSAP(m_intIDSAP, True)
                    End If

                    tblRightsResult = tblSAP.ToADODataTable
        ...
        Public Function Change() As Int32
            ...
            Dim objSAP As New SAPProxy_Base.SAPProxy_Base()
            Dim sapTable As New SAPProxy_Base.ZDADDISTRIKTETable()

            Dim count As Integer = tblRightsResult.Rows.Count
            Dim row As DataRow

            For Each row In tblRightsResult.Rows

                Dim sapTableRow As New SAPProxy_Base.ZDADDISTRIKTE()
