...
//new FunctionReflector("Z_dpm_Read_Prot_Telefonate_01").WriteOrmForExportTableStructures("I_AG", "10026883");
            ...
            //new FunctionReflector("Z_DPM_READ_SENDTAB_03").WriteOrmForExportTableStructures("I_AG", "0010010753");
        ...
        private static void CoCTest()
        {
            ...
            var list = Z_DPM_COC_TYPDATEN.GT_WEB.GetExportListWithExecute(sap);
            if (list.Count > 0)
            {
                var item = list.First();
