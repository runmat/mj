...
namespace SapORM.Services
{
    public class DynSapProxyNoCache : IDynSapProxyCache
    {
        ...
        private static readonly List<IDynSapProxyObject> Proxys = new List<IDynSapProxyObject>();
        ...
        static IDynSapProxyObject GetProxyByName(string bapiName)
        {
            return Proxys.FirstOrDefault(d => d.BapiName.ToUpper() == bapiName.ToUpper());   
        }
