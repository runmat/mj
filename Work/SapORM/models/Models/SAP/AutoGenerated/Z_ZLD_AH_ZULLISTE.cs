...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_ZULLISTE.GT_OUT> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_ZULLISTE.GT_KUN> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
