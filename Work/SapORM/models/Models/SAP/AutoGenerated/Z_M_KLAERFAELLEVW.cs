...
{
	public partial class Z_M_KLAERFAELLEVW
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_M_KLAERFAELLEVW).Name);
		}
		...
		public partial class GT_WEB : IModelMappingApplied
		{
			...
			public string TDLINE1 { get; set; }

			public string TDLINE2 { get; set; }

			public string TDLINE3 { get; set; }

			public string TDLINE4 { get; set; }

			public string TDLINE5 { get; set; }
			...
			public static GT_WEB Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_WEB
				{
					...
					TDLINE1 = (string)row["TDLINE1"],
					TDLINE2 = (string)row["TDLINE2"],
			...
			public static List<GT_WEB> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_M_KLAERFAELLEVW", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_WEB> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_M_KLAERFAELLEVW", inputParameterKeys, inputParameterValues);
