...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_M_SCHLUESSELDIFFERENZEN.GT_WEB_OUT_TUETE> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_M_SCHLUESSELDIFFERENZEN.GT_WEB_OUT_BRIEFE> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_M_SCHLUESSELDIFFERENZEN.GT_WEB_OUT_HERST> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
