...
{
	public partial class Z_DPM_CD_ABGL_STRAFZETTEL
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_CD_ABGL_STRAFZETTEL).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_CD_ABGL_STRAFZETTEL).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public static void SetImportParameter_I_VORGDAT(ISapDataService sap, DateTime? value)
		{
			sap.SetImportParameter("I_VORGDAT", value);
		}
		...
		public partial class ET_OUT : IModelMappingApplied
		{
			...
			public static List<ET_OUT> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_CD_ABGL_STRAFZETTEL", inputParameterKeys, inputParameterValues);
			...
			public static List<ET_OUT> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_CD_ABGL_STRAFZETTEL", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_CD_ABGL_STRAFZETTEL.ET_OUT> list)
		{
