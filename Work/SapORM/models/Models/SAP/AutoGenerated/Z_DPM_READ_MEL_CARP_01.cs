...
{
	public partial class Z_DPM_READ_MEL_CARP_01
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_READ_MEL_CARP_01).Name);
		}
		...
		public void SetImportParameter_I_CARPORT_ID_AG(ISapDataService sap, string value)
		{
		...
		public partial class GT_TAB : IModelMappingApplied
		{
			...
			public static List<GT_TAB> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_READ_MEL_CARP_01", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_TAB> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_READ_MEL_CARP_01", inputParameterKeys, inputParameterValues);
