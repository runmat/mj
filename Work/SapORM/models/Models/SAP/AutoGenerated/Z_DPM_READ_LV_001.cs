...
namespace SapORM.Models
{
	public partial class Z_DPM_READ_LV_001
	{
		...
		public void SetImportParameter_I_BLOCK(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_BLOCK", value);
		}

		public void SetImportParameter_I_EKORG(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_EKORG", value);
		}

		public void SetImportParameter_I_MSTDE(ISapDataService sap, DateTime? value)
		{
			sap.SetImportParameter("I_MSTDE", value);
		}

		public void SetImportParameter_I_VWAG(ISapDataService sap, string value)
		{
