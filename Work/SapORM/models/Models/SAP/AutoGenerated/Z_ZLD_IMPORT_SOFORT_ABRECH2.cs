...
{
	public partial class Z_ZLD_IMPORT_SOFORT_ABRECH2
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_ZLD_IMPORT_SOFORT_ABRECH2).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_ZLD_IMPORT_SOFORT_ABRECH2).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_IMP_BAK : IModelMappingApplied
		{
			...
			public static List<GT_IMP_BAK> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_ZLD_IMPORT_SOFORT_ABRECH2", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_IMP_BAK> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_ZLD_IMPORT_SOFORT_ABRECH2", inputParameterKeys, inputParameterValues);
		...
		public partial class GT_IMP_WEBUSER_DATEN : IModelMappingApplied
		{
			[SapIgnore]
			[ScriptIgnore]
			public ISapConnection SAPConnection { get; set; }
			...
			public static IEnumerable<GT_IMP_WEBUSER_DATEN> Select(DataTable dt, ISapConnection sapConnection = null)
			{
				return dt.AsEnumerable().Select(r => Create(r, sapConnection));
			}

			public static List<GT_IMP_WEBUSER_DATEN> ToList(DataTable dt, ISapConnection sapConnection = null)
			{
				return Select(dt, sapConnection).ToListOrEmptyList();
			}

			public static IEnumerable<GT_IMP_WEBUSER_DATEN> Select(IEnumerable<DataTable> dts, ISapConnection sapConnection = null)
			{
				var tbl = dts.FirstOrDefault(t => t.TableName.ToLower() == typeof(GT_IMP_WEBUSER_DATEN).Name.ToLower());
				if (tbl == null)
					return null;
			...
			public static List<GT_IMP_WEBUSER_DATEN> ToList(IEnumerable<DataTable> dts, ISapConnection sapConnection = null)
			{
				return Select(dts, sapConnection).ToListOrEmptyList();
			}

			public static List<GT_IMP_WEBUSER_DATEN> ToList(ISapDataService sapDataService)
			{
				return ToList(sapDataService.GetExportTables(), sapDataService.SapConnection);
			}

			public static List<GT_IMP_WEBUSER_DATEN> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				if (sapDataService == null) 
					return new List<GT_IMP_WEBUSER_DATEN>();
			...
			public static List<GT_IMP_WEBUSER_DATEN> GetExportListWithExecute(ISapDataService sapDataService)
			{
				if (sapDataService == null) 
					return new List<GT_IMP_WEBUSER_DATEN>();
			...
			public static List<GT_IMP_WEBUSER_DATEN> GetExportList(ISapDataService sapDataService)
			{
				if (sapDataService == null) 
					return new List<GT_IMP_WEBUSER_DATEN>();
			...
			public static List<GT_IMP_WEBUSER_DATEN> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				if (sapDataService == null) 
					return new List<GT_IMP_WEBUSER_DATEN>();
			...
			public static List<GT_IMP_WEBUSER_DATEN> GetImportList(ISapDataService sapDataService)
			{
				if (sapDataService == null) 
					return new List<GT_IMP_WEBUSER_DATEN>();
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_BAK> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_BAK> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_POS> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_POS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_BANK> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_BANK> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_ADRS> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_ADRS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_WEBUSER_DATEN> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_IMP_WEBUSER_DATEN> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_EX_ERRORS> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_SOFORT_ABRECH2.GT_EX_ERRORS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
