...
{
	public partial class Z_DPM_READ_SENDTAB_04
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_READ_SENDTAB_04).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_READ_SENDTAB_04).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public static void SetImportParameter_I_KUNPDI(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_KUNPDI", value);
		}
		...
		public partial class GT_OUT : IModelMappingApplied
		{
			...
			public static List<GT_OUT> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_READ_SENDTAB_04", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_OUT> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_READ_SENDTAB_04", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_READ_SENDTAB_04.GT_OUT> list)
		{
