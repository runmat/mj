...
{
	public partial class Z_DPM_ZULASSUNGSSPERRE_01
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_ZULASSUNGSSPERRE_01).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_ZULASSUNGSSPERRE_01).Name, inputParameterKeys, inputParameterValues);
		}


		public static void SetImportParameter_I_ACTION(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_ACTION", value);
		}
		...
		public partial class GT_IN : IModelMappingApplied
		{
			...
			public static List<GT_IN> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_ZULASSUNGSSPERRE_01", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_IN> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_ZULASSUNGSSPERRE_01", inputParameterKeys, inputParameterValues);
		...
		public partial class GT_OUT : IModelMappingApplied
		{
			...
			public string BEM_RETURN { get; set; }
			...
			public static GT_OUT Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				...
				{
					CHASSIS_NUM = (string)row["CHASSIS_NUM"],
					BEM_RETURN = (string)row["BEM_RETURN"],
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_ZULASSUNGSSPERRE_01.GT_IN> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_ZULASSUNGSSPERRE_01.GT_OUT> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}
