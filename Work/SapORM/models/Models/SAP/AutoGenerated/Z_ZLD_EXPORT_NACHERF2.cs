...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_ZLD_EXPORT_NACHERF2.GT_EX_BAK> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_ZLD_EXPORT_NACHERF2.GT_EX_POS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_EXPORT_NACHERF2.GT_EX_KUNDE> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_EXPORT_NACHERF2.GT_EX_BANK> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_EXPORT_NACHERF2.GT_EX_ADRS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
