...
{
	public partial class Z_ZLD_IMPORT_AH_WARENKORB
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_ZLD_IMPORT_AH_WARENKORB).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_ZLD_IMPORT_AH_WARENKORB).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_BAK : IModelMappingApplied
		{
			...
			public static List<GT_BAK> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_ZLD_IMPORT_AH_WARENKORB", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_BAK> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_ZLD_IMPORT_AH_WARENKORB", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_ZLD_IMPORT_AH_WARENKORB.GT_BAK> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_ZLD_IMPORT_AH_WARENKORB.GT_BAK> list, DataTable dtDst)
		{
