...
{
	public partial class Z_M_EC_AVM_ZULASSUNGEN
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_M_EC_AVM_ZULASSUNGEN).Name);
		}
		...
		public static void SetImportParameter_I_PDI(ISapDataService sap, string value)
		{
		...
		public partial class GT_WEB : IModelMappingApplied
		{
			...
			public string ZCARPORT_NAME1 { get; set; }
			...
			public string LICENSE_NUM_VON { get; set; }

			public string LICENSE_NUM_BIS { get; set; }
			...
			public static GT_WEB Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_WEB
				{
					...
					LICENSE_NUM_VON = (string)row["LICENSE_NUM_VON"],
					LICENSE_NUM_BIS = (string)row["LICENSE_NUM_BIS"],
			...
			public static List<GT_WEB> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_M_EC_AVM_ZULASSUNGEN", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_WEB> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_M_EC_AVM_ZULASSUNGEN", inputParameterKeys, inputParameterValues);
