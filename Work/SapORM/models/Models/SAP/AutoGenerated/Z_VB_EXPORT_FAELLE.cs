...
{
	public partial class Z_VB_EXPORT_FAELLE
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_VB_EXPORT_FAELLE).Name);
		}
		...
		public static void SetImportParameter_I_HERKUNFT(ISapDataService sap, string value)
		{
		...
		public partial class GT_VERBANDBUCH : IModelMappingApplied
		{
			...
			public static List<GT_VERBANDBUCH> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_VB_EXPORT_FAELLE", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_VERBANDBUCH> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_VB_EXPORT_FAELLE", inputParameterKeys, inputParameterValues);
