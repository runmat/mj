...
{
	public partial class Z_DPM_READ_TAB_PROT_01
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_READ_TAB_PROT_01).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_READ_TAB_PROT_01).Name, inputParameterKeys, inputParameterValues);
		}


		public static void SetImportParameter_I_ANWENDUNG(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_ANWENDUNG", value);
		}
		...
		public partial class GT_OUT : IModelMappingApplied
		{
			...
			public string WEB_UPLOAD { get; set; }
			...
			public static GT_OUT Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_OUT
				{
					...
					WEB_UPLOAD = (string)row["WEB_UPLOAD"],
			...
			public static List<GT_OUT> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_READ_TAB_PROT_01", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_OUT> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_READ_TAB_PROT_01", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_READ_TAB_PROT_01.GT_OUT> list)
		{
