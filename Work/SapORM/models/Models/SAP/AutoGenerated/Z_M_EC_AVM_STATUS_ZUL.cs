...
{
	public partial class Z_M_EC_AVM_STATUS_ZUL
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_M_EC_AVM_STATUS_ZUL).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_M_EC_AVM_STATUS_ZUL).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_WEB : IModelMappingApplied
		{
			...
			public string ZUL_GES { get; set; }

			public string BR_O_FZG_PKW { get; set; }

			public string BR_O_FZG_LKW { get; set; }
			...
			public static GT_WEB Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_WEB
				{
					...
					ZUL_GES = (string)row["ZUL_GES"],
					BR_O_FZG_PKW = (string)row["BR_O_FZG_PKW"],
					BR_O_FZG_LKW = (string)row["BR_O_FZG_LKW"],
			...
			public static List<GT_WEB> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_M_EC_AVM_STATUS_ZUL", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_WEB> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_M_EC_AVM_STATUS_ZUL", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_M_EC_AVM_STATUS_ZUL.GT_WEB> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_M_EC_AVM_STATUS_ZUL.GT_WEB> list, DataTable dtDst)
		{
