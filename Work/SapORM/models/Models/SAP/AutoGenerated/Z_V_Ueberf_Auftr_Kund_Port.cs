...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_V_Ueberf_Auftr_Kund_Port.T_SELECT> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_V_Ueberf_Auftr_Kund_Port.T_AUFTRAEGE> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
