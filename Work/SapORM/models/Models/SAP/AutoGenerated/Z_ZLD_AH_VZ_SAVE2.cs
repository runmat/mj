...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_VZ_SAVE2.GT_BAK> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_VZ_SAVE2.GT_POS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_VZ_SAVE2.GT_EX_ERRORS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_VZ_SAVE2.GT_BANK> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_AH_VZ_SAVE2.GT_ADRS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
