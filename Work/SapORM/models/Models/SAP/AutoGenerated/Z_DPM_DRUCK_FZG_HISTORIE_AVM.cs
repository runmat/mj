...
{
	public partial class Z_DPM_DRUCK_FZG_HISTORIE_AVM
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_DRUCK_FZG_HISTORIE_AVM).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_DRUCK_FZG_HISTORIE_AVM).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_EQUIS : IModelMappingApplied
		{
			...
			public static List<GT_EQUIS> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_DRUCK_FZG_HISTORIE_AVM", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_EQUIS> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_DRUCK_FZG_HISTORIE_AVM", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_EQUIS> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_EQUIS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_UEBER> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_UEBER> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_EINST> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_EINST> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_TYPEN> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_TYPEN> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_AUSST> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_AUSST> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_LLZB2> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_LLZB2> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_TUETE> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_TUETE> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_TKOMP> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_TKOMP> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_LLSCH> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_DPM_DRUCK_FZG_HISTORIE_AVM.GT_LLSCH> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
