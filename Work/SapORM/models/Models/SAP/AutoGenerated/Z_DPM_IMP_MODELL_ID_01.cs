...
{
	public partial class Z_DPM_IMP_MODELL_ID_01
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_IMP_MODELL_ID_01).Name);
		}
		...
		public partial class GT_IN : IModelMappingApplied
		{
			...
			public string ZMODELL { get; set; }

			public string ZAUFTRAGS_NR { get; set; }

			public string LICENSE_NUM { get; set; }

			public string WERKS_NR { get; set; }
			...
			public static GT_IN Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_IN
				{
					...
					ZAUFTRAGS_NR = (string)row["ZAUFTRAGS_NR"],
					LICENSE_NUM = (string)row["LICENSE_NUM"],
					WERKS_NR = (string)row["WERKS_NR"],
			...
			public static List<GT_IN> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_IMP_MODELL_ID_01", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_IN> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_IMP_MODELL_ID_01", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_IMP_MODELL_ID_01.GT_IN> list)
		{
