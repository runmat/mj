...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_ZLD_IMP_KOMPER2.GT_IMP_BAK> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_ZLD_IMP_KOMPER2.GT_IMP_POS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_IMP_KOMPER2.GT_IMP_BANK> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_IMP_KOMPER2.GT_IMP_ADRS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_IMP_KOMPER2.GT_EX_ERRORS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_IMP_KOMPER2.GT_BARQ> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
