...
{
	public partial class Z_M_Imp_Zul_Haend_002
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_M_Imp_Zul_Haend_002).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_M_Imp_Zul_Haend_002).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_WEB : IModelMappingApplied
		{
			...
			public string NUMMER_SUS { get; set; }

			public string NAME1_SUS { get; set; }

			public string NAME2_SUS { get; set; }

			public string STRASSE_SUS { get; set; }

			public string HAUSNR_SUS { get; set; }

			public string PSTLZ_SUS { get; set; }

			public string ORT_SUS { get; set; }

			public string ZIELBAHNHOF { get; set; }

			public string BEM_SUS_BEARB { get; set; }

			public string STAT_SUS_BEARB { get; set; }
			...
			public static GT_WEB Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_WEB
				{
					...
					NUMMER_SUS = (string)row["NUMMER_SUS"],
					NAME1_SUS = (string)row["NAME1_SUS"],
					NAME2_SUS = (string)row["NAME2_SUS"],
					STRASSE_SUS = (string)row["STRASSE_SUS"],
					HAUSNR_SUS = (string)row["HAUSNR_SUS"],
					PSTLZ_SUS = (string)row["PSTLZ_SUS"],
					ORT_SUS = (string)row["ORT_SUS"],
					ZIELBAHNHOF = (string)row["ZIELBAHNHOF"],
					BEM_SUS_BEARB = (string)row["BEM_SUS_BEARB"],
					STAT_SUS_BEARB = (string)row["STAT_SUS_BEARB"],
					SUBRC = (string)row["SUBRC"],
			...
			public static List<GT_WEB> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_M_Imp_Zul_Haend_002", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_WEB> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_M_Imp_Zul_Haend_002", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_M_Imp_Zul_Haend_002.GT_WEB> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_M_Imp_Zul_Haend_002.GT_WEB> list, DataTable dtDst)
		{
