...
namespace SapORM.Models
{
	...
	public static partial class DataTableExtensions
	{
		...
		public static void Apply(this IEnumerable<Z_ZLD_CJ2_CALC_MWST.ES_DOCS_K> list, DataTable dtDst)
		{
		...
		public static void Apply(this IEnumerable<Z_ZLD_CJ2_CALC_MWST.GT_POS> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
		...
		public static void Apply(this IEnumerable<Z_ZLD_CJ2_CALC_MWST.IS_DOCS_K> list, DataTable dtDst)
		{
			SapDataServiceExtensions.Apply(list, dtDst);
		}
