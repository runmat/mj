...
{
	public partial class Z_WFM_SET_STATUS_01
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_WFM_SET_STATUS_01).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_WFM_SET_STATUS_01).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_DATEN : IModelMappingApplied
		{
			...
			public string INS_FOLGE_TASK { get; set; }

			public string RET_FOLGE_TASK_ID { get; set; }
			...
			public static GT_DATEN Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_DATEN
				{
					...
					INS_FOLGE_TASK = (string)row["INS_FOLGE_TASK"],
					RET_FOLGE_TASK_ID = (string)row["RET_FOLGE_TASK_ID"],
					ERR = (string)row["ERR"],
			...
			public static List<GT_DATEN> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_WFM_SET_STATUS_01", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_DATEN> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_WFM_SET_STATUS_01", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_WFM_SET_STATUS_01.GT_DATEN> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}

		public static void Apply(this IEnumerable<Z_WFM_SET_STATUS_01.GT_DATEN> list, DataTable dtDst)
		{
