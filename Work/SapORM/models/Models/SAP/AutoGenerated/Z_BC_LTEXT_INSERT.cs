...
namespace SapORM.Models
{
	public partial class Z_BC_LTEXT_INSERT
	{
		...
		public static void SetImportParameter_I_LTEXT_ID(ISapDataService sap, string value)
		{
		...
		public static string GetExportParameter_E_LTEXT_NR(ISapDataService sap)
		{
			return sap.GetExportParameter<string>("E_LTEXT_NR").NotNullOrEmpty().Trim();
		}
