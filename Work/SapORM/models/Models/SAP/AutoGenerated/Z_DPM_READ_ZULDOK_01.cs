...
namespace SapORM.Models
{
	public partial class Z_DPM_READ_ZULDOK_01
	{
		...
		public static void SetImportParameter_I_NAME_HALTER(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_NAME_HALTER", value);
		}

		public static void SetImportParameter_I_NUR_UNVOLLST(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_NUR_UNVOLLST", value);
		}

		public static void SetImportParameter_I_NUR_VOLLST(ISapDataService sap, string value)
		{
		...
		public static void SetImportParameter_I_ZKUNNR_EXT(ISapDataService sap, string value)
		{
