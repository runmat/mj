...
{
	public partial class Z_DPM_SAVE_WERTE_GUTA_VERW_01
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_SAVE_WERTE_GUTA_VERW_01).Name);
		}
		...
		public partial class GT_IN : IModelMappingApplied
		{
			...
			public string HAENDL_EINK_WERT_NET { get; set; }

			public string HAENDL_VERK_WERT_NET { get; set; }

			public string HAENDL_EINK_WERT_BRU { get; set; }

			public string HAENDL_VERK_WERT_BRU { get; set; }
			...
			public static GT_IN Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				var o = new GT_IN
				{
					...
					HAENDL_VERK_WERT_BRU = (string)row["HAENDL_VERK_WERT_BRU"],
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_SAVE_WERTE_GUTA_VERW_01.GT_IN> list)
		{
