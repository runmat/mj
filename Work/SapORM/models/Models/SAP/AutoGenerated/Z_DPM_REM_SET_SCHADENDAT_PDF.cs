...
{
	public partial class Z_DPM_REM_SET_SCHADENDAT_PDF
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_REM_SET_SCHADENDAT_PDF).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_REM_SET_SCHADENDAT_PDF).Name, inputParameterKeys, inputParameterValues);
		}


		public static void SetImportParameter_I_ART(ISapDataService sap, string value)
		{
		...
		public static void SetImportParameter_I_READ(ISapDataService sap, string value)
		{
			sap.SetImportParameter("I_READ", value);
		}

		public static void SetImportParameter_I_SVMDAT(ISapDataService sap, DateTime? value)
		{
			sap.SetImportParameter("I_SVMDAT", value);
		}
		...
		public partial class GT_IN : IModelMappingApplied
		{
			...
			public static List<GT_IN> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_REM_SET_SCHADENDAT_PDF", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_IN> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_REM_SET_SCHADENDAT_PDF", inputParameterKeys, inputParameterValues);
		...
		public partial class GT_OUT : IModelMappingApplied
		{
			...
			public string SDPDF_DAT { get; set; }
			...
			public static GT_OUT Create(DataRow row, ISapConnection sapConnection = null, IDynSapProxyFactory dynSapProxyFactory = null)
			{
				...
				try
				{
					o = new GT_OUT
					{
						...
						SDPDF_DAT = (string)row["SDPDF_DAT"],
						BEM = (string)row["BEM"],
					};
				}
				catch(Exception e)
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_REM_SET_SCHADENDAT_PDF.GT_IN> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}


		public static DataTable ToTable(this IEnumerable<Z_DPM_REM_SET_SCHADENDAT_PDF.GT_OUT> list)
		{
			return SapDataServiceExtensions.ToTable(list);
		}
