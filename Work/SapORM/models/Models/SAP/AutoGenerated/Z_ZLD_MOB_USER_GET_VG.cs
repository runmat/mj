...
{
	public partial class Z_ZLD_MOB_USER_GET_VG
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_ZLD_MOB_USER_GET_VG).Name);
		}
		...
		public partial class GT_VGANZ : IModelMappingApplied
		{
			...
			public static List<GT_VGANZ> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_ZLD_MOB_USER_GET_VG", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_VGANZ> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_ZLD_MOB_USER_GET_VG", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_ZLD_MOB_USER_GET_VG.GT_VGANZ> list)
		{
