...
{
	public partial class Z_DPM_REM_READ_BLOCKADETEXT_02
	{
		public static void Init(ISapDataService sap)
		{
			sap.Init(typeof(Z_DPM_REM_READ_BLOCKADETEXT_02).Name);
		}

		public static void Init(ISapDataService sap, string inputParameterKeys, params object[] inputParameterValues)
		{
			sap.Init(typeof(Z_DPM_REM_READ_BLOCKADETEXT_02).Name, inputParameterKeys, inputParameterValues);
		}
		...
		public partial class GT_OUT : IModelMappingApplied
		{
			...
			public static List<GT_OUT> GetExportListWithInitExecute(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetExportTablesWithInitExecute("Z_DPM_REM_READ_BLOCKADETEXT_02", inputParameterKeys, inputParameterValues);
			...
			public static List<GT_OUT> GetImportListWithInit(ISapDataService sapDataService, string inputParameterKeys = null, params object[] inputParameterValues)
			{
				...
				var dts = sapDataService.GetImportTablesWithInit("Z_DPM_REM_READ_BLOCKADETEXT_02", inputParameterKeys, inputParameterValues);
	...
	public static partial class DataTableExtensions
	{
		...
		public static DataTable ToTable(this IEnumerable<Z_DPM_REM_READ_BLOCKADETEXT_02.GT_OUT> list)
		{
