...
{
    class SapConnectionTestSystem : ISapConnection 
    {
        public bool ProdSAP { get { return false; } }

        public string SAPAppServerHost
        {
            get { return "192.168.10.152"; }
        }
        ...
        {
            get { throw new NotSupportedException("SqlServerConnectionString is not supported in class 'SapConnectionTestSystem'"); }
        }
    }
}
