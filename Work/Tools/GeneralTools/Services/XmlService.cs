...
namespace GeneralTools.Services
{
    public class XmlService
    {
        ...
        /// <summary>
        /// Führt eine XML Serialisierung gegen ein Objekt und verkleinert das erzeugte XML anschließend via GZip
        /// </summary>
        /// <param name="data">Serializierbares Objekt</param>
        /// <returns>Base64 Darstellung des GZIPten XML aus der Serializierung</returns>
        public static string XmlSerializeToStringCompressed(object data)
        {
            var serialized = XmlSerializeToString(data);
