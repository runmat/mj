...
{
    public class PageVisitLogItemDetailSelector : Store, IValidatableObject 
    {
        ...
        {
            var tableAttribute = typeof(PageVisitLogItemDetail).GetCustomAttributes(false).OfType<TableAttribute>().FirstOrDefault();
