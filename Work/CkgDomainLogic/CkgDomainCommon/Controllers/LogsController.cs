...
namespace ServicesMvc.Controllers
{
    public class LogsController : CkgDomainController 
    {
        ...
        {
            var dt = ViewModel.PageVisitLogItemsFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
        ...
        {
            var dt = ViewModel.PageVisitLogItemsDetailFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
        ...
        {
            var dt = ViewModel.WebServiceTrafficLogItemsUIFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
