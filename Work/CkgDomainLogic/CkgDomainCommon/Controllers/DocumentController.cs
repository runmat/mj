...
namespace CkgDomainLogic.Controllers
{
    public class DocumentController : CkgDomainController
    {
        ...
        {
            var dt = DokumentViewModel.DokumentsFiltered.GetGridFilteredDataTable(orderBy, filterBy, LogonContext.CurrentGridColumns);
        ...
        {
            var dt = DokumentViewModel.DocumentTypesFiltered.GetGridFilteredDataTable(orderBy, filterBy, LogonContext.CurrentGridColumns);
