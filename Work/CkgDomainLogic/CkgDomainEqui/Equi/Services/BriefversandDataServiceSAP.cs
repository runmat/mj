...
namespace CkgDomainLogic.Equi.Services
{
    ...
    {
        public List<Fahrzeugbrief> Fahrzeugbriefe { get { return PropertyCacheGet(() => LoadFahrzeugbriefeFromSap().ToList()); } }
        ...
        {
            var sapList = Z_DPM_BRIEFBESTAND_001.GT_DATEN.GetExportListWithInitExecute(SAP, "I_KUNNR, I_BESTAND", LogonContext.KundenNr.ToSapKunnr(), "X");
