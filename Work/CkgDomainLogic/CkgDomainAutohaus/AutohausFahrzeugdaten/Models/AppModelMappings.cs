...
namespace CkgDomainLogic.AutohausFahrzeugdaten.Models
{
    public class AppModelMappings : ModelMappings
    {
        ...
        static public ModelMapping<Z_AHP_READ_TYPDAT_BESTAND.GT_WEB_IMP_MASS, UploadFahrzeug> Z_AHP_READ_TYPDAT_BESTAND_GT_WEB_IMP_MASS_From_UploadFahrzeug
        {
            get
            {
                return EnsureSingleton(() => new ModelMapping<Z_AHP_READ_TYPDAT_BESTAND.GT_WEB_IMP_MASS, UploadFahrzeug>(
                    new Dictionary<string, string>()
                    , null
                    , (s, d) =>
                    {
