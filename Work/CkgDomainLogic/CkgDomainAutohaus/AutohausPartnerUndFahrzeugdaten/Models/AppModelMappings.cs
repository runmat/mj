...
namespace CkgDomainLogic.AutohausPartnerUndFahrzeugdaten.Models
{
    public class AppModelMappings : ModelMappings
    {
        ...
        static public ModelMapping<Z_AHP_READ_TYPDAT_BESTAND.GT_WEB_IMP_MASS, Fahrzeugdaten> Z_AHP_READ_TYPDAT_BESTAND_GT_WEB_IMP_MASS_From_Fahrzeugdaten
        {
            get
            {
                return EnsureSingleton(() => new ModelMapping<Z_AHP_READ_TYPDAT_BESTAND.GT_WEB_IMP_MASS, Fahrzeugdaten>(
