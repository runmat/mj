...
namespace ServicesMvc.Controllers
{
    public partial class CocBeauftragungController  
    {
        ...
        {
            var dt = ViewModel.HalterAdressenFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
        ...
        {
            var dt = ViewModel.ReguliererAdressenFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
        ...
        {
            var dt = ViewModel.RechnungsEmpfaengerAdressenFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
        ...
        {
            var dt = ViewModel.VersandScheinSchilderAdressenFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
        ...
        {
            var dt = ViewModel.VersandZb2CocAdressenFiltered.GetGridFilteredDataTable(orderBy, filterBy, CurrentGridColumns);
