...
namespace CkgDomainLogic.Fahrer.Models
{
    public class FahrerAuftragsProtokoll : IFahrerAuftragsFahrt
    {
        ...
        public string Filename
        {
            get
            {
                return string.Format(FahrerProtokollFilenamePattern, 
                                        KundenNr.PadLeft(10, '0'), 
                                        AuftragsNr.PadLeft(10, '0'), 
                                        ProtokollName.IsNotNullOrEmpty() ? ProtokollName : ProtokollArt, 
                                        Fahrt);
            }
        }
    }
