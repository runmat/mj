...
namespace ServicesMvc.Controllers
{
    public partial class LeasingController
    {
        ...
        {
            var dt = LeasingCargateCsvUploadViewModel.LeasingCargateDisplayListItemsFiltered.GetGridFilteredDataTable(orderBy, filterBy, LogonContext.CurrentGridColumns);
