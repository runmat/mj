...
Namespace Kernel.DocumentGeneration
    ...
    Public Class WordDocumentFactory
        ...
        Public Sub CreateDocument(ByVal reportName As String, ByVal page As System.Web.UI.Page, ByVal wordTemplatePath As String, Optional ByVal extendDocument As String = "", Optional ByVal elementForExtend As Object = Nothing)
            ...
            ' # PDF Temporär Zwischenspeichern und anschließend FileTransfer

            Dim TempPDFPath As String = Configuration.ConfigurationManager.AppSettings("TempPDFPath")
            ...
            Dim fi As New System.IO.FileInfo(TempPDFPath & reportName & ".pdf")
            Dim counter As Integer = 0

            Do While (fi.Exists)
                fi = New System.IO.FileInfo(TempPDFPath & reportName & counter & ".pdf")
                counter += 1
            Loop

            pdfDoc.Save(fi.FullName)

            TransmitFileToClient(page, fi.FullName, Dateitypen.pdf)
        ...
        Public Sub CreateDocumentDataset(ByVal reportName As String, ByVal page As System.Web.UI.Page, ByVal wordTemplatePath As String, _
            ...
            Try
                ...
                TransmitFileToClient(page, fi.FullName, Dateitypen.pdf, reportName)
        ...
        'Erstellt PDF-Dokument aus einer Wordvorlage und den übergebenen Daten(DataSet)
        'Legt die Datei im "TempPDFPath" (web.config) ab und gibt den endgültig vergebenen Dateinamen zurück
        Public Function CreateDocumentDatasetandSaveFile(ByVal reportName As String, ByVal page As System.Web.UI.Page, ByVal wordTemplatePath As String, _
                                            ByVal ht As System.Data.DataTable, ByVal DS As System.Data.DataSet) As String
            'Word-Dokument laden
            Me._HeadTable = ht
            Dim docStream As New IO.FileStream(page.Request.PhysicalApplicationPath + wordTemplatePath, IO.FileMode.Open, IO.FileAccess.Read, IO.FileShare.ReadWrite)
            Dim wordDoc As New Aspose.Words.Document(docStream)
