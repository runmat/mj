...
#Region " Membervariables "
        ...
        Private m_blnTeamViewer As Boolean
        Private m_blnIsServiceGroup As Boolean = False
...
#Region " Constructor "
        ...
        Public Sub New(ByVal intGroupID As Integer, _
                               ...
                               ByVal strStartMethod As String, _
                               ByVal strMessage As String, _
                               ByVal intMaxReadMessageCount As Int32, _
                               ByVal blnTeamViewer As Boolean,
                               ByVal blnIsServiceGroup As Boolean)
            m_blnIsNew = blnNew
            m_intGroupID = intGroupID
            m_strGroupName = strGroupName
            m_strDocuPath = strDocuPath
            ...
            m_strMessage = strMessage
            m_intMaxReadMessageCount = intMaxReadMessageCount
            m_blnTeamViewer = blnTeamViewer
            m_blnIsServiceGroup = blnIsServiceGroup
        End Sub
...
#Region " Properties "
        ...
        Public ReadOnly Property ShowsTeamViewer() As Boolean
            Get
                Return m_blnTeamViewer
            End Get
        End Property

        Public ReadOnly Property IsServiceGroup() As Boolean
            Get
                Return m_blnIsServiceGroup
            End Get
        End Property
#End Region
        ...
        Private Sub GetGroup(ByVal cn As SqlClient.SqlConnection)
            Try
                ...
                While dr.Read
                    ...
                    End If
                    If Not dr("TVShow") Is System.DBNull.Value Then
                        m_blnTeamViewer = CBool(dr("TVShow"))
                    Else
                        m_blnTeamViewer = False
                    End If
                    If Not dr("IsServiceGroup") Is System.DBNull.Value Then
                        m_blnIsServiceGroup = CBool(dr("IsServiceGroup"))
                    Else
                        m_blnIsServiceGroup = False
                    End If
                End While
                dr.Close()
                cn.Close()
            ...
            Try
                ...
                Dim strUpdate As String = "UPDATE WebGroup " & _
                                          "SET GroupName=@GroupName, " & _
                                               ...
                                               "TVShow=@TVShow, " & _
                                               "IsServiceGroup=@IsServiceGroup " & _
                                          "WHERE GroupID=@GroupID"
                ...
                With cmd.Parameters
                    ...
                    .AddWithValue("@TVShow", m_blnTeamViewer)
                    .AddWithValue("@IsServiceGroup", m_blnIsServiceGroup)
                End With
                ...
                If m_blnIsNew Then
                    ...
                    m_blnIsNew = False ' ^^ nach dem Speichern ist die Gruppe aber auch nicht mehr neu.. just saying..
                Else
                    cmd.ExecuteNonQuery()
                End If
            Catch ex As Exception
