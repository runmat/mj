...
Namespace Kernel.Common
    Public Class Common
                        ...
                        If rows.Length = 1 Then
                            Select Case UCase(CStr(rows(0)("FieldType")))
                                Case "COL"
                                    ...
                                    '--------------------------------------------------------                
                                    'If TypeOf control.Parent Is TableCell Then
                                    '    Dim tmpCell As TableCell
                                    '    tmpCell = CType(control.Parent, TableCell)
        ...
        '            If TypeOf innercontrol Is LinkButton Then
        '                If UCase(innercontrol.ID) = strFieldName Then
        '                    linkbutton = CType(innercontrol, LinkButton)
        ...
        '                If UCase(innercontrol.ID) = strFieldName Then
        '                    radiobutton = CType(innercontrol, RadioButton)
