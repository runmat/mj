            ...
            If blnWriteLog Then
                Try
                    ...
                    Else
                        strTemp = "0"
                    End If
                    cmdTable = New SqlClient.SqlCommand("INSERT INTO LogStandard (Category, UserName, SessionID, Source, Task, Identification, Description, Customername, CustomerID, TestZugriff, Severity) VALUES ('" & _
                                                        strCategory & "', '" & strUserName & "', '" & strSessionID & "', '" & CStr(intSource) & "', '" & strTask & "', '" & strIdentification & "', '" & strDescription & "', '" & strCustomername & "', " & intCustomerID.ToString & ", " & strTemp & ", " & intSeverity & ");" & _
