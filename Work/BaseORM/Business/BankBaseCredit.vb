...
#Region " Methods"
        ...
        Public Overrides Sub Show()
            ...
            '        ' Log-Aufruf vor Revision -- CDI 02.05.12
        ...
        '            m_intIDSAP = m_objlogApp.WriteStartDataAccessSAP(m_objUser.UserName, m_objUser.IsTestUser, "Z_M_Creditlimit_Detail", m_strAppID, m_strSessionID, m_objUser.CurrentLogAccessASPXID)
        '            objSAP.Z_M_Creditlimit_Detail(Right("00" & m_objUser.Organization.OrganizationReference, 2), Right("0000000000" & m_objUser.KUNNR, 10), "", "1510", CreditAccountDetailTable)
        '            objSAP.CommitWork()
        ...
        '                    col.ReadOnly = False
        '                Next
        '                ' Aufruf Log vor Revision -- CDI 02.05.12
        '                ' WriteLogEntry(True, "KUNNR=" & Right(m_strCustomer, 5), m_tblKontingente)
        '            End If
        '        Catch ex As Exception
        '            Select Case ex.Message
