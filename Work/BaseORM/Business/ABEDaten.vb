        ...
        Public Sub FillDatenABE(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Web.UI.Page, ByVal strEquNr As String) ' Dynproxy
            ...
            If Not m_blnGestartet Then
                ...
                Try
                    ...
                    'S.AP.setImportParameter("ZZEQUNR", strEquNr)
                    'S.AP.callBapi()

                    S.AP.InitExecute("Z_M_ABEZUFZG", "ZZKUNNR, ZZEQUNR", m_strCustomer, strEquNr)
                    ...
                    m_ZZTEXT_AUFBAU = S.AP.GetExportParameter("ZZFHRZKLASSE_TXT")
                    ...
                    m_ZZLEISTUNGSGEW = S.AP.GetExportParameter("ZZANHLAST_UNGEBR")
...
#Region "Not_Used"
        ...
        '                objSAP.Z_M_Abezufzg(strEquNr, m_strCustomer, m_ZFARBE_KLAR, strZZABEKZ, m_ZZABGASRICHTL_TG, m_ZZACHSL_A1_STA, m_ZZACHSL_A2_STA, m_ZZACHSL_A3_STA, m_ZZACHSLST_ACHSE1, m_ZZACHSLST_ACHSE2, m_ZZACHSLST_ACHSE3, strZZAKPZ, strZZAKUP, _
        '                 strZZALBR, strZZALHI, strZZALMI, strZZALUB, strZZALVO, strZZANGE, m_ZZANHLAST_GEBR, m_ZZANHLAST_UNGEBR, m_ZZANTRIEBSACHS, m_ZZANZACHS, m_ZZANZSITZE, m_ZZANZSTEHPLAETZE, strZZAUFB, _
        '                 strZZAUFTXT, strZZAUSF, strZZBDR1, strZZBDR2, strZZBE01, strZZBE02, strZZBE03, _
        '                 strZZBE04, strZZBE05, strZZBE06, strZZBE07, strZZBE08, strZZBE09, strZZBE10, _
        '                 strZZBE11, strZZBE12, strZZBE13, strZZBE14, strZZBE15, strZZBE16, strZZBE17, _
        '                 strZZBE18, strZZBE19, strZZBE20, strZZBE21, strZZBE22, m_ZZBEIUMDREH, m_ZZBEMER1, m_ZZBEMER10, m_ZZBEMER11, m_ZZBEMER12, m_ZZBEMER13, m_ZZBEMER14, m_ZZBEMER2, m_ZZBEMER3, _
        '                 m_ZZBEMER4, m_ZZBEMER5, m_ZZBEMER6, m_ZZBEMER7, m_ZZBEMER8, m_ZZBEMER9, m_ZZBEREIFACHSE1, m_ZZBEREIFACHSE2, m_ZZBEREIFACHSE3, m_ZZBREITEMAX, m_ZZBREITEMIN, strZZCHASSIS_NUM, m_ZZCO2KOMBI, m_ZZCODE_AUFBAU, m_ZZCODE_KRAFTSTOF, _
        '                 m_ZZDREHZSTANDGER, strZZEARTX, decZZENGINE_CAP, _
        '                 decZZENGINE_POWER, strZZENGINE_TYPE, m_ZZFABRIKNAME, m_ZZFAHRGERAEUSCH, m_ZZFAHRZEUGKLASSE, strZZFARBE, m_ZZFASSVERMOEGEN, strZZFDB9, m_ZZFHRZKLASSE_TXT, strZZFLEET_CAT, _
        '                 decZZFLEET_HGT, decZZFLEET_LEN, strZZFLEET_VIN, decZZFLEET_WID, m_ZZGENEHMIGDAT, m_ZZGENEHMIGNR, decZZGROSS_WGT, _
        '                 m_ZZHANDELSNAME, m_ZZHERST_TEXT, m_ZZHERSTELLER_SCH, m_ZZHOECHSTGESCHW, m_ZZHOEHEMAX, m_ZZHOEHEMIN, m_ZZHUBRAUM, m_ZZKLARTEXT_TYP, strZZKLTXT, m_ZZKRAFTSTOFF_TXT, m_ZZLAENGEMAX, m_ZZLAENGEMIN, m_ZZLEISTUNGSGEW, strZZLGEW, _
        '                 m_ZZMASSEFAHRBMAX, m_ZZMASSEFAHRBMIN, strZZMAX_OCCUPANTS, m_ZZNATIONALE_EMIK, m_ZZNENNLEISTUNG, strZZNULA, strZZNUM_AXLE, strZZORHI, _
        '                 strZZORVO, strZZPRFZ, strZZREHI, strZZREPLA_DATE, strZZREVO, strZZREVOLUTIONS, strZZSDB9, m_ZZSLD, decZZSPEED_MAX, _
        '                 m_ZZSTANDGERAEUSCH, strZZSTPL, m_ZZSTUETZLAST, strZZTANK, m_ZZTEXT_AUFBAU, strZZTYP, m_ZZTYP_SCHL, m_ZZTYP_VVS_PRUEF, strZZTYPA, strZZTYPE_TEXT, strZZUNIT_POWER, m_ZZVARIANTE, m_ZZVERSION, m_ZZVVS_SCHLUESSEL, m_ZZZULGESGEW, m_ZZZULGESGEWSTAAT)
