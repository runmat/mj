...
"\r\n                if (!expr.test(strKennz)) {\r\n                    return false;" +
"\r\n                }\r\n                break;\r\n            default:\r\n             " +
"   // Standard-Kennzeichen\r\n                expr = /^[A-ZÄÖÜ]{1,3}-[A-Z]{1,2}\\d{" +
"1,4}$/;\r\n                if (!expr.test(strKennz)) {\r\n                    return" +
" false;\r\n                }\r\n                break;\r\n        }\r\n        return tr" +
"ue;\r\n    }\r\n\r\n    // Prüft das Datum (string)\r\n    function CheckFormatDatum(str" +
"Datum) {\r\n        if (strDatum != null && strDatum != \"\") {\r\n            var exp" +
"r = /^[0-3][0-9].[0-1][0-9].\\d{4}$/;\r\n            if (!expr.test(strDatum)) {\r\n " +
"               return false;\r\n            }\r\n        }\r\n        return true;\r\n  " +
"  }\r\n\r\n    // Prüft, ob das angegebenen Datum (string) vor oder nach dem Referen" +
"zdatum (string) liegt, \r\n    // gibt 1 (größer), 0 (gleich), -1 (kleiner) oder -" +
"2 (Fehler) zurück\r\n    function VergleicheDatum(strRefDatum, strDatum) {\r\n      " +
"  if (CheckFormatDatum(strRefDatum) == false || CheckFormatDatum(strDatum) == fa" +
"lse) {\r\n            return -2;\r\n        }\r\n        var datePartsRef = strRefDatu" +
"m.split(\".\");\r\n        var datumRef = new Date(datePartsRef[2], (datePartsRef[1]" +
" - 1), datePartsRef[0]);\r\n        var dateParts = strDatum.split(\".\");\r\n        " +
"var datum = new Date(dateParts[2], (dateParts[1] - 1), dateParts[0]);\r\n        v" +
"ar jahrRef = datumRef.getFullYear();\r\n        var monatRef = datumRef.getMonth()" +
";\r\n        var tagRef = datumRef.getDate();\r\n        var jahr = datum.getFullYea" +
"r();\r\n        var monat = datum.getMonth();\r\n        var tag = datum.getDate();\r" +
"\n        if (jahr == jahrRef) {\r\n            if (monat == monatRef) {\r\n         " +
"       if (tag == tagRef) {\r\n                    return 0;\r\n                } el" +
"se {\r\n                    if (tag < tagRef) {\r\n                        return -1" +
";\r\n                    } else {\r\n                        return 1;\r\n            " +
...
"rechneDiv(jahr, 100);\r\n        var m = 15 + berechneDiv(3 * k + 3, 4) - berechne" +
"Div(8 * k + 13, 25);\r\n        var s = 2 - berechneDiv(3 * k + 3, 4);\r\n        va" +
"r a = jahr % 19;\r\n        var d = (19 * a + m) % 30;\r\n        var r = berechneDi" +
"v(berechneDiv(d + a, 11), 29);\r\n        var og = 21 + d - r;\r\n        var sz = 7" +
" - ((jahr + berechneDiv(jahr, 4) + s) % 7);\r\n        var oe = 7 - ((og - sz) % 7" +
...
".getMonth();\r\n        var tag = date.getDate();\r\n        // statische Feiertage\r" +
"\n        for (i = 0; i < listeFesteFeiertage.length; i++) {\r\n            // getM" +
"onth liefert 0..11, deshalb -1\r\n            if ((monat == listeFesteFeiertage[i]" +
"[0] - 1)\r\n          && (tag == listeFesteFeiertage[i][1])) {\r\n                re" +
"turn [false, \'\'];\r\n            }\r\n        }\r\n        // dynamische Feiertage\r\n  " +
"      // Ostersonntag\r\n        var ostersonntag = berechneOstersonntag(jahr);\r\n " +
"       if ((monat == ostersonntag.getMonth())\r\n          && (tag == ostersonntag" +
".getDate())) {\r\n            return [false, \'\'];\r\n        }\r\n        // Karfreita" +
"g\r\n        var feiertag = new Date(ostersonntag.getFullYear(), ostersonntag.getM" +
"onth(), ostersonntag.getDate());\r\n        feiertag.setDate(ostersonntag.getDate(" +
") - 2);\r\n        if ((monat == feiertag.getMonth())\r\n          && (tag == feiert" +
"ag.getDate())) {\r\n            return [false, \'\'];\r\n        }\r\n        // Ostermo" +
"ntag\r\n        feiertag = new Date(ostersonntag.getFullYear(), ostersonntag.getMo" +
"nth(), ostersonntag.getDate());\r\n        feiertag.setDate(ostersonntag.getDate()" +
" + 1);\r\n        if ((monat == feiertag.getMonth())\r\n              && (tag == fei" +
"ertag.getDate())) {\r\n            return [false, \'\'];\r\n        }\r\n        // Chri" +
"sti Himmelfahrt\r\n        feiertag = new Date(ostersonntag.getFullYear(), osterso" +
"nntag.getMonth(), ostersonntag.getDate());\r\n        feiertag.setDate(ostersonnta" +
"g.getDate() + 39);\r\n        if ((monat == feiertag.getMonth())\r\n              &&" +
" (tag == feiertag.getDate())) {\r\n            return [false, \'\'];\r\n        }\r\n   " +
"     // Pfingstmontag\r\n        feiertag = new Date(ostersonntag.getFullYear(), o" +
"stersonntag.getMonth(), ostersonntag.getDate());\r\n        feiertag.setDate(oster" +
"sonntag.getDate() + 50);\r\n        if ((monat == feiertag.getMonth())\r\n          " +
"    && (tag == feiertag.getDate())) {\r\n            return [false, \'\'];\r\n        " +
"}\r\n        return [true, \'\'];\r\n    }\r\n\r\n    // Stellt sicher, dass das angegeben" +
"e Datum kein Samstag oder Sonntag ist\r\n    function istKeinWochenende(date) {\r\n " +
"       var wochentag = date.getDay();\r\n        if ((wochentag == 0) || (wochenta" +
"g == 6)) {\r\n            return [false, \'\'];\r\n        }\r\n        return [true, \'\'" +
"];\r\n    }\r\n\r\n    // Werktagsermittlung (verarbeitet Dates oder Texte im Format \"" +
"TTMMJJ\")\r\n    function nurWerktage(date) {\r\n        if ((date != null) && (date " +
"!= \"\")) {\r\n            var tempDate;\r\n            if (date instanceof Date) {\r\n " +
"               tempDate = date;\r\n            }\r\n            else {\r\n            " +
"    jahr = 2000 + parseInt(date.substring(4, 6), 10);\r\n                monat = p" +
"arseInt(date.substring(2, 4), 10) - 1;\r\n                tag = parseInt(date.subs" +
