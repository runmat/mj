...
Partial Public Class jve_ZugriffsHistorie
    ...
    '''<summary>
    '''rbOnline-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents rbOnline As Global.System.Web.UI.WebControls.RadioButton

    '''<summary>
    '''rbError-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents rbError As Global.System.Web.UI.WebControls.RadioButton

    '''<summary>
    '''ddbZeit-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents ddbZeit As Global.System.Web.UI.WebControls.DropDownList
