Public Class Rechnungsdatenanhang
    ...
    Public Shared Function SaveTemplate(ByVal strConnectionstring As String, ByVal intID As Integer, ByVal strBezeichnung As String, ByVal intDatenAbZeile As Integer,
                                        ByVal strSpalteKennzeichen As String, ByVal strSpalteGebuehren As String) As String
        Dim strError As String = ""
        ...
        Using cn As New SqlClient.SqlConnection(strConnectionstring)
            Try
                ...
                Using cmd As SqlClient.SqlCommand = cn.CreateCommand()
                    ...
                    If intID > 0 Then
                        cmd.CommandText = "UPDATE RechnungsanhangTemplates SET Bezeichnung = @Bezeichnung, DatenAbZeile = @DatenAbZeile, SpalteKennzeichen = @SpalteKennzeichen, SpalteGebuehren = @SpalteGebuehren WHERE ID = @ID;"
                    Else
                        cmd.CommandText = "INSERT INTO RechnungsanhangTemplates (Bezeichnung, DatenAbZeile, SpalteKennzeichen, SpalteGebuehren) VALUES (@Bezeichnung, @DatenAbZeile, @SpalteKennzeichen, @SpalteGebuehren);"
                    End If
