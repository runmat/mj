...
#Region " Membervariables "
        ...
        Private m_AppIsList As Boolean
#End Region
...
#Region " Properties "
        ...
        Public ReadOnly Property AppIsList() As Boolean
            Get
                Return m_AppIsList
            End Get
        End Property
        ...
        Private Sub GetApp(ByVal cn As SqlClient.SqlConnection)
            ...
            Try
                While dr.Read
                    ...
                    m_AppIsList = CBool(dr("AppIsList"))
                End While
                dr.Close()
                cn.Close()
                ...
                Try
                    ...
                    If Not dt Is Nothing Then
                        For Each dr In dt.Rows
                            cmd = New SqlClient.SqlCommand()
                            cmd.Connection = cn
                            cmd.CommandText = "INSERT INTO Rights VALUES (@GroupID,@AppID,0,0,'')"
        ...
        Public Sub Save(ByVal cn As SqlClient.SqlConnection, Optional ByRef typ As Boolean = True)
            ...
            Try
                ...
                With cmd.Parameters
                    ...
                    .AddWithValue("@AppIsList", m_AppIsList)
                End With
