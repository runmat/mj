...
namespace AppZulassungsdienst.lib
{
    ...
    #region Methods
        ...
        {  
            ...
            tblError.Columns.Add("Postingnr",typeof(System.String));
            tblError.Columns.Add("ErrorNr", typeof(System.String));
        }
        ...
        //    if (_mSubrc != string.Empty && _mSubrc != "0")
        //    {
        //        bError = true;
        //    }
        //    else if (_mMessage != string.Empty)
        //    {
        //        bError = true;
        //    }
        ...
        //public void FillWerte(DateTime dateVon, DateTime dateBis)
        //{
        //    ClearErrorState();

        //    try
        //    {
        //        DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_GET_WERTE", ref _mApp, ref _mUser, ref _mPage);
        ...
        //        _mSubrc = myProxy.getExportParameter("E_SUBRC");
        //        _mMessage = myProxy.getExportParameter("E_MESSAGE");
        ...
        //public void FillPositionen(VorfallFilter filter)
        //{
        //    ClearErrorState();
        ...
        //    try
        //    {
        //        DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_GET_ALL_DOCS", ref _mApp, ref _mUser, ref _mPage);
        ...
        //            tblDocs.Columns.Add("Date", typeof(System.String));
                    
        //            foreach (DataRow row in tblDocs.Rows)
        //            {
        //                row["Ampel"] = TranslateStatus2((string) row["Status"]);
        ...
        //            // Datum als String
        //            tblDocs.Columns.Remove("BUDAT");
        //            tblDocs.Columns.Add("BUDAT", typeof(System.String));
        ...
        //public void FillGeschaeftsvorfaelle(VorfallFilter filter)
        //{
        //    ClearErrorState();
        ...
        //    try
        //    {
        //        DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_GET_TRANSACTIONS", ref _mApp, ref _mUser, ref _mPage);
        ...
        //public void GetPeriodeFromDate(DateTime datum)
        //{
        //    DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_GET_PERIOD", ref _mApp, ref _mUser, ref _mPage);
        ...
        //public void SavePosition(ref DataRow row)
        //{
        //    string vorfFlag;
        ...
        //    try
        //        {
        //            DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_SAVE_DOC", ref _mApp, ref _mUser, ref _mPage);
        ...
        //            if (!ErrorOccured())
        //            {
        //                FillPositionen(_mVorfallGewaehlt);
        //            }
        //        }
        //        catch (Exception ex)
        //        {
        ...
        //public void Buchen(ref DataRow row)
        //{
            
        //    if(row["Status"].ToString() == "ZE" || row["Status"].ToString() == "ZG")
        //    {
        //        try
        //        {
        //            DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_CASHJOURNALDOC_CREATE", ref _mApp, ref _mUser, ref _mPage);

        //            myProxy.setImportParameter("I_VKBUR", row["KOSTL"].ToString());
        //            myProxy.setImportParameter("I_POSTING_NUMBER", row["POSTING_NUMBER"].ToString());
    ...
    #region Functions
        ...
        public bool CheckDebiKrediNeeded(string transaktNummer)
        {
            ...
            if (_mGeschaeftsvorfalleDebi.Select("TRANSACT_NUMBER = '" + transaktNummer +"'").Length>0)
            {
                bNeeded = true;
            }
            if (_mGeschaeftsvorfalleKredi.Select("TRANSACT_NUMBER = '" + transaktNummer + "'").Length > 0)
            {
                bNeeded = true;
            }
        ...
        //public DataRow GetMwSt(DataRow row)
        //{
        //    try
        //    {
        //        DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_ZLD_CJ_CALC_MWST", ref _mApp, ref _mUser, ref _mPage);
                
        //        DataTable impTbl = myProxy.getImportTable("IS_DOCS");
               
        //        DataRow impRow = impTbl.NewRow();
        //        impRow["BUKRS"] = row["BUKRS"];
        //        impRow["TRANSACT_NUMBER"] = row["TRANSACT_NUMBER"];
        //        impRow["TAX_CODE"] = GetTaxCode(row["TRANSACT_NUMBER"].ToString());
        //        impRow["H_RECEIPTS"] = row["H_RECEIPTS"]; //.ToString().Replace('.',',');
        //        impRow["H_PAYMENTS"] = row["H_PAYMENTS"]; //.ToString().Replace('.', ',');
        //        impRow["H_NET_AMOUNT"] = "0";
        //        impRow["H_TAX_AMOUNT"] = "0";
        //        impTbl.Rows.Add(impRow);
        ...
        //        if (!ErrorOccured())
        //        {
        //            DataTable table = myProxy.getExportTable("ES_DOCS");
        //            DataRow rowOut = table.Rows[0];
        //            return rowOut;
        //        }
        //    }
        //    catch (Exception ex)
        ...
        // !!! Wird derzeit noch nicht verwendet - Prüfung welche Translation verwendet werden soll nötig !!!


        //public string TranslateStatus2(string status)
        //{
        //    string statusImg;
        ...
        //    {
        //        case "ZE":
        //            statusImg = "../../../Images/onebit_06.png";    //grün
        //            break;
        //        case "ZL":
        //            statusImg = "../../../Images/onebit_23.png";    //Schloss
        //            break;
        //        case "":
        //            statusImg = "../../../Images/onebit_10.png";    //rot
        //            break;
        //        case "ZG":
        //            statusImg = "../../../Images/onebit_07.png";    //gelb
        //            break;
        //        default:
        //            statusImg = "../../../Images/onebit_23.png";    //Schloss
        //            break;
