                                    ...
                                    <table cellpadding="0" runat="server" id="TableBank" cellspacing="0">
                                         ...
                                         <tr class="formquery" id="trError" runat="server">
                                            <td colspan="3" class="firstLeft active">
                                               ...
                                               <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2">
                                                    <asp:TextBox ID="txtZulDateBank" Enabled="false" runat="server" CssClass="TextBoxNormal" Width="65px"></asp:TextBox>
                                                </td>
                                            </tr>                                         
                                            <tr class="formquery">
                                                <td class="firstLeft active" >
                                                ...
                                                <td class="firstLeft active" style="height: 30px">
                                                    <asp:TextBox ID="txtKundeBankSuche" onfocus="javascript:this.select();" Enabled="false" runat="server" CssClass="TextBoxNormal" MaxLength="8"
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2">
                                                    <asp:TextBox ID="txtRef1Bank" Enabled="false" runat="server" 
                                                        CssClass="TextBoxNormal" MaxLength="20"></asp:TextBox>
                                                    &nbsp;<asp:TextBox ID="txtRef2Bank" Enabled="false" runat="server" 
                                         ...
                                         <tr>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%;">
                                                    <asp:TextBox ID="txtName1" Width="400px" CssClass="TextBoxNormal" 
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; height: 30px;">
                                                    <asp:TextBox ID="txtName2" Width="400px" CssClass="TextBoxNormal" 
                                                        runat="server" MaxLength="40"></asp:TextBox>
                                                </td>
                                            </tr>   
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; ">
                                                    <asp:TextBox ID="txtStrasse" Width="400px" CssClass="TextBoxNormal" 
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" >
                                                    <asp:TextBox ID="txtPlz" runat="server" onKeyPress="return numbersonly(event, false)"  CssClass="TextBoxNormal" MaxLength="5"
                                                        Width="65px"></asp:TextBox>
                                                </td>
                                                <td class="firstLeft active" style="width: 100%;">
                                                    <asp:TextBox ID="txtOrt" Width="400px" CssClass="TextBoxNormal" runat="server" 
                                         ...
                                         <tr>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; ">
                                                    <asp:TextBox ID="txtKontoinhaber" Width="400px" CssClass="TextBoxNormal" 
                                                        runat="server" MaxLength="40"></asp:TextBox>
                                                </td>
                                            </tr>   
                                            <tr class="formquery">
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; ">
                                                    <asp:TextBox ID="txtSWIFT" Width="400px" CssClass="TextBoxNormal" 
                                                        runat="server" MaxLength="11" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>   
                                            <tr class="formquery">
                                                <td class="firstLeft active" >
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; ">
                                                    <asp:TextBox ID="txtGeldinstitut" Width="400px" CssClass="TextBoxNormal" 
                                                        runat="server" MaxLength="40" Text="Wird automatisch gefüllt!" Enabled="False"></asp:TextBox>
                                                </td>
                                            </tr>  
                                         <tr class="formquery">
                                             <td class="firstLeft active" colspan="3">
                                    ...
                                    <table id="tab1" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" style="width:100%" >
                                                    <asp:LinkButton ID="cmdCreate0" runat="server" CssClass="TablebuttonMiddle" 
                                                        Height="16px" Width="100px" onclick="cmdCreate0_Click" >» Daten holen</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr class="formquery">
                                                <td class="firstLeft active">
                                            ...
                                            <tr class="formquery">
                                                <td class="firstLeft active">
                                                    <asp:CheckBox ID="cbxSave" runat="server" Enabled="False" Text="saved" 
                                                        Visible="False" />
                                                </td>
                                                <td class="firstLeft active" colspan="2">
