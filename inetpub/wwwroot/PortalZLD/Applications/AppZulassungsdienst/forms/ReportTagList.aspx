<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportTagList.aspx.cs"
    Inherits="AppZulassungsdienst.forms.ReportTagList" MasterPageFile="../MasterPage/App.Master" %>
                ...
                <div id="innerContentRight" style="width: 100%">
                        ...
                        <table id="tab1" runat="server" cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr class="formquery">
                                    ...
                                    <td class="firstLeft active">
                                        <asp:Label ID="Label2" runat="server">bis:</asp:Label>
                                    </td>
                                    <td class="firstLeft active" style="width: 100%;">
                    ...
                    <div id="dataQueryFooter">
                        <asp:LinkButton ID="cmdCreate" runat="server" CssClass="Tablebutton" Width="78px" OnClick="cmdCreate_Click" 
                            OnClientClick="checkZulassungsdatum();">» Weiter </asp:LinkButton>
                    </div>
                    <div id="dataFooter">
                        &nbsp;
                    </div>
