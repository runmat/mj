                        ...
                        <ContentTemplate>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; height: 30px;">
                                                    <asp:LinkButton ID="cmdGetData" runat="server" CssClass="TablebuttonMiddle" Height="16px"
                                                        Width="100px" OnClick="cmdGetData_Click" >» Daten holen</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr class="formquery">
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="3" style="width: 100%;">
                                                    ...
                                                    <asp:CheckBox ID="chkKennzSonder" runat="server" AutoPostBack="true" Text="Kennzeichen-Sondergöße"
                            ...
                            <div id="ButtonFooter" runat="server" class="dataQueryFooter">
                                ...
                                <asp:LinkButton ID="cmdCreate" runat="server" CssClass="TablebuttonXLarge" Width="155px"
                                    ...
                                    >» Speichern/Neu </asp:LinkButton>
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="TablebuttonXLarge" Width="155px"
                                    Height="22px" OnClick="LinkButton1_Click" TabIndex="12" >» Eingabeliste </asp:LinkButton>
                            </div>
