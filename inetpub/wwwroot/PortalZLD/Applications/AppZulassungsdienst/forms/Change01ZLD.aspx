                                    ...
                                    <table id="tab1" runat="server" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; height: 30px;">
                                                    <asp:LinkButton ID="cmdGetData" runat="server" CssClass="TablebuttonMiddle" Height="16px"
                                                        Width="100px" OnClick="cmdGetData_Click" >ª Daten holen</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr class="formquery">
                                                <td class="firstLeft active">
                                                    ...
                                                    <asp:GridView ID="GridView1" Style="border: none 0px #ffffff" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtMenge" CssClass="TextBoxNormal" runat="server" Width="30px" 
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active">
                                                    <asp:TextBox ID="txtStVa" runat="server" CssClass="TextBoxNormal" MaxLength="8" 
                                                        Width="65px" TabIndex="8" ></asp:TextBox>
                                                </td>
                                                <td class="firstLeft active">
