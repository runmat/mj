<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change01ZLD.aspx.cs" Inherits="AppZulassungsdienst.forms.Change01ZLD"
                                    ...
                                    <table cellpadding="0" runat="server" id="TableBank" cellspacing="0">
                                        ...
                                        <tr class="formquery">
                                            ...
                                            <td class="firstLeft active" style="width: 100%; height: 30px;">
                                                <asp:TextBox ID="txtKundebank" Enabled="false" runat="server" CssClass="TextBoxNormal"
                                        ...
                                        <tr class="formquery">
                                            ...
                                            <td class="firstLeft active" colspan="2" style="width: 100%;">
<%--                                                <asp:RadioButton ID="rbEinzug" Value="1" Text="Einzugserm‰chtigung" GroupName="Einzug"
                                                    runat="server" />
                                    ...
                                    <table id="tab1" runat="server" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="2" style="width: 100%; height: 30px;">
                                                    <asp:LinkButton ID="cmdCreate0" runat="server" CssClass="TablebuttonMiddle" Height="16px"
                                                        Width="100px" OnClick="cmdCreate0_Click" >ª Daten holen</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr class="formquery">
                                                <td class="firstLeft active">
                                                ...
                                                <td class="firstLeft active">
                                                    <asp:TextBox ID="txtKunnr" AutoPostBack="false"  runat="server" 
                                                        CssClass="TextBoxNormal" MaxLength="8"
                                                        Width="75px" TabIndex="2"  ></asp:TextBox>
                                                </td>
                                                <td class="firstLeft active" colspan="2" style="width: 100%; vertical-align:top; margin-top:3px">
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="3">
                                                    <asp:TextBox ID="txtReferenz1" runat="server" CssClass="TextBoxNormal" MaxLength="20"
                                                        Width="230px" TabIndex="4" style="text-transform:uppercase;" ></asp:TextBox>
                                                    &nbsp;<asp:TextBox ID="txtReferenz2" runat="server" CssClass="TextBoxNormal" MaxLength="20"
                                                        Width="230px" TabIndex="5" style="text-transform:uppercase;" />
                                                </td>
                                            </tr>
                                            <tr class="formquery">
                                                            ...
                                                            <asp:TemplateField ItemStyle-BorderStyle="None" ItemStyle-Width="380px">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="ibtnDel" CommandName="Del" CommandArgument='<%# ((GridViewRow)Container).RowIndex %>'
                                                                        ...
                                                                        Height="16px" Width="16px" runat="server" TabIndex="-1" />
                                                                </ItemTemplate>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active">
                                                    <asp:TextBox ID="txtStVa" runat="server" CssClass="TextBoxNormal" MaxLength="8" 
                                                        Width="65px" TabIndex="8"  ></asp:TextBox><%--AutoPostBack="true"--%>
                                                </td>
                                                <td class="firstLeft active">
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="3" style="width: 100%">
                                                    <asp:LinkButton runat="server" ID="lbtnFeinstaub" CssClass="TablebuttonXSmall" Width="20px" Height="16px" Text="+" OnClick="lbtnFeinstaub_Click" style="background-size:auto"></asp:LinkButton>
                                            ...
                                            <tr class="formquery">
                                                ...
                                                <td class="firstLeft active" colspan="3" style="height: 32px">
                                                    <asp:TextBox ID="txtKennz1" MaxLength="3" CssClass="TextBoxNormal" Width="30px" 
                                                        runat="server" TabIndex="10" style="text-transform:uppercase;"></asp:TextBox>
                                                    <span style="padding-right: 2px; padding-left: 2px">-</span>
                                                    <asp:TextBox ID="txtKennz2" MaxLength="6" onfocus="this.select()" 
                                                        CssClass="TextBoxNormal" Width="100px"
                                                        runat="server" TabIndex="11" style="text-transform:uppercase;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr class="formquery">
                                                <td class="firstLeft active">
                                                ...
                                                <td class="firstLeft active" colspan="3" style="width: 100%;">
                                                    ...
                                                    <asp:CheckBox ID="chkKennzSonder" runat="server" AutoPostBack="true" Text="Kennzeichen-Sondergˆﬂe"
                            ...
                            <div id="ButtonFooter" runat="server" class="dataQueryFooter">
                                <asp:LinkButton ID="lbtnBank" runat="server" CssClass="TablebuttonXLarge" Width="155px"
                                    Height="22px" Style="padding-right: 5px" OnClick="lbtnBank_Click" 
                                    >ª Bankdaten/Adresse </asp:LinkButton>
                                <asp:LinkButton ID="cmdCreate" runat="server" CssClass="TablebuttonXLarge" Width="155px"
                                    Height="22px" Style="padding-right: 5px" OnClick="cmdCreate_Click" OnClientClick="checkZulassungsdatum();" TabIndex="12" 
                                    >ª Speichern/Neu </asp:LinkButton>
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="TablebuttonXLarge" Width="155px"
                                    Height="22px" OnClick="LinkButton1_Click" TabIndex="12" >ª Eingabeliste </asp:LinkButton>
                            </div>
