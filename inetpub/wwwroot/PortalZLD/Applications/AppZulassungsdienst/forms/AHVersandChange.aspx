<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AHVersandChange.aspx.cs" Inherits="AppZulassungsdienst.forms.AHVersandChange"  MasterPageFile="../MasterPage/App.Master" %>
                                ...
                                <asp:Panel ID="pnlBankdaten" runat="server" style="display:none">
                                    <table cellpadding="0" runat="server" id="TableBank" cellspacing="0">
                                        ...
                                        <tr class="formquery">
                                            ...
                                            <td class="firstLeft active">
                                                <asp:TextBox ID="txtPlz" runat="server" CssClass="TextBoxNormal" MaxLength="5" Width="65px"></asp:TextBox>
                                            </td>
