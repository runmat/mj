<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wareneingang.aspx.cs" Inherits="AppZulassungsdienst.forms.Wareneingang"    MasterPageFile="../MasterPage/App.Master" %>
    ...
    <div id="site">
        <div id="content">
            <div id="navigationSubmenu">
                <asp:LinkButton ID="lb_zurueck" runat="server" Visible="True" 
                    onclick="lb_zurueck_Click">zurück</asp:LinkButton>
                       ...
                       <ContentTemplate >
                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr  class="formquery">
                                        ...
                                        <td >
                                            <asp:TextBox ID="txtBestellnummer" AutoPostBack="true" runat="server" 
                                                text="* *" ontextchanged="txtBestellnummer_TextChanged"
                                               ></asp:TextBox>
                                        </td>
                                        <td  class="firstLeft active">
                                        ...
                                        <td>
                                        <asp:TextBox ID="txtLieferantName" AutoPostBack="true"   runat="server" text="* *" ontextchanged="txtLieferantName_TextChanged"
                                               ></asp:TextBox>
                                        </td>
                                        <td  width="100%"  >
                                            &nbsp;
                        ...
                        <div id="dataFooter">
                            <asp:LinkButton ID="lbWeiter" Text="Weiter" Height="16px" Width="78px" runat="server"
                                CssClass="Tablebutton" onclick="lbWeiter_Click"></asp:LinkButton>
                        </div>
