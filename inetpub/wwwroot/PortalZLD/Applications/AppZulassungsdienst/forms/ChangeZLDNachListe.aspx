									...
									<asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
										...
										<PagerSettings Visible="false" />
 										<Columns>
											...
											<asp:TemplateField Visible="false">
												<ItemTemplate>
												    <asp:Label ID="lblGebMatnr" runat="server" Text='<%# Eval("GebMatnr") %>'/>
												</ItemTemplate>
											</asp:TemplateField>
											<asp:TemplateField SortExpression="id_sap" HeaderText="col_ID">
												<HeaderTemplate>
													<asp:LinkButton ID="col_ID" runat="server" CommandName="Sort" CommandArgument="id_sap">col_ID</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label  ID="lblsapID" runat="server"  Font-Bold='<%# Eval("bearbeitet") %>'  Text='<%# Eval("id_sap") %>'/>
												</ItemTemplate>
											...
											<asp:TemplateField SortExpression="PosLoesch"  HeaderText="col_LoeschKZ">
												<HeaderTemplate>
													<asp:LinkButton ID="col_LoeschKZ" runat="server" CommandName="Sort" CommandArgument="PosLoesch">col_LoeschKZ</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label ID="lblPosLoesch" runat="server" Font-Bold='<%# Eval("bearbeitet") %>' Text='<%# Eval("PosLoesch").ToString() %>'/>
												</ItemTemplate>
											...
											<asp:TemplateField Visible="false">
												<ItemTemplate>
												    <asp:Label ID="lblMatnr"  runat="server"  Text='<%# Eval("Matnr") %>'/>
												</ItemTemplate>
											</asp:TemplateField>
											<asp:TemplateField SortExpression="Matbez" HeaderText="col_Matbez">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Matbez" runat="server" CommandName="Sort" CommandArgument="Matbez">col_Matbez</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label ID="lblMatbez" runat="server" Font-Bold='<%# Eval("bearbeitet") %>' Text='<%# Eval("Matbez") %>'/>
											...
											<asp:TemplateField SortExpression="GebPreis" HeaderText="col_GebPreis">
												...
												<ItemTemplate>
												    <asp:TextBox ID="txtGebPreis" onKeyPress="return numbersonly(event, true)"  CssClass="TextBoxNormal" Width="45" Font-Size="8pt" runat="server"
												                 ...
												                 Enabled='<%# proofGebPak(Eval("ID").ToString(), Eval("id_pos").ToString()) %>' />
											...
											<asp:TemplateField SortExpression="Preis_Amt" HeaderText="col_Preis_Amt">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Preis_Amt" runat="server" CommandName="Sort" CommandArgument="Preis_Amt">col_Preis_Amt</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:TextBox ID="txtPreis_Amt" onKeyPress="return numbersonly(event, true)"  CssClass="TextBoxNormal" Width="45" Font-Size="8pt" runat="server"
												                 Text='<%# Eval("Preis_Amt", "{0:F}") %>'  Visible='<%# Eval("GebMatPflicht").ToString() == "X" %>'  />
											...
											<asp:TemplateField SortExpression="Steuer" HeaderText="col_Steuer">
												...
												<ItemTemplate>
												    <asp:TextBox ID="txtSteuer" onKeyPress="return numbersonly(event, true)"  CssClass="TextBoxNormal" Width="45" Font-Size="8pt" runat="server" 
												                 Visible='<%# (Int32)Eval("id_pos")== 10 %>' Text='<%# Eval("Steuer", "{0:F}") %>'/>
												</ItemTemplate>
												<HeaderStyle CssClass="TablePadding" Width="52px"  />
												<ItemStyle CssClass="TablePadding" Width="52px"   />
											</asp:TemplateField>    
											<asp:TemplateField SortExpression="PreisKZ" HeaderText="col_PreisKZ">
												...
												<ItemTemplate>
												    <asp:TextBox ID="txtPreisKZ" Enabled='<%# proofPauschMat(Eval("PauschalKunde").ToString(), Eval("Matnr").ToString()) %>' 
												                 Visible='<%# (Int32)Eval("id_pos")== 10 %>' onKeyPress="return numbersonly(event, true)"  CssClass="TextBoxNormal" Width="45"  Font-Size="8pt" runat="server"  Text='<%# Eval("PreisKZ", "{0:F}") %>'/>
												</ItemTemplate>
												<HeaderStyle CssClass="TablePadding" Width="52px"  />
												<ItemStyle CssClass="TablePadding"  Width="52px"  />
											</asp:TemplateField>
											<asp:TemplateField SortExpression="Zulassungsdatum" HeaderText="col_Zulassungsdatum">
												...
												<ItemTemplate>
												    <asp:Label ID="lblZulassungsdatum" Visible='<%# proofDateVisible((Int32)Eval("id_pos"), Eval("Vorgang").ToString()) %>' runat="server"  Font-Bold='<%# Eval("bearbeitet") %>' Text='<%# Eval("Zulassungsdatum", "{0:d}") %>'/>
												    <asp:TextBox ID="txtZulassungsdatum" onKeyPress="return numbersonly(event, false)"  CssClass="TextBoxNormal" MaxLength="6" Width="45" Font-Size="8pt" runat="server"
												                 Text='<%# Eval("Zulassungsdatum") %>' Visible='<%# proofDateEditable((Int32)Eval("id_pos"), Eval("Vorgang").ToString()) %>' />
												</ItemTemplate>
											...
											<asp:TemplateField SortExpression="Referenz1" HeaderText="col_Referenz1">
												...
												<ItemTemplate>
												    <asp:Label ID="lblReferenz1" Visible='<%# (Int32)Eval("id_pos")== 10 %>'  runat="server"  Font-Bold='<%# Eval("bearbeitet") %>' Text='<%# Eval("Referenz1") %>'/>
												</ItemTemplate>
                                            ...
                                            <asp:TemplateField SortExpression="Referenz2" HeaderText="col_Referenz2" >
												...
												<ItemTemplate>
												    <asp:Label ID="lblReferenz2" Visible='<%# (Int32)Eval("id_pos")== 10 %>'  runat="server"  Font-Bold='<%# Eval("bearbeitet") %>' Text='<%# Eval("Referenz2") %>'/>
												</ItemTemplate>
                                            ...
                                            <asp:TemplateField SortExpression="KreisKZ" HeaderText="col_Amt">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Amt"  runat="server" CommandName="Sort" CommandArgument="KreisKZ">col_Amt</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:TextBox ID="txtKreisKZ" CssClass="TextBoxNormal" MaxLength="3" Width="30" Font-Size="8pt" runat="server" Visible='<%# (Int32)Eval("id_pos")== 10 %>' Text='<%# Eval("KreisKZ") %>' style="text-transform:uppercase;" />
												</ItemTemplate>
											...
											<asp:TemplateField SortExpression="Kennzeichen" HeaderText="col_Kennzeichen">
												...
												<ItemTemplate>
												    <asp:Label ID="lblKennKZ1"  runat="server"  Visible='<%# (Int32)Eval("id_pos")== 10 %>'  Font-Bold='<%# Eval("bearbeitet") %>' Text='<%# Eval("KennKZ") %>'/>
												    <asp:TextBox ID="txtKennzAbc"  onkeyup="FilterKennz(this,event)"  CssClass="TextBoxNormal" Width="45"  Visible='<%# (Int32)Eval("id_pos")== 10 %>' Font-Size="8pt" MaxLength="6" runat="server"  Text='<%# Eval("KennABC") %>'/>
												</ItemTemplate>
											...
											<asp:TemplateField SortExpression="Reserviert" HeaderText="col_Reserviert">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Reserviert" runat="server" CommandName="Sort" CommandArgument="Reserviert">col_Reserviert</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label ID="lblReserviert" runat="server" Visible='<%# ((Boolean)Eval("Reserviert")) == true  %>' Font-Bold='<%# Eval("bearbeitet") %>' Text="R"/>
												    <asp:Label ID="lblWunschKennz" runat="server" Visible='<%# ((Boolean)Eval("WunschKenn")) == true  && ((Boolean)Eval("Reserviert")) == false %>' Font-Bold='<%# Eval("bearbeitet") %>' Text="W"/>
												</ItemTemplate>
											...
											<asp:TemplateField SortExpression="Feinstaub" HeaderText="col_Reserviert">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Feinstaub" runat="server" CommandName="Sort" CommandArgument="Feinstaub">col_Feinstaub</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label ID="lblFeinstaub" runat="server" Visible='<%#((Boolean)Eval("Feinstaub")) == true %>'  Font-Bold='<%# Eval("bearbeitet") %>' Text="F"/>
												</ItemTemplate>
                                            ...
                                            <asp:TemplateField SortExpression="BemerkungAH" HeaderText="col_BemerkungAH">
												<HeaderTemplate>
													<asp:LinkButton ID="col_BemerkungAH" runat="server" CommandName="Sort" CommandArgument="BemerkungAH">col_BemerkungAH</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label runat="server" Visible='<%# (Int32)Eval("id_pos")== 10 %>' Text='<%# Eval("Bemerkung") %>'/>
												</ItemTemplate>
												<HeaderStyle CssClass="TablePadding"  Width="85px" />
												<ItemStyle CssClass="TablePadding"   Width="85px" />
											</asp:TemplateField>
                                            <asp:TemplateField SortExpression="VorerfDatum" HeaderText="col_Vorerfasst">
                                                <HeaderTemplate>
													<asp:LinkButton ID="col_Vorerfasst"  runat="server" CommandName="Sort" CommandArgument="VorerfDatum">col_Vorerfasst</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <asp:Label ID="lblVorerfasst" runat="server" Font-Bold='<%# Eval("bearbeitet") %>' 
												               Text='<%# Eval("VorerfDatum", "{0:d}") + " " + (Eval("VorerfUhrzeit") == null || Eval("VorerfUhrzeit").ToString().Length < 6 ? "" : Eval("VorerfUhrzeit").ToString().Substring(0, 2) + ":" + Eval("VorerfUhrzeit").ToString().Substring(2, 2) + ":" + Eval("VorerfUhrzeit").ToString().Substring(4, 2)) %>'/>
												</ItemTemplate>
											...
											<asp:TemplateField SortExpression="EC" HeaderText="col_EC">
												<HeaderTemplate>
													<asp:LinkButton ID="col_EC" runat="server" CommandName="Sort" CommandArgument="EC">col_EC</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
											...
											<asp:TemplateField SortExpression="Bar" HeaderText="col_Bar">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Bar" runat="server" CommandName="Sort" CommandArgument="Bar">col_Bar</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
							                ...
							                <asp:TemplateField SortExpression="RE" HeaderText="col_RE">
												<HeaderTemplate>
													<asp:LinkButton ID="col_RE" runat="server" CommandName="Sort" CommandArgument="RE">col_RE</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
                                            ...
                                            <asp:TemplateField SortExpression="Name1" HeaderText="col_Adresse">
												...
												<ItemTemplate>
												    <div runat="server" Visible='<%# (Int32)Eval("id_pos")== 10 %>'>
                                            ...
                                            <asp:TemplateField SortExpression="Inhaber" HeaderText="col_Bankverbindung">
												<HeaderTemplate>
													<asp:LinkButton ID="col_Bankverbindung" runat="server" CommandName="Sort" CommandArgument="Inhaber">col_Bankverbindung</asp:LinkButton>
                                                </HeaderTemplate>
												<ItemTemplate>
												    <div runat="server" Visible='<%# (Int32)Eval("id_pos")== 10 %>'>
												        <asp:Label runat="server" Text='<%# Eval("Inhaber") %>'/>
                                                        <br/>
