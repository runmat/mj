<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ServicesMenue.ascx.vb" Inherits="CKG.PortalZLD.ServicesMenue" %>
    ...
    <div id="flyout">
        ...
        <div id="info">
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" 
                ...
                <div id="KVPMenue" style="margin-top: 5px;"  align="center" >
                    <% If MenuKVPSource.Count > 0 Then%>
                        <table cellspacing="0" cellpadding="0" rules="all" border="1" style="background-color:White;width:395px;border-collapse:collapse;">
	                        <tbody>
		                        <tr class="menuehead">
