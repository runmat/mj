<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Selection.aspx.vb" Inherits="CKG.Services.Selection"
    ...
    <div id="site">
        <div id="content">
            <div id="navigationSubmenu">
                ...
                <%--<asp:HyperLink ID="lnkAdmin" CssClass="Adminbutton" runat="server" Text="" Visible="False"
                    NavigateUrl="../Admin/UserManagement.aspx">Verwaltung</asp:HyperLink>--%>
                &nbsp;
                <div class="divGreet">
