...
Public Class Mvc
    ...
    Sub SetMvcIFrameUrl()
        ...
        Dim logonUser As User = ErpBaseMvc.MVC.GetSessionUserObject()
        ...
        Try
            ...
            url = ErpBaseMvc.MVC.MvcPrepareUrl(appUrl, Request("appID"), logonUser.UserName, True)
        ...
        ifrMvcApp.Attributes("onload") = "hideiFrameLoading();"
