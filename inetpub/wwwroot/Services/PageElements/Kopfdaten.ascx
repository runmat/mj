<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Kopfdaten.ascx.vb"  Inherits="CKG.Services.PageElements.Kopfdaten" %>
...
<HeaderStyle Font-Bold="True"></HeaderStyle>
        ...
        <tr>
            ...
            <td nowrap="nowrap" style="padding-left:42px">
