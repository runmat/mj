...
Partial Public Class GridNavigation
    ...
    Private m_PageSizeIndex As Int32 = 1

    Public Property PageSizeIndex As Integer
        Get
            Return m_PageSizeIndex
        End Get
        Set(ByVal Value As Integer)
            m_PageSizeIndex = Value
        End Set
    ...
    Private Sub fillPageSizeDropDown()
        ...
        ddlPageSize.SelectedIndex = m_PageSizeIndex
    End Sub
