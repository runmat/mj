<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WizardStep2Part5.ascx.cs" Inherits="CKG.Components.Zulassung.UserControls.WizardStep2Part5" %>
...
<div runat="server" id="Container">
    ...
    <asp:Panel ID="Panel1" DefaultButton="btnSearch" runat="server">
     <table cellpadding="0" cellspacing="0" style="width: 895px; margin-top: -5px;" class="InputTable">
            <tr>
                <td width="120" style="height: 10px; padding: 0;">
                </td>
                <td style="height: 10px; padding: 0;">
                    <asp:CheckBox runat="server" ID="chk_Halter" Text="Halter ist Versicherungsnehmer" AutoPostBack="true" Checked="true" OnCheckedChanged="Halter_Check" />
                </td>
            </tr>
            <tr>
                <td>
