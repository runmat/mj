<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report01.aspx.vb" Inherits="CKG.Components.ComCommon.DAT.Report01"
      ...
      <div id="innerContent">
        <div id="innerContentRight" style="width: 100%">
          ...
          <div id="paginationQuery" style="text-align: right;">
            <span style="font-weight: bold;">SilverDAT Version:&nbsp;</span><asp:Label ID="lbVersion"
              runat="server" />
          </div>
