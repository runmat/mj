...
Namespace Treuhand
    ...
    Partial Public Class Change102_2s
        ...
        '''<summary>
        '''cmdFreigabe-Steuerelement
        '''</summary>
        '''<remarks>
        '''Automatisch generiertes Feld
        '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
        '''</remarks>
        Protected WithEvents cmdFreigabe As Global.System.Web.UI.WebControls.LinkButton

        '''<summary>
        '''cmdAblehnen-Steuerelement
        '''</summary>
        '''<remarks>
        '''Automatisch generiertes Feld
        '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
        '''</remarks>
        Protected WithEvents cmdAblehnen As Global.System.Web.UI.WebControls.LinkButton
    End Class
End Namespace
