<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change101s.aspx.vb" Inherits="CKG.Components.ComCommon.Treuhand.Change101s"
                    ...
                    <div id="data" style="border-left: solid 1px #dfdfdf; border-right: solid 1px #dfdfdf">
                        ...
                        <script language="JavaScript" type="text/javascript">										
                            function openinfo(url) {
                                fenster = window.open(url, "Zulassungsdatum", "menubar=0,scrollbars=yes,toolbars=0,location=0,directories=0,status=0,width=750,height=250");
                                fenster.focus();
                            }
                        </script>
                    </div>
