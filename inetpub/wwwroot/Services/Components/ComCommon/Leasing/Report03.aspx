                                        ...
                                        <tr class="formquery">
                                            <td class="firstLeft active" colspan="2">
                                              <asp:GridView ID="grvProtokollUpload1" runat="server" AutoGenerateColumns="False" 
                                                GridLines="Both" Width="100%" BackColor="#ffffff" ShowHeader="true">
                                            ...
                                            <div class="dataQueryFooter" style="padding-right: 5px">
                                                <asp:LinkButton ID="cmdCancel" runat="server"  CssClass="Tablebutton" Width="78px">» Übersicht </asp:LinkButton>                                                    
                                            </div>                                              
                                            </td>
                                        </tr>
                                ...
                                <asp:Panel ID="Panel1" DefaultButton="btnEmpty" runat="server">
                                    <table id="tab1" runat="server" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="formquery">
                                                <td class="firstLeft active">
                                                    <asp:Label ID="lblAuftragdatum" runat="server">Auftragsdatum bis</asp:Label>
                                                </td>
                                                <td class="active">
