<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change101.aspx.vb" Inherits="CKG.Components.ComCommon.Change101"
                                        ...
                                        <td colspan="3" style="padding-top: 0px; padding-left: 7px; padding-right: 5px">
                                            ...
                                            <asp:Panel ID="PLAdressmanuell" BackColor="#DCDCDC" runat="server" Width="100%">
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="First" style="padding-left: 21px">
                                                            <asp:Label ID="lbl_AnredeManuell" runat="server">lbl_AnredeManuell</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlAnredeManuell" runat="server">
                                                                <asp:ListItem Value="" Selected="True">- keine -</asp:ListItem>
