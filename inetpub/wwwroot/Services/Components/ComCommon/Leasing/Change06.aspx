<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change06.aspx.vb" Inherits="CKG.Components.ComCommon.Change06"
      ...
      <asp:LinkButton ID="lbBack" Style="padding-left: 15px" runat="server" class="firstLeft active"
        ...
        <div id="innerContentRight" style="width: 100%">
          ...
          <asp:Panel ID="Panel1" runat="server">
            ...
            <div>
                <asp:Label ID="lblErrorSave" runat="server" EnableViewState="false" ForeColor="Red"></asp:Label>
            </div>
              <table id="tab1" runat="server" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr class="formquery">
                  <td class="firstLeft active">
                    <asp:Label ID="lblLeistungsart" runat="server" Text="Enthaltene Leistungsart:" AssociatedControlID="txtLeistungsart" />
                  </td>
                  <td class="active">
                    <asp:TextBox ID="txtLeistungsart" runat="server" />
                  </td>
                </tr>
                <tr class="formquery">
          ...
          <div id="Result" runat="Server" visible="false">
            ...
            <div id="data">
              <table cellspacing="0" cellpadding="0" width="100%" bgcolor="white" border="0">
                  ...
                  <td>
                    <asp:GridView ID="gvBestand" Width="100%" runat="server" CellPadding="1" CellSpacing="1"
                      ...
                      <Columns>
                        <asp:TemplateField>
                          <HeaderTemplate>
                            <asp:LinkButton ID="col_Auswahl" runat="server" CommandName="Sort" CommandArgument="AUSWAHL"
                              Text="col_Auswahl" />
                          </HeaderTemplate>
                          <ItemTemplate>
                            <asp:HiddenField ID="hfAuswahl" runat="server" Value='<%# DataBinder.Eval(Container, "DataItemIndex") %>' />
                            <asp:CheckBox ID="cbAuswahl" runat="server" Checked='<%# Eval("AUSWAHL") %>' AutoPostBack="true" OnCheckedChanged="cbAuswahlCheckedChanged" />
                          </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                          <HeaderTemplate>
                ...
                <tr>
                  <td>
                    <asp:Button ID="bEingang" runat="server" Text="Eingang" OnClick="bEingangClick" />
                    <asp:Button ID="bBereitmeldung" runat="server" Text="Bereitmeldung" OnClick="bBereitmeldungClick" />
                    <asp:Button ID="bAusgang" runat="server" Text="Ausgang" OnClick="bAusgangClick" />
                  </td>
                </tr>
              </table>
            </div>
