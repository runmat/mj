<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report30_2s.aspx.vb" Inherits="CKG.Components.ComCommon.Report30_2s" %>
...
<head runat="server">
    ...
    <link href="/Services/Styles/default.css" rel="stylesheet" type="text/css" media="screen, projection"/>
    <style type="text/css">
        .TableStyle
        {
                                ...
                                <tr>
                                    <td class="TaskTitle" valign="top" align="left">
                                        ...
                                        <img alt="Drucken" style="float:left;cursor:pointer"  title="Drucken" onclick="javascript:window.print()" src="../../../images/Drucker04_08.jpg" />
                                         &nbsp;
                                        <img alt="Schliessen" style="float:right; width:18px; height:18px;cursor:pointer"  title="Schliessen" onclick="javascript:window.close()" src="../../../images/Delete02_06.jpg" />
                                    </td>
                                </tr>
                            </table>
