...
#Region "Events"
    ...
    Protected Sub lbBack_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbBack.Click
        ...
        ElseIf Request.UrlReferrer.OriginalString.Contains("Report01.aspx") Then
...
#Region "Methods"
    Private Sub DoSubmit(Optional ByVal equnr As String = "")
        ...
        Dim m_Report As New Logistik.Historie_Log(m_User, m_App, "")
                ...
                If m_Report.diverseFahrzeuge.Rows.Count < 2 OrElse Not equnr.Length = 0 Then
                    ...
                    Else
                        ...
                        If Request.QueryString("LinkedApp") Is Nothing Then 'wenn aus hauptmenü aufgerufen
                            Response.Redirect("Report01_02.aspx?AppID=" & Session("AppID").ToString)
                        Else 'wenn verlinkung
                            Dim sUrl As String
                            sUrl = Request.QueryString.Item("LinkedApp")
                            Response.Redirect("Report01_02.aspx?AppID=" & Session("AppID").ToString & "&LinkedApp=" & sUrl)
                        End If
