...
Public Class CWSDLZusatzfahrtenKfz1
    ...
    Protected Overrides Sub OnInit(e As System.EventArgs)
        ...
        Me.AddFzgPropertyChanged(Me.TransferPage.Dal.Fzg1)
    End Sub

    Protected Overrides Sub OnLoad(e As System.EventArgs)
        MyBase.OnLoad(e)

        If Me.TransferPage.Dal.Fzg1 IsNot Nothing Then
            Dim fzg As Fahrzeug = Me.TransferPage.Dal.Fzg1
