...
Public Class CWSDLZieladresseKfz2
    ...
    Protected Overrides Sub OnInit(e As EventArgs)
        ...
        AddFzgPropertyChanged(TransferPage.Dal.Fzg2)
    End Sub
    ...
    Protected Overrides Sub OnLoad(e As EventArgs)
        ...
        If Services.MustInitSelectbox AndAlso Not dal.Fzg2 Is Nothing Then
            Dim fahrt As Fahrt = dal.Fzg2.Zielfahrt

            If fahrt IsNot Nothing Then
        ...
        If ProtocolUpload.NeedsInitialization Then
            If protokollArten IsNot Nothing Then
                Dim initialProtokolle = protokollArten.Select("Fahrt='2' OR Fahrt=''").Select(Function(r) Protokoll.FromRow(r, "2")).ToList
    ...
    Private Sub OnFzgPropertyChanged(sender As Object, e As ComponentModel.PropertyChangedEventArgs)
        If e.PropertyName.Equals("Zielfahrt", StringComparison.Ordinal) Then
            Dim fahrt As Fahrt = TransferPage.Dal.Fzg2.Zielfahrt
    ...
    Protected Sub OnValidateExpress(sender As Object, e As ServerValidateEventArgs)
        ...
        ElseIf IsVorholung({dal.Fzg1.Abholfahrt, dal.Fzg2.Zielfahrt}.Union(dal.Fzg2.Zusatzfahrten).ToArray) AndAlso _
        ...
        ElseIf IsSamstag({dal.Fzg1.Abholfahrt, dal.Fzg2.Zielfahrt}.Union(dal.Fzg2.Zusatzfahrten).ToArray) AndAlso _
        ...
        ElseIf IsSonstiges({dal.Fzg1.Abholfahrt, dal.Fzg2.Zielfahrt}.Union(dal.Fzg2.Zusatzfahrten).ToArray) AndAlso _
    ...
    Public Sub Save() Implements ICollapsibleWizardStep.Save
        Dim fzg = Me.TransferPage.Dal.Fzg2
    ...
    Public Sub Validate() Implements ICollapsibleWizardStep.Validate
        Me.Page.Validate("CWSDLZieladresseKfz2")
    End Sub
