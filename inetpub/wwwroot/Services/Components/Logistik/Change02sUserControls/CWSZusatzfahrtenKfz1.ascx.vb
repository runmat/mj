...
Public Class CWSZusatzfahrtenKfz1
    ...
    Private Sub OnDalPropertyChanged(sender As Object, e As ComponentModel.PropertyChangedEventArgs)
        If e.PropertyName.Equals("Fzg1", StringComparison.Ordinal) Then
            Me.Zusatzfahrten.ShowVehicleDetails(Me.TransferPage.Dal.Fzg1)
        End If
    End Sub
    ...
    Public Sub Save() Implements ICollapsibleWizardStep.Save
        Me.TransferPage.Dal.Fzg1.Zusatzfahrten.Clear()
        ...
        For Each fahrt As Fahrt In Me.Zusatzfahrten.Fahrten
            ...
            Me.TransferPage.Dal.Fzg1.Zusatzfahrten.Add(fahrt)
        Next
    End Sub

    Public Sub Validate() Implements ICollapsibleWizardStep.Validate
        Me.Page.Validate("CWSZusatzfahrtenKfz1Extra")
    End Sub
