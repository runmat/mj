...
Public Class CWSZieladresseKfz2
    ...
    Protected Overrides Sub OnLoad(e As EventArgs)
        ...
        If Not IsPostBack AndAlso Not TransferPage.Dal.Fzg2 Is Nothing AndAlso Not TransferPage.Dal.Fzg2.Zielfahrt Is Nothing Then
            TransportAddress.Fahrt = TransferPage.Dal.Fzg2.Zielfahrt
        End If
    End Sub
    ...
    Private Sub OnDalPropertyChanged(sender As Object, e As ComponentModel.PropertyChangedEventArgs)
        If e.PropertyName.Equals("Fzg2", StringComparison.Ordinal) Then
            TransportAddress.ShowVehicleDetails(TransferPage.Dal.Fzg2)
        End If
    End Sub
    ...
    Public Sub Save() Implements ICollapsibleWizardStep.Save
        ...
        TransferPage.Dal.Fzg2.Zielfahrt = fahrt
    End Sub

    Public Sub Validate() Implements ICollapsibleWizardStep.Validate
        Page.Validate("CWSZieladresseKfz2")
    End Sub
