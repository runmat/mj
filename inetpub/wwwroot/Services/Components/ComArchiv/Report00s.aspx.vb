...
#End Region
    ...
    Private Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        SetEndASPXAccess(Me)
        HelpProcedures.FixedGridViewCols(gvArchiv)
    End Sub
...
#End Region
    ...
    Protected Sub rblTypes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles rblTypes.SelectedIndexChanged
        Dim easy As EasyAccess.EasyAccess
