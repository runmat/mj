<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="_Report03s.aspx.vb" Inherits="CKG.Components.ComArchive._Report03s" MasterPageFile="../../MasterPage/Services.Master" %>
                                    ...
                                    <tr class="formquery">
                                        <td colspan="2">
                                            <table id="tblSearch" cellspacing="0" cellpadding="0" border="0" runat="server">
                                                <tr class="formquery">
                                                    <td class="firstLeft active" colspan="5" nowrap="nowrap" style="width:100%" >
                                                         Nur ausgefüllte Felder werden bei der Suche berücksichtigt. 
                                                    </td>
                                                </tr>
                                                <tr class="formquery" id="trchkSearch" runat="server">
                                                    <td class="firstLeft active" colspan="5" nowrap="nowrap" style="width:100%">
                                                        <span>Nur die mit <asp:CheckBox ID="cbx1" runat="server" Checked="True" Enabled="False"></asp:CheckBox> markierten Felder werden in der Trefferliste angezeigt.</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
