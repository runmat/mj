...
Namespace Vorlagen
    ...
    Partial Public Class SelektionMitRadGridUndSearchFormVB
        ...
        '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
        '''</remarks>
        Protected WithEvents CE_DatumBis As Global.AjaxControlToolkit.CalendarExtender
        ...
        '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
        '''</remarks>
        Protected WithEvents MEE_DatumBis As Global.AjaxControlToolkit.MaskedEditExtender
