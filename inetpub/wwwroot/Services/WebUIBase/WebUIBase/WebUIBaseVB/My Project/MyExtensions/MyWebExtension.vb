...
Namespace My
    ''' <summary>
    ''' Modul zum Definieren der Eigenschaften, die im My-Namespace für Webprojekte zur Verfügung stehen.
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Module MyWebExtension
        ...
        ''' <summary>
        ''' Bietet Zugriff auf WebServices, die diesem Projekt hinzugefügt wurden.
        ''' </summary>
        <Global.System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")> _
