...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        'Ansprechpartnerverwaltung ist gemäß ITA 7266 auch für Nicht-Admins nutzbar
    ...
    Protected Sub lbtnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbtnSave.Click
        ...
        Try
            ...
            If Session("ContactID") Is Nothing Then
                cmdTable.Parameters.AddWithValue("@PictureName", DBNull.Value)
            ...
            If String.IsNullOrEmpty(lblPictureName.Text) = False Then
                Image1.ImageUrl = Replace(ConfigurationManager.AppSettings("UploadPath"), "\", "/") & "responsible/" & lblPictureName.Text
            End If
    ...
    Private Sub SetBorder(ByVal ctrl As Control, ByVal SetColor As Drawing.Color)
            ...
            If Not (upFile.PostedFile.FileName = String.Empty) Then
                ...
                If Not (upFile.PostedFile Is Nothing) Then
                    ...
                    If lblPictureName.Text.Length > 0 Then
                        fnameOld = ConfigurationManager.AppSettings("UploadPathLocal") & "responsible\" & lblPictureName.Text
                        info = New IO.FileInfo(fnameOld)
                        If (info.Exists) Then
                            IO.File.Delete(fnameOld)
                        End If
                    End If
                    ...
                    Dim fnameNew As String = ConfigurationManager.AppSettings("UploadPathLocal") & "responsible\" & Session("ContactID") & TimeAppend & ".jpg"
                    ...
                    Image1.ImageUrl = Replace(ConfigurationManager.AppSettings("UploadPath"), "\", "/") & "responsible/" & Session("ContactID") & TimeAppend & ".jpg"
    ...
    Private Sub Contact_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles Me.PreRender
    ...
    Private Sub FillContact(ByVal id As String)
        ...
        If String.IsNullOrEmpty(dr("PictureName").ToString) = False Then
            Image1.ImageUrl = Replace(ConfigurationManager.AppSettings("UploadPath"), "\", "/") & "responsible/" & dr("PictureName")
    ...
    Protected Sub ibtSetGroup_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles ibtSetGroup.Click
    ...
    Private Sub gvCustomer_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvCustomer.RowCommand
        If e.CommandName = "Edit" Then
            Dim index As Integer = Convert.ToInt32(e.CommandArgument)
    ...
    Private Sub gvCustomer_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles gvCustomer.RowDataBound
        Try
    ...
    Private Sub gvCustomer_RowDeleting(ByVal sender As Object, ByVal e As GridViewDeleteEventArgs) Handles gvCustomer.RowDeleting

    End Sub

    Private Sub gvCustomer_RowEditing(ByVal sender As Object, ByVal e As GridViewEditEventArgs) Handles gvCustomer.RowEditing
    ...
    Protected Sub lbtnBack_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbtnBack.Click
        ...
        Image1.ImageUrl = "/Services/images/placeholder.png"
        lblPictureName.Text = ""
    ...
    Protected Sub lbtnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbtnDelete.Click
        ...
        Try
            ...
            Dim fnameNew As String = ConfigurationManager.AppSettings("UploadPathLocal") & "responsible\" & Session("ContactID") & ".jpg"
            info = New IO.FileInfo(fnameNew)
            If (info.Exists) Then
    ...
    Protected Sub ibtnFilter_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles ibtnFilter.Click
