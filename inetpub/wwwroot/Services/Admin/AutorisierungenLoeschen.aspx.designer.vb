...
Partial Public Class AutorisierungenLoeschen
    ...
    '''<summary>
    '''txtInitializedBy-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents txtInitializedBy As Global.System.Web.UI.WebControls.TextBox

    '''<summary>
    '''txtInitializedWhen-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents txtInitializedWhen As Global.System.Web.UI.WebControls.TextBox

    '''<summary>
    '''txtAuthorizationID-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents txtAuthorizationID As Global.System.Web.UI.WebControls.TextBox
    ...
    '''<summary>
    '''txtCustomerReference-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents txtCustomerReference As Global.System.Web.UI.WebControls.TextBox

    '''<summary>
    '''txtProcessReference-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents txtProcessReference As Global.System.Web.UI.WebControls.TextBox
