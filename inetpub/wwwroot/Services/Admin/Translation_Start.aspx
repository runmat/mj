                                        ...
                                        <tr class="formquery">
                                            ...
                                            <td class="firstLeft active">
                                               <span> <asp:RadioButton ID="rbField" runat="server" GroupName="Art" 
                                                ...
                                                <asp:RadioButton ID="rbColumn" runat="server" GroupName="Art" 
                                                ...
                                                <asp:GridView ID="dgSearchResult" Width="100%" runat="server" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Anwendung" SortExpression="AppName">
                                                            <ItemTemplate>
                                                                <asp:LinkButton  runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AppName")%>' CommandName="goToFieldTranslation"  ID="btnSelect" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.AppID")%>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
