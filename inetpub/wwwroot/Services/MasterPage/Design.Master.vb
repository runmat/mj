...
Partial Public Class Design
    ...
    Private Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        If m_User Is Nothing Then
            ...
            If Not IsPostBack Then
                ...
                With bc
                    If .Type = "IE6" Then
                        ...
                        strCSSLink &= "<link href=""../Customize/AppKroschke/KroschkeIE6.css"" media=""screen, projection"" type=""text/css"" rel=""stylesheet"" />"
                    Else
            ...
            End If
        Else
            If m_User.CustomerName = "Volksfürsorge" Then
                ...
                'strCSSLink = ("<link href=""../Customize/AppGenerali/generali.css"" media=""screen, projection"" type=""text/css"" rel=""stylesheet"" />")
                imgLogo.ImageUrl = "../Images/logoDAD.jpg"

            ElseIf m_User.CustomerName = "Porsche" Then

                With bc
                    If .Type = "IE6" Then

                        strCSSLink = "<link href=""../Styles/defaultIE6.css"" media=""screen, projection"" type=""text/css"" rel=""stylesheet"" />"
                        strCSSLink &= "<link href=""../Customize/Porsche/PorscheIE6.css"" media=""screen, projection"" type=""text/css"" rel=""stylesheet"" />"
                    Else

                        strCSSLink = "<link href=""../Styles/default.css"" media=""screen, projection"" type=""text/css"" rel=""stylesheet"" />"
                        strCSSLink &= "<link href=""../Customize/Porsche/Porsche.css"" media=""screen, projection"" type=""text/css"" rel=""stylesheet"" />"
                    End If
                End With
