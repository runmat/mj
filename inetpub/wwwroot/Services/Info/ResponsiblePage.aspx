<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResponsiblePage.aspx.vb"
    Inherits="CKG.Services.ResponsiblePage" MasterPageFile="../MasterPage/Services.Master" %>
                ...
                <div id="innerContent">
                    <div id="innerContentRight" style="width: 100%">
                        ...
                        <div id="Result" runat="Server">
                            <div id="TableQuery">
                                <table id="TableRepeater" runat="server" cellspacing="0" cellpadding="0" width="100%"
                                                ...
                                                <ItemTemplate>
                                                    <div style="float: left; padding-bottom: 10px">
                                                        <div class="responsiblePicture">
                                                            <img alt="<%# DataBinder.Eval(Container, "DataItem.EmployeeName") %>" src="../bilder/responsible/<%# DataBinder.Eval(Container, "DataItem.PictureName") %>"
                                                        ...
                                                        <div class="responsibleTextName">
                                                            ...
                                                            <div class="responsibleText">
                                                                Telefon:&nbsp;<%#DataBinder.Eval(Container, "DataItem.Telefon")%>
                                                            </div>
                                                            <div class="responsibleText">
                                                                Mobil:&nbsp;<%#DataBinder.Eval(Container, "DataItem.Mobile")%>
                                                            </div>
                                                            <div class="responsibleText">
