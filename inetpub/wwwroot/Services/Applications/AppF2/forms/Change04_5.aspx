<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change04_5.aspx.vb" Inherits="AppF2.Change04_5" MasterPageFile="../MasterPage/AppMaster.Master" %>
        ...
        <div id="site">
            <div id="content">
                <div id="navigationSubmenu">
                    ...
                    <asp:HyperLink ID="lnkAbrufgrund" runat="server" NavigateUrl="Change04_4.aspx"
                    ...
                    <div id="innerContentRight" style="width: 100%;">
                        <div id="innerContentRightHeading">
                            <h1>
                                ...
                                <asp:UpdatePanel runat="server" ID ="UPData"><ContentTemplate>
                                ...
                                <div id="data">
                                    <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField SortExpression="MANDT"  HeaderStyle-ForeColor="White" HeaderText="Versandart">
                                                <ItemTemplate>
