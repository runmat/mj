<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change07.aspx.vb" Inherits="AppF2.Change07"
                            ...
                            <div id="TableQuery">
                                <table id="tab1" runat="server" cellpadding="0" cellspacing="0" width="100%" style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr id="trAuswahl" class="formquery" runat="server">
                                            <td class="firstLeft active">
                                               &nbsp;
                                            </td>
                                            <td class="active">
                                                <span>
                                                <asp:RadioButton ID="rb_Haendler" runat="server" 
                                                    GroupName="Auswahl" Text="An Händler" /></span>
                                                <span><asp:RadioButton ID="rb_Bank" runat="server" GroupName="Auswahl" 
                                                    Text="An Bank" Checked="True" /></span>
                                            </td>
