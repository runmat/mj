...
Partial Public Class Change01_4
    ...
    Private Sub GenerateAbrufgruende(ByVal FinArt As String)
        If FinArt = "02" Then
            If objHaendler.FlagVersand = "1" Then
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 0"
            End If

            If objHaendler.FlagVersand = "2" Then
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 9"
            End If

            If objHaendler.FlagVersand = "4" Then
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 8"
            End If
        ElseIf FinArt = "01" Then
            If objHaendler.FlagVersand = "1" Then
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 10"
            End If
            ...
            If objHaendler.FlagVersand = "4" Then
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 8"
            End If
        ElseIf FinArt = "03" Then
            If objHaendler.FlagVersand = "1" Then ' Händler
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 0"
            End If
            ...
            If objHaendler.FlagVersand = "4" Then ' Zulassungsstellen
                objHaendler.VersandAdressArt = "AND VersandAdressArt = 8"
            End If
        End If
    End Sub
    ...
    Protected Sub ddlFinanzierungsart_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlFinanzierungsart.SelectedIndexChanged
        If ddlFinanzierungsart.SelectedValue <> "000" Then
            ...
            ddlAbrufgrund.DataSource = cmbAbrufgrund_ItemDataBound1("1", ddlFinanzierungsart.SelectedValue)
            ddlAbrufgrund.DataValueField = "SapWert"
            ddlAbrufgrund.DataTextField = "WebBezeichnung"
            ddlAbrufgrund.DataBind()
