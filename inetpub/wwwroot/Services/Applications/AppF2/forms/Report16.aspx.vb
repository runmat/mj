...
#End Region
    ...
    Private Function LoadFromCsv(ByVal von As DateTime, ByVal bis As DateTime, ByVal skill As String) As Boolean
        ...
        Try
            ...
            Dim headerRowAltesFormat As Integer = 8
            Dim headerRowNeuesFormat As Integer = 14
            Dim datumNeuesFormat As New DateTime(2014, 10, 9)
            ...
            While datum.Date <= bis.Date
                ...
                If datum.Date < datumNeuesFormat Then
                    headerRow = headerRowAltesFormat
                Else
                    headerRow = headerRowNeuesFormat
                End If

                'alle csv-Dateien Suchen die dem aktuellen Datum entsprechen
                'Endung _9: Tagesreports, Endung _13: Monatsreports
                Dim fileInfos As FileInfo() = inDirInf.GetFiles(String.Format("{0:yyyyMMdd}*_9.csv", datum))
                ...
                If fileInfos.Length > 0 Then
                    For Each fi As FileInfo In fileInfos
                        ...
                        Using sr As New StreamReader(fi.FullName, Encoding.Default)
                            While Not sr.EndOfStream
                                ...
                                ElseIf rowInd > headerRow Then
                                    ...
                                    'TARGOBANK Spezifische Zeichenfolge "prompt" entfernen
    ...
    Protected Sub rgTelefon_ExcelMLExportRowCreated(sender As Object, e As GridExportExcelMLRowCreatedArgs)
    ...
    Protected Sub rgTelefon_ExcelMLExportStylesCreated(sender As Object, e As GridExportExcelMLStyleCreatedArgs)
