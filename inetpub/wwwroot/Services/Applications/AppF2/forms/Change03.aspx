<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change03.aspx.vb" Inherits="AppF2.Change03"
                                ...
                                <table id="tab1" runat="server" cellpadding="0" cellspacing="0" width="100%" style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr class="formquery" id="tr_LiZNR" runat="server">
                                            ...
                                            <td class="active">
                                                <asp:TextBox ID="txtLiZNR" runat="server" MaxLength="20"></asp:TextBox>
                                            </td>
                                        </tr>                                        
                                        <tr>
