<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change01_3.aspx.vb" Inherits="AppF2.Change01_3"
                                                    ...
                                                    <table id="Tablex1" runat="server" cellspacing="0" cellpadding="5" width="100%" bgcolor="white"
                                                        ...
                                                        <tr id="tr_AdresseArt" >
                                                            <td align="left" class="firstLeft active">
                                                                <asp:Label ID="Label2" Text="Adressauswahl" runat="server"></asp:Label>
                                                            </td>
                                                            <td align="left" width="100%" colspan="5">
                                                                <asp:RadioButton Text="rb_Haendler" ID="rb_Haendler" runat="server" AutoPostBack="true"
                                                                    GroupName="VersandAdrArt" Checked="True" />
                                                                <asp:RadioButton Text="rb_BCA" ID="rb_BCA" runat="server" AutoPostBack="true" GroupName="VersandAdrArt" />
                                                                <asp:RadioButton Text="rb_freieAdresse" ID="rb_freieAdresse" runat="server" AutoPostBack="true"
                                                                    GroupName="VersandAdrArt" />
                                                            </td>
                                                        </tr>
                                                        <tr id="tr_Partneradresse" runat="server" >
                                                            ...
                                                            <td align="left" width="100%" colspan="5" class="firstLeft active">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="100%">
                                                                            <asp:LinkButton ID="lb_Suche" CssClass="TableButton" runat="server">Suchen</asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                    </div>
                                                      ...
                                                      <tr id="tr_ZulStelle" runat="server" visible="false">
                                                            ...
                                                            <td align="left" width="100%" colspan="5" class="firstLeft active">
                                                                    ...
                                                                    <table id="Table1" runat="server" cellspacing="0" cellpadding="3" width="100%" bgcolor="white">
                                                                        <tr>
                                                                            <td style="padding-left: 5px">
                                                                                ...
                                                                                <asp:Label ID="lblSucheGeschaeft" runat="server" Visible="False"></asp:Label>
                                                                                <asp:LinkButton ID="lbt_SucheGeschNeu" runat="server" Visible="False">Neu Suche</asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>

                                                                    <table id="Table3" runat="server" cellspacing="0" cellpadding="3"
                                                                    width="100%" bgcolor="white" >
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lbl_OrtSucheGe" runat="server" CssClass="TextLarge"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtOrtSucheGe" runat="server" CssClass="TextBoxNormal"></asp:TextBox>
                                                                        </td>
                                                                        <td width="100%">
                                                                            &nbsp;
                                                                            <asp:Label ID="Label4" runat="server" CssClass="TextLarge" 
                                                                                Text="Alle Eingaben mit Platzhalter-Suche (*) möglich (z.B. Muster*')"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="lbl_KennzKreis" runat="server" CssClass="TextLarge"></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtKennzKreis" runat="server" CssClass="TextBoxShort"></asp:TextBox>
                                                                            </td>
                                                                            <td width="100%">
                                                                                &nbsp;</td>
                                                                        </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lbl_PLZSucheGe" runat="server" CssClass="TextBoxShort"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtPLZSucheGe" runat="server" CssClass="TextBoxShort"></asp:TextBox>
                                                                        </td>
                                                                        <td width="100%">
                                                                            <asp:LinkButton ID="lb_SucheGesch" CssClass="TableButton" runat="server">Suchen</asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            <td class="firstLeft active" colspan="6" style="font-weight: normal">
                                                                ...
                                                                zugestellt,<br />
                                                                &nbsp;&nbsp;&nbsp;-5% aller Sendungen benötigen zwischen 24 und 48 Stunden bis zur
                                                                Zustellung.<br />
                                                                <br />
