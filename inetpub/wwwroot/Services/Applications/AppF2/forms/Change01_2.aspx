<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change01_2.aspx.vb" Inherits="AppF2.Change01_2"
                                ...
                                <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField SortExpression="MANDT" HeaderText="Anfordern">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkTemp" runat="server" Enabled='<%# DataBinder.Eval(Container, "DataItem.MESSAGE")="" %>' Checked='<%# (DataBinder.Eval(Container, "DataItem.MANDT")="1") %>'>
                                                </asp:CheckBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                          
