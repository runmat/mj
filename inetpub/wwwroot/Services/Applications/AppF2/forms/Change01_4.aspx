<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change01_4.aspx.vb" Inherits="AppF2.Change01_4" MasterPageFile="../MasterPage/AppMaster.Master" %>
                                           ...
                                           <asp:TemplateField SortExpression="ZZFINART_BEZ" HeaderText="col_Finart">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="White" HeaderText="Abrufgrund">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="cmbAbrufgrund" AutoPostBack="true" runat="server" DataSource='<%# cmbAbrufgrund_ItemDataBound1( DataBinder.Eval(Container, "DataItem.MANDT"), DataBinder.Eval(Container, "DataItem.ZZFINART_GRP"))%>'
                                                            DataValueField="SapWert" DataTextField="WebBezeichnung" Width="275px" OnSelectedIndexChanged="cmbAbrufgrund_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <HeaderStyle ForeColor="White"></HeaderStyle>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Abrufgrund-Info/Text" HeaderStyle-ForeColor="White">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblZusatzinfo" runat="server" Visible="True" EnableViewState="True"></asp:Label>
                                                        <asp:TextBox BorderStyle="Solid" BorderWidth="1" ID="txtZusatztext" runat="server"
                                                            Visible="False" EnableViewState="True" MaxLength="50" Width="250px"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <HeaderStyle ForeColor="White"></HeaderStyle>
                                                </asp:TemplateField>
                                            </Columns>
