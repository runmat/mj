<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="Report06.aspx.vb" Inherits="AppInsurance.Report06" MasterPageFile="../MasterPage/App.Master" %>
            ...
            <div id="innerContent">
                <div id="innerContentRight" style="width: 100%">
                                    ...
                                    <td class="active" valign="top" align="right">
                                        <div id="queryImage">
                                            <asp:ImageButton ID="NewSearch" runat="server" ImageUrl="../../../Images/queryArrow.gif"
                                                OnClick="NewSearch_Click" Style="width: 18px" />
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                                            ...
                                            <table id="tabSelektion" runat="server" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    ...
                                                    <tr class="formquery">
                                                        ...
                                                        <td class="firstLeft active">
                                                            <asp:TextBox ID="txt_SerialNr" runat="server" CssClass="TextBoxNormal" MaxLength="17"
                                                    ...
                                                    <tr class="formquery">
                                                        ...
                                                        <td class="firstLeft active">
                                                            <asp:TextBox ID="txt_Vermittler" runat="server" CssClass="TextBoxNormal" MaxLength="17"
                                                                Width="200px"></asp:TextBox>
                    ...
                    <div id="Result" runat="server" style="height: 460px" visible="false">
                        <telerik:radgrid ID="fzgGrid" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False"
                            runat="server" GridLines="None" height="420px" Width="100%" BorderWidth="0px"
                            AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"  Visible="False" Culture="de-DE" 
                            ...
                            OnSortCommand="FzgGridSortCommand"
                            CellSpacing="0" ClientSettings-AllowColumnsReorder="false" VirtualItemCount="2">
                            <exportsettings HideStructureColumns="true" IgnorePaging="True" OpenInNewWindow="True"
                                ExportOnlyData="false" >
                    <Excel Format="ExcelML"></Excel>
                    </exportsettings>
                            <mastertableview datakeynames="" commanditemdisplay="Top" summary="KFZ Steuer Avisierung"
                        ...
                        <ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
                         ...
                         <telerik:GridEditCommandColumn ButtonType="ImageButton" 
                                 SortExpression="EditCommandColumn" HeaderText="" UniqueName="EditCommandColumn" 
                                 CancelText="Abbrechen" EditText="Bemerkung ändern" InsertText="Übernehmen">
                    ...
                    <div id="dataQueryFooter">
                        <asp:LinkButton ID="lb_Weiter" runat="server" Text="lb_Weiter" CssClass="Tablebutton"
                            Width="78px" Height="16px" CausesValidation="False" Font-Underline="False" OnClick="lb_Weiter_Click">» Suchen</asp:LinkButton>
                    </div>
                    <div id="dataFooter">
                        &nbsp;
                    </div>
