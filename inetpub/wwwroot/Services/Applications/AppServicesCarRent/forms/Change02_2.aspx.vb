...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lnkKreditlimit.NavigateUrl = "Change02.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdSave.Click
        ...
        Else
            ...
            Response.Redirect("Change02_3.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart)
        End If
    End Sub
...
#Region "Methods"
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "", Optional ByVal fill As Boolean = False)
        ...
        Else
            ...
            lblNoData.Text = "Es wurde(n) " & tmpDataView.Count.ToString & " Schlüssel gefunden."
            lblNoData.Visible = True
