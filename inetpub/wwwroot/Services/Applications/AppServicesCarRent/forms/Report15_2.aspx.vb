...
Partial Public Class Report15_2
    Inherits Page
#Region "Declarations"
    ...
    Private ResultStueckliste As DataTable
...
#Region "Methods"
    ...
    Private Sub FillKeyInfo()
        ...
        If Not Session("objReport") Is Nothing Then
            ...
            _historie.FILLStueckliste(Session("AppID").ToString, Session.SessionID.ToString, Me, strFahrg, "")
            With _historie

                lblFahrgestellnummer.Text = strFahrg

                If Not .ResultStueckliste Is Nothing AndAlso Not .ResultStueckliste.Rows Is Nothing AndAlso .ResultStueckliste.Rows.Count > 0 Then
                    Session("AppResultStueckliste") = .ResultStueckliste
                    'Befüllen des Grids läuft über das "NeedDataSource"-Event
                Else
                    trLebenslaufTueteStkl.Visible = False
                End If
            End With
        End If
