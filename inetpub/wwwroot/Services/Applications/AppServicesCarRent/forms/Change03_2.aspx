<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change03_2.aspx.vb" Inherits="AppServicesCarRent.Change03_2"     MasterPageFile="../MasterPage/App.Master" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField SortExpression="MANDT" HeaderText="col_Anfordern">
                                                   <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chk0000" runat="server" Visible='<%# DataBinder.Eval(Container, "DataItem.STATUS") ="" %>'></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField SortExpression="ZZZLDAT" HeaderText="col_ZulDatum">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_ZulDatum" runat="server" CommandName="Sort" CommandArgument="ZZZLDAT">col_ZulDatum</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblZulDatum" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.REPLA_DATE","{0:d}") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
