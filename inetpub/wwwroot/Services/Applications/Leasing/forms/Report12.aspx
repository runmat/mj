<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report12.aspx.cs" Inherits="Leasing.forms.Report12"
            ...
            <div id="innerContent">
                <div id="innerContentRight" style="width: 100%">
                    ...
                    <telerik:RadGrid ID="tempBriefGrid" runat="server" AllowSorting="true" AllowPaging="true"
                        ...
                        <%--OnExcelMLExportRowCreated="fzgGrid_ExcelMLExportRowCreated" OnExcelMLExportStylesCreated="fzgGrid_ExcelMLExportStylesCreated"--%>
                        ...
                        <MasterTableView CommandItemDisplay="Top" Summary="Temporär versendete Briefe" TableLayout="Auto"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn SortExpression="Status" UniqueName="Status" HeaderText=" ">
                                    <ItemTemplate>
                                        ...
                                        <asp:Image runat="server" Visible='<%# string.IsNullOrEmpty((string)Eval("Status")) %>'
                                            Width="12px" Height="12px" ToolTip="Endgültiger Versand beauftragt" ImageUrl="/Services/Images/ok02_10.jpg" />
                                    </ItemTemplate>
                                ...
                                <telerik:GridBoundColumn DataField="CHASSIS_NUM" SortExpression="CHASSIS_NUM" UniqueName="CHASSIS_NUM"
                                    Display="True" HeaderStyle-Width="20%" Groupable="False" ItemStyle-Wrap="false" />
                                <%--Kfz-Kennzeichen--%>
                                ...
                                <telerik:GridBoundColumn DataField="LIZNR" SortExpression="LIZNR" UniqueName="LIZNR"
                                    Display="True" Groupable="False" ItemStyle-Wrap="false" />
                                <%--Objektnummer--%>
                                <telerik:GridBoundColumn DataField="ZZREFERENZ1" SortExpression="ZZREFERENZ1" UniqueName="ZZREFERENZ1"
                                    Display="True" HeaderStyle-Width="20%" Groupable="False" ItemStyle-Wrap="false" />
                                <%--DAD Versanddatum/Lastscan--%>
                                <telerik:GridBoundColumn DataField="ZZTMPDT" SortExpression="ZZTMPDT" DataFormatString="{0:dd.MM.yyyy}"
                                    UniqueName="ZZTMPDT" Display="True" HeaderStyle-Width="20%" Groupable="False"
                    ...
                    <div id="dataQueryFooter">
                        ...
                        <asp:LinkButton ID="cmdEnd" runat="server" CssClass="Tablebutton" Width="78px" Height="16px"
                            Style="float: left;" CausesValidation="False" Font-Underline="False" OnClick="EndVersendet"
                            Enabled="False">» Endgültig</asp:LinkButton>
                    </div>
                    <div id="dataFooter">
                        &nbsp;
                    </div>
