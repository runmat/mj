<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_002_03.aspx.cs" Inherits="Leasing.forms.Report_002_03"  MasterPageFile="../Master/App.Master" %>
                             ...
                             <div id="data">
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <asp:TemplateField SortExpression="Versand" HeaderText="col_Versand">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_Versand" runat="server" CommandName="Sort" CommandArgument="Status">col_Versand</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField SortExpression="Mahndatum_LN" HeaderText="col_Mahndatum_LN">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_Mahndatum_LN" runat="server" CommandName="Sort" CommandArgument="Mahndatum_LN">col_Mahndatum_LN</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblMahndatum_LN" Text='<%# DataBinder.Eval(Container, "DataItem.Mahndatum_LN", "{0:d}") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle Wrap="False" />
                                                    <ItemStyle Wrap="False" />
                                                </asp:TemplateField>
                                                <asp:TemplateField SortExpression="Mahnstufe_LN" HeaderText="col_Mahnstufe_LN">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_Mahnstufe_LN" runat="server" CommandName="Sort" CommandArgument="Mahnstufe_LN">col_Mahnstufe_LN</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblMahnstufe_LN" Text='<%# DataBinder.Eval(Container, "DataItem.Mahnstufe_LN") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle Wrap="False" />
                                                    <ItemStyle Wrap="False" />
                                                ...
                                                <asp:TemplateField SortExpression="Versand_VG" HeaderText="col_Versand_VG">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_Versand_VG" runat="server" CommandName="Sort" CommandArgument="col_Mahnstufe_LN">col_Mahnstufe_LN</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField SortExpression="Mahndatum_VG" HeaderText="col_Mahndatum_VG">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_Mahndatum_VG" runat="server" CommandName="Sort" CommandArgument="Mahndatum_VG">col_Mahndatum_VG</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblMahndatum_VG" Text='<%# DataBinder.Eval(Container, "DataItem.Mahndatum_VG") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle Wrap="False" />
                                                    <ItemStyle Wrap="False" />
                                                </asp:TemplateField>     
                                                <asp:TemplateField SortExpression="Mahnstufe_VG" HeaderText="col_Mahnstufe_VG">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_Mahnstufe_VG" runat="server" CommandName="Sort" CommandArgument="col_Mahnstufe_VG">col_Info</asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblMahnstufe_VG" Text='<%# DataBinder.Eval(Container, "DataItem.Mahnstufe_VG") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle Wrap="False" />
                                                    <ItemStyle Wrap="False" />
