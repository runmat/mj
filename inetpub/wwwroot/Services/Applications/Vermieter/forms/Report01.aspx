<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report01.aspx.cs" Inherits="Vermieter.forms.Report01"
                            ...
                            <table id="tab1" runat="server" cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr class="formquery">
                                    ...
                                    <td class="active" style="width: 100%">
                                        <span>
                                            <asp:RadioButton ID="rbAlle" runat="server" Checked="True" Text="Alles" GroupName="TypAuswahl" />
                                        </span>
                                    </td>
                                </tr>
                                <tr class="formquery">
                                    ...
                                    <td class="active" style="width: 100%">
                                        <span>
                                            <asp:RadioButton ID="rbBriefe" runat="server" Text="Nur Briefe" GroupName="TypAuswahl" /></span>
                                    </td>
                                </tr>
                                <tr class="formquery">
                                    <td class="firstLeft active">
                                    ...
                                    <td class="active" style="width: 100%">
                                        <span>
                                            <asp:RadioButton ID="rbSchluessel" runat="server" Text="Nur Schlüssel" GroupName="TypAuswahl" />
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div style="font-weight: bold; margin-top: 20px; padding-left: 15px; padding-top: 5px;
                                            padding-bottom: 5px; padding-right: 17px; color: #4c4c4c;">
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td class="active" style="vertical-align: middle; width:22px;">
                                                        <asp:ImageButton ID="ibtDetails" runat="server" Style="padding-left: 0px" Width="17px" OnClick="ibtDetails_Click" />
                                                    </td>
                                ...
                                <tr class="formquery">
                                    ...
                                    <td class="active" style="width: 100%">
                                        <asp:Panel ID="pnlDetails" runat="server" Width="650px" Visible="false">
                                            <span>
                                                <asp:CheckBox ID="chkBeauftragte" runat="server" Checked="True" Text="auch neue Beauftragungen" />&nbsp;
                                                <asp:CheckBox ID="chkTreuOffen" runat="server" Text="Freigabe Treugeber offen" Checked="True" />&nbsp;
                                                <asp:CheckBox ID="chkVersandvorbereitung" runat="server" Text="Versandvorbereitung DAD"
                                                    Checked="True" />
                                            </span>
                                        </asp:Panel>
                                    </td>
