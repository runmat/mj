<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dokverandKontingente.aspx.vb" Inherits="AppGenerali.dokverandKontingente"   MasterPageFile="../MasterPage/Genarali.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <asp:Content ID="ContentMenue" ContentPlaceHolderID="ContentPlaceHolderMenue" runat="server">
     <uc1:menue ID="menue"  runat="server"/>
</asp:Content>
