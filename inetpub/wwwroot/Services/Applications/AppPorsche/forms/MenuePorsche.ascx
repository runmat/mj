<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="MenuePorsche.ascx.vb" Inherits="AppPorsche.MenuePorsche" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>


   
    <div style="width: 29px; position: static; margin-top: 15px; ">
    <asp:ImageButton ID="ibtnInfo" ToolTip="Menü" OnClientClick="return false;"  runat="server" ImageUrl="../../../Images/navi_grey.gif" />
</div>
    <div id="flyout">
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" 
                ...
                <div id="btnCloseParent" >
                    schliessen <asp:LinkButton ID="btnClose" runat="server" 
                        OnClientClick="return false;" Text="X" ToolTip="schliessen"  Style=" color: #666666; 
                         text-align: center; font-weight: bold; text-decoration: none; border: outset thin #FFFFFF;
                         padding: 2px;" />
                </div>
                ...
                <div style="margin-top: 5px;"  align="center" >
                    <asp:GridView Width="395px" ID="GridChange" runat="server" AutoGenerateColumns="False"
                        ...
                        <HeaderStyle CssClass="menuehead" ForeColor="White" />
                ...
                <div  style="margin-top: 5px;"  align="center" >
                    <asp:GridView Width="395px" ID="Report" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" DataNavigateUrlFields="AppUrl"
                                DataTextField="AppFriendlyName" HeaderText="Report" ControlStyle-CssClass="MainmenuLink"
                                ItemStyle-CssClass="MainmenuItemAlternate" ItemStyle-Wrap="False" >
                                <ControlStyle CssClass="MainmenuLink" />
                                <ItemStyle CssClass="MainmenuItemAlternate" HorizontalAlign="Left" 
                                    Wrap="False" />
        ...
        <Animations>
                <OnClick>
                    <Sequence>
                        ...
                        <FadeIn AnimationTarget="info" Duration=".2" MaximumOpacity=".96"/>
                        <StyleAction AnimationTarget="flyout" Attribute="display" Value="none"/>
                        <%-- Flash the text/border red and fade in the "close" button --%>
                              <Parallel AnimationTarget="flyout" Duration=".5">
                            <FadeIn AnimationTarget="btnCloseParent" MaximumOpacity=".96" />
                        </Parallel>
                    </Sequence>
                </OnClick>
        </Animations>
