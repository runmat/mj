<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report02s_1.aspx.cs" Inherits="AppMBB.forms.Report02s_1" %>
                ...
                <table height="963" cellspacing="0" cellpadding="0" width="733" border="0" ms_2d_layout="TRUE">
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="9" rowspan="2">
                            <asp:Label ID="Label45" runat="server" Font-Names="Arial" Font-Size="Small">Stadt Flensburg<br>FB 1/Kfz-Zulassung und Führerscheinstelle<br>Rudolf-Diesel-Str. 3a<br>24941 Flensburg</asp:Label>
                        </td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="7">
                            <asp:Label ID="Label25" runat="server" Font-Size="Smaller" Font-Names="Arial">Typ und Ausführung</asp:Label>
                        </td>
                        <td colspan="4">
                        </td>
                    </tr>
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="13">
                            <asp:Label ID="Label41" runat="server" Font-Size="Smaller" Font-Names="Arial" Font-Bold="True">Erklärung des Anzeigenden</asp:Label>
                        </td>
                        <td colspan="7">
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td colspan="20">
                            <asp:Label ID="Label42" runat="server" Font-Size="Smaller" Font-Names="Arial" Width="609px"
                                Height="39px">Das / die Kennzeichen wurden vom Halter bei Rückgabe des Leasingfahrzeuges trotz Aufforderung nicht zurück gegeben. Der Halter ist nicht bereit, eine Verlusterklärung abzugeben.</asp:Label>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td colspan="20">
                            <asp:Label ID="Label46" runat="server" Font-Names="Arial" Font-Size="Smaller" Width="606px"
                                Height="28px">Ich werde die Zulassungsstelle für Kraftfahrzeuge umgehend verständigen, wenn ich das / die Kennzeichen ohne deren Mitwirkung zurückerhalten sollte.</asp:Label>
                        </td>
                    </tr>
                    <tr valign="top">
