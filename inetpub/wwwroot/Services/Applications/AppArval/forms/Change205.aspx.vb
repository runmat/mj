            ...
            If Not (uFile Is Nothing) Then
                ...
                For Each rowData In objDataset1.Tables(0).Rows
                    ...
                    If Not (strLeasingvertragsNr.Length = 0 Or strKennzeichen.Length = 0) Then
                        ...
                        Else
                            If Not IsNumeric(strLeasingvertragsNr) Then Continue For
                        ...
                        If (tblTemp.Columns.Count) = 0 Then
                            ...
                            tblTemp = objHaendler.Result.Clone()
                            tblTemp.Rows.Clear()
                            tblTemp.Columns.Add("STATUS", GetType(String))
                ...
                If Not tblTemp.Rows Is Nothing AndAlso tblTemp.Rows.Count > 0 Then
                    objHaendler.Fahrzeuge = tblTemp
                    Session("objHaendler") = objHaendler
                    Response.Redirect(String.Format("Change205_2.aspx?AppID={0}&art={1}&file={2}", Session("AppID"), versandart, cbxDatei.Checked))
                Else
...
' 
' *****************  Version 1  *****************
' User: Jungj        Date: 17.04.09   Time: 11:20
