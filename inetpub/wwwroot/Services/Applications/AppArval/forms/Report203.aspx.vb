    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            If lblError.Text.Length = 0 Then
                m_Report.Fill(Session("AppID").ToString, Session.SessionID, Me, txtAbmeldedatumVon.Text, rbArt.SelectedItem.Value.ToString)
...
' 
' *****************  Version 2  *****************
' User: Dittbernerc  Date: 29.07.09   Time: 16:38
