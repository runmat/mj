<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeBehind="Input_002_01.aspx.vb"
    Inherits="AppArval.Input_002_01" MasterPageFile="../../../MasterPage/Services.Master" %>
                    ...
                    <div id="innerContentRight" style="width: 100%;">
                        ...
                        <div id="dataFooter">
                            <asp:LinkButton ID="cmdCreate" Text="Report erstellen" Height="16px" Width="128px"
                                runat="server" CssClass="TablebuttonLarge"></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
