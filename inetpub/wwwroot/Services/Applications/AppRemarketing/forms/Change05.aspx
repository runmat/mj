<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change05.aspx.cs" Inherits="AppRemarketing.forms.Change05" 
                                ...
                                <tr class="formquery">
                                    ...
                                    <td class="active" style="width: 88%">
                                        <span>
                                            ...
                                            OnCheckedChanged="rbDetail_CheckedChanged" />  </span>
                                    </td>
                                </tr>
                                <tr class="formquery">
                                ...
                                <table id="tab1" runat="server" cellpadding="0" cellspacing="0" width="100%" style="width: 100%;border-bottom: none">
                                    <tbody>
                                        ...
                                        <tr id="trSelectionButton" runat="server" class="formquery">
                                            <td colspan="2" class="firstLeft active" style="width: 100%;height: 57px">
