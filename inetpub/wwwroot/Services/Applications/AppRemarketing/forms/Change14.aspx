<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change14.aspx.cs" Inherits="AppRemarketing.forms.Change14"  MasterPageFile="../Master/AppMaster.Master" %>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr class="formquery">
                                    ...
                                    <td class="firstLeft active">
                                        ...
                                        <a href="javascript:openinfo('InfoHCAusgang.htm');">
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn DataField="DAT_HC_AUSG" SortExpression="DAT_HC_AUSG" Groupable="false">
