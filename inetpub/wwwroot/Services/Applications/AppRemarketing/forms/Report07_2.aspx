<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report07_2.aspx.cs" Inherits="AppRemarketing.forms.Report07_2" MasterPageFile="../Master/AppMaster.Master" %>
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="BEM_1" SortExpression="BEM_1" >
                                                        <HeaderStyle Width="200px" />
                                                        <ItemStyle Wrap="false" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="IMPDAT_SCHAEDEN" SortExpression="IMPDAT_SCHAEDEN" DataFormatString="{0:d}" >
