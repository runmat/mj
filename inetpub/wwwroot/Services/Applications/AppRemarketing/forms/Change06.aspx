<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change06.aspx.cs" Inherits="AppRemarketing.forms.Change06"
                        ...
                        <table id="tab1" runat="server" cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr class="formquery">
                                <td class="firstLeft active" colspan="2" style="width: 100%">
                                    ...
                                    <asp:Label ID="lblNoData" runat="server" Visible="true"></asp:Label>&nbsp
                                </td>
                            </tr>
                            <tr id="trSearchFin" runat="server" visible="true" class="formquery">
