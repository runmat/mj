...
namespace AppRemarketing.forms
{
    public partial class Change09 : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                tblData = (DataTable)Session["VorschaedenTable"];
            }

            if (Session["Vorschaeden"] != null)
            {
        ...
        private void Fillgrid()
        {
            ...
            else
            {
                ...
                Session["VorschaedenTable"] = tblData;
        ...
        protected void lbSend_Click(object sender, EventArgs e)
        {
            ...
            if (tr_Fin.Visible)
            {
                ...
                //Wird für die Einzelerfassung nicht benötigt.
                m_Report.tblError = null;
        ...
        protected void Auswahl_CheckedChanged(object sender, EventArgs e)
        {
            tr_Upload.Visible = rbUpload.Checked;
            lbCreate.Visible = rbUpload.Checked;
            lbSend.Visible = rbEinzelerfassung.Checked;
            tr_Fin.Visible = rbEinzelerfassung.Checked;
            tr_Kennzeichen.Visible = rbEinzelerfassung.Checked;
        ...
        protected void rgGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case RadGrid.ExportToExcelCommandName:
                    ...
                    eSettings.FileName = string.Format("UploadVorschaeden_{0:yyyyMMdd}", DateTime.Now);
