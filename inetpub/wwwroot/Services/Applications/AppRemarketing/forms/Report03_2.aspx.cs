...
{
    public partial class Report03_2 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Report03.aspx?AppID=" + (string)Session["AppID"]);
        }
        ...
        protected void rgGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case RadGrid.ExportToExcelCommandName:
                    ...
                    eSettings.FileName = string.Format("Gesamtdaten_{0:yyyyMMdd}", DateTime.Now);
