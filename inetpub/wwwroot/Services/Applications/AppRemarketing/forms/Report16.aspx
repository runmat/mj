<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report16.aspx.cs" Inherits="AppRemarketing.forms.Report16"  MasterPageFile="../Master/AppMaster.Master" %>
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="Ausgangsdatum" SortExpression="Ausgangsdatum" DataFormatString="{0:d}" >
