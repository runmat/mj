...
{
    public partial class Change17 : Page
    {
        private User m_User;
        private App m_App;
        private bool isExcelExportConfigured;
        private UebergabeTUEV m_Report;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (Session["objUebergabeTUEV"] != null)
            {
                m_Report = (UebergabeTUEV)Session["objUebergabeTUEV"];
            }
        }
        ...
        protected void lbCreate_Click(object sender, EventArgs e)
        {
            ...
            m_Report = new UebergabeTUEV(ref m_User, m_App, (string)Session["AppID"], Session.SessionID, "");
            ...
            m_Report.tblUpload.Columns.Add("DAT_UEB_HC_TUEVSUED", typeof(string));
            m_Report.tblUpload.Columns.Add("HCORT", typeof(string));
            m_Report.tblUpload.Columns.Add("KM_STAND_UEB", typeof(string));
            ...
            foreach (DataRow dr in tmpTable.Rows)
            {
                ...
                {
                    newRow["DAT_UEB_HC_TUEVSUED"] = Convert.ToDateTime(dr[2]).ToShortDateString();
                }
                else
                {
                    lblError.Text = "Kein korrektes Übergabedatum. Bitte überprüfen Sie Ihre Daten.";
                    return;
                }

                newRow["HCORT"] = dr[3];
                newRow["KM_STAND_UEB"] = dr[4];

                m_Report.tblUpload.Rows.Add(newRow);
            }

            m_Report.Edit = false;
            Session["objUebergabeTUEV"] = m_Report;
        ...
        protected void rgGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if ((m_Report.Edit) && (e.Item is GridDataItem))
            {
                ...
                item.FindControl("txtUebergabedatum").Visible = true;
                item.FindControl("lblUebergabedatum").Visible = false;
            ...
            foreach (GridDataItem gdi in rgGrid1.Items)
            {
                ...
                if (id != "&nbsp;")
                {
                    ...
                    if (errorRows.Length > 0)
                    {
                        ...
                        errorRows[0]["DAT_UEB_HC_TUEVSUED"] = ((TextBox)gdi.FindControl("txtUebergabedatum")).Text;
                        errorRows[0]["HCORT"] = ((TextBox)gdi.FindControl("txtHCOrt")).Text;
                        errorRows[0]["KM_STAND_UEB"] = ((TextBox)gdi.FindControl("txtKM")).Text;
                    }
                }
            }
        ...
        protected void lbSend_Click(object sender, EventArgs e)
        {
            ...
            m_Report.setUebergabedatum((string)Session["AppID"], (string)Session.SessionID, this);
        ...
        protected void rgGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case RadGrid.ExportToExcelCommandName:
                    ...
                    eSettings.FileName = string.Format("UploadUebergabeTUEV_{0:yyyyMMdd}", DateTime.Now);
