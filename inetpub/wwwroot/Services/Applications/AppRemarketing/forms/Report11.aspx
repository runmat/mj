                                                    ...
                                                    <telerik:GridTemplateColumn Groupable="false">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="lnkTuev" runat="server" Target="_blank" ImageUrl="/services/images/TUEV.png"
                                                                ...
                                                                NavigateUrl='<%# "http://vw-ruecknahme.autoplus-portal.de/getDADFile?fin=" + Eval("FAHRGNR").ToString() %>' ></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:RadGrid ID="rgGrid2" Visible="false" runat="server" PageSize="10" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" >
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="SCHADBETR_AV" SortExpression="SCHADBETR_AV" DataFormatString="{0:c}">
                                                        <HeaderStyle Width="85px" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="AUFBETR_AV" SortExpression="AUFBETR_AV" DataFormatString="{0:c}">
                                                        <HeaderStyle Width="85px" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="OPTWRTAV" SortExpression="OPTWRTAV" DataFormatString="{0:c}">
                                                        <HeaderStyle Width="85px" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="WRTMBETR_AV" SortExpression="WRTMBETR_AV" DataFormatString="{0:c}">
                                                        <HeaderStyle Width="85px" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
