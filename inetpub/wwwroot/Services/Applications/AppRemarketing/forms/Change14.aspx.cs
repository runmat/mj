...
namespace AppRemarketing.forms
{
    public partial class Change14 : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                tblData = (DataTable)Session["HCAusgangUploadTable"];
            }

            if (Session["HCAusgangUpload"] != null)
            {
                m_Report = (HC)Session["HCAusgangUpload"];
            }
        }
        ...
        protected void lbCreate_Click(object sender, EventArgs e)
        {
            ...
            m_Report.tblUpload.Columns.Add("DAT_HC_AUSG", typeof(string));
            ...
            foreach (DataRow dr in tmpTable.Rows)
            {
                ...
                {
                    newRow["DAT_HC_AUSG"] = Convert.ToDateTime(dr[2]).ToShortDateString();
                }
                else
                {
        ...
        private void Fillgrid()
        {
            ...
            else
            {
                ...
                Session["HCAusgangUploadTable"] = tblData;
        ...
        {
            Session["HCAusgangUploadTable"] = null;
        ...
        protected void lbSend_Click(object sender, EventArgs e)
        {
            ...
            m_Report.setHCAusgaenge((string)Session["AppID"], (string)Session.SessionID, this);
            ...
            if (m_Report.tblError.Rows.Count > 0)
            {
                ...
                ((HC)Session["HCAusgangUpload"]).Edit = true;
        ...
        protected void rgGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case RadGrid.ExportToExcelCommandName:
                    ...
                    eSettings.FileName = string.Format("UploadHCAusgaenge_{0:yyyyMMdd}", DateTime.Now);
