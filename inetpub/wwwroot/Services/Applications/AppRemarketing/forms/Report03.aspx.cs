...
namespace AppRemarketing.forms
{
    public partial class Report03 : System.Web.UI.Page
    {
        ...
        private GesamtdatenPublic m_report;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    m_report = new GesamtdatenPublic(ref m_User, m_App, (string)Session["AppID"], (string)Session.SessionID, strFileName);
                ...
                else
                {
                    ...
                    {
                        m_report = (GesamtdatenPublic)Session["objReport"];
                    }
                }
        ...
        protected void cmdSearch_Click(object sender, EventArgs e)
        {
            if (rb_Einzelselektion.Checked == true)
            {
                ...
                else if (txtFahrgestellnummer.Text.Length > 0)
                {
                    m_report.tblUpload = new DataTable();
                    m_report.tblUpload.Columns.Add("F1", System.Type.GetType("System.String"));
                    DataRow NewRow = m_report.tblUpload.NewRow();
        ...
        private void DoSubmit()
        {
            ...
            else
            {
                ...
                Response.Redirect("Report03_2.aspx?AppID=" + (string)Session["AppID"]);
            }
...
//
//*****************  Version 3  *****************
//User: Jungj        Date: 16.09.10   Time: 20:11
//Updated in $/CKAG2/Applications/AppRemarketing/forms
//ITA 4127 unfertig
//
//*****************  Version 2  *****************
//User: Jungj        Date: 15.09.10   Time: 18:50
//Updated in $/CKAG2/Applications/AppRemarketing/forms
//ITA 4127 unfertig
//
// ************************************************ 