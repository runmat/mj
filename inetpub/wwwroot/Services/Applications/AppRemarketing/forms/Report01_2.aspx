<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report01_2.aspx.cs" Inherits="AppRemarketing.forms.Report01_2"  
                                    ...
                                    <div style="width: 100%; max-width: 909px">        
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    <telerik:GridBoundColumn DataField="Vermieter" SortExpression="Vermieter" >
                                                    ...
                                                    <telerik:GridBoundColumn DataField="DatumZBII" SortExpression="DatumZBII" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="CarportEingang" SortExpression="CarportEingang" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="RkRechnung" SortExpression="RkRechnung" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Gutachten" SortExpression="Gutachten" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Stilllegung" SortExpression="Stilllegung" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
                                            </MasterTableView>
