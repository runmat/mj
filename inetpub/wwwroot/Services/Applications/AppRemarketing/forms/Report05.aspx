<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report05.aspx.cs" Inherits="AppRemarketing.forms.Report05" MasterPageFile="../Master/AppMaster.Master" %>
                    ...
                    <asp:Panel ID="Panel1" runat="server" DefaultButton="lbCreate">
                        <div id="TableQuery" runat="server" style="margin-bottom: 10px">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr id="tr_Carport" runat="server" class="formquery">
                                    <td class="firstLeft active">
                                        Carport:
                                    </td>
                                    <td class="firstLeft active">
                                        <asp:TextBox ID="txtCarport" runat="server" CssClass="TextBoxNormal" Width="200px"
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="Carport-Nummer" SortExpression="Carport-Nummer" >
                                                        <HeaderStyle Width="100px" />
                                                        <ItemStyle Wrap="false" />
                                                    </telerik:GridBoundColumn>
