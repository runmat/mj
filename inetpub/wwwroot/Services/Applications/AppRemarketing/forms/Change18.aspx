<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change18.aspx.cs" Inherits="AppRemarketing.forms.Change18" MasterPageFile="../Master/AppMaster.Master" %>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr class="formquery">
                                    ...
                                    <td class="firstLeft active">
                                        ...
                                        <a href="javascript:openinfo('InfoRechnungsdaten.htm');">
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn DataField="NUMMER_RE" SortExpression="NUMMER_RE" Groupable="false">
                                                        <HeaderStyle Width="105px" />
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblRechnungsnummer" Text='<%# Eval("NUMMER_RE") %>'>
                                                            </asp:Label>
                                                            <asp:TextBox ID="txtRechnungsnummer" runat="server" Visible="False" 
                                                                Text='<%# Eval("NUMMER_RE") %>' 
                                                                BorderColor="Red" Width="100px" BorderWidth="1px">
                                                            </asp:TextBox>
                                                        </ItemTemplate>
                                                    ...
                                                    <telerik:GridTemplateColumn DataField="BETRAG_RE" SortExpression="BETRAG_RE" Groupable="false">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblRechnungsbetrag" Text='<%# Eval("BETRAG_RE") %>'>
                                                            </asp:Label>
                                                            <asp:TextBox ID="txtRechnungsbetrag" runat="server" Visible="False" 
                                                                Text='<%# Eval("BETRAG_RE") %>' 
                                                                BorderColor="Red" Width="80px" BorderWidth="1px">
                                                            </asp:TextBox>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridTemplateColumn DataField="DATUM_RE" SortExpression="DATUM_RE" Groupable="false">
                                                        <HeaderStyle Width="85px" />
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblRechnungsdatum" Text='<%# Eval("DATUM_RE") %>'>
                                                            </asp:Label>
                                                            <asp:TextBox ID="txtRechnungsdatum" runat="server" Visible="False" 
                                                                Text='<%# Eval("DATUM_RE", "{0:dd.MM.yyyy}") %>' 
                                                                BorderColor="Red" Width="80px" BorderWidth="1px">
                                                            </asp:TextBox>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
