<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report23.aspx.cs" Inherits="AppRemarketing.forms.Report23" MasterPageFile="../Master/AppMaster.Master" %>
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn DataField="HALTED" SortExpression="HALTED" GroupByExpression="HALTED GROUP BY HALTED" >
                                                    ...
                                                    <telerik:GridTemplateColumn DataField="TAGE_UEBERF" SortExpression="TAGE_UEBERF" GroupByExpression="TAGE_UEBERF GROUP BY TAGE_UEBERF" >
                                                        <HeaderStyle Width="85px" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                        <ItemTemplate>
