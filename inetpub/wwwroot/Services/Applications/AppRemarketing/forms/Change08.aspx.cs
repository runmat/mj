...
{
    public partial class Change08 : Page
    {
        private User m_User;
        private App m_App;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                tblData = (DataTable)Session["SelbstvermarktungTable"];
            }

            if (Session["Selbstvermarktung"] != null)
            {
                m_Report = (ZulassungsdatenPublic)Session["Selbstvermarktung"];
            }
        }
        ...
        protected void lbCreate_Click(object sender, EventArgs e)
        {
            ...
            m_Report.tblUpload.Columns.Add("DAT_ABRECHNUNG", typeof(string));
            ...
            foreach (DataRow dr in tmpTable.Rows)
            {
                ...
                newRow["FAHRGNR"] = dr[0].ToString();

                DateTime DummyDate;
                if ((DateTime.TryParse(dr[1].ToString(), out DummyDate)))
                {
                    newRow["DAT_ABRECHNUNG"] = DummyDate.ToShortDateString();
                }
                else
                {
                    newRow["DAT_ABRECHNUNG"] = dr[1].ToString();
                }
            ...
            m_Report.Edit = false;
            Session["Selbstvermarktung"] = m_Report;
        ...
        private void Fillgrid()
        {
            if (!m_Report.Edit)
            {
                ...
                rgGrid1.MasterTableView.GetColumn("ZBEM").Visible = false;
            }
            else
            {
                ...
                if (rgGrid1.MasterTableView.GetColumn("ZBEM").Visible)
                {
                    UpdateErrTable();
                }
                else
                {
                    rgGrid1.MasterTableView.GetColumn("ZBEM").Visible = true;
                }
            }
            ...
            else
            {
                ...
                Session["SelbstvermarktungTable"] = tblData;
        ...
        {
            Session["SelbstvermarktungTable"] = null;
        ...
        private DataTable getDataTableFromExcel(string filepath, string filename)
        {
            ...
            object[] tmpObj = { null, null, null, "Table" };

            DataTable schemaTable = objConn.GetOleDbSchemaTable(System.Data.OleDb.OleDbSchemaGuid.Tables, tmpObj);
        ...
        protected void lbSend_Click(object sender, EventArgs e)
        {
            ...
            m_Report.setSelbstvermarktung((string)Session["AppID"], Session.SessionID, this);
            ...
            if (m_Report.tblError.Rows.Count > 0)
            {
                ...
                ((ZulassungsdatenPublic)Session["Selbstvermarktung"]).Edit = true;
        ...
        protected void rgGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case RadGrid.ExportToExcelCommandName:
                    ...
                    eSettings.FileName = string.Format("UploadSelbstvermarktung_{0:yyyyMMdd}", DateTime.Now);
