<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report03_2.aspx.cs" Inherits="AppRemarketing.forms.Report03_2"  
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="MELDDATGUTA" SortExpression="MELDDATGUTA" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="SCHADMELDDAT" SortExpression="SCHADMELDDAT" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="100px" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
                                            </MasterTableView>
