<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change07.aspx.cs" Inherits="AppRemarketing.forms.Change07" MasterPageFile="../Master/AppMaster.Master" %>
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="Zulassungsdatum" SortExpression="Zulassungsdatum" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="105px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Briefnummer" SortExpression="Briefnummer" >
