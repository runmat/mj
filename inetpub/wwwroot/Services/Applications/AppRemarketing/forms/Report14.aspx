<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report14.aspx.cs" Inherits="AppRemarketing.forms.Report14" MasterPageFile="../Master/AppMaster.Master" %>
                                ...
                                <td>
                                    <div style="width: 100%; max-width: 909px">        
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            OnItemCommand="rgGrid1_ItemCommand" OnNeedDataSource="rgGrid1_NeedDataSource" >
                                            ...
                                            <MasterTableView Width="100%" TableLayout="Auto" AllowPaging="true" CommandItemDisplay="Top"  >
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="UPEPreis" SortExpression="UPEPreis" >
                                                        <HeaderStyle Width="85px" />
                                                        <ItemStyle Wrap="false" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
