...
namespace AppRemarketing.forms
{
    public partial class Report18 : System.Web.UI.Page
    {
        ...
        private Auswertung m_Report;
        private Belastungsanzeigen Autovermieter;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    m_Report = new Auswertung(ref m_User, m_App, (string)Session["AppID"], (string)Session.SessionID, strFileName);
                    Session.Add("Auswertung", m_Report);
                ...
                {
                    if (Session["Auswertung"] != null)
                    {
                        m_Report = (Auswertung)Session["Auswertung"];
                    }
                }
            }
            catch
        ...
        private void FillVermieter()
        {
            ...
            Autovermieter = new Belastungsanzeigen(ref m_User, m_App, (string)Session["AppID"], (string)Session.SessionID, "");
            ...
            else
            {
                ...
                {
                    Autovermieter.Vermieter = mVermieter.Vermieter;

                    Session["Vermieter"] = Autovermieter;
