<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change08.aspx.cs" Inherits="AppRemarketing.forms.Change08" MasterPageFile="../Master/AppMaster.Master" %>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr class="formquery">
                                    ...
                                    <td class="firstLeft active">
                                        ...
                                        <a href="javascript:openinfo('InfoUpload2.htm');">
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="DAT_ABRECHNUNG" SortExpression="DAT_ABRECHNUNG" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="105px" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="ZBEM" SortExpression="ZBEM" Visible="false" UniqueName="ZBEM" >
