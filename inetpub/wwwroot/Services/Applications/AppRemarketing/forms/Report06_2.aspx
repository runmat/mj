<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report06_2.aspx.cs" Inherits="AppRemarketing.forms.Report06_2"
                                        ...
                                        <telerik:RadGrid ID="rgGrid1" runat="server" PageSize="15" AllowSorting="True" 
                                            ...
                                            <MasterTableView Width="100%" GroupLoadMode="Client" TableLayout="Auto" AllowPaging="true" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="UEBMZLDAT" SortExpression="UEBMZLDAT" DataFormatString="{0:d}" >
                                                        <HeaderStyle Width="105px" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
                                            </MasterTableView>
