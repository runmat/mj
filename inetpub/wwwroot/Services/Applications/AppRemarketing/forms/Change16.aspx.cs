...
{
    public partial class Change16 : Page
    {
        private User m_User;
        private App m_App;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (Session["objReifenversand"] != null)
            {
                m_Report = (Reifenversand)Session["objReifenversand"];
            }
        }
        ...
        protected void lbCreate_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in tmpTable.Rows)
            {
                ...
                {
                    lblError.Text = "Kein korrektes Versanddatum. Bitte überprüfen Sie Ihre Daten.";
                    return;
                }
            ...
            m_Report.Edit = false;
            Session["objReifenversand"] = m_Report;
        ...
        protected void rgGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if ((m_Report.Edit) && (e.Item is GridDataItem))
            {
                ...
                item.FindControl("txtVersanddatum").Visible = true;
                item.FindControl("lblVersanddatum").Visible = false;
            }
        }
        ...
        protected void lbSend_Click(object sender, EventArgs e)
        {
            ...
            m_Report.setVersanddatum((string)Session["AppID"], (string)Session.SessionID, this);
        ...
        protected void rgGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case RadGrid.ExportToExcelCommandName:
                    ...
                    eSettings.FileName = string.Format("UploadReifenversand_{0:yyyyMMdd}", DateTime.Now);
