...
namespace AppRemarketing.forms
{
    public partial class Report07 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    m_report = new Schaden(ref m_User, m_App, (string)Session["AppID"], (string)Session.SessionID, strFileName);
                    Session.Add("Schaden", m_report);
                ...
                {
                    if ((Session["Schaden"] != null))
                    {
                        m_report = (Schaden)Session["Schaden"];
                    }
                }
        ...
        private void DoSubmit()
        {
            ...
            {
                Session["Schaden"] = m_report;
                Response.Redirect("Report07_2.aspx?AppID=" + (string)Session["AppID"]);
            }
        ...
        protected void cmdSearch_Click(object sender, EventArgs e)
        {
            if (rb_Einzelselektion.Checked == true)
            {
                ...
                if ((txtFahrgestellnummer.Text.Length > 0) || (txtKennzeichen.Text.Length > 0))
                {
                    m_report.tblUpload = new DataTable();
                    m_report.tblUpload.Columns.Add("FIN", System.Type.GetType("System.String"));
                    m_report.tblUpload.Columns.Add("Kennzeichen", System.Type.GetType("System.String"));

					DataRow NewRow = m_report.tblUpload.NewRow();
                    NewRow["FIN"] = txtFahrgestellnummer.Text.Trim();
                    NewRow["Kennzeichen"] = txtKennzeichen.Text.Trim();
                ...
                else
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        if (txtDatumBis.Text.Length > 0) { m_report.DatumBis = txtDatumBis.Text; }
