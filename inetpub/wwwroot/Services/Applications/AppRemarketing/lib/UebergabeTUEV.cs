...
{
    public class UebergabeTUEV : BankBase
	{
        #region "Declarations"
        ...
        public UebergabeTUEV(ref CKG.Base.Kernel.Security.User objUser, CKG.Base.Kernel.Security.App objApp, string strAppID, string strSessionID, string strFilename)
        ...
        public void setUebergabedatum(String strAppID, String strSessionID, System.Web.UI.Page page)
        {
            m_strClassAndMethod = "UebergabeTUEV.setUebergabedatum";
            m_strAppID = strAppID;
            m_strSessionID = strSessionID;

            try
            {
                DynSapProxyObj myProxy = DynSapProxy.getProxy("Z_DPM_REM_SET_UEB_HC_TUEVS_01", ref m_objApp, ref m_objUser, ref page);
                ...
                foreach (DataRow dr in tblUpload.Rows)
                {
                    ...
                    newRow["FAHRGNR"] = dr[0];
                    newRow["KENNZ"] = dr[1];
                    newRow["DAT_UEB_HC_TUEVSUED"] = dr[2];
                    newRow["HCORT"] = dr[3];
