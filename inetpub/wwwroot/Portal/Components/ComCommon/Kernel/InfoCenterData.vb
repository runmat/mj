...
#Region "Methods"
    ...
    Public Sub SaveDocumentRights(ByVal documentId As Integer, ByVal groups As Generic.List(Of Integer))
        Dim tablerow As DataRow
    ...
    Public Sub DeleteDocumentRights(ByVal documentId As Integer, ByVal groups As Generic.List(Of Integer))
        Dim tablerow As DataRow
