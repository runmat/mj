...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report11_2.aspx.vb" Inherits="CKG.Components.ComCommon.Report11_2" %>
													...
													<TR>
														<TD vAlign="top" align="left" colSpan="2" width="100%">
															<TABLE id="Table10" cellSpacing="0" cellPadding="5" bgColor="white" border="0">
																<TR>
																	<TD class="PageNavigation" vAlign="middle" align="left" colSpan="2">Status:&nbsp;
																		<asp:label id="lblStatus" runat="server"></asp:label></TD>
																	<TD class="PageNavigation" vAlign="middle" align="right" colSpan="3">
																		<asp:hyperlink id="lnkSchluesselinformationen" runat="server" NavigateUrl="Report38.aspx?chassisnum=" Target="_blank">Schlüsselinformationen</asp:hyperlink>&nbsp;&nbsp;
																		<asp:HyperLink id="HyperLink2" runat="server" Target="_blank"> ABE-Daten</asp:HyperLink></TD>
																</TR>
																<TR>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Kennzeichen:</TD>
																	...
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Briefnummer:&nbsp;</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:label id="lblBriefnummer" runat="server"></asp:label></TD>
																</TR>
																<TR id="Tr5" runat="server">
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">Fahrgestellnummer:</TD>
																	...
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">Briefeingang:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="lblBriefeingang" runat="server"></asp:label></TD>
																</TR>
																<TR>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Hersteller:</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:label id="lblHersteller" runat="server"></asp:label></TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Fahrzeugmodell:&nbsp;</TD>
																...
																<TR>
																	<TD class="" vAlign="top" align="left">Bereitdatum:</TD>
																	<TD class="" vAlign="top" align="right"><strong>
																			<asp:label id="lblBereitdatum" runat="server"></asp:label></strong></TD>
																	</STRONG>
																	<TD class="" vAlign="middle" align="left"></TD>
																	<TD class="" vAlign="top" align="left">PDI-Nummer / -Name:</TD>
																...
																<TR>
																	<TD class="PageNavigation" vAlign="middle" align="left">Briefdaten
																	</TD>
																	<TD class="PageNavigation" vAlign="top" align="right" colSpan="4">
																		<asp:label id="Label3" runat="server">CoC</asp:label>
																		<asp:checkbox id="cbxCOC" runat="server" Enabled="False" TextAlign="Left"></asp:checkbox></TD>
																</TR>
																<TR id="Tr1" runat="server">
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Erstzulassungsdatum:&nbsp;</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:label id="lblErstzulassungsdatum" runat="server"></asp:label></TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left"><asp:label id="lblMindestlaufzeitDescription" runat="server" Visible="False">Mindestlaufzeit:</asp:label>Ordernummer:</TD>
																...
																<TR>
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">Ehemaliges 
																		Kennzeichen:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="lblEhemaligesKennzeichen" runat="server"></asp:label></TD>
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">Umgemeldet 
																		am:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="lblUmgemeldetAm" runat="server"></asp:label></TD>
																</TR>
																<TR>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Ehemalige 
																		Briefnummer:</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:label id="lblEhemaligeBriefnummer" runat="server"></asp:label></TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Briefaufbietung:</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:checkbox id="chkBriefaufbietung" runat="server" Enabled="False"></asp:checkbox></TD>
																</TR>
																<TR>
																...
																<TR>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Carport-Eingang:</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:label id="lblPDIEingang" runat="server"></asp:label></TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left"></TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Kennzeicheneingang:</TD>
																	<TD class="TextLarge" vAlign="top" align="right"><asp:label id="lblKennzeicheneingang" runat="server"></asp:label></TD>
																</TR>
																<TR>
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">Check-In:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="lblCheckIn" runat="server"></asp:label></TD>
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left"></TD>
																	<TD class="StandardTableAlternateDescription" vAlign="middle" align="left">Fahrzeugschein:&nbsp;</TD>
																...
																<TR>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Beide Kennzeichen 
																		vorhanden:</TD>
																	...
																	<TD class="TextLargeDescription" vAlign="middle" align="left"></TD>
																	<TD class="TextLargeDescription" vAlign="middle" align="left">Stillegung:</TD>
