...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change81.aspx.vb" Inherits="CKG.Components.ComCommon.Change81" %>
										...
										<tr>
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
													<TR>
														<TD class="TextLarge" noWrap align="right">Leasingvertragsnummer:&nbsp;&nbsp;</TD>
													...
													<TR>
														<TD class="StandardTableAlternate" noWrap align="right">Nummer 
															ZB2:&nbsp;&nbsp;&nbsp;</TD>
														<TD class="StandardTableAlternate"><asp:textbox id="txtNummerZB2" runat="server" Width="250px" MaxLength="17"></asp:textbox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" noWrap align="right">Fahrgestell-Nr**:&nbsp;&nbsp;&nbsp;</TD>
													...
													<TR>
														<TD vAlign="top" noWrap align="right">Platzhaltersuche:&nbsp;&nbsp;&nbsp;</TD>
