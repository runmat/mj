<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report20.aspx.vb" Inherits="CKG.Components.ComCommon.Report20" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR id="tr_Filialen" runat="server">
													...
													<TR id="TRdistrikte" runat="server">
														<TD class="TextLarge" vAlign="top" width="150">Distrikte</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:Label id="lblDistrikte" runat="server" Visible="False">Label</asp:Label>
															<asp:dropdownlist id="ddlDistrikte" runat="server"></asp:dropdownlist></TD>
													</TR>
													<TR>
