...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            lnkKreditlimit.NavigateUrl = "Change80.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart
            ...
            If Not IsPostBack Then
                ...
                Else
                    DataGrid1.BackColor = System.Drawing.Color.SandyBrown
                End If
                FillGrid(0, , True)
            End If
        ...
        Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
            ...
            Else
                ...
                Response.Redirect("Change80_3.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart)
            End If
        End Sub
...
' 
' *****************  Version 2  *****************
' User: Jungj        Date: 22.10.08   Time: 14:48
' Updated in $/CKAG/Components/ComCommon/AppDokVerw
' umstellung auf fahrzeughistorie im finance bereich
' 
' *****************  Version 1  *****************
