<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change80_4.aspx.vb" Inherits="CKG.Components.ComCommon.AppDokVerw.Change80_4" %>
							...
							<tr>
								...
								<td vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" vAlign="top"><asp:hyperlink id="lnkFahrzeugsuche" runat="server" CssClass="TaskTitle" NavigateUrl="Change04.aspx">Fahrzeugsuche</asp:hyperlink>&nbsp;<asp:hyperlink id="lnkFahrzeugAuswahl" runat="server" CssClass="TaskTitle" NavigateUrl="Change04_2.aspx">Fahrzeugauswahl</asp:hyperlink>&nbsp;<asp:hyperlink id="lnkAdressAuswahl" runat="server" CssClass="TaskTitle" NavigateUrl="Change04_3.aspx">Adressauswahl</asp:hyperlink><asp:label id="lblAddress" runat="server" Visible="False"></asp:label><asp:label id="lblMaterialNummer" runat="server" Visible="False"></asp:label></TD>
										</TR>
									</TABLE>
											...
											<TD vAlign="top" align="left" colSpan="3">
												...
												<TABLE id="Table7" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="tr_VersandAdresse" runat="server">
														<TD class="" vAlign="top" noWrap><asp:label id="lbl_VersandAdresse" runat="server" Font-Underline="True">lbl_VersandAdresse</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left" colSpan="2"><asp:label id="lblXVersand" runat="server"></asp:label></TD>
													</TR>
													<TR id="tr_Versandart" runat="server">
														<TD class="" vAlign="top" noWrap><asp:label id="lbl_Versandart" runat="server" Font-Underline="True">lbl_Versandart</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left" colSpan="2"><asp:label id="lblXVersandartData" runat="server"></asp:label></TD>
													</TR>
													<TR id="tr_Versandgrund" runat="server">
														<TD class="" vAlign="top" noWrap><asp:label id="lbl_Versandgrund" runat="server" Font-Underline="True">lbl_Versandgrund</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left" colSpan="2"><asp:label id="lblXVersandGrundData" runat="server"></asp:label></TD>
													</TR>
													<TR id="tr_Fahrzeuge" runat="server">
														<TD class="StandardTableAlternate" vAlign="top">
															<P><asp:label id="lbl_Fahrzeuge" runat="server">lbl_Fahrzeuge</asp:label></P>
															<P>&nbsp;</P>
															<P>&nbsp;</P>
														</TD>
														<TD class="StandardTableAlternate" vAlign="top" align="left" colSpan="2"><asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" Width="100%" bodyHeight="250" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader">
