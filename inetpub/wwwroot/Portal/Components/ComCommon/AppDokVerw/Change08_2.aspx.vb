...
Partial Public Class Change08_2
    Inherits Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lnkKreditlimit.NavigateUrl = "Change08.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart & "&art2=" & authentifizierung
        ...
        If Not IsPostBack Then
            ...
            If versandart = "TEMP" Then
                DataGrid1.BackColor = Color.LightSkyBlue
            Else
                DataGrid1.BackColor = Color.SandyBrown
            End If
            FillGrid(0, , True)
        End If
    End Sub
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Else
            Session("objHaendler") = objHaendler
            Response.Redirect("Change08_3.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart & "&art2=" & authentifizierung)
        End If
    End Sub
