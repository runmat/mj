...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change80_5.aspx.vb" Inherits="CKG.Components.ComCommon.AppDokVerw.Change80_5" %>
										...
										<TR>
											<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" BackColor="White" PageSize="50" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False" Width="100%">
													...
													<Columns>
														...
														<asp:BoundColumn Visible="False" DataField="m_blnFMSZulassung" SortExpression="m_blnFMSZulassung" HeaderText="m_blnFMSZulassung"></asp:BoundColumn>
