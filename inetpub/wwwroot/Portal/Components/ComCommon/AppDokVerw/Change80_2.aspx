...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change80_2.aspx.vb" Inherits="CKG.Components.ComCommon.AppDokVerw.Change80_2" %>
								...
								<td vAlign="top">
									...
									<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											...
											<asp:datagrid id="DataGrid1" runat="server" Width="100%" BackColor="White" PageSize="50" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False">
