...
#Region " Methods"
    ...
    Public Sub GiveCars()
        ...
        If Not m_blnGestartet Then
            ...
            Try
                ...
                S.AP.InitExecute("Z_M_Unangefordert_Lp", "I_CHASSIS_NUM, I_KUNNR, I_LICENSE_NUM, I_LIZNR, I_TIDNR",
                                 m_strSucheFahrgestellNr, m_objUser.KUNNR.PadLeft(10, "0"c), m_strSucheKennzeichen, m_strSucheLeasingvertragsNr, m_strSucheNummerZB2)
    ...
    Public Function LeseAdressenSAP(ByRef page As Web.UI.Page, ByVal strParentNode As String, ByVal strName As String, ByVal strPLZ As String, Optional ByVal adressart As String = "A", Optional ByVal nodelevel As String = "99") As Int32
        ...
        Try
            ...
            S.AP.InitExecute("Z_M_Customer_Get_Children_Fms", "VALID_ON, NODE_LEVEL, CUSTOMERNO, I_NAME1, I_PSTLZ, CUSTHITYP",
                             Today.ToShortDateString, nodelevel, Right("0000000000" & strParentNode, 10), strName, strPLZ, adressart)
    ...
    Public Function GiveResultStructure() As DataTable
        If m_tblResult IsNot Nothing Then
            Return m_tblResult.Clone
        End If
...
' ************************************************
' $History: AppDokVerw_01.vb $
' 
' *****************  Version 11  *****************
' User: Fassbenders  Date: 20.05.10   Time: 16:18
...
' 
' *****************  Version 9  *****************
' User: Fassbenders  Date: 10.03.10   Time: 14:26
' Updated in $/CKAG/Components/ComCommon/AppDokVerw/Lib
' ITA: 2918
' 
' *****************  Version 8  *****************
...
' 
' *****************  Version 5  *****************
' User: Rudolpho     Date: 28.07.08   Time: 17:01
' Updated in $/CKAG/Components/ComCommon/AppDokVerw/Lib
' ITA: 2081
' 
' *****************  Version 4  *****************
' User: Rudolpho     Date: 24.07.08   Time: 15:13
' Updated in $/CKAG/Components/ComCommon/AppDokVerw/Lib
' 
' *****************  Version 3  *****************
' User: Jungj        Date: 24.07.08   Time: 15:03
' Updated in $/CKAG/Components/ComCommon/AppDokVerw/Lib
' SapConnection close verbessert
' 
' *****************  Version 2  *****************
