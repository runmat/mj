...
<Serializable()> Public Class AppDokVerw_05
    Inherits BankBase
...
#Region " Declarations"
    ...
    'Adressen
    Public ZielAdressen As DataTable


    <NonSerialized()> Private m_strAdressNummer As String
    <NonSerialized()> Private m_tblLaender As DataTable
#End Region
...
#Region " Methods"
        ...
        If Not m_blnGestartet Then
            ...
            Try
                S.AP.InitExecute("Z_M_Unangefordert_Lp", "I_KUNNR, I_LICENSE_NUM, I_LIZNR, I_CHASSIS_NUM, I_TIDNR",
                                 m_objUser.KUNNR.PadLeft(10, "0"c), m_strSucheKennzeichen, m_strSucheLeasingvertragsNr, m_strSucheFahrgestellNr, m_strSucheNummerZB2)
    ...
    Public Sub AnfordernSAP()
        If Not m_blnGestartet Then
            ...
            Try
                ...
                S.AP.Init("Z_M_Briefanforderung_Allg_002")
                ...
                m_strAdressNummer = S.AP.GetExportParameter("E_ADRNR")
        ...
        Try
            ...
            While drAppData.Read()
                If Not drAppData Is Nothing Then
                    If Not TypeOf drAppData(intI) Is DBNull Then
    ...
    Public Function GetAdresse(ByVal Kennung As String, _
        ...
        Try
            ...
            S.AP.InitExecute("Z_M_IMP_AUFTRDAT_007", "I_KUNNR, I_KENNUNG, I_NAME1, I_PSTLZ",
                             Right("0000000000" & m_objUser.KUNNR, 10), Kennung, Name, PLZ)

            Dim SAPTable As DataTable = S.AP.GetExportTable("GT_WEB")
            ZielAdressen = SAPTable

            With ExportTable
                .Columns.Add("POS_TEXT", System.Type.GetType("System.String"))
                .Columns.Add("POS_KURZTEXT", System.Type.GetType("System.String"))
                ...
                .Columns.Add("STRAS", System.Type.GetType("System.String"))
                .Columns.Add("PSTLZ", System.Type.GetType("System.String"))
                .Columns.Add("ORT01", System.Type.GetType("System.String"))
                .Columns.Add("EMAIL", System.Type.GetType("System.String"))
                .Columns.Add("LAND1", System.Type.GetType("System.String"))
                .Columns.Add("TELNR", System.Type.GetType("System.String"))
            End With
    ...
    <Obsolete("Leere Funktion, die nach Prüfung auf bestehende Verweise entfernt werden sollte.", False)>
    ...
    Public Function GiveResultStructure() As DataTable
        ...
        With tblTemp
            ...
            .Columns.Add("SWITCH", System.Type.GetType("System.Boolean"))
        End With
