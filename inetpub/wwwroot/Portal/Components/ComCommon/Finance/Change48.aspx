					...
					<td>
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR id="trSaveButton" runat="server" Visible="False">
								...
								<TD vAlign="center" align="right" width="100%"><asp:label id="lblNoData" runat="server" Visible="False" Font-Bold="True"></asp:label>&nbsp;</TD>
														...
														<asp:TemplateColumn HeaderText="Auswahl">
															<ItemTemplate>
																<TABLE id="Table11" cellSpacing="1" cellPadding="1" width="100%" border="0">
																	<TR>
																		<TD align="left">
																			<asp:LinkButton id="Linkbutton1" runat="server" CssClass="StandardButtonSmall" Text="Autorisieren" CommandName="Autorisieren" CausesValidation="false">Autorisieren</asp:LinkButton></TD>
																		<TD align="right">
																			<asp:LinkButton id=Linkbutton4 runat="server" Visible='<%# DataBinder.Eval(Container, "DataItem.BatchAuthorization") %>' CssClass="StandardButtonStorno" Text="Löschen" CommandName="Loeschen" CausesValidation="False">Löschen</asp:LinkButton></TD>
																	</TR>
																</TABLE>
															</ItemTemplate>
														</asp:TemplateColumn>
