<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Kopfdaten.ascx.vb" Inherits="CKG.Components.ComCommon.PageElements.Kopfdaten" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
