									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td class="TaskTitle" colSpan="2"><asp:linkbutton id="lnkCreateExcel" runat="server">Excelformat</asp:linkbutton><asp:hyperlink id="lnkShowCSV" runat="server" Visible="False" Target="_blank">CSV-Datei</asp:hyperlink>&nbsp;
												<asp:label id="lblDownloadTip" runat="server" Visible="False" Font-Bold="True" Font-Size="8pt">rechte Maustaste => Ziel speichern unter...</asp:label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:hyperlink id="lnkBack" runat="server" Visible="False" NavigateUrl="javascript:history.back()">zurück</asp:hyperlink></td>
										</tr>
										<TR>
