...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report18_2.aspx.vb" Inherits="CKG.Components.ComCommon.Report18_2" %>
                                        ...
                                        <asp:DataGrid ID="DataGrid1" runat="server" BackColor="White" PageSize="50" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="col_Vertragsnummer2">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="Labelxaq12" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Vertragsnummer2") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="col_VersandartText">
                                                    <HeaderTemplate>
                                                        <asp:LinkButton ID="col_VersandartText" runat="server" CommandName="Sort" CommandArgument="VersandartText">col_VersandartText
                                                        </asp:LinkButton>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label523" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.VersandartText") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>                        
