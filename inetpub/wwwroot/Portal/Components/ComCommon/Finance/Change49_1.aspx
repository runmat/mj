<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change49_1.aspx.vb" Inherits="CKG.Components.ComCommon.Change49_1" %>
										...
										<TR>
											<TD>
												<TABLE id="Table4" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													...
													<TR>
														<TD class="StandardTableAlternate" width="150"><asp:Label Runat="server" ID="lbl_Briefnummer" text="lbl_Briefnummer"></asp:Label></TD>
														<TD class="StandardTableAlternate">
															<asp:label id="txtBriefNr" runat="server" Width="350px"></asp:label></TD>
													</TR>
													<TR>
														<TD class="TextLarge" width="150"><asp:Label Runat="server" ID="lbl_Mandant" text="lbl_Mandant"></asp:Label></TD>
														<TD class="TextLarge">
