...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change54_1.aspx.vb" Inherits="CKG.Components.ComCommon.Change54_1" %>
                            ...
                            <asp:DataGrid ID="DataGrid1" runat="server" BackColor="White" PageSize="50" bodyHeight="400"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="col_Aktion">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlAktion" runat="server">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                </Columns>
