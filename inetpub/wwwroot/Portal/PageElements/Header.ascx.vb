        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack Then
                ...
                If eventArg = "Logout" Then
                    Response.Redirect("/Portal/(S(" & Session.SessionID & "))/Start/Logout.aspx")
                End If
            End If
            If Not m_User Is Nothing Then
                With Me
                    ...
                    If Not IsPostBack Then
                        lnkHauptmenue.NavigateUrl = "/Portal/(S(" & Session.SessionID & "))/Start/Selection.aspx"
                        lnkChangePassword.NavigateUrl = "/Portal/(S(" & Session.SessionID & "))/Start/ChangePassword.aspx"
                        lnkLogout.NavigateUrl = "/Portal/(S(" & Session.SessionID & "))/Start/Logout.aspx"
                        lnkContact.NavigateUrl = "/Portal/(S(" & Session.SessionID & "))/Info/ContactPage.aspx"
                        lnkResponsible.NavigateUrl = "/Portal/(S(" & Session.SessionID & "))/Info/ResponsiblePage.aspx"
                        lnkImpressum.NavigateUrl = "/Portal/(S(" & Session.SessionID & "))/Info/Impressum.aspx"
            ...
            Else
                ...
                lnkHauptmenue.NavigateUrl = "/Portal/Start/Login.aspx"
                tdQuickSupport.Visible = False
