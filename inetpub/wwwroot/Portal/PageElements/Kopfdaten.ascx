<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Kopfdaten.ascx.vb" Inherits="CKG.Portal.PageElements.Kopfdaten" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
