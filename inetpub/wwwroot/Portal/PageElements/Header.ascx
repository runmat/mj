    ...
    <tr>
       ...
       <td class="HeaderLinks" valign="bottom" id="tdQuickSupport" runat="server"
            ...
            <div id="divTeamviewer" runat="server" style="position: relative; width: 50px; height: 50px;">
                <a href="/Portal/Downloads/DADQS_de.exe" style="text-decoration: none;">
                     <img src="/Portal/Images/TeamviewerLogo.png" alt="Download TeamViewer"
        ...
        <td class="HeaderLinks" valign="bottom" nowrap="nowrap" id="tdHauptmenue" runat="server">
            <asp:HyperLink ID="lnkHauptmenue" runat="server" NavigateUrl="/Portal/Start/Selection.aspx">Hauptmenü</asp:HyperLink>
        </td>
        <td class="HeaderLinks" id="tdChangePasword" valign="bottom" nowrap="nowrap" runat="server">
            <asp:HyperLink ID="lnkChangePassword" runat="server" Visible="False" NavigateUrl="/Portal/Start/ChangePassword.aspx">Passwort ändern</asp:HyperLink>
        </td>
        <td class="HeaderLinks" id="tdLogout" valign="bottom" nowrap="nowrap" runat="server">
            <asp:HyperLink ID="lnkLogout" runat="server" Visible="False" NavigateUrl="/Portal/Start/Logout.aspx">Abmelden</asp:HyperLink>
        </td>
        ...
        <td class="HeaderLinks" valign="bottom" nowrap="nowrap">
            <asp:HyperLink ID="lnkContact" NavigateUrl="/Portal/Info/ContactPage.aspx" runat="server">Kontakt</asp:HyperLink>
        </td>
        <td class="HeaderLinks" valign="bottom" nowrap="nowrap" id="tdResponsible" runat="server">
            <asp:HyperLink ID="lnkResponsible" NavigateUrl="/Portal/Info/ResponsiblePage.aspx"
                runat="server">Ansprechpartner</asp:HyperLink>
        </td>
        <td class="HeaderLinks" valign="bottom" nowrap="nowrap">
            <asp:HyperLink ID="lnkImpressum" NavigateUrl="/Portal/Info/Impressum.aspx" runat="server">Impressum</asp:HyperLink>
        </td>
