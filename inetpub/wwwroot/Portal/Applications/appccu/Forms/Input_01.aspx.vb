'#########  ITA: 976 
'#########  übernommen von AppArval\Forms\Input_002_01
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    Response.Redirect("Report_01.aspx?AppID=" & Session("AppID").ToString & "&typ=" & rbSelect.SelectedItem.Value)
                End If
            End If
            'End If
...
' 
' *****************  Version 6  *****************
' User: Uha          Date: 23.05.07   Time: 10:17
' Updated in $/CKG/Applications/AppCCU/AppCCUWeb/Forms
