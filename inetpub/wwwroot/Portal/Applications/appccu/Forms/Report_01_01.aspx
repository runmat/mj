<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_01_01.aspx.vb"
    Inherits="AppCCU.Report_01_01" %>
                                        ...
                                        <table id="Table10" cellspacing="0" cellpadding="5" bgcolor="white" border="0">
                                            <tr>
                                                ...
                                                <td valign="top" nowrap align="left">
                                                    <asp:Label ID="Label25" runat="server" CssClass="DetailTableFont" Font-Size="">Lizenzdauer:</asp:Label>
                                                </td>
                                            ...
                                            <tr class="PageNavigation">
                                                <td valign="top" nowrap align="left">
                                                    <font size="3">
                                                        <asp:Label ID="Label6" runat="server" CssClass="DetailTableFontBold" Font-Bold="True">Lizenznehmer</asp:Label></font>
                                                </td>
                                                ...
                                                <td valign="top" nowrap align="left" width="91">
                                                    <font size="3"><font size="3">
                                                        <asp:Label ID="Label35" runat="server" CssClass="DetailTableFontBold" Font-Bold="True">Halter</asp:Label></font></font>
                                                </td>
                                                <td valign="top" nowrap align="left">
                                                    <font size="3"><font size="2"></font></font>
                                                </td>
                                            ...
                                            <tr>
                                                <td valign="top" nowrap align="left" height="18">
                                                    <asp:Label ID="Label26" runat="server" CssClass="DetailTableFont" Font-Size="">Zuletzt gemahnt / Stufe:</asp:Label>
                                                </td>
                                                <td class="TextLarge" valign="top" nowrap align="left" colspan="3" height="18">
                                                ...
                                                <td class="TextLarge" valign="top" nowrap align="left" colspan="2" height="18">
