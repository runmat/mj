<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Input_02.aspx.vb" Inherits="AppCCU.Input_02" %>
				...
				<TR>
					<TD>
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="" vAlign="top" width="120"><asp:linkbutton id="cmdCreate" runat="server" CssClass="StandardButton">Report erstellen</asp:linkbutton><asp:calendar id="calDatum" runat="server" CellPadding="0" BorderColor="Black" BorderStyle="Solid" Width="120px" Visible="False">
								...
								<TD class="">
									<TABLE id="Table1" cellSpacing="0" cellPadding="2" width="100%" bgColor="white" border="0" runat="server">
										<TR>
											<TD class="" vAlign="center" noWrap width="140">
												Amtl. Kennzeichen&nbsp;&nbsp;
											</TD>
											<TD class="" vAlign="center" noWrap><asp:textbox id="txtKennzeichenVon" runat="server" Width="100px"></asp:textbox></TD>
											<TD class="" vAlign="center" noWrap width="100%"><asp:textbox id="txtKennzeichenBis" runat="server" Width="100px" Visible="False"></asp:textbox>&nbsp;(FL-X1000)&nbsp;</TD>
										</TR>
										<TR>
											<TD class="" vAlign="center" width="140">
												Fahrgestellnummer&nbsp;
											</TD>
											<TD class="" vAlign="center" noWrap><asp:textbox id="txtFahrgestellVon" runat="server" Width="100px"></asp:textbox></TD>
											<TD class="" vAlign="center" noWrap width="100%"><asp:textbox id="txtFahrgestellBis" runat="server" Width="100px" Visible="False"></asp:textbox>&nbsp;(WDX11111111111111)</TD>
										</TR>
										<TR>
											<TD class="" vAlign="center" width="140">Referenznr.</TD>
										...
										<TR>
											<TD vAlign="center" width="140">Kundennummer</TD>
										...
										<TR>
											<TD vAlign="top" colSpan="2"><asp:radiobuttonlist id="rbMahnung" runat="server">
											...
											<TD vAlign="top" width="100%"><asp:radiobuttonlist id="rbSelect" runat="server" Visible="False" Height="49px">
