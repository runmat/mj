...
#End Region
    ...
    Private Sub showdata()
        ...
        lblAntrag.Text = CCuni_1.toShortDateString(selectedRow(1).ToString)    'Angelegt.
       
        lblLBeginn.Text = CCuni_1.toShortDateString(selectedRow(5).ToString) 'Leasingbeginn
        lblLEnde.Text = CCuni_1.toShortDateString(selectedRow(6).ToString)   'Leasingende
        ...
        lblVBeginn.Text = CCuni_1.toShortDateString(selectedRow(19).ToString) 'Versicherungsbeginn
        lblVEnde.Text = CCuni_1.toShortDateString(selectedRow(20).ToString)  'Versicherungsende
        lblVschein.Text = selectedRow(24).ToString  'VersicherungsSchein-Nr

        'Versanddatum, Rückgabedatum, Zurück LN + VG
        lblVersandLN.Text = CCuni_1.toShortDateString(selectedRow(11).ToString) 'VersandLN
        lblVersandVG.Text = CCuni_1.toShortDateString(selectedRow(15).ToString) 'RückgabeLN
        lblRueckLN.Text = CCuni_1.toShortDateString(selectedRow(14).ToString)   'VersandVG
        lblRueckVG.Text = CCuni_1.toShortDateString(selectedRow(18).ToString)  'RückgabeVG
        ...
        lblKonzs_ZO.Text = CType(selectedRow("Halternr"), String)
        ...
        Dim VersandLNunv As String = CCuni_1.toShortDateString(selectedRow(27).ToString) 'VersandLNunv
        Dim RueckversandLNunv As String = CCuni_1.toShortDateString(selectedRow(29).ToString) 'RueckversandLNunv
        Dim VersandLNunv2 As String = CCuni_1.toShortDateString(selectedRow(28).ToString) 'VersandLNunv2
        Dim RueckversandLNunv2 As String = CCuni_1.toShortDateString(selectedRow(30).ToString) 'RueckversandLNunv2
        ...
        Dim VersandVGunv As String = CCuni_1.toShortDateString(selectedRow(31).ToString) 'VersandVGunv
        Dim RueckversandVGunv As String = CCuni_1.toShortDateString(selectedRow(33).ToString) 'RueckversandVGunv
        Dim VersandVGunv2 As String = CCuni_1.toShortDateString(selectedRow(32).ToString) 'VersandVGunv2
        Dim RueckversandVGunv2 As String = CCuni_1.toShortDateString(selectedRow(34).ToString) 'RueckversandVGunv2
        ...
        'Fahrzeugdaten
        lblEz.Text = CCuni_1.toShortDateString(selectedRow("Erstzulassung").ToString) 'Erstzulassung
        ...
        lblMadatLN.Text = CCuni_1.toShortDateString(selectedRow(12).ToString) 'MahndatumLN
        lblMahnsVG.Text = CType(selectedRow(17), String) 'MahnstufeVG
        lblMadatVG.Text = CCuni_1.toShortDateString(selectedRow(16).ToString) 'MahndatumVG

    End Sub

    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Dim strFileName As String = Format(Now, "yyyyMMdd_HHmmss_") & m_User.UserName & ".xls"
        Dim m_Report As New CCuni_1(m_User, m_App, strFileName)
        Dim equi As String
        equi = Request.Item("Equipment")    'Equipment-Nr. holen
