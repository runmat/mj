<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UploadEdit04.aspx.vb" Inherits="AppUeberf.UploadEdit04" %>
		...
		<form id="Form1" method="post" runat="server">
					...
					<TD vAlign="top" align="left" width="100%" colSpan="3">
						<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD style="WIDTH: 1040px; HEIGHT: 30px" colSpan="2">
									...
									&nbsp;<asp:label id="lblInfo" runat="server" Width="802px" CssClass="TextLarge" EnableViewState="False"></asp:label></TD>
							</TR>
							<TR>
							...
							<tr>
								<TD style="WIDTH: 174px" vAlign="top" width="174">
									<TABLE id="Table12" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD width="150">
										<asp:imagebutton id="cmdBack0" runat="server" Width="73px" Height="40px" 
                                                    ImageUrl="/Portal/Images/BackToMap.jpg" 
                                            ToolTip="Zurück zur Übersicht"></asp:imagebutton></TD>
										</TR>
										<TR>
						...
						<TABLE id="Table5" style="WIDTH: 918px; HEIGHT: 67px" cellSpacing="0" cellPadding="1" width="918" border="0" runat="server">
							...
							<TR>
								<TD style="WIDTH: 436px"></TD>
								<TD>
									<asp:label id="Label42" runat="server" Width="141px" Visible="False">Zulassung durch KCL:</asp:label>
			...
			<TABLE id="Table2" style="WIDTH: 1040px; HEIGHT: 60px" cellSpacing="1" cellPadding="1" width="1040" border="0">
				<TR>
					...
					<TD style="WIDTH: 80px">
                        <asp:button id="cmdSave" runat="server" Width="80px" 
                            Text="Speichern"></asp:button></TD>
					<TD style="WIDTH: 299px">&nbsp;</TD>
					<TD><asp:button id="cmdPrint" runat="server" Width="80px" Visible="False" 
                            Text="Druckansicht"></asp:button></TD>
				</TR>
				<TR>
			...
			</TBODY></TABLE></TD></TR></TABLE></div></form>
	</body>
</HTML>
