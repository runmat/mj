				...
				<tr>
					<TD style="WIDTH: 100%" vAlign="top">
						<TABLE id="Table1" style="WIDTH: 100%; HEIGHT: 67px" cellSpacing="0" cellPadding="1" width="918" border="0" runat="server">
							...
							<TR>
								<TD style="WIDTH: 317px" height="21"><asp:label id="Label7" runat="server" Width="110px">Straﬂe, Nr:</asp:label><asp:label id="lblAbStrasse" runat="server" Font-Size="Smaller"></asp:label></TD>
