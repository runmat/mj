...
Public Class Report205
    Inherits System.Web.UI.Page

    '##### ARVAL Report "Versendete Fahrzeugbriefe"
...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New Arval_06(m_User, m_App, strFileName)

            lblError.Text = ""

            If lblError.Text.Length = 0 Then
                m_Report.Fill(Session("AppID").ToString, Session.SessionID.ToString, txtAbmeldedatumVon.Text, txtLvnr.Text)
                ...
                Else
                    ...
                    Else
                        ...
                        logApp.UpdateEntry("APP", Session("AppID").ToString, "Report: Versendete Fahrzeugbriefe")
        ...
        Catch ex As Exception
            ...
            'logApp.UpdateEntry("ERR", Session("AppID").ToString, "Fehler im Report <Versendete Fahrzeugbriefe>. Fehler: " & ex.Message)
        End Try
    End Sub
