...
Public Class ArvalService
    Inherits System.Web.Services.WebService

    <WebMethod(EnableSession:=True)> _
 Public Function GetAdressList(ByVal prefixText As String, ByVal count As Integer) As String()
        Dim NewArr(0) As String
        Dim BaseArr() As String
        Dim i As Integer


        BaseArr = CType(Session("LnAdressen"), System.String())
        Try

            If prefixText.Length > 2 Then
