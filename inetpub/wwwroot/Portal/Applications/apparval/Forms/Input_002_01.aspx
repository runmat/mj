...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Input_002_01.aspx.vb"
    Inherits="AppARVAL.Input_002_01" %>
                    ...
                    <tr>
                        <td valign="top" width="120">
                            <table id="Table2" cellspacing="0" cellpadding="0" width="120" border="0">
                                <tr>
                                    <td class="TextHeader">
                                        <asp:LinkButton ID="cmdCreate" runat="server" CssClass="StandardButton">Report erstellen</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td class="" valign="top">
                                        <table id="Table1" cellspacing="2" cellpadding="1" width="100%" bgcolor="white" border="0">
                                            <tr>
                                                <td class="" valign="middle" nowrap width="200">
                                                ...
                                                <td class="" valign="middle" width="100%">
                                                    <asp:TextBox ID="txtKennzeichenBis" runat="server" Width="100px"></asp:TextBox>&nbsp;(M-X1000)&nbsp;
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="" valign="middle" width="200">
                                                ...
                                                <td class="" valign="middle" width="100%">
                                                    <asp:TextBox ID="txtFahrgestellBis" runat="server" Width="100px"></asp:TextBox>&nbsp;(WDX11111111111111)
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="" valign="middle" width="200">
                                                ...
                                                <td class="" valign="middle" width="100%">
                                                    <asp:TextBox ID="txtLeasVBis" runat="server" Width="100px"></asp:TextBox>&nbsp;(1000000012)
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td valign="top" nowrap width="200" colspan="2">
