...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report202.aspx.vb" Inherits="AppARVAL.Report202" %>
                                    ...
                                    <td valign="top" align="left">
                                        <table id="Table1" cellspacing="0" cellpadding="5" width="100%" bgcolor="white" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="TextLarge" valign="center">
                                                    <asp:TextBox ID="txtHalter" runat="server"></asp:TextBox>&nbsp;(12345678)
                                                </td>
                                            </tr>
                                        </table>
                                        <br>
