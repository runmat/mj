...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report205.aspx.vb" Inherits="AppARVAL.Report205" %>
                                        ...
                                        <table id="Table1" cellspacing="0" cellpadding="5" width="100%" bgcolor="white" border="0">
                                            <tr>
                                                ...
                                                <td class="TextLarge" valign="center" height="31">
                                                    <asp:TextBox ID="txtAbmeldedatumVon" runat="server"></asp:TextBox>&nbsp;(XX-Y1234)
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="StandardTableAlternate" valign="center">
                                                    <asp:TextBox ID="txtLvnr" runat="server"></asp:TextBox>&nbsp;(12345678)
                                                </td>
                                            </tr>
                                        </table>
                                        <br>
