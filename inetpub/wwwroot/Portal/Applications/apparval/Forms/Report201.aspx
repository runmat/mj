<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report201.aspx.vb" Inherits="AppARVAL.Report201" %>
                ...
                <table id="Table0" cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        <td valign="top">
                            ...
                            <p>
                                <asp:Calendar ID="calBis" runat="server" CellPadding="0" BorderColor="Black" BorderStyle="Solid"
                                    Width="120px" Visible="False">
                                    <TodayDayStyle Font-Bold="True"></TodayDayStyle>
                                    <NextPrevStyle ForeColor="White"></NextPrevStyle>
                                    <DayHeaderStyle Font-Bold="True" BackColor="Silver"></DayHeaderStyle>
                                        ...
                                        <table id="Table1" cellspacing="0" cellpadding="5" width="100%" bgcolor="white" border="0">
                                            <tr>
                                                ...
                                                <td class="TextLarge" valign="center">
                                                    <asp:TextBox ID="txtAbmeldedatumVon" runat="server" Visible="False"></asp:TextBox><asp:LinkButton
                                                        ID="btnCal1" runat="server" CssClass="StandardButtonTable" Width="100px" Visible="False">...</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="StandardTableAlternate" valign="center">
                                                    <asp:TextBox ID="txtAbmeldedatumBis" runat="server" Visible="False"></asp:TextBox><asp:LinkButton
                                                        ID="btnCal2" runat="server" CssClass="StandardButtonTable" Width="100px" Visible="False">...</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="TextLarge" valign="center" width="150">
