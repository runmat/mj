<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report31_2.aspx.vb" Inherits="AppFFE.Report31_2" %>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR id="trPageSize" runat="server">
											<TD class="LabelExtraLarge" align="left" colSpan="2">
											 <img alt="" src="../../../images/excel.gif" style="width: 15px; height: 17px" />&nbsp;<asp:LinkButton ID="lnkCreateExcel" CssClass="ExcelButton" runat="server" Visible="False">Excelformat</asp:LinkButton>&nbsp;<asp:hyperlink id="lnkExcel" runat="server" CssClass="ExcelButton" Visible="False" Target="_blank">Excelformat</asp:hyperlink><STRONG>
												&nbsp;</STRONG><asp:label id="lblDownloadTip" CssClass="Downloadtip" runat="server" Visible="False" Font-Bold="True" Font-Size="8pt">rechte Maustaste => Ziel speichern unter...</asp:label></TD>
