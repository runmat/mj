<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report50.aspx.vb" Inherits="AppFFE.Report50" %>
											...
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
													...
													<TR id="trOrt" runat="server">
														<TD class="TextLarge" width="4" height="32">Ort: </TD>
														<TD class="TextLarge">
                                                            <asp:textbox id="txtOrt" runat="server"></asp:textbox><asp:label id="lblOrt" runat="server" Visible="False"></asp:label></TD>
													</TR>
													<TR id="trGesamt" runat="server">
														<TD class="TextLarge" width="4" height="32">Gesamtbestand: </TD>
														<TD class="TextLarge">
                                                            <asp:CheckBox ID="chk_Gesamt" runat="server" AutoPostBack="True" />
                                                        </TD>
													</TR>
