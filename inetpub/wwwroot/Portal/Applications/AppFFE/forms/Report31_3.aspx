<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report31_3.aspx.vb" Inherits="AppFFE.Report31_3" %>
										...
										<TR>
											<TD align="right">
												...
												<img alt="" src="../../../images/excel.gif" style="width: 15px; height: 17px" />&nbsp;
												 <asp:LinkButton id="lnkCreateExcel" CssClass="ExcelButton"  runat="server" Visible="False">Excelformat</asp:LinkButton>
										...
										<TR>
											<TD>
												<asp:datagrid id="DataGrid1" runat="server" Width="100%" BackColor="White" PageSize="50" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False">
													...
													<Columns>
														<asp:BoundColumn DataField="Finanzierungsnummer" SortExpression="Finanzierungsnummer" HeaderText="Finanzierungsnummer"></asp:BoundColumn>
														<asp:BoundColumn DataField="Anfragenummer" HeaderText="Anfragenummer"></asp:BoundColumn>
														<asp:TemplateColumn SortExpression="Fahrgestellnummer" HeaderText="Fahrgestellnummer">
															<ItemTemplate>
																...
																<asp:Literal id=Literal5 runat="server" Text='<%# "<a name=""" &amp; DataBinder.Eval(Container, "DataItem.Finanzierungsnummer") &amp; """>" &amp; DataBinder.Eval(Container, "DataItem.Fahrgestellnummer") &amp; "</a>" %>'>
																</asp:Literal>
															</ItemTemplate>
															<EditItemTemplate>
														...
														<asp:BoundColumn DataField="ZBII-Nummer" SortExpression="ZBII-Nummer" HeaderText="ZBII-Nummer"></asp:BoundColumn>
														...
														<asp:TemplateColumn SortExpression="MemoString" HeaderText="Memo">
															<ItemTemplate>
																<asp:LinkButton id=WriteMemo runat="server" CssClass="StandardButtonSmall" CausesValidation="False" CommandName="WriteMemo" ToolTip='<%# DataBinder.Eval(Container, "DataItem.Memo") %>' Text='<%# DataBinder.Eval(Container, "DataItem.MemoString") %>'>
																</asp:LinkButton>
															</ItemTemplate>
														</asp:TemplateColumn>
														...
														<asp:TemplateColumn SortExpression="FaelligkeitString" HeaderText="F&#228;lligkeit">
															<ItemTemplate>
																<asp:LinkButton id=Linkbutton2 runat="server" CssClass="StandardButtonSmall" Visible='<%# DataBinder.Eval(Container, "DataItem.DelayedPayment") AND (NOT DataBinder.Eval(Container, "DataItem.DatumAendern")) %>' CommandName="Aendern" CausesValidation="False" Text='<%# DataBinder.Eval(Container, "DataItem.FaelligkeitString") %>'>
																</asp:LinkButton>
																<asp:LinkButton id=LinkButton1 runat="server" CssClass="StandardButtonSmall" Visible='<%# DataBinder.Eval(Container, "DataItem.DelayedPayment") AND DataBinder.Eval(Container, "DataItem.DatumAendern") %>' CommandName="Speichern" CausesValidation="False">Speichern</asp:LinkButton>
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:BoundColumn DataField="Betrag" SortExpression="Betrag" HeaderText="Betrag"></asp:BoundColumn>
													</Columns>
