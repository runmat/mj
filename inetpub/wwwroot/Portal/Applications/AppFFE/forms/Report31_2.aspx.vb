...
Partial Public Class Report31_2
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Session("objFDDBank4") = objFDDBank4
        Response.Redirect("Report31_3.aspx?AppID=" & Session("AppID").ToString)
    End Sub
    ...
    Private Sub FillGrid(ByVal objBank As FFE_Bank_4, ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If objBank.Status = 0 Then
            If objBank.AuftragsUebersicht Is Nothing OrElse objBank.AuftragsUebersicht.Rows.Count = 0 Then
                trDataGrid1.Visible = False
                trPageSize.Visible = False
    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If Not e.Item.Cells(1).Text.Length = 0 Then
            Dim strRedirectURL As String = "Report31_3.aspx?AppID=" & Session("AppID").ToString
            Dim s As String = e.Item.Cells(1).Text
...
End Class
' ************************************************
' $History: Report31_2.aspx.vb $
' 
' *****************  Version 5  *****************
' User: Rudolpho     Date: 13.06.08   Time: 11:57
