...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report37_1.aspx.vb" Inherits="AppFFE.Report37_1" %>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" vAlign="top">
                                                <asp:Label ID="lblAuswahl" runat="server" Font-Bold="True" Font-Size="8pt"></asp:Label>
                                            </TD>
										</TR>
										<tr>
											<td></td>
                                                ...
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
													...
													<TR>
														...
														<td align="right">
                                                            ...
                                                            <asp:LinkButton ID="lnkCreateExcel" CssClass="ExcelButton" runat="server" Visible="False">Excelformat</asp:LinkButton>&nbsp; <asp:dropdownlist id="ddlPageSize" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
													</TR>
												</table>
											</td>
										</TR>
										<TR>
											...
											<asp:datagrid id="DataGrid1" runat="server" Width="100%" AllowSorting="True" 
												...
												<asp:TemplateColumn SortExpression="EQUNR" HeaderText="col_EQUNR">
															<HeaderTemplate>
														...
														<asp:TemplateColumn SortExpression="Filiale" HeaderText="col_Filiale">
															<HeaderTemplate>
																<asp:LinkButton ID="col_Filiale" CommandName="sort" CommandArgument="Filiale" Runat="server">col_Filiale</asp:LinkButton>
															</HeaderTemplate>
															<ItemTemplate>
																<asp:Label Visible="True" Runat="server" ID="Label68">
																	<%#DataBinder.Eval(Container, "DataItem.Filiale")%>
																</asp:Label>
															</ItemTemplate>
														</asp:TemplateColumn>	
