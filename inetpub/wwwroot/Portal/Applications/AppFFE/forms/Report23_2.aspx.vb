...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                objReport23_objFDDBank = New FFE_BankBase(m_User, m_App, Session("AppID").ToString, Session.SessionID.ToString, Session("SelectedDealer").ToString)
    ...
    Private Sub DoSubmit()
        ...
        If objReport23_objFDDBank.Status = 0 Then
            ...
            objReport23_objFDDBank3 = New FFE_Bank_3(m_User, m_App, Session("AppID").ToString, Session.SessionID.ToString, strFileName)
            ...
            End If
            objReport23_objFDDBank3.Report()
