...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                Dim tmpIntValue As Int32 = objAddressList.LeseAdressenSAP(Session("AppID").ToString, Session.SessionID.ToString, Me.Page, m_User.Reference, "B") 'B = HEZ Halter
                ...
                tmpIntValue = objAddressList.LeseAdressenSAP(Session("AppID").ToString, Session.SessionID.ToString, Me.Page, m_User.Reference, "C") 'C = HEZ Schein & Schilder
                If tmpIntValue > 0 Then
                    Dim tmpRow As DataRow
    ...
    Private Sub DoSubmit()
        ...
        objHaendler = CType(Session("objHaendler"), FFE_Haendler)
        objHaendler.getZulStelle(Me.Page, plz, ort, status)
