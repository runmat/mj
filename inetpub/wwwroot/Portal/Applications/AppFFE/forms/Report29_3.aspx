<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report29_3.aspx.vb" Inherits="AppFFE.Report29_3" %>
										...
										<TR>
											<TD align="right" valign="middle">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
												 ...
												 <asp:LinkButton id="lnkCreateExcel" runat="server"  CssClass="ExcelButton"  Text="Excelformat" Visible="False"></asp:LinkButton>
												<asp:hyperlink id="lnkExcel" CssClass="StandardButtonTable" runat="server" Visible="False" Target="_blank">
													<strong>Excelformat</strong></asp:hyperlink>&nbsp;
												<asp:label id="lblDownloadTip" CssClass="Downloadtip" runat="server" Visible="False" Font-Bold="True" Font-Size="8pt">rechte Maustaste => Ziel speichern unter...</asp:label>&nbsp;
