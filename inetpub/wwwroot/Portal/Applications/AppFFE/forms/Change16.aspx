...
<%@ Page language="vb" AutoEventWireup="false" Codebehind="Change16.aspx.vb" Inherits="AppFFE.Change16" enableViewState="True" %>
										...
										<tr>
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
													<TR id="trFiliale" runat="server" visible="false">
														<TD class="TextLarge" width="166" height="32">Filiale:</TD>
														<TD class="TextLarge"><asp:dropdownlist id="ddl_Filiale" runat="server"></asp:dropdownlist></TD>
													</TR>
