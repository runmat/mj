...
Partial Public Class Change02_2
            ...
            Else
                ...
                Else
                    ...
                    If (objFDDBank2.ZeigeHEZ) Then
                        ...
                        ddlKontingentart.Items.Add(item)
                    End If
                    'If (objFDDBank2.ZeigeKFKL) Then
                    '    item = New ListItem()
                    '    item.Value = "4"
                    '    item.Text = CStr(vwTemp(0)(6)) & " Vorgänge 'KF/KL'" 'HEZ
                    '    str &= "<u><b>" & CStr(vwTemp(0)(6)) & "</b></u> Vorgänge 'KF/KL'<br><br>"
                    '    ddlKontingentart.Items.Add(item)
                    'End If
                    lblAnzeige.Text = str
                    checkFastForward()
    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If Not e.Item.Cells(1).Text.Length = 0 Then
            ...
            'If int6 = 0 Then                                   'KF/KL = 0 , dann verberge
            '    objFDDBank2.ZeigeKFKL = False
            '    counter -= 1
            'End If
            '------------------------------
            If (counter = 0) Then
...
' 
' *****************  Version 5  *****************
' User: Jungj        Date: 27.06.08   Time: 15:04
