<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report29_2.aspx.vb" Inherits="AppFFE.Report29_2" %>
							...
							<TR>
								...
								<TD vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" vAlign="top"><asp:hyperlink id="lnkKreditlimit" runat="server" CssClass="StandardButton" NavigateUrl="Report29.aspx">Filialsuche</asp:hyperlink>&nbsp;</TD>
										</TR>
									</TABLE>
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR id="trPageSize" runat="server">
											...
											<img alt="" src="../../../images/excel.gif"  style="width: 15px;  height: 17px" />&nbsp;<asp:LinkButton ID="lnkCreateExcel" CssClass="ExcelButton" runat="server" Visible="False">Excelformat</asp:LinkButton>&nbsp;<asp:hyperlink id="lnkExcel" CssClass="ExcelButton" runat="server" Visible="False" Target="_blank"><STRONG>Excelformat</STRONG></asp:hyperlink>
												
												<asp:label id="lblDownloadTip" CssClass="Downloadtip" runat="server" Visible="False" Font-Bold="True" Font-Size="8pt">rechte Maustaste => Ziel speichern unter...</asp:label></TD>
										...
										<TR id="trDataGrid1" runat="server">
											<TD align="center" colSpan="2"><asp:datagrid id="DataGrid1" runat="server" BackColor="White" Width="100%" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" PageSize="50">
													...
													<Columns>
														...
														<asp:TemplateColumn SortExpression="Anzahl Standard endg&#252;ltig" Visible="False" HeaderText="Anzahl&lt;br&gt;Standard endg&#252;ltig">
														...
														<asp:TemplateColumn SortExpression="Anzahl KF/KL" HeaderText="Anzahl KF/KL">
															<HeaderStyle HorizontalAlign="Center" Width="120px"></HeaderStyle>
															<ItemStyle HorizontalAlign="Right"></ItemStyle>
															<ItemTemplate>
																<asp:Label id="Label6" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Anzahl KF/KL") %>'>
																</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															</ItemTemplate>
															<EditItemTemplate>
																<asp:TextBox id="Textbox2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Anzahl KF/KL") %>'>
																</asp:TextBox>
															</EditItemTemplate>
														</asp:TemplateColumn>														
														<asp:TemplateColumn></asp:TemplateColumn>
