<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change07_2.aspx.vb" Inherits="AppFFE.Change07_2" %>
												...
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
													...
													<TR id="tr_Ordernummer" runat="server">
														<TD class="StandardTableAlternate" width="150">
															<asp:label id="lbl_Order" runat="server">lbl_Order</asp:label>&nbsp;&nbsp;</TD>
