...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report47.aspx.vb" Inherits="AppFFE.Report47" %>
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													...
													<TR id="tr1" runat="server">
														<TD class="TextLarge" vAlign="top" width="150">
															<asp:label id="lblAufbietung" runat="server"  Text="in Aufbietung:"></asp:label>
														</TD>
														<TD>
														<asp:CheckBox  runat="server" ID="chbInAufbietung" AutoPostBack="True" />
														</TD>
													</TR>
