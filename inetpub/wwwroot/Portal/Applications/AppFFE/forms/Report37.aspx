<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report37.aspx.vb" Inherits="AppFFE.Report37" %>
													...
													<TR>
														...
														<TD class="TextLarge" vAlign="center" width="100%">
                                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server">
                                                                ...
                                                                <asp:ListItem Value="FA14">Direktauslieferung mit Zulassungsdatum</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </TD>
													</TR>
												</TABLE>
