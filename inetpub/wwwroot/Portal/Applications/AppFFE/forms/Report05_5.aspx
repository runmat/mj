...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report05_5.aspx.vb" Inherits="AppFFE.Report05_5" %>
											...
											<TD>
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr id="trExcel" runat="server">
														<td class="LabelExtraLarge"> <img alt="" src="../../../images/excel.gif" style="width: 15px; height: 17px" />&nbsp;<asp:hyperlink id="lnkExcel" runat="server" Visible="False" Target="_blank">Excelformat</asp:hyperlink>&nbsp;&nbsp;
