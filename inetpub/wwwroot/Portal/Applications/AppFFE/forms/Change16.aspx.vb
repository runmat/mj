...
#End Region
            ...
            Else
                If Not cmbHaendler.SelectedItem Is Nothing And CType(Session("Treffer"), Integer) = 1 Then
                    ...
                    If Not strInitiator.Length = 0 Then
                        ...
                        lblMessage.Text = "Die Angaben zum Händler " & Session("SelectedDealer") & " wurden vom Benutzer """ & strInitiator & """ geändert.<br>&nbsp;&nbsp;Die Autorisierung steht noch aus!"
                ...
                Else
                    ...
                    If Not objDistrikt.Message.Length > 0 Then
                        ...
                        If Not objDistrikt.Message.Length > 0 Then
                            ...
                            HelpProcedures.fakeLogEntryForAutorisierung(logApp, m_User, Session.SessionID, Session("AppID"), "Die Autorisierung der  Änderung des Regionalbüros des Händlers " & Session("SelectedDealer").ToString & " war erfolgreich!")
                            DoSubmit2()
    ...
    Private Sub cmdDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDel.Click
        ...
        Try
            Dim logApp As New Base.Kernel.Logging.Trace(objApp.Connectionstring, objApp.SaveLogAccessSAP, objApp.LogLevel)
            DeleteAuthorizationEntry(objApp.Connectionstring, Session("AuthorizationID"))
            HelpProcedures.fakeLogEntryForAutorisierung(logApp, m_User, Session.SessionID, Session("AppID"), "Die Autorisierung für die Löschung der Änderung des Regionalbüros des Händlers " & Session("SelectedDealer").ToString & " war erfolgreich!")
            DoSubmit2()
            ...
            DistrictDropDown.Enabled = False
        Catch ex As Exception
            lblError.Text = "Fehler beim Löschen des Vorgangs! " & ex.Message
        End Try
    End Sub
