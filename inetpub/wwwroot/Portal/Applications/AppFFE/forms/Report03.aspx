<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report03.aspx.vb" Inherits="AppFFE.Report03" %>
							...
							<TR>
								<TD vAlign="top" width="120">
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="center" width="150"><asp:linkbutton id="cmdCreate" runat="server" Visible="False" CssClass="StandardButton">Erstellen</asp:linkbutton></TD>
										</TR>
									</TABLE>
								</TD>
								<TD vAlign="top">
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="FilialeRow" runat="server">
														<TD class="TextLarge"><asp:label id="lblFilialeShow" runat="server" Visible="False">Distrikt:</asp:label></TD>
														<TD class="TextLarge" width="100%"><asp:dropdownlist id="cmbFilialen" runat="server" Visible="False"></asp:dropdownlist><asp:label id="lblFiliale" runat="server" Visible="False"></asp:label></TD>
													</TR>
