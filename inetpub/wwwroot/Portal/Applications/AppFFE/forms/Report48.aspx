<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report48.aspx.vb" Inherits="AppFFE.Report48" %>
							...
							<TR>
								<TD vAlign="top" width="124">
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="126" border="0" height="38">
										...
										<TR>
											<TD vAlign="center" width="121"><asp:linkbutton id="cmdCreate" runat="server" CssClass="StandardButton">&#149;&nbsp;Erstellen</asp:linkbutton></TD>
										</TR>
									</TABLE>
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR>
														...
														<TD class="TextLarge" vAlign="center" width="100%"><asp:textbox id="txtDate" runat="server" Visible="False" Width="84px"></asp:textbox>
