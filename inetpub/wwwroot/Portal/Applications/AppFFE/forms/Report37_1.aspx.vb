...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If Not Session("App_FzgTyp") Is Nothing Then
                lblAuswahl.Text = Session("App_FzgTyp").ToString
            End If
    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If e.CommandName = "Fahrzeughistorie" Then
            Dim dvAppLinks As DataView = m_User.Applications.DefaultView
            dvAppLinks.RowFilter = "APPURL='../Applications/AppFFE/Forms/Report46.aspx'"
            ...
            If dvAppLinks.Count = 1 Then
                ...
                Response.Redirect("Report46.aspx?AppID=" & dvAppLinks.Item(0).Item("AppID") & strParameter & "&VIN=" & e.CommandArgument)
            Else
                lblError.Text = "Fehler bei der Weiterleitung zur Fahrzeughistorie"
...
' 
' *****************  Version 2  *****************
' User: Jungj        Date: 14.05.08   Time: 14:23
' Updated in $/CKAG/Applications/AppFFE/forms
' ITA 1881, 1877
' 
' *****************  Version 1  *****************
