<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change14.aspx.vb" Inherits="AppFFE.Change14" %>
				...
				<TR>
					<td>
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR id="trDistrikte" runat="server">
								<TD vAlign="top" height="40">
									<asp:linkbutton id="cmdSelect" runat="server" CssClass="StandardButton"> &#149;&nbsp;Auswählen</asp:linkbutton>
									<asp:linkbutton id="cmdReset" runat="server" Visible="False" CssClass="StandardButton"> 
                                    •&nbsp;zurück</asp:linkbutton></TD>
								<TD vAlign="top" align="left" width="100%" height="40">
									<table>
										<TR>
											<TD class="TextLarge"><asp:label id="lblDistriktShow" runat="server">Filiale:</asp:label></TD>
