...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report81_2.aspx.vb" Inherits="AppFMS.Report81_2" %>
														...
														<TD vAlign="top" align="middle" colSpan="2">
															<TABLE id="Table10" cellSpacing="0" cellPadding="5" align="left" bgColor="white" border="0">
																...
																<TR id="Tr1" runat="server">
																	...
																	<TD class="TextLargeDescription" vAlign="center" align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="TextLargeDescription" vAlign="center" align="left">Auftragsnummer:</TD>
																...
																<TR>
																	<TD class="TextLargeDescription" vAlign="top" align="left" colspan="2">
																		<table border="0" width="100%" cellpadding="0" cellspacing="0">
																			...
																			<TR>
																				<TD>
																					<asp:label id="Label4" runat="server" DESIGNTIMEDRAGDROP="45">Versandgrund:&nbsp;</asp:label></TD>
																				<TD class="TextLarge" noWrap align="right">
																					<asp:label id="lblGrund" runat="server"></asp:label></TD>
																			</TR>
																		</table>
																	</TD>
