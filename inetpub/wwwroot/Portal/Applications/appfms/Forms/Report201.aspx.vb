...
Public Class Report201
    ...
    '##### FMS Report "Fehlende Abmeldeunterlagen"
...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New FMS_03(m_User, m_App, strFileName)

            lblError.Text = ""

            If lblError.Text.Length = 0 Then
                m_Report.Fill(Session("AppID").ToString, Session.SessionID.ToString, Me.Page)
                ...
                Else
                    ...
                    Else
                        ...
                        Response.Redirect("/Portal/(S(" & Session.SessionID & "))/Shared/Report01_2.aspx?AppID=" & Session("AppID").ToString & "&legende=Report201")
                    End If
                End If
            End If
        Catch ex As Exception
