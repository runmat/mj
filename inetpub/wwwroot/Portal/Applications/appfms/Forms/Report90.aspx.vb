    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                objHaendler = New FMS_90(m_User, m_App, Session("AppID").ToString, Session.SessionID.ToString, "")
            ...
            Else
                objHaendler = CType(Session("objHaendler"), FMS_90)
            End If
