<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report80.aspx.vb" Inherits="AppFMS.Report80" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR>
														<TD class="TextLarge" vAlign="center" width="120" noWrap>Datum von:</TD>
														<TD class="TextLarge" vAlign="center" width="100%"><asp:textbox id="txtAbmeldedatumVon" runat="server"></asp:textbox>&nbsp;<asp:linkbutton id="btnCal1" runat="server" CssClass="StandardButtonTable" Width="100px">Kalender...</asp:linkbutton></TD>
													</TR>
													<TR>
