    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If (Session("objHaendler") Is Nothing) OrElse (Not IsPostBack) Then
                objHaendler = New FMS_2(m_User, m_App, Session("AppID").ToString, Session.SessionID.ToString, "")
                'objHaendler.KUNNR = Right("0000000000" & m_User.KUNNR, 10)                 'Kunnr. FMS
            Else
            ...
            If Not (uFile Is Nothing) Then
                ...
                For Each rowData In objDataset1.Tables(0).Rows
                    ...
                    If Not TypeOf rowData(2) Is System.DBNull Then
                        strSachbearbeiterNr = CStr(rowData(2)).Trim(" "c)
                    End If
