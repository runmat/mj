...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report81.aspx.vb" Inherits="AppFMS.Report81" %>
												...
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">
															<P align="right">Auftragsnummer:&nbsp;&nbsp;
															</P>
														</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:TextBox id="txtOrdernummer" runat="server" MaxLength="11"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">
