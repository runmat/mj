...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change80_2.aspx.vb" Inherits="AppFMS.Change80_2" %>
											...
											<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="100%" BackColor="White" PageSize="50" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False">
													...
													<Columns>
														...
														<asp:TemplateColumn SortExpression="EXPIRY_DATE" HeaderText="Abmeldedatum">
															<ItemTemplate>
																<asp:Label id=lblNoDate runat="server" Font-Bold="True" Visible='<%# (TypeOf DataBinder.Eval(Container, "DataItem.EXPIRY_DATE") Is System.DBNull) OrElse (DataBinder.Eval(Container, "DataItem.EXPIRY_DATE")="00000000") %>' ForeColor="Red">XX.XX.XXXX</asp:Label>
