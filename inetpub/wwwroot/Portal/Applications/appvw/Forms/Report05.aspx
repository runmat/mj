...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report05.aspx.vb" Inherits="AppVW.Report05" %>
						...
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD vAlign="top">
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													...
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">
															<P align="right">Fahrgestellnummer°:</P>
														</TD>
														<TD class="TextLarge" vAlign="center">
													...
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">
															<P align="right">Händlernummer</P>
														</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:textbox id="txt_Haendlernummer" runat="server" MaxLength="17"></asp:textbox></TD>
													</TR>
												</TABLE>
												<BR>
											</TD>
									...
									°erfordert mindestens 11 Zeichen, leerer Rest entspricht&nbsp; *
								</TD>
							</TR>
							<TR>
