...
#End Region
    ...
    Protected WithEvents rdbMahnstufe As System.Web.UI.WebControls.RadioButtonList
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        ...
        m_objTable = Session("objTable")


        If IsNothing(m_objTable) = True OrElse m_objTable.Rows.Count = 0 Then
            DataGrid1.Visible = False
            Me.ddlPageSize.Visible = False
    ...
    Private Sub cmdForward_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdForward.Click
        Dim objData As VW_07


        objData = New VW_07(m_User, m_App, "")


        objData.Mahnstufe = rdbMahnstufe.SelectedItem.Text

        m_objTable = objData.FillMahnungen(Session("AppID").ToString, Session.SessionID.ToString)

        Session("objTable") = m_objTable
...
' 
' *****************  Version 3  *****************
' User: Fassbenders  Date: 1.10.07    Time: 16:59
...
' 
' *****************  Version 1  *****************
' User: Fassbenders  Date: 14.09.07   Time: 11:30
