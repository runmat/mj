<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change07.aspx.vb" Inherits="AppSIXT.Change02" %>
											...
											<TD class="TextLarge" vAlign="center" width="444">
												<P align="left">
													<TABLE class="TableBackGround" id="Table2" cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD><asp:radiobuttonlist id="rbAktion" runat="server" Width="243px">
																	<asp:ListItem Value="1" Selected="True">Blockregeln anlegen</asp:ListItem>
																	<asp:ListItem Value="2">geblockte Fahrzeuge freigeben</asp:ListItem>
																	<asp:ListItem Value="3">Regeln l&#246;schen</asp:ListItem>
																	<asp:ListItem Value="4">alle offenen Regeln</asp:ListItem>
																	<asp:ListItem Value="5">Vorschlagsliste bearbeiten</asp:ListItem>
