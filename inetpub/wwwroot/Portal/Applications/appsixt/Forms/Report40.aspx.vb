...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (Not Request.QueryString("AppID") Is Nothing) AndAlso Request.QueryString("AppID").Length > 0 Then
            Response.Redirect("Report37.aspx?AppID=" & Request.QueryString("AppID").ToString & "&Ges=1")
        Else
