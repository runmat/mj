...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New Sixt_B07(m_User, m_App, strFileName)
            ...
            lblError.Text = ""
            'Datumsfelder prüfen
            If (txtAbmeldedatumVon.Text.Length = 0) Or (txtAbmeldedatumBis.Text.Length = 0) Then
                checkInput = False
            End If
            If (Not IsDate(txtAbmeldedatumVon.Text)) Or (Not IsDate(txtAbmeldedatumBis.Text)) Then
                checkInput = False
            End If
            ...
            If checkInput Then
                ...
                End If
                If (datAbmeldedatumBis.Subtract(datAbmeldedatumVon).Days > 30) Then
                    checkInput = False
            ...
            If checkInput Then
                m_Report.Fill(Session("AppID").ToString, Session.SessionID.ToString, Me, datAbmeldedatumVon, datAbmeldedatumBis, strKennzeichen, strFahrgestellnummer)
