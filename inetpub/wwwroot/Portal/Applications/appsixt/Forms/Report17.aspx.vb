...
#End Region
    ...
    Private Sub InitialLoad()
        ...
        Try
            datEingangsdatumVon = CType(ConfigurationManager.AppSettings("DatumVon01"), Date)
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New Sixt_B03(m_User, m_App, strFileName)
            ...
            If txtPDI.Text.Length = 0 Then
                strPDI = "|"
            Else
                strPDI = UCase(txtPDI.Text)
            End If
            If txtFahrgestellnummer.Text.Length = 0 Then
                strFahrgestellnummer = "|"
            Else
                strFahrgestellnummer = UCase(txtFahrgestellnummer.Text)
            End If
            If txtModell.Text.Length = 0 Then
                strModell = "|"
            Else
                strModell = UCase(txtModell.Text)
            End If
            lblError.Text = ""
            ...
            If checkInput Then
                m_Report.Fill(Session("AppID").ToString, Session.SessionID.ToString, Me, strPDI, datEingangsdatumVon, datEingangsdatumBis, strFahrgestellnummer, strModell)
