						...
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD vAlign="top">
									...
									<asp:label id="lblInfo" runat="server" CssClass="TextInfo" EnableViewState="False">Eingabe erforderlich, wenn PDI gefüllt. Format: TT.MM.JJJJ. Der Datumsbereich darf maximal einen Monat (30 Tage) umfassen.</asp:label></TD>
							</TR>
							<TR>
								<TD vAlign="top">&nbsp;</TD>
