<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report17.aspx.vb" Inherits="AppSIXT.Report17" %>
							...
							<TR>
								...
								<TD vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD class="" vAlign="top">
												<asp:label id="lblError" runat="server" CssClass="TextError" EnableViewState="False" DESIGNTIMEDRAGDROP="73"></asp:label></TD>
										</TR>
									</TABLE>
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														...
														<TD class="TextLarge" vAlign="center" width="100%"><asp:textbox id="txtPDI" runat="server"></asp:textbox>
															<asp:textbox id="txtEingangsdatumVon" runat="server" Visible="False" Enabled="False"></asp:textbox>
															<asp:textbox id="txtEingangsdatumBis" runat="server" Visible="False" Enabled="False"></asp:textbox></TD>
													</TR>
													<TR>
													...
													<TR>
														<TD class="TextLarge" vAlign="center">Fahrzeugmodell:</TD>
														<TD class="TextLarge" vAlign="center"><asp:textbox id="txtModell" runat="server"></asp:textbox></TD>
													</TR>
