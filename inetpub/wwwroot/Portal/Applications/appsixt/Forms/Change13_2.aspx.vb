...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lnkKreditlimit.NavigateUrl = "Change13.aspx?AppID=" & Session("AppID").ToString
        ...
        Try
            ...
            If Session("objFahrzeuge") Is Nothing Then
                Response.Redirect("Change13.aspx?AppID=" & Session("AppID").ToString)
            End If

            objFahrzeuge = CType(Session("objFahrzeuge"), SIXT_Mindesthaltefrist)
    ...
    Private Function CheckGrid() As Int32
        ...
        Try
            For Each item In DataGrid1.Items
                intZaehl = 0
                Dim strEquipmentnummer As String = "Equipmentnummer='" & item.Cells(1).Text & "'"
