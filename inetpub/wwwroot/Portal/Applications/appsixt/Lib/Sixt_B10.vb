    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Web.UI.Page, _
        ...
        If Not m_blnGestartet Then
            ...
            Try
                ...
                'Dim myProxy As DynSapProxyObj = DynSapProxy.getProxy("Z_M_MELDUNGEN_FAHRZEUGE_FIBU", m_objApp, m_objUser, page)
                ...
                S.AP.Init("Z_M_MELDUNGEN_FAHRZEUGE_FIBU", "I_KUNNR, I_VKORG", Right("0000000000" & m_objUser.KUNNR, 10), "1510")
