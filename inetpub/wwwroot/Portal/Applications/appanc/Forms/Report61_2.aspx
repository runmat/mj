...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report61_2.aspx.vb" Inherits="AppANC.Report61_2" %>
							...
							<tr>
								...
								<td vAlign="top">
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle"><asp:hyperlink id="lnkKreditlimit" runat="server" Visible="False" NavigateUrl="Equipment.aspx" CssClass="TaskTitle">Abfragekriterien</asp:hyperlink>&nbsp;</TD>
										</TR>
										<TR>
											<TD class="LabelExtraLarge">
												<TABLE id="Table9" cellSpacing="0" cellPadding="5" width="100%" border="0">
													<TR>
														<TD vAlign="top" align="left" colSpan="2"><TABLE id="Table10" cellSpacing="0" cellPadding="5" bgColor="white" border="0">
																<TR>
																	<TD class="PageNavigation" vAlign="center" align="left">Status:&nbsp;&nbsp;</TD>
																	<TD class="PageNavigation" vAlign="top" align="right"><asp:label id="lblStatus" runat="server"></asp:label></TD>
																	<TD class="PageNavigation" vAlign="center" align="right" colSpan="3"><asp:hyperlink id="lnkSchluesselinformationen" runat="server" NavigateUrl="Report62.aspx?chassisnum=" Target="_blank" CssClass="PageNavigation">Schlüsselinformationen</asp:hyperlink>&nbsp;
																		<asp:hyperlink id="HyperLink1" runat="server" Target="_blank" CssClass="PageNavigation">ABE-Daten</asp:hyperlink></TD>
																</TR>
																<TR>
																...
																<TR>
																	...
																	<TD class="PageNavigation" vAlign="top" align="right" colSpan="4"><asp:label id="Label3" runat="server">CoC</asp:label><asp:checkbox id="cbxCOC" runat="server" Enabled="False" TextAlign="Left"></asp:checkbox></TD>
																</TR>
