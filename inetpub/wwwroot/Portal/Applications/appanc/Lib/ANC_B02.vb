...
Public Class ANC_B02
    REM § Status-Report, Kunde: ANC, BAPI: Z_M_Briefeohnefzg2 (Fill),
...
#Region " Methods"
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal strBriefnummer As String, ByVal datEingangsdatumVon As DateTime, ByVal datEingangsdatumBis As DateTime, ByVal strFahrgestellnummer As String, ByVal strHaendlerID As String)
        'm_strClassAndMethod = "ANC_B02.FILL"
        'm_strAppID = strAppID
        'm_strSessionID = strSessionID
        'If Not m_blnGestartet Then
        '    m_blnGestartet = True

        '    Dim objSAP As New SAPProxy_ANC_02.SAPProxy_ANC_02()
        ...
        '    Try
        '        Dim SAPTable As New SAPProxy_ANC_02.
        ...
        '            Dim objZulassungsVorbelegung As DADWebClass.ZulassungsVorbelegung
        '            objZulassungsVorbelegung = New DADWebClass.ZulassungsVorbelegung(CStr(tblTemp2.Rows(i)("ZZFAHRG")), Now, m_objApp.Connectionstring)
    ...
    Public Sub FillHistory(ByVal strAppID As String, ByVal strSessionID As String, ByVal strAmtlKennzeichen As String, ByVal strFahrgestellnummer As String, ByVal strBriefnummer As String, ByVal strOrdernummer As String)
        m_strClassAndMethod = "ANC_B02.FillHistory"
        m_strAppID = strAppID
        m_strSessionID = strSessionID
        If Not m_blnGestartet Then
            m_blnGestartet = True
            ...
            Try
                Dim SAPTable As New SAPProxy_ANC.ZDAD_M_WEB_BRIEFDATEN_SIXTTable()

                intID = m_objlogApp.WriteStartDataAccessSAP(m_objUser.UserName, m_objUser.IsTestUser, "Z_M_Brieflebenslauf_Vanguard", strAppID, strSessionID, m_objUser.CurrentLogAccessASPXID)
                objSAP.Z_M_Brieflebenslauf_Vanguard(Right("0000000000" & m_objUser.KUNNR, 10), UCase(strBriefnummer), UCase(strFahrgestellnummer), UCase(strAmtlKennzeichen), UCase(strOrdernummer), SAPTable)
                objSAP.CommitWork()
                If intID > -1 Then
                    m_objlogApp.WriteEndDataAccessSAP(intID, True)
                End If
