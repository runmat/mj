...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change08Edit.aspx.vb" Inherits="AppCSC.Change08Edit" %>
				...
				<tr>
					<td>
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD vAlign="top" height="3" class="TaskTitle">&nbsp;</TD>
								<TD vAlign="top" height="3" class="TaskTitle" width="100%">
									<asp:hyperlink id="lnk" runat="server" NavigateUrl="Change08.aspx">Vorgangssuche</asp:hyperlink></TD>
							</TR>
							<tr>
								<TD vAlign="top">
										...
										<TR>
											<TD>
												<TABLE id="Table4" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													...
													<TR>
														<TD class="StandardTableAlternate" width="150">Versand:</TD>
														<TD class="StandardTableAlternate">
															<asp:label id="txtVersand" runat="server" Width="350px"></asp:label></TD>
													</TR>
													<TR>
														<TD class="TextLarge" width="150">Wiedereingang:</TD>
														<TD class="TextLarge">
															<asp:label id="txtWiedereingang" runat="server" Width="350px"></asp:label></TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" width="150">nochm. Versand:</TD>
														<TD class="StandardTableAlternate">
													...
													<TR>
														<TD class="TextLarge" width="150">Kontonummer neu:</TD>
														<TD class="TextLarge">
															<asp:textbox id="txtVertragsnummerNeu" runat="server" Width="350px" MaxLength="35"></asp:textbox></TD>
													</TR>
												</TABLE>
											</TD>
										</TR>
