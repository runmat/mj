<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report41.aspx.vb" Inherits="AppCSC.Report41" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													...
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">Kontonummer:</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:TextBox id="txtKontonummer" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" vAlign="top" width="150">Kennzeichen:</TD>
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:TextBox id="txtKennzeichen" runat="server"></asp:TextBox></TD>
													</TR>
												</TABLE>
												<BR>
											</TD>
