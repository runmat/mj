...
#End Region
    ...
    Protected WithEvents txtVertragsnummerNeu As System.Web.UI.WebControls.TextBox
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lnk.NavigateUrl = "Change08.aspx?AppID=" & CStr(Request.QueryString("AppID"))
        Try
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        txtVertragsnummerNeu.Enabled = False
    ...
    Private Sub cmdConfirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConfirm.Click
        Try
            ...
            If txtVertragsnummerNeu.Text.Length = 0 Then
                logApp.CollectDetails("Vertragsnummer", CType(txtVertragsnummer.Text, Object))
            Else
                If txtVertragsnummer.Text = txtVertragsnummerNeu.Text Then
                    logApp.CollectDetails("Vertragsnummer", CType(txtVertragsnummer.Text, Object))
                Else
                    logApp.CollectDetails("Vertragsnummer", CType(txtVertragsnummer.Text & " -> " & txtVertragsnummerNeu.Text, Object))
                End If
            End If
            ...
            m_objCSCEinzel.Kontonummer = txtVertragsnummerNeu.Text
            m_objCSCEinzel.Gesperrt = cbxGesperrt.Checked
            m_objCSCEinzel.Change(Session("AppID").ToString, Session.SessionID, Me.Page, strKontonummerAlt)
    ...
    Private Sub cmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        ...
        txtVertragsnummerNeu.Enabled = True
