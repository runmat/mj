...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change11_2.aspx.vb" Inherits="AppCSC.Change11_2" %>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD vAlign="top" class="TaskTitle">
									<asp:hyperlink id="lnkKreditlimit" runat="server" CssClass="TaskTitle" NavigateUrl="Change11.aspx">Vorgangssuche</asp:hyperlink></TD>
							</TR>
							<tr>
								<TD class="" vAlign="top">
								...
								<TD vAlign="top" height="371">
									<TABLE id="Table5" cellSpacing="0" cellPadding="0" border="0">
										<TR>
											<TD class="LabelExtraLarge" vAlign="top" align="left" colSpan="3">
												<asp:label id="lblNoData" runat="server" EnableViewState="False"></asp:label></TD>
										</TR>
										<TR>
											<TD class="LabelExtraLarge" vAlign="top" align="left" colSpan="3">
									...
									<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False" Width="100%" BackColor="White">
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Datum_Sperrliste" SortExpression="Datum_Sperrliste" HeaderText="Datum&lt;br&gt;Sperrliste" DataFormatString="{0:dd.MM.yyyy}"></asp:BoundColumn>
											...
											<asp:BoundColumn DataField="Problem" SortExpression="Problem" HeaderText="Status"></asp:BoundColumn>
							...
							<TR>
								<TD class=""></TD>
								<TD height="14"><asp:label id="lblError" runat="server" CssClass="TextError" EnableViewState="False"></asp:label></TD>
							</TR>
							<TR>
								<TD>&nbsp;</TD>
