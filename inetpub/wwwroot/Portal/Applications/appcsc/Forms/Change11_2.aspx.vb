...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lnkKreditlimit.NavigateUrl = "Change11.aspx?AppID=" & Session("AppID").ToString
        Try
    ...
    Private Sub cmdConfirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConfirm.Click
        ...
        For i = 0 To tmpDataView.Count - 1
            ...
            If IsDate(tmpDataView.Item(i)("Datum_Sperrliste")) Then
                rowNew("Datum Sperrliste") = CType(tmpDataView.Item(i)("Datum_Sperrliste"), DateTime).ToShortDateString
            End If
