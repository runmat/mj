<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change08.aspx.vb" Inherits="AppCSC.Change08" %>
				...
				<tr>
					<td>
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<td class="PageNavigation" colSpan="2" noWrap><asp:label id="lblHead" runat="server"></asp:label><asp:label id="lblPageTitle" runat="server"> - Vorgangssuche</asp:label>
								</td>
							</TR>
							<tr>
												...
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													...
													<TR>
														...
														<TD class="TextLarge">Bitte geben mindestens ein Suchkriterium ein.<BR>
															Platzhalter sind in dieser Suche nicht zulässig.</TD>
													</TR>
												</TABLE>
												<br>
											</td>
