<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change01.aspx.vb" Inherits="AppAlphabet.Change01" %>
									...
									<TD vAlign="top" align="left">
										...
										<tr>
												<td class="TextLarge" width="162">
													<P align="right">Vertragsnummer:&nbsp;
													</P>
												</td>
												<td class="TextLarge"><asp:textbox id="txtSucheLiznr" runat="server" Width="155px"></asp:textbox></td>
										</tr>
