...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report01.aspx.vb" Inherits="AppFFD.Report01" %>
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="FilialeRow" runat="server">
														<TD class="TextLarge"><asp:label id="lblFilialeShow" runat="server" Visible="False">Filiale:</asp:label></TD>
