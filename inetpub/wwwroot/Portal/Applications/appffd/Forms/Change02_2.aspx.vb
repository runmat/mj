...
#End Region
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        'objFDDBank2.ZeigeFlottengeschaeft = rbFlottengeschaeft.Checked
        'objFDDBank2.ZeigeHEZ = rbHEZ.Checked      'HEZ
        'objFDDBank2.ZeigeStandard = rbStandard.Checked  'HEZ
    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If Not e.Item.Cells(1).Text.Length = 0 Then
            ...
            Dim int5 As Int32
            Dim int55 As Int32
            Dim counter As Integer = 2 'Anzahl Kontingentarten - 1: Standard, Delayed Payment, HEZ
            ...
            'If int3 + int4 = 0 Then                             'Standard endgültig + temporär = 0, dann zeige Delayed Payment
            '    objFDDBank2.ZeigeFlottengeschaeft = True
            '    objFDDBank2.Haendler = Session("SelectedDealer").ToString
            '    Session("objFDDBank2") = objFDDBank2
            ...
            'If int5 = 0 Then                                    'Delayed Payment = 0, dann verberge (wieder)
            '    objFDDBank2.ZeigeFlottengeschaeft = False
            '    objFDDBank2.Haendler = Session("SelectedDealer").ToString
            '    Session("objFDDBank2") = objFDDBank2
            '    strRedirectURL = "Change02Edit.aspx?AppID=" & Session("AppID").ToString
            ...
            If int3 + int4 = 0 Then                             'Standard endgültig + temporär = 0
                objFDDBank2.ZeigeStandard = False
            ...
            If int5 = 0 Then                                    'Delayed Payment = 0, dann verberge 
                objFDDBank2.ZeigeFlottengeschaeft = False
                'rbFlottengeschaeft.Visible = False
                counter -= 1
            End If
