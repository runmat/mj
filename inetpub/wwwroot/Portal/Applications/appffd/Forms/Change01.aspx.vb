    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If (Not Request.QueryString("ID") Is Nothing) AndAlso (Request.QueryString("ID").Length > 0) Then
                ...
                End If
                suche1.RedirectUrl = "Change01Edit.aspx?ID=" & Request.QueryString("ID").ToString & strLastRecordParam
            Else
                If CStr(Request.QueryString("LastRecord")) = "True" Then
                    strLastRecordParam = "?LastRecord=True"
                End If
                suche1.RedirectUrl = "Change01Edit.aspx" & strLastRecordParam
            End If
            suche1.User = m_User
        ...
        Catch ex As Exception
            m_App.WriteErrorText(1, m_User.UserName, "Change01", "Page_Load", ex.ToString)
...
' 
' *****************  Version 6  *****************
' User: Rudolpho     Date: 15.06.07   Time: 8:09
' Updated in $/CKG/Applications/AppFFD/AppFFDWeb/Forms
' 
' *****************  Version 5  *****************
