...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change14.aspx.vb" Inherits="AppFFD.Change14" %>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR id="trDistrikte" runat="server">
								<TD vAlign="top" height="40">
									...
									<asp:linkbutton id="cmdReset" runat="server" Visible="False" CssClass="StandardButton"> &#149;&nbsp;Zurücksetzen</asp:linkbutton></TD>
