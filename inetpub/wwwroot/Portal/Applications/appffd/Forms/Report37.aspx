<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report37.aspx.vb" Inherits="AppFFD.Report37" %>
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														...
														<TD class="TextLarge" vAlign="center" width="100%"><asp:dropdownlist id="ddlFahrzeugtyp" runat="server"></asp:dropdownlist></TD>
													</TR>
												</TABLE>
												<BR>
											</TD>
