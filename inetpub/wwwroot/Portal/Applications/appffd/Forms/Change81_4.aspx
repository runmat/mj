...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change81_4.aspx.vb" Inherits="AppFFD.Change81_4" %>
													...
													<TR>
														<TD vAlign="top" align="left" colSpan="2"><asp:datagrid id="DataGrid1" runat="server" Width="100%" AllowSorting="True" AutoGenerateColumns="False" bodyHeight="250" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader">
																...
																<Columns>
																	...
																	<asp:BoundColumn DataField="KONZS" SortExpression="KONZS" HeaderText="H&#228;ndler-NR"></asp:BoundColumn>
																	...
																	<asp:BoundColumn DataField="VERMARKTUNGSCODE" SortExpression="VERMARKTUNGSCODE" HeaderText="Vermarktung"></asp:BoundColumn>
																	<asp:BoundColumn DataField="VERSANDART" SortExpression="VERSANDART" HeaderText="Versandart"></asp:BoundColumn>
																	<asp:BoundColumn DataField="FEHLER_KZ" SortExpression="FEHLER_KZ" HeaderText="Bemerkung"></asp:BoundColumn>
