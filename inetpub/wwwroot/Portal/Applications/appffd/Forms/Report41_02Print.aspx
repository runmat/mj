<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report41_02Print.aspx.vb" Inherits="AppFFD.Report41_02Print"%>
				...
				<TR>
					<TD vAlign="top" align="left" colSpan="2">
						<TABLE id="Table3" height="56" cellSpacing="0" cellPadding="0" width="612" border="1">
							<TR>
								<TD width="254" bgColor="#cccccc"><FONT face="Arial" size="1"><STRONG>Kontingentart</STRONG></FONT></TD>
							...
							<TR>
								<TD width="254"><FONT face="Arial" size="2"><asp:textbox id="txtA001" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="100%" Font-Size="XX-Small"></asp:textbox></FONT></TD>
							...
							<TR>
								<TD width="254" height="20"><FONT face="Arial" size="2"><asp:textbox id="txtA002" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="100%" Font-Size="XX-Small"></asp:textbox></FONT></TD>
						...
						<TABLE id="Table4" height="58" cellSpacing="0" cellPadding="0" width="612" border="1">
							<TR>
								<TD width="416" bgColor="#cccccc"><FONT face="Arial" size="1"><STRONG>Kontingentart</STRONG></FONT></TD>
								<TD width="144" bgColor="#cccccc"><FONT face="Arial" size="1"><STRONG>Richtwert</STRONG></FONT></TD>
								<TD width="393" bgColor="#cccccc"><FONT face="Arial" size="1"><STRONG>Inanspruchnahme</STRONG></FONT></TD>
							</TR>
							<TR>
								<TD width="416" height="21"><FONT face="Arial" size="2"><asp:textbox id="A003" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="100%" Font-Size="XX-Small"></asp:textbox></FONT></TD>
								<TD width="144" height="21"><asp:textbox id="R003" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="30px" Font-Size="XX-Small"></asp:textbox></TD>
							...
							<TR>
								<TD width="416" height="20"><FONT face="Arial" size="2"><asp:textbox id="A004" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="100%" Font-Size="XX-Small"></asp:textbox></FONT></TD>
								<TD width="144" height="20"><asp:textbox id="R004" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="30px" Font-Size="XX-Small"></asp:textbox></TD>
						...
						<TABLE id="Table5" height="36" cellSpacing="0" cellPadding="0" width="612" border="1">
							<TR>
								<TD width="254" bgColor="#cccccc" height="13"><FONT face="Arial" size="1"><STRONG>Gesamt</STRONG></FONT></TD>
								<TD width="99" bgColor="#cccccc" height="13"><FONT face="Arial" size="1"><STRONG>Kontingente</STRONG></FONT></TD>
								<TD bgColor="#cccccc" height="13"><FONT face="Arial" size="1"><STRONG>Inanspruchnahme</STRONG></FONT></TD>
							</TR>
							<TR>
								<TD width="254"><FONT face="Arial" size="2"><asp:textbox id="Textbox10" runat="server" BorderColor="Transparent" BorderWidth="0px" BackColor="Transparent" Width="100%" Font-Size="XX-Small"></asp:textbox></FONT></TD>
					...
					<TD colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="611px" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="250" AutoGenerateColumns="False">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="Kontingentart" HeaderText="Kontingentart">
									<HeaderStyle Width="275"></HeaderStyle>
								</asp:BoundColumn>
