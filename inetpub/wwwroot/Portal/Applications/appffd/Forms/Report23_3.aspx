...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report23_3.aspx.vb" Inherits="AppFFD.Report23_3" %>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD><asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" Width="100%" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" PageSize="50" BackColor="White">
													...
													<Columns>
														<asp:BoundColumn DataField="Vertragsnummer" SortExpression="Vertragsnummer" HeaderText="Vertrag">
                                                        ...
                                                        <asp:BoundColumn DataField="Finanzierungsart" SortExpression="Finanzierungsart" HeaderText="Fin.-Art">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="Ordernummer" SortExpression="Ordernummer" HeaderText="Order">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="COC" SortExpression="COC" HeaderText="COC"></asp:BoundColumn>
														<asp:BoundColumn DataField="Erfassung Fahrzeug" SortExpression="Erfassung Fahrzeug" HeaderText="Erfassung&lt;br&gt;Fahrzeug" DataFormatString="{0:dd.MM.yyyy}">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
														</asp:BoundColumn>
