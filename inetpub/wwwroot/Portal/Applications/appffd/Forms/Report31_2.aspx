...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report31_2.aspx.vb" Inherits="AppFFD.Report31_2"%>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR id="trPageSize" runat="server">
											<TD class="LabelExtraLarge" align="left" colSpan="2">
												<asp:hyperlink id="lnkExcel" runat="server" Visible="False" Target="_blank">Excelformat</asp:hyperlink><STRONG>
												</STRONG>
