...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report13_2.aspx.vb" Inherits="AppFFD.Report13_2" %>
											...
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														...
														<TD class="TextLarge"><asp:textbox id="txtOrdernummer" runat="server" MaxLength="10" Width="250px"></asp:textbox></TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" width="150">Vertragsnummer:&nbsp;&nbsp;&nbsp;</TD>
														<TD class="StandardTableAlternate"><asp:textbox id="txtVertragsnummer" runat="server" MaxLength="35" Width="250px"></asp:textbox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" width="150">Fahrgestellnummer:</TD>
														<TD class="TextLarge">
															<asp:textbox id="txtFahrgestellnummer" runat="server" Width="250px" MaxLength="35"></asp:textbox></TD>
													</TR>
												</TABLE>
												<br>
											</td>
