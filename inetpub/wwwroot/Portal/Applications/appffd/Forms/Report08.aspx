...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report08.aspx.vb" Inherits="AppFFD.Report08" %>
				...
				<TR>
					<TD>
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="TaskTitle" colSpan="2"><asp:hyperlink id="lnkExcel" runat="server" Visible="False" Target="_blank">Excelformat</asp:hyperlink>&nbsp;
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR>
														<TD class="TextLarge" vAlign="center" width="142">Geschäftsjahr:</TD>
														<TD class="TextLarge" vAlign="center" noWrap><asp:textbox id="txtJahr" runat="server" Width="75px"></asp:textbox></TD>
														<TD class="TextLarge" vAlign="center">Kontingentart:</TD>
														<TD class="TextLarge" vAlign="center"><asp:dropdownlist id="ddlKontingentart" runat="server"></asp:dropdownlist></TD>
														<TD class="TextLarge" vAlign="center" width="100%"><asp:linkbutton id="cmdCreate" runat="server" CssClass="StandardButton">&#149;&nbsp;Erstellen</asp:linkbutton>
															<asp:label id="lblMessage" runat="server" CssClass="TextLarge" EnableViewState="False"></asp:label></TD>
														<TD class="TextLarge" vAlign="center" width="100%"><asp:dropdownlist id="ddlPageSize" runat="server" Visible="False" AutoPostBack="True"></asp:dropdownlist></TD>
													</TR>
												</TABLE>
