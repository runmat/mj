...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change02Edit.aspx.vb" Inherits="AppFFD.Change02Edit" %>
												...
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<TR>
														...
														<TD noWrap align="right">
															<asp:HyperLink id="HyperLink1" runat="server" CssClass="StandardButton" NavigateUrl="Druck1.aspx" Target="_blank">&#149;&nbsp;Druckversion</asp:HyperLink>&nbsp;&nbsp;&nbsp;
											...
											<TD>
												<asp:datagrid id="DataGrid1" runat="server" Width="100%" PageSize="50" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False" BackColor="White">
													...
													<Columns>
														...
														<asp:TemplateColumn SortExpression="Faelligkeit" HeaderText="F&#228;lligkeit">
															<ItemTemplate>
																<asp:TextBox id=TextBox2 runat="server" Visible='<%# not DataBinder.Eval(Container, "DataItem.InAutorisierung") %>' Width="60px" MaxLength="10" Text='<%# DataBinder.Eval(Container, "DataItem.Faelligkeit", "{0:dd.MM.yyyy}") %>'>
																</asp:TextBox>
														...
														<asp:TemplateColumn SortExpression="Kunde" HeaderText="Kunde">
															<ItemTemplate>
																<asp:TextBox id=Textbox1 runat="server" Visible='<%# not DataBinder.Eval(Container, "DataItem.InAutorisierung") %>' Width="75px" MaxLength="50" Text='<%# DataBinder.Eval(Container, "DataItem.Kunde") %>'>
																</asp:TextBox>
