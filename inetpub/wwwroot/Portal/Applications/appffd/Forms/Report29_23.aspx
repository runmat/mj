<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report29_23.aspx.vb" Inherits="AppFFD.Report29_23" %>
...
<HTML>
	<HEAD>
		<TITLE>‹berzogene Kontingente (Details)</TITLE>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<td class="PageNavigation" colSpan="2">
									<asp:Label id="lblHead" runat="server">‹berzogene Kontingente (Details)</asp:Label></td>
							</TR>
							<TR>
