...
#End Region
    ...
    Private mObjFehlendeAbmeldeunterlagen As FehlendeAbmeldeunterlagen
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjFehlendeAbmeldeunterlagen Is Nothing Then
                If Session("mObjFehlendeAbmeldeunterlagenSession") Is Nothing Then
                    mObjFehlendeAbmeldeunterlagen = New FehlendeAbmeldeunterlagen(m_User, m_App, "")
                    mObjFehlendeAbmeldeunterlagen.Fill(Session("AppID").ToString)
                    If Not mObjFehlendeAbmeldeunterlagen.Status = 0 Then
                        lblError.Text = mObjFehlendeAbmeldeunterlagen.Message
                        Exit Sub
                    End If
                    Session.Add("mObjFehlendeAbmeldeunterlagenSession", mObjFehlendeAbmeldeunterlagen)
                Else
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjFehlendeAbmeldeunterlagen.Status = 0 Then

            If IsNothing(mObjFehlendeAbmeldeunterlagen.Result) OrElse mObjFehlendeAbmeldeunterlagen.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjFehlendeAbmeldeunterlagen.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjFehlendeAbmeldeunterlagen.Result.Copy
