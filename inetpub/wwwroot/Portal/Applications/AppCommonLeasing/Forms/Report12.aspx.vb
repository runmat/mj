...
Public Class Report12
    ...
    Private _app As App
    Private _vers As Versandstatuswechsel
    ...
    Protected Overrides Sub OnLoad(e As EventArgs)
        ...
        Try
            ...
            _vers = TryCast(Session("Versandstatuswechsel"), Versandstatuswechsel)
            If _vers Is Nothing Then
                _vers = New Versandstatuswechsel(_user, _app, CStr(Session("AppID")))
                Session("Versandstatuswechsel") = _vers
            End If
    ...
    Protected Sub EndVersendet(ByVal sender As Object, ByVal e As EventArgs)
        _vers.EndVersand()
        If _vers.Status <> 0 Then
            lblError.Visible = True
            lblError.Text = _vers.Message
