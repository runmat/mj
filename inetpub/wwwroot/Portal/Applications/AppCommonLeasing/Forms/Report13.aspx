<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report13.aspx.vb" Inherits="AppCommonLeasing.Report13" %>
                            ...
                            <tr>
                                <td valign="top" style="width: 140px">
                                    <table id="Table2" cellspacing="0" cellpadding="0" style="width: 100%" border="0">
                                        ...
                                        <tr>
                                            <td valign="middle">
                                                <asp:LinkButton CssClass="StandardButton" Height="18px" ID="cmdEnd" OnClick="Entsperren"
                                                    Visible="False" Enabled="False" runat="server" Width="120px" Text="•&nbsp;Entsperren" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
