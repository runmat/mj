...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjGesamtbestand Is Nothing Then
                If Session("mObjGesamtbestandSession") Is Nothing Then
                    Throw New Exception("benötigtiges SessionObjekt nicht vorhanden")
                Else
                    mObjGesamtbestand = CType(Session("mObjGesamtbestandSession"), Gesamtbestand)
                End If
            End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjGesamtbestand.Status = 0 Then
            ...
            If IsNothing(mObjGesamtbestand.Result) OrElse mObjGesamtbestand.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjGesamtbestand.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjGesamtbestand.Result.Copy
        ...
        Catch ex As Exception
            lblError.Text = "Beim erstellen der Exceldatei ist ein Fehler aufgetreten.<br>(" & ex.Message & ")"
        End Try
    End Sub
End Class
' ************************************************
...
' 
' *****************  Version 4  *****************
' User: Jungj        Date: 6.11.08    Time: 14:00
' Updated in $/CKAG/Applications/AppCommonLeasing/Forms
' ITA 2362,2365 nachbesserungen
' 
' *****************  Version 3  *****************
