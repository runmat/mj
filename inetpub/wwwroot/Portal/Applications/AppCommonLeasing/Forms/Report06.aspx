<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report06.aspx.vb" Inherits="AppCommonLeasing.Report06" %>
                            ...
                            <table id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    <td valign="top" align="left">
                                        <table id="Table3" cellspacing="0" cellpadding="5" runat="server" width="100%" bgcolor="white"
                                            border="0">
                                            ...
                                            <tr id="tr_Kennzeichen">
                                                ...
                                                <td class="StandardTableAlternate" valign="center">
                                                    <asp:TextBox CssClass="TextBoxLarge" ID="txtKennzeichen" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr id="tr_Fahrgestellnummer">
                                                ...
                                                <td class="TextLarge" valign="center">
                                                    <asp:TextBox CssClass="TextBoxLarge" ID="txtFahrgestellnummer" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
