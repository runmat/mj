...
#End Region
    ...
    Private mObjDokumenteOhneDaten As DokumenteOhneDaten
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjDokumenteOhneDaten Is Nothing Then
                If Session("mObjDokumenteOhneDatenSession") Is Nothing Then
                    mObjDokumenteOhneDaten = New DokumenteOhneDaten(m_User, m_App, "")
                    mObjDokumenteOhneDaten.Fill(Session("AppID").ToString)
                    If Not mObjDokumenteOhneDaten.Status = 0 Then
                        lblError.Text = mObjDokumenteOhneDaten.Message
                        Exit Sub
                    End If
                    Session.Add("mObjDokumenteOhneDatenSession", mObjDokumenteOhneDaten)
                Else
                    mObjDokumenteOhneDaten = CType(Session("mObjDokumenteOhneDatenSession"), DokumenteOhneDaten)
                End If
            End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjDokumenteOhneDaten.Status = 0 Then

            If IsNothing(mObjDokumenteOhneDaten.Result) OrElse mObjDokumenteOhneDaten.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjDokumenteOhneDaten.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjDokumenteOhneDaten.Result.Copy
