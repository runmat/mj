...
#End Region
    ...
    Private mObjFehlendeCoC As FehlendeCoC
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjFehlendeCoC Is Nothing Then
                If Session("mObjFehlendeCoCSession") Is Nothing Then
                    mObjFehlendeCoC = New FehlendeCoC(m_User, m_App, "")
                    mObjFehlendeCoC.Fill(Session("AppID").ToString)
                    If Not mObjFehlendeCoC.Status = 0 Then
                        lblError.Text = mObjFehlendeCoC.Message
                        Exit Sub
                    End If
                    Session.Add("mObjFehlendeCoCSession", mObjFehlendeCoC)
                Else
                    mObjFehlendeCoC = CType(Session("mObjFehlendeCoCSession"), FehlendeCoC)
                End If
            End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjFehlendeCoC.Status = 0 Then

            If IsNothing(mObjFehlendeCoC.Result) OrElse mObjFehlendeCoC.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjFehlendeCoC.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjFehlendeCoC.Result.Copy
