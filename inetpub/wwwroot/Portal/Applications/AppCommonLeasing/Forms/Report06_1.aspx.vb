...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjVersendeteZBIIEndg Is Nothing Then
                If Session("mObjVersendeteZBIIEndgSession") Is Nothing Then
                    Throw New Exception("benötigtiges SessionObjekt nicht vorhanden")
                Else
                    mObjVersendeteZBIIEndg = CType(Session("mObjVersendeteZBIIEndgSession"), VersendeteZBIIEndg)
                End If
            End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjVersendeteZBIIEndg.Status = 0 Then
            ...
            If IsNothing(mObjVersendeteZBIIEndg.Result) OrElse mObjVersendeteZBIIEndg.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjVersendeteZBIIEndg.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjVersendeteZBIIEndg.Result.Copy
