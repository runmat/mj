...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjVersendeteZBIITemp Is Nothing Then
                If Session("mObjVersendeteZBIITempSession") Is Nothing Then
                    Throw New Exception("benötigtiges SessionObjekt nicht vorhanden")
                Else
                    mObjVersendeteZBIITemp = CType(Session("mObjVersendeteZBIITempSession"), VersendeteZBIITemp)
                End If
            End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjVersendeteZBIITemp.Status = 0 Then
            ...
            If IsNothing(mObjVersendeteZBIITemp.Result) OrElse mObjVersendeteZBIITemp.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjVersendeteZBIITemp.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjVersendeteZBIITemp.Result.Copy
