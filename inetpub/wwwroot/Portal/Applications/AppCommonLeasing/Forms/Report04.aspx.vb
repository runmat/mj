...
#End Region
    ...
    Private mObjZulassungsklaerfaelle As Zulassungsklaerfaelle
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjZulassungsklaerfaelle Is Nothing Then
                If Session("mObjZulassungsklaerfaelleSession") Is Nothing Then
                    mObjZulassungsklaerfaelle = New Zulassungsklaerfaelle(m_User, m_App, "")
                    mObjZulassungsklaerfaelle.Fill(Session("AppID").ToString)
                    If Not mObjZulassungsklaerfaelle.Status = 0 Then
                        lblError.Text = mObjZulassungsklaerfaelle.Message
                        Exit Sub
                    End If
                    Session.Add("mObjZulassungsklaerfaelleSession", mObjZulassungsklaerfaelle)
                Else
                    mObjZulassungsklaerfaelle = CType(Session("mObjZulassungsklaerfaelleSession"), Zulassungsklaerfaelle)
                End If
            End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjZulassungsklaerfaelle.Status = 0 Then

            If IsNothing(mObjZulassungsklaerfaelle.Result) OrElse mObjZulassungsklaerfaelle.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjZulassungsklaerfaelle.Result)
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            tblTemp = mObjZulassungsklaerfaelle.Result.Copy
