...
Public Class Versandstatuswechsel
    Inherits BankBase
    ...
    Public Sub GetData(fahrgestellnummer As String, kennzeichen As String, vertragsnummer As String, objektnummer As String, von As DateTime?, bis As DateTime?)
        Try
            ...
            'Dim proxy = DynSapProxy.getProxy("Z_DPM_TEMP_VERSENDUNGEN_01", m_objApp, m_objUser, Page)

            'proxy.setImportParameter("I_AG", m_objUser.KUNNR.PadLeft(10, "0"c))

            S.AP.Init("Z_DPM_TEMP_VERSENDUNGEN_01", "I_AG", m_strKUNNR)
    ...
    Public Sub EndVersand()
        Try
            m_intStatus = 0
            m_strMessage = String.Empty

            'Dim proxy = DynSapProxy.getProxy("Z_DPM_TEMP_END_SPERR_01", m_objApp, m_objUser, page)
            'proxy.setImportParameter("I_AG", m_objUser.KUNNR.PadLeft(10, "0"c))

            S.AP.Init("Z_DPM_TEMP_END_SPERR_01", "I_AG", m_strKUNNR)
