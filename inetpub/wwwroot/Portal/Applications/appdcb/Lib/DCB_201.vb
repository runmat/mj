...
#Region " Methods"
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String)
        m_strClassAndMethod = "DCB_201.FILL"
        m_strAppID = strAppID
        ...
        If Not m_blnGestartet Then
            ...
            Try
                ...
                S.AP.InitExecute("Z_M_ABM_FEHLENDE_UNTERL_002", "I_KUNNR", Right("0000000000" & m_objUser.Customer.KUNNR, 10))

                'Dim m_strKUNNR As String
                'm_strKUNNR = Right("0000000000" & m_objUser.Customer.KUNNR, 10)


                'Dim myProxy As DynSapProxyObj = DynSapProxy.getProxy("Z_M_ABM_FEHLENDE_UNTERL_002", m_objApp, m_objUser, page)
