...
Public Class Report201
    ...
    'Daimler Chrysler Bank, Report "Fehlende Abmeldeunterlagen"
    'Code: DCB_201
    'BAPI: Z_M_Abm_Fehlende_Unterl_002
...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New DCB_201(m_User, m_App, strFileName)
                ...
                Else
                    ...
                    Else
                        ...
                        Try
                            ...
                            tblExcel.Columns.Remove("Typ Schlüssel")
                            tblExcel.Columns.Remove("Ausführung")
                            tblExcel.Columns.Remove("Name")
                            tblExcel.Columns.Remove("Straße")
                        ...
                        Response.Redirect("Report201_2.aspx?AppID=" & Session("AppID").ToString & "&legende=Report201")
                    End If
                End If
            End If
        Catch ex As Exception
