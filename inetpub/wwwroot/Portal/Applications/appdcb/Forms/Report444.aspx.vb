...
#End Region
    ...
    Private Sub DoSubmit()
        Dim mReport As New DCB_444(m_User, m_App, "")
        Dim b As Boolean
        ...
        Try
            ...
            Else
                If b Then
                    mReport.FillHistory(Session("AppID").ToString, Session.SessionID.ToString, strAmtlKennzeichen, strFahrgestellnummer, strBriefnummer)
                    If mReport.ResultCount > 1 Then
                        b = False
                        ...
                        tmpView = mReport.Result.DefaultView
                        tmpView.Sort = "TIDNR"
                    ...
                    Else
                        Session("ResultTable") = mReport.History
                    End If
                End If
            End If
        Catch ex As Exception
        ...
        If b Then
            If Not mReport.Status = 0 Then
                lblError.Text = mReport.Message
            Else
                If (mReport.History Is Nothing) OrElse (mReport.History.Rows.Count = 0) OrElse (mReport.History.Rows(0)("ZZFAHRG").ToString = String.Empty) Then
                    lblError.Text = "Keine Ergebnisse für die gewählten Kriterien."
                Else
                    Response.Redirect("Report444_2.aspx?AppID=" & Session("AppID").ToString)
                End If
            End If
        End If
