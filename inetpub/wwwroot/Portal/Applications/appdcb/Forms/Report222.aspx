...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report222.aspx.vb" Inherits="AppDCB.Report222" %>
                    ...
                    <tr>
                        ...
                        <td valign="top" width="100%">
                            ...
                            <table id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0">
                                        ...
                                        <table id="Table1" cellspacing="0" cellpadding="5" width="100%" bgcolor="white" border="0">
                                            <tr>
                                                <td class="TextLarge" valign="center" width="150">
                                                    Stillegungsdatum von:
                                                </td>
                                                <td class="TextLarge" valign="center">
                                                    <asp:TextBox ID="txtStillegungVon" runat="server"></asp:TextBox>&nbsp;<font color="red">*</font>
                                                    <asp:LinkButton ID="btnCal1" runat="server" CssClass="StandardButtonTable" Width="100px">Kalender...</asp:LinkButton>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="TextLarge" valign="center" width="150">
                                                    Stillegungsdatum bis:
                                                </td>
                                                <td class="TextLarge" valign="center">
                                                    <asp:TextBox ID="txtStillegungBis" runat="server"></asp:TextBox>&nbsp;<font color="red">*</font>
                                ...
                                <tr>
                                    <td valign="top" align="left" width="100%">
                                        <font color="#ff0000">*</font> Eingabe erforderlich.
                                    </td>
                                </tr>
                            </table>
                        </td>
