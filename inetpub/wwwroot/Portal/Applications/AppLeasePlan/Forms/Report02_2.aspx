...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report02_2.aspx.vb" Inherits="AppLeasePlan.Report02_2" %>
							...
							<tr>
								<TD vAlign="top" width="120">
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="center" width="150"><asp:linkbutton id="lb_Uebersicht" runat="server" CssClass="StandardButton"> lb_Uebersicht</asp:linkbutton></TD>
										</TR>
										<TR>
											<TD vAlign="center" width="150"><asp:linkbutton id="lb_Typdaten" runat="server" CssClass="StandardButton"> lb_Typdaten</asp:linkbutton></TD>
										</TR>
										<TR>
											<TD vAlign="center" width="150"><asp:linkbutton id="lb_Lebenslauf" runat="server" CssClass="StandardButton"> lb_Lebenslauf</asp:linkbutton></TD>
										</TR>
										<TR>
											<TD vAlign="center" width="150"><asp:linkbutton id="lb_Uebermittlung" runat="server" CssClass="StandardButton"> lb_Uebermittlung</asp:linkbutton></TD>
										</TR>
									</TABLE>
								</TD>
								<td vAlign="top">
													...
													<TR id="trUebersicht" runat="server">
														<TD vAlign="top" align="left" colSpan="2"><TABLE id="Table10" cellSpacing="0" cellPadding="5" width="800" bgColor="white" border="0">
																...
																<TR>
																	...
																	<TD class="TextLarge" vAlign="center" noWrap align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="TextLarge" vAlign="center" noWrap align="left">
																...
																<TR>
																	...
																	<TD class="StandardTableAlternate" vAlign="center" noWrap align="left">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="StandardTableAlternate" vAlign="center" noWrap align="left">
																...
																<TR>
																	...
																	<TD class="StandardTableAlternateDescription" vAlign="center" noWrap align="left"></TD>
																	...
																	<TD class="StandardTableAlternate" vAlign="center" noWrap align="left" rowSpan="2">&nbsp;&nbsp;&nbsp;</TD>
																	<TD class="StandardTableAlternate" vAlign="top" noWrap align="left" rowSpan="2">
