<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report30.aspx.vb" Inherits="AppRDZ.Report30" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													...
													<TR>
														<TD class="StandardTableAlternate" vAlign="center" width="150">PLZ Halterort:</TD>
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:TextBox id="txtPLZ" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">Name Zulassungspartner:</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:TextBox id="txtZulassungspartner" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" vAlign="center" width="150"></TD>
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:TextBox id="txtZulassungspartnerNr" runat="server" Visible="False"></asp:TextBox></TD>
													</TR>
												</TABLE>
												<BR>
											</TD>
