<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Kopfdaten.ascx.vb" Inherits="AppBPLG.PageElements.Kopfdaten" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="3" width="100%" align="center" border="0">
				<TR>
					<TD class="TextLarge" vAlign="top">
						<asp:label id="lbl_HaendlerNummer" runat="server">Endkundennummer:</asp:label></TD>
