...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report03_1.aspx.vb" Inherits="AppVFS.Report03_1" %>
									...
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="middle" width="150">
												<asp:linkbutton id="cmdBack" runat="server" CssClass="StandardButton">&#149;&nbsp;Zurück</asp:linkbutton></TD>
										</TR>
										<TR>
										...
										<tr>
											<td vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" PageSize="50" BackColor="White">
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="Kennzeichen anzeigen" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
														...
														<asp:TemplateColumn HeaderText="Adresse anzeigen" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                                                            HeaderStyle-HorizontalAlign="Center">
															<HeaderTemplate>
