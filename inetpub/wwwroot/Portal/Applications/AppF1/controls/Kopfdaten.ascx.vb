...
Public MustInherit Class Kopfdaten
    ...
    Private m_strSapInterneHaendlerNummer As String
...
#End Region
    ...
    Public Property SapInterneHaendlerNummer() As String
        Get
            If Not m_strSapInterneHaendlerNummer Is Nothing Then
                Return m_strSapInterneHaendlerNummer
            Else
                Return ""
            End If
        End Get
        Set(ByVal Value As String)
            m_strSapInterneHaendlerNummer = Value
        End Set
    End Property
    ...
    Public Property Kontingente() As DataTable
        ...
        Set(ByVal Value As DataTable)
            ...
            If Not m_tblKontingente Is Nothing Then
                'wenn ein Händlerkontingent vorhanden ist und dies 0 ist, dann ausblenden, wenn user=Händler
                If Not m_tblKontingente.Select("RECART='Händler'").Count = 0 Then
                    If CInt(m_tblKontingente.Select("RECART='Händler'")(0)("KLIMK")) = 0 Then
                        If Not GetUser(Me.Page).Reference.Trim(" "c).Length = 0 Then
...
' 
' *****************  Version 5  *****************
' User: Jungj        Date: 26.03.09   Time: 14:43
...
' Created in $/CKAG/Components/ComCommon/Finance/PageElements
' 
' *****************  Version 1  *****************
' User: Fassbenders  Date: 4.04.08    Time: 10:48
' Created in $/CKAG/portal/Components/ComCommon/Finance/PageElements
' 
' *****************  Version 1  *****************
...
' 
' *****************  Version 4  *****************
' User: Uha          Date: 10.12.07   Time: 17:59
' Updated in $/CKG/Portal/PageElements
' Händlernummer ist jetzt übersetzbares Feld
' 
' *****************  Version 3  *****************
