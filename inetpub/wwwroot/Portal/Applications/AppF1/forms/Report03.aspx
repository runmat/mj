<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report03.aspx.vb" Inherits="AppF1.Report03" %>
                ...
                <table id="Table0" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td class="PageNavigation" colspan="3">
                            ...
                            <asp:Label ID="lblPageTitle" runat="server"> (Händlersuche)</asp:Label>
                        </td>
                    </tr>
                    <tr>
