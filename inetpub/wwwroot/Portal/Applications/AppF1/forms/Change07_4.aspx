<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change07_4.aspx.vb" Inherits="AppF1.Change07_4" %>
							...
							<tr>
								<TD vAlign="top" width="120">
									<TABLE id="Table12" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="middle" width="150"><asp:linkbutton id="cmdSave" OnClientClick="Show_BusyBox1();" runat="server" CssClass="StandardButton">&#149;&nbsp;Absenden</asp:linkbutton></TD>
										</TR>
									</TABLE>
								</TD>
								<td vAlign="top">
