<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change07_2.aspx.vb" Inherits="AppF1.Change07_2" %>
...
<body leftmargin="0" topmargin="0" ms_positioning="FlowLayout">
                                ...
                                <tr>
                                    <td valign="top" align="left" colspan="3">
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                            ...
                                            Text="Bitte wählen Sie immer Fahrzeugdokument pro Versandadresse / Abrufgrund aus." 
                                            ></asp:Label></td>
                                        ...
                                        <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Abrufgrund">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="cmbAbrufgrund" runat="server" AutoPostBack="True" DataTextField="WebBezeichnung" Enabled="false"
    ...
    <div id="divMessage" runat="server" visible="false" style="top: 270px; margin-left: 500px;
                        ...
                        <div style="border-left: solid 2px #576B96; border-right: solid 2px #576B96; width: 400px;
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="padding-right: 10px; padding-top: 10px">
                                        Sie haben mindestens einen Abrufgrund ausgewählt, der ausschließlich zum Versand an 
                            Zulassungsstellen verwendet wird. Fahrzeuge mit anderen Abrufgründen werden 
                            entfernt.
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div style="border-left: solid 2px #576B96; border-right: solid 2px #576B96; text-align: right;
                            ...
                            <asp:Button ID="btnOK" runat="server" Text="Übernehmen" style="margin-right:10px" />
                        <asp:Button ID="btnCancel" runat="server" Text="Abbrechen" style="margin-right:10px" />
                        </div>
