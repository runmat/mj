<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change02Aut.aspx.vb" Inherits="AppF1.Change02Aut" %>
										...
										<TR>
											<TD>
												<TABLE id="Table4" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													...
													<TR>
														<TD class="StandardTableAlternate" vAlign="top">Abrufgrund</TD>
														<TD class="StandardTableAlternate" vAlign="top" colSpan="2"><asp:label id="lblAbrufgrund" runat="server"></asp:label></TD>
