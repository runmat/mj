										...
										<TR>
											<TD vAlign="top" align="left" colSpan="3">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr>
														<td>
														 <asp:Label ID="lblInfo" Visible="false" Font-Bold="true" runat="server" Text="Label"></asp:Label> &nbsp;<asp:label id="lblNoData" runat="server" Visible="False"></asp:label>
												...
												<asp:textbox id="txtKopf" runat="server" MaxLength="23" Width="250px"></asp:textbox><asp:linkbutton id="LinkButton1" runat="server" CssClass="StandardButtonTable" Visible="False">&#149;&nbsp;Kopftext erf.</asp:linkbutton>
                                                <asp:DropDownList ID="ddlAbrufgrund" runat="server" style="padding-left:15px" 
											...
											<td vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" PageSize="50" BackColor="White">
													...
													<Columns>
													  <asp:TemplateColumn SortExpression="ZZFAHRG" HeaderText="col_Fahrgestellnummer">
														...
														<asp:BoundColumn Visible="False" DataField="Positionstext" SortExpression="Positionstext" HeaderText="Referenz"></asp:BoundColumn>
														...
														<asp:TemplateColumn HeaderText="KF/KL"  Visible="false">
															<ItemTemplate>
																<asp:RadioButton id="chk0006" runat="server" GroupName="Kontingentart" >
																</asp:RadioButton>
															</ItemTemplate>
														</asp:TemplateColumn>														
