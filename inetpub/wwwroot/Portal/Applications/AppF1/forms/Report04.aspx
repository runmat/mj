<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report04.aspx.vb" Inherits="AppF1.Report04" %>
							...
							<TR>
								<TD vAlign="top" width="120">
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="center"><asp:linkbutton id="cmdCreate" OnClientClick="Show_BusyBox1();"  runat="server" CssClass="StandardButton"> &#149;&nbsp;Erstellen</asp:linkbutton></TD>
										</TR>
									</TABLE>
								</TD>
								<TD vAlign="top">
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														<TD class="TextLarge" vAlign="center">Fahrzeugtyp:&nbsp;
														</TD>
														<TD class="TextLarge" vAlign="center" width="100%">
                                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server">
                                                                <asp:ListItem Selected="True" Value="FA11">Neuwagen mit Zulassungsdatum</asp:ListItem>
                                                                <asp:ListItem Value="FA12">Vorführwagen mit Abmeldedatum</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </TD>
													</TR>
												</TABLE>
