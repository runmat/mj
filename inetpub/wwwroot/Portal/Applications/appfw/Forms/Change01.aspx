<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change01.aspx.vb" Inherits="AppFW.Change01" %>
										...
										<tr>
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
																...
																<tr>
																	<td class="TextLarge" colspan="2">
                                                                        <asp:RadioButtonList ID="rblVersandart" runat="server">
                                                                            <asp:ListItem Value="2035" Selected="True">Versand Standardbrief Deutsche Post AG</asp:ListItem>
                                                                            <asp:ListItem Value="1391">DHL Standardversand mit Sendungsverfolgung und 
                                                                            Bestätigung vom Empfänger</asp:ListItem>
                                                                            <asp:ListItem Value="1390">DHL Expressversand mit Zeitoption vor 12:00 Uhr</asp:ListItem>
                                                                            <asp:ListItem Value="1389">DHL Expressversand mit Zeitoption vor 10:00 Uhr</asp:ListItem>
                                                                            <asp:ListItem Value="1385">DHL Expressversand mit Zeitoption vor 09:00 Uhr</asp:ListItem>
                                                                            <asp:ListItem Value="9999">Selbstabholer beim DAD Ahrensburg</asp:ListItem>
                                                                        </asp:RadioButtonList>
                                                                    </td>
													...
													<TR>
														<TD class="StandardTableAlternate" vAlign="top" noWrap align="right">Abmeldung erforderlich&nbsp;&nbsp;&nbsp;</TD>
														<TD class="StandardTableAlternate">
															<table cellSpacing="0" cellPadding="0" border="0">
																<tr>
																	<td class="StandardTableAlternate" colspan="2">
                                                                        <asp:RadioButtonList ID="rblVermarkt" runat="server" 
                                                                            RepeatDirection="Horizontal"><asp:ListItem Text="Ja" Value="1"></asp:ListItem>
                                                                            <asp:ListItem Text="nein" Selected="True" Value="0"></asp:ListItem></asp:RadioButtonList></td>
                                                    ...
                                                    <tr>
                                                        <td class="StandardTableAlternate" valign="top" nowrap align="right">
                                                            Finanzierung Ford Bank&nbsp;&nbsp;&nbsp;
                                                        </td>
                                                        <td class="StandardTableAlternate">
                                                            <table cellspacing="0" cellpadding="0" border="0">
                                                                <tr>
                                                                    <td class="StandardTableAlternate" colspan="2">
                                                                        <asp:RadioButtonList ID="rblEigentuemer" runat="server" RepeatDirection="Horizontal">
                                                                            <asp:ListItem Text="Ja" Value="1"></asp:ListItem>
                                                                            <asp:ListItem  Text="nein" Value="0" Selected="True"></asp:ListItem>
                                                                        </asp:RadioButtonList>
                                                                    </td>
                                                                </tr>
                                                            </table>
