...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report03.aspx.vb" Inherits="AppFW.Report03" %>
					...
					<TD>
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="tr_Datumab" >
														...
														<TD class="TextLarge" vAlign="middle"><asp:textbox id="txtAbDatum" runat="server" Width="130px"></asp:textbox><asp:button id="btnOpenSelectAb" runat="server" Width="30px" CausesValidation="False" Height="22px" Text="..."></asp:button>
													...
													<TR runat="server">
														<TD class="TextLarge" vAlign="middle" width="150"></TD>
														<TD class="TextLarge" vAlign="middle"><asp:radiobutton id="rb_unvollstaendig" runat="server" Text="unvollständig" GroupName="grpAction" Checked="True"></asp:radiobutton>&nbsp;
															<asp:radiobutton id="rb_vollstaendig" runat="server" Text="vollständig" GroupName="grpAction"></asp:radiobutton>&nbsp;</TD>
													</TR>
												</TABLE>
												<BR>
											</TD>
							...
							<!--	
								...
								function check_sichtbarkeit()
								{
										var o=document.getElementById("rb_vollstaendig");
									...
									window.onload=check_sichtbarkeit;
