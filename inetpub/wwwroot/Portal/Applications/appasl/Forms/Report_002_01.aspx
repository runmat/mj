...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_002_01.aspx.vb"
    Inherits="AppASL.Report_002_01" %>
                ...
                <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <asp:DataGrid ID="Datagrid1" runat="server" BackColor="White" headerCSS="tableHeader"
                                                ...
                                                <tr>
                                                    <td nowrap>
                                                        <asp:HyperLink ID="Hyperlink3" runat="server" Target='<%# "_blank" %>' Width="75px"
                                                            CssClass="StandardButtonTable" NavigateUrl='<%# "Report_002_02.aspx?equipment=" &amp; DataBinder.Eval(Container.DataItem, "Equipment") &amp; "&amp;kf=" &amp; DataBinder.Eval(Container.DataItem, "Klärfall") %>'>Details</asp:HyperLink>&nbsp;
                                                    </td>
                                                    <td nowrap>
                    ...
                    <tr>
                        <td>
                         ...
                         <td><table id="tblBanner" cellspacing="0" cellpadding="3" runat="server">
                    <tbody>
                        <tr>
                            <td class="Banner">
                                KF1
