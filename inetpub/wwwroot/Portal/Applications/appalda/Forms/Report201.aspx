...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report201.aspx.vb" Inherits="AppALDA.Report201" %>
							...
							<TR>
								<TD vAlign="top">
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="center"><asp:linkbutton id="cmdCreate" runat="server" CssClass="StandardButton" Visible="False"> &#149;&nbsp;Erstellen</asp:linkbutton></TD>
										</TR>
									</TABLE>
									<P>&nbsp;</P>
									<P>&nbsp;</P>
