<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report200.aspx.vb" Inherits="AppALDA.Report200" %>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR>
														<TD class="TextLarge" vAlign="center">
															Durchführungsdatum&nbsp;von<FONT color="black">*:</FONT>
														</TD>
														<TD class="TextLarge" vAlign="center"><asp:textbox id="txtAbmeldedatumVon" runat="server"></asp:textbox>&nbsp;
															<asp:LinkButton id="btnCal1" runat="server" CssClass="StandardButtonTable" Width="100px">Kalender...</asp:LinkButton>&nbsp;&nbsp; 
															(TT.MM.JJJJ)</TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" vAlign="center" noWrap>Durchführungsdatum bis<FONT color="black">*</FONT>:</TD>
														<TD class="StandardTableAlternate" vAlign="center"><asp:textbox id="txtAbmeldedatumBis" runat="server"></asp:textbox>&nbsp;
												...
												*<FONT size="1">Eingabe erforderlich. Der maximale Zeitraum beträgt 3 Monate in die 
													Vergangenheit.</FONT>
												<BR>
											</TD>
										</TR>
