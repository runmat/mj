...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change03_2.aspx.vb" Inherits="AppSTRAUB.Change03_2" %>
										...
										<TR>
											<TD class="LabelExtraLarge" vAlign="top" align="left" colSpan="3">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														<TD class="LabelExtraLarge" width="100%"><asp:label id="lblNoData" runat="server"></asp:label></TD>
												...
												<asp:datagrid id="DataGrid1" runat="server" BackColor="White" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" PageSize="50" Width="100%" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True">
													...
													<Columns>
														<asp:BoundColumn Visible="False" HeaderText="PDI"></asp:BoundColumn>
														...
														<asp:BoundColumn Visible="False" HeaderText="Hersteller"></asp:BoundColumn>
														...
														<asp:BoundColumn DataField="Versandanschrift" SortExpression="Versandanschrift" HeaderText="Versandanschrift"></asp:BoundColumn>
														<asp:BoundColumn DataField="Versanddatum" SortExpression="Versanddatum" HeaderText="Versanddatum"></asp:BoundColumn>
														<asp:BoundColumn Visible="False" HeaderText="Eingangsdatum"></asp:BoundColumn>
														<asp:BoundColumn DataField="Anforderer" SortExpression="Anforderer" HeaderText="Anforderer"></asp:BoundColumn>
