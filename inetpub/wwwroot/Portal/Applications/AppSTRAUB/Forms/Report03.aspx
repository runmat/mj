...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report03.aspx.vb" Inherits="AppSTRAUB.Report03"%>
					...
					<TD>
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0" bgColor="white">
													...
													<TR>
														...
														<TD class="TextLarge" vAlign="center" width="100%">
															<asp:TextBox id="txtErfassungsdatumVon" runat="server" Visible="False"></asp:TextBox>&nbsp;
															<asp:LinkButton id="btnVon" runat="server" CssClass="StandardButtonTable" Width="100px" Visible="False"> &#149;&nbsp;Kalender...</asp:LinkButton>
														</TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" vAlign="center"></TD>
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:TextBox id="txtErfassungsdatumBis" runat="server" Visible="False"></asp:TextBox>&nbsp;
															<asp:LinkButton id="btnBis" runat="server" CssClass="StandardButtonTable" Width="100px" Visible="False"> &#149;&nbsp;Kalender...</asp:LinkButton></TD>
													</TR>
												</TABLE>
											</TD>
										</TR>
							...
							<TR>
								<TD vAlign="top"></TD>
								<TD vAlign="top">
									<asp:Label id="Label2" runat="server" CssClass="TextError" Visible="False">*</asp:Label>
									<asp:label id="lblInfo" runat="server" CssClass="TextInfo" EnableViewState="False" Visible="False"> Eingabe erforderlich. Format: TT.MM.JJJJ</asp:label></TD>
							</TR>
							<TR>
								<TD vAlign="top">&nbsp;</TD>
