...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New Straub_07(m_User, m_App, strFileName)
            ...
            If checkInput Then
                m_Report.FILL(Session("AppID").ToString, Session.SessionID.ToString, datAbmeldedatumVon, datAbmeldedatumBis, strKennzeichen, strFahrgestellnummer)
