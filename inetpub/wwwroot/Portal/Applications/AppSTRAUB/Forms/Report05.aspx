				...
				<TR>
					<TD>
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD vAlign="top"></TD>
								<TD vAlign="top"><asp:label id="Label2" runat="server" CssClass="TextError">*</asp:label><asp:label id="lblInfo" runat="server" CssClass="TextInfo" EnableViewState="False"> Eingabe erforderlich. Format: TT.MM.JJJJ. Der maximale Zeitraum beträgt 30 Tage.</asp:label></TD>
							</TR>
							<TR>
								<TD vAlign="top">&nbsp;</TD>
