    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If Not e.CommandArgument Is Nothing AndAlso CStr(e.CommandArgument).Trim.Length > 0 Then
            ...
            If strTarget.Length > 0 Then
                ...
                Literal1.Text &= "                          window.open(""Report06_" & strTarget & ".aspx?strKennzeichen=" & CStr(e.CommandArgument).Trim & """, ""_blank"", ""left=0,top=0,scrollbars=YES,menubar=YES,toolbar=YES,resizable=YES"");" & vbCrLf
                Literal1.Text &= "			//-->" & vbCrLf
