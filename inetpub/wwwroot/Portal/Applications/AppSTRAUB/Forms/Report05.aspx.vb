...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            If (m_Report.PPDI = "0") Then
                m_Report.PPDI = String.Empty
            End If
            'Hersteller + Herstellercode
            strHersteller = ddlHersteller.SelectedItem.Text
            If strHersteller = "-alle-" Then
                strHersteller = String.Empty
                strHerstellerCode = String.Empty
            Else
                strHersteller = Right(strHersteller, strHersteller.Length - strHersteller.IndexOf("-") - 1).TrimStart(" "c)
                strHerstellerCode = ddlHersteller.SelectedItem.Text
                strHerstellerCode = Left(strHerstellerCode, strHerstellerCode.IndexOf("-")).TrimEnd(" "c)
            End If

            m_Report.PHersteller = strHersteller
            m_Report.PHerstellerCode = strHerstellerCode
