...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report09_3.aspx.vb" Inherits="AppSTRAUB.Report09_3" %>
									...
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										<TR>
											<TD class="TaskTitle" width="150">&nbsp;
												<asp:hyperlink id="lnkFahrzeugsuche" runat="server" NavigateUrl="javascript:window.close()">Fenster schließen</asp:hyperlink></TD>
										</TR>
										<TR>
												...
												<TABLE id="Table9" cellSpacing="0" cellPadding="5" width="100%" border="0">
													<TR>
														<TD vAlign="top" align="left" colSpan="2">
															<TABLE id="Table10" class="BorderFull" cellSpacing="0" cellPadding="5" border="0" bgColor="white">
																<tr>
