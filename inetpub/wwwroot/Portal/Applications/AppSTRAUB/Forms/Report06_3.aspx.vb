        ...
        Try
            ...
            If Not AppName = "Selection" AndAlso _
               m_User.Applications.Select(AppName).Length = 0 Then
                ...
                'Me.Response.Redirect("/Portal/Start/Selection.aspx")
            Else
                ...
                Else
                    ...
                    Else
                        ...
                        If Not IsPostBack Then
                            Dim rows As DataRow() = m_objTable.Select("Kennzeichen='" & strKennzeichen & "'")
                            If rows.Length = 1 Then
                                If Not rows(0)("Kennzeichen") Is Nothing AndAlso CStr(rows(0)("Kennzeichen")).Trim.Length > 0 Then
                                    lblFahrzeugkennzeichen.Text = CStr(rows(0)("Kennzeichen"))
                                End If
                                ...
                                If (rows(0)("Schilder").ToString.Trim = "V") Then
                                    CheckBox1.Checked = False
                                End If
                                If (rows(0)("Schilder").ToString.Trim = "H") Then
