...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report02_ING.aspx.vb" Inherits="AppING.Report02_ING" %>
						...
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD class="PageNavigation" colSpan="2">
									<asp:Label id="lblHead" runat="server" CssClass="HauptMenue"></asp:Label>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														<TD class="TextLarge" vAlign="center" width="150" noWrap>Versanddatum von:
														</TD>
													...
													<TR>
														<TD class="StandardTableAlternate" vAlign="center" width="150">Versanddatum bis:</TD>
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:TextBox id="txtAbmeldedatumBis" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
													</TR>
												</TABLE>
