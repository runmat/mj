...
Public Class ING_02
    REM § Status-Report, Kunde: ING, BAPI: Z_M_BRIEFVERSAND_ING,
...
#Region " Methods"
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal datAbmeldedatumVon As DateTime, ByVal datAbmeldedatumBis As DateTime)
        m_strClassAndMethod = "ING_02.FILL" '---Customize
        m_strAppID = strAppID
        ...
        If Not m_blnGestartet Then
            ...
            Try
                ...
                intID = m_objLogApp.WriteStartDataAccessSAP(m_objUser.UserName, m_objUser.IsTestUser, "Z_M_Briefversand_Ing", strAppID, strSessionID, m_objUser.CurrentLogAccessASPXID)
                objSAP.Z_M_Briefversand_Ing(Right("0000000000" & m_objUser.KUNNR, 10), strDatTempBis, strDatTempVon, SAPTable)
                objSAP.CommitWork()
                ...
                WriteLogEntry(True, "VERSDATAB=" & datAbmeldedatumVon.ToShortDateString & ", VERSDATBI=" & datAbmeldedatumBis.ToShortDateString & ", KUNNR=" & m_objUser.KUNNR, m_tblResult, False)
            Catch ex As Exception
                ...
                End If
                WriteLogEntry(False, "VERSDATAB=" & datAbmeldedatumVon.ToShortDateString & ", VERSDATBI=" & datAbmeldedatumBis.ToShortDateString & ", KUNNR=" & m_objUser.KUNNR & ", " & Replace(m_strMessage, "<br>", " "), m_tblResult, False)
            Finally
                If intID > -1 Then
