...
#End Region
    ...
    Private objHaendler As SixtLease_08
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If Not IsPostBack Then
                objHaendler = New SixtLease_08(m_User, m_App, "")
                ...
                End If
            Else
                objHaendler = CType(Session("objHaendler"), SixtLease_08)
            End If
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            If lblError.Text.Length = 0 Then
                objHaendler.Fill(Session("AppID").ToString, Session.SessionID.ToString, Page)

                Session("ResultTable") = objHaendler.Result

                If Not objHaendler.Status = 0 Then
                    lblError.Text = "Fehler: " & objHaendler.Message
                Else
                    ...
                    Else
                        ...
                        Try
                            Excel.ExcelExport.WriteExcel(objHaendler.Result, ConfigurationManager.AppSettings("ExcelPath") & strFileName)
                        Catch
                        End Try
