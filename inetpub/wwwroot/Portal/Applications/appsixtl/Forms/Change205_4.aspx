...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change205_4.aspx.vb" Inherits="AppSIXTL.Change205_4" %>
							...
							<tr>
								...
								<td vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" vAlign="top"><asp:hyperlink id="lnkFahrzeugsuche" runat="server" NavigateUrl="Change205.aspx" CssClass="TaskTitle">Fahrzeugsuche</asp:hyperlink>&nbsp;<asp:hyperlink id="lnkFahrzeugAuswahl" runat="server" NavigateUrl="Change205_2.aspx" CssClass="TaskTitle" Visible="False">Fahrzeugauswahl</asp:hyperlink>&nbsp;<asp:hyperlink id="lnkAdressAuswahl" runat="server" NavigateUrl="Change205_3.aspx" CssClass="TaskTitle" Visible="False">Adressauswahl</asp:hyperlink><asp:label id="lblAddress" runat="server" Visible="False"></asp:label><asp:label id="lblMaterialNummer" runat="server" Visible="False"></asp:label></TD>
										</TR>
									</TABLE>
											...
											<TD vAlign="top" align="left" colSpan="3">
												...
												<TABLE id="Table7" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="trVersandTemp" runat="server">
														...
														<TD class="TextLarge" vAlign="top" align="left" colSpan="2"><asp:label id="lblVersand" runat="server"></asp:label></TD>
													</TR>
													<TR id="trVersandArt" runat="server">
														...
														<TD class="TextLarge" vAlign="top" align="left" colSpan="2"><asp:label id="lblVersandart" runat="server"></asp:label></TD>
													</TR>
													<TR>
														<TD class="" vAlign="top" noWrap><asp:label id="lblVersandgrundText" runat="server" Font-Underline="True">Versandgrund:</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left" colSpan="2"><asp:label id="lblVersandGrund" runat="server"></asp:label></TD>
													</TR>
													<TR>
