...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change333_3.aspx.vb" Inherits="AppSIXTL.Change333_3" %>
							...
							<tr>
								...
								<td vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" vAlign="top"><asp:hyperlink id="lnkKreditlimit" runat="server" NavigateUrl="Change333_2.aspx"><<&nbsp;Briefauswahl</asp:hyperlink></TD>
										</TR>
									</TABLE>
											...
											<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" BackColor="White" PageSize="50" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False" Width="100%">
													...
													<Columns>
														<asp:TemplateColumn SortExpression="Auswahl" HeaderText="Freigabe">
															...
															<ItemTemplate>
																<asp:CheckBox id=cbxFreigabe runat="server" CssClass="CheckBoxSelect" Checked='<%# DataBinder.Eval(Container, "DataItem.Auswahl")="X" %>'>
																</asp:CheckBox>
															</ItemTemplate>
														</asp:TemplateColumn>
