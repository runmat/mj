...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change300_2.aspx.vb" Inherits="AppSIXTL.Change300_2" %>
				...
				<tr>
					<td>
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD vAlign="top" align="left" colSpan="3" height="41">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														<TD class="LabelExtraLarge" align="left" height="9"><asp:label id="lblNoData" runat="server" Visible="False" Font-Bold="True"></asp:label>
											...
											<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" PageSize="50" BackColor="White">
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="Leasingvertrags-Nr.*">
															<ItemTemplate>
																<asp:TextBox id=txtLVNR runat="server" CssClass="InputBoxFlat" Width="100px" MaxLength="8" Text='<%# DataBinder.Eval(Container, "DataItem.Leasingvertragsnummer") %>'>
																</asp:TextBox>
															</ItemTemplate>
														</asp:TemplateColumn>
							...
							<TR>
								<TD width="120">&nbsp;</TD>
								<TD>*<FONT size="1">Nur Ziffern, 7- oder 8-stellig</FONT></TD>
							</TR>
						</TABLE>
					</td>
				</tr>
