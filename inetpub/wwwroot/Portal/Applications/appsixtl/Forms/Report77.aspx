<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report77.aspx.vb" Inherits="AppSIXTL.Report77" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													...
													<TR>
														<TD class="TextLarge" vAlign="middle" width="150">Fahrgestellnummer:</TD>
														<TD class="TextLarge" vAlign="middle">
															<asp:TextBox id="txtFahrgestellnummer" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="middle" width="150">Briefnummer:
														</TD>
														<TD class="TextLarge" vAlign="middle">
													...
													<TR>
														<TD class="TextLarge" vAlign="middle" width="150">Leasingvertragsnr.:</TD>
														<TD class="TextLarge" vAlign="middle">
