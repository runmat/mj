...
#End Region
    ...
    Private Sub DoSubmit()
        Dim m_Report As New SixtLease_11(m_User, m_App, "")
        Try
            ...
            Else
                ...
                Session("ResultTableRaw") = m_Report.History
        ...
        Else
            ...
            Else
                Response.Redirect("Report77_2.aspx?AppID=" & Session("AppID").ToString)
            End If
        End If
    End Sub
