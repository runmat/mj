...
#End Region
    ...
    Private Sub initialLoad()
        ...
        If objHaendler.LeseAdressenSAP(Session("AppID").ToString, Session.SessionID.ToString, m_User.Customer.KUNNR) > 0 Then
    ...
    Private Sub cmdBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBack.Click
        Response.Redirect("Change205_2.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart)
    End Sub
