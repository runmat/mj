...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New SixtLease_05(m_User, m_App, strFileName)
            ...
            If lblError.Text.Length = 0 Then
                ...
                Else
                    ...
                    Else
                        ...
                        Response.Redirect("/Portal/(S(" & Session.SessionID & "))/Shared/Report01_2.aspx?AppID=" & Session("AppID").ToString & "&legende=Report208")
                    End If
                End If
            End If
        Catch ex As Exception
