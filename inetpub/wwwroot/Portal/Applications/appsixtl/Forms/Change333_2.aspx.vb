...
#End Region
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        If Not CheckGrid() Then
            ...
            Exit Sub
        End If
        Response.Redirect("Change333_3.aspx?AppID=" & Session("AppID").ToString)
        'Alles ok, weiter...
    ...
    Private Sub Linkbutton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Response.Redirect("Change333_2.aspx?AppID=" & Session("AppID").ToString)
    End Sub
