<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change205_3.aspx.vb" Inherits="AppSIXTL.Change205_3" %>
											...
											<td class="TextLarge" vAlign="top" align="left" colSpan="3">
												<TABLE id="Table2" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="trZulst" runat="server">
														<TD class="TextLarge"><asp:radiobutton id="rb_Zulst" runat="server" AutoPostBack="True" Text="Zulassungsstelle:" GroupName="grpAdresse"></asp:radiobutton></TD>
													...
													<TR id="trSAPAdresse" runat="server">
														<TD class="StandardTableAlternate" noWrap><asp:radiobutton id="rb_SAPAdresse" runat="server" AutoPostBack="True" Text="Hinterlegte Adresse:" GroupName="grpAdresse"></asp:radiobutton></TD>
													...
													<TR>
														<TD class="TextLarge" colSpan="4"><asp:radiobutton id="rb_VersandAdresse" runat="server" AutoPostBack="True" Text="Versandanschrift:" GroupName="grpAdresse"></asp:radiobutton></TD>
													</TR>
													<TR id="trVersandAdrEnd1" runat="server">
														...
														<TD class="StandardTableAlternate" noWrap align="right">Ansprechpartner / 
															Zusatz:&nbsp;&nbsp;</TD>
													...
													<TR id="trVersandAdrEnd2" runat="server">
														...
														<TD class="TextLarge" vAlign="top" noWrap align="right">Hausnummer.:&nbsp;&nbsp;</TD>
													...
													<TR id="trVersandAdrEnd3" runat="server">
														...
														<TD class="StandardTableAlternate" align="right" width="1">Ort:&nbsp;&nbsp;</TD>
													...
													<TR id="trVersandAdrEnd4" runat="server">
														<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="txtGrund" runat="server">Versandgrund:&nbsp;</asp:label></TD>
														...
														<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="lblAuf" runat="server">auf:&nbsp;</asp:label></TD>
													...
													<TR id="trZeit" runat="server">
														...
														<TD class="StandardTableAlternate" colSpan="6"><asp:radiobutton id="chk0900" runat="server" Text="vor 9:00 Uhr" GroupName="Versandart"></asp:radiobutton><asp:radiobutton id="chk1000" runat="server" Visible="False" Text="vor 10:00 Uhr" GroupName="Versandart"></asp:radiobutton>&nbsp;<asp:radiobutton id="chk1200" runat="server" Text="Express vor 12.00 Uhr" GroupName="Versandart" Checked="true"></asp:radiobutton><asp:radiobutton id="chkVersandStandard" runat="server" Text="innerhalb von 48 h" GroupName="Versandart" Visible="false"></asp:radiobutton></TD>
													</TR>
												</TABLE>
											</td>
										</tr>
										<tr>
											<td vAlign="top" align="left" colSpan="3"><asp:label id="Label1" runat="server" Visible="False">*Diese Versandarten sind mit zusätzlichen Kosten verbunden.</asp:label></td>
										</tr>
										<TR>
