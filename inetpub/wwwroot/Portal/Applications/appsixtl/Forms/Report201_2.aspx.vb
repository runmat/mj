...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (legende = "Report201") Then
            lblInfo.Text = "<br>'X' = vorhanden" & "<br>'T' = Temporärer Versand"
        End If
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        ...
        Else
            ...
            If m_User.Applications.Select("AppName = 'Report77'").Length > 0 Then
                strHistoryLink = "Report77.aspx?AppID=" & m_User.Applications.Select("AppName = 'Report77'")(0)("AppID").ToString & "&VIN="
            End If
            ...
            For Each item In DataGrid1.Items
                ...
                If item.Cells(9).Text = "T" AndAlso item.Cells(10).Text.Length > 0 Then
                    hyperlink = New HyperLink()

                    hyperlink.Text = "T"
                    hyperlink.Target = "_blank"
                    hyperlink.ToolTip = "Anzeige Fahrzeughistorie"
                    hyperlink.NavigateUrl = strHistoryLink & item.Cells(10).Text
                    item.Cells(9).Controls.Add(hyperlink)
                    item.Cells(9).HorizontalAlign = HorizontalAlign.Center
...
' 
' *****************  Version 6  *****************
' User: Fassbenders  Date: 20.11.07   Time: 16:08
' Updated in $/CKG/Applications/AppSIXTL/AppSIXTLWeb/Forms
' 
' *****************  Version 5  *****************
' User: Fassbenders  Date: 20.11.07   Time: 15:56
' Updated in $/CKG/Applications/AppSIXTL/AppSIXTLWeb/Forms
' 
' *****************  Version 4  *****************
