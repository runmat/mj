...
#End Region
    ...
    Private Sub cmdCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCreate.Click
        ...
        If (txtStillegungVon.Text = String.Empty) And (txtStillegungBis.Text = String.Empty) Then
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New Hertz_05(m_User, m_App, strFileName)
            Dim datStillegungVon As DateTime
            Dim datStillegungBis As DateTime
            ...
            Else
                'lblError.Text &= "Geben Sie bitte ein gültiges Datum (von) ein!<br>"
            End If
            If Not txtStillegungBis.Text.Length = 0 Then
                If Not IsDate(txtStillegungBis.Text) Then
                    If Not IsStandardDate(txtStillegungBis.Text) Then
                        If Not IsSAPDate(txtStillegungBis.Text) Then
                            lblError.Text &= "Geben Sie bitte ein gültiges Datum (bis) ein!<br>"
                        Else
                            datStillegungBis = CDate(txtStillegungBis.Text)
                        End If
                    Else
                        datStillegungBis = CDate(txtStillegungBis.Text)
                    End If
