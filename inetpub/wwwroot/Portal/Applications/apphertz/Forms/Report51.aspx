...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report51.aspx.vb" Inherits="AppHERTZ.Report51" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														<TD class="TextLarge" vAlign="center" width="150" noWrap>
													...
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">Fahrgestellnummer:</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:TextBox id="txtFahrgestellnummer" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">Briefnummer:
														</TD>
														<TD class="TextLarge" vAlign="center">
													...
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">Ordernummer:</TD>
														<TD class="TextLarge" vAlign="center">
