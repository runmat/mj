<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report71.aspx.vb" Inherits="AppHERTZ.Report71" %>
										...
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR>
														<TD class="TextLarge" vAlign="center" noWrap>Erstzulassungsdatum von:
														</TD>
														<TD class="TextLarge" vAlign="center" width="100%"><asp:textbox id="txtStillegungVon" runat="server"></asp:textbox></TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" vAlign="center" width="180">Erstzulassungsdatum 
															bis:</TD>
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:textbox id="txtStillegungBis" runat="server"></asp:textbox></TD>
													</TR>
													<TR>
