<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report50.aspx.vb" Inherits="AppHERTZ.Report50" %>
												...
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													...
													<TR>
														...
														<TD class="StandardTableAlternate" vAlign="center">
															<asp:TextBox id="txtAbmeldedatumVon" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
