...
Public Class Hertz_70
    REM § Status-Report, Kunde: Hertz, BAPI: Z_V_ZABMELDELISTE,
...
#Region " Methods"
    ...
    Public Overloads Overrides Sub Fill()
        Fill(m_strAppID, m_strSessionID, m_datStillegungVon)
    End Sub

    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal datStillegungVon As DateTime)
        m_strClassAndMethod = "Hertz_70.FILL"
        m_strAppID = strAppID
        ...
        If Not m_blnGestartet Then
            ...
            Try
                Dim SAPTable As New SAPProxy_HERTZ.ZDADVABMELDUNGTable() ' .ZDAD_S_BESTANDSLISTETable()
                ...
                intID = m_objlogApp.WriteStartDataAccessSAP(m_objUser.UserName, m_objUser.IsTestUser, "Z_V_Zabmeldeliste", strAppID, strSessionID, m_objUser.CurrentLogAccessASPXID)
                objSAP.Z_V_Zabmeldeliste(strDatStillVon, Right("0000000000" & m_objUser.Customer.KUNNR, 10), SAPTable)
                objSAP.CommitWork()
                If intID > -1 Then
