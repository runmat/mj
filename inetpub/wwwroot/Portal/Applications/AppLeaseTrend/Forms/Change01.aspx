<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change01.aspx.vb" Inherits="AppLeaseTrend.Change01" %>
											...
											<tr>
												<td vAlign="top" align="left">
													<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
														<TR>
															<TD class="TextLarge" vAlign="top" noWrap align="left" width="137">
															...
															<TD class="TextLarge"><FONT size="1">
																	<TABLE id="Table7" cellSpacing="1" cellPadding="1" border="0">
																		<TR>
																			<TD><asp:textbox id="txtOrdernummer" runat="server" Width="250px" MaxLength="10"></asp:textbox></TD>
																		</TR>
																	</TABLE>
																</FONT>
															</TD>
														...
														<TR>
															<TD class="TextLarge" vAlign="top" noWrap align="left" width="137">
																<TABLE id="Table9" cellSpacing="1" cellPadding="1" border="0">
																	<TR>
																		<TD><asp:label id="Label2" runat="server">Kundennummer (Leasingnehmer)</asp:label></TD>
																	</TR>
																</TABLE>
															</TD>
															<TD class="" height="37"><FONT size="1">
																	<TABLE id="Table5" cellSpacing="1" cellPadding="1" border="0">
																		<TR>
																			<TD><asp:textbox id="txtKunnrZL" runat="server" Width="250px" MaxLength="9"></asp:textbox>&nbsp;</TD>
																		</TR>
																	</TABLE>
																</FONT>
															</TD>
														...
														<TR>
															<TD class="TextLarge" vAlign="top" noWrap align="left" width="137">
																<TABLE id="Table4" cellSpacing="1" cellPadding="1" border="0">
																	<TR>
																		<TD>
																			<asp:label id="Label3" runat="server">Kundennummer (Lieferant)</asp:label></TD>
																	</TR>
																</TABLE>
															</TD>
															<TD height="37">
																<TABLE id="Table10" cellSpacing="1" cellPadding="1" border="0">
																	<TR>
																		<TD>
																			<asp:textbox id="txtKunnrZF" runat="server" MaxLength="9" Width="250px"></asp:textbox></TD>
																	</TR>
																</TABLE>
															</TD>
														</TR>
														<TR>
															<TD class="TextLarge" noWrap align="left" width="137"></TD>
															<TD></TD>
														</TR>
														<TR>
														...
														<TR>
															<TD class="" noWrap align="left" width="137"></TD>
						...
						<!--
								function showhide()
								{
									...
									if (o.display != "none"){
											...
											document.forms[0].txtKunnrZL.disabled=false;
											document.forms[0].txtKunnrZF.disabled=false;
											...
											document.forms[0].txtKunnrZL.disabled=true;
											document.forms[0].txtKunnrZF.disabled=true;											document.forms[0].cbxDatei.checked=true;
