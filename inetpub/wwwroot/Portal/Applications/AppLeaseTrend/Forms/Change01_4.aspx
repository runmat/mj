...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change01_4.aspx.vb" Inherits="AppLeaseTrend.Change01_4" %>
											...
											<TD vAlign="top" align="left" colSpan="3">
												...
												<TABLE id="Table7" cellSpacing="0" cellPadding="5" width="100%" bgColor="white" border="0">
													<TR id="trVersandTemp" runat="server">
														<TD class="" vAlign="top" noWrap><asp:label id="lblVersandAdresse" runat="server" Font-Underline="True">Versandadresse:</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left"><asp:label id="lblVersand" runat="server"></asp:label></TD>
													</TR>
													<TR id="trVersandArt" runat="server">
														<TD class="" vAlign="top" noWrap><asp:label id="lblVersandartTxt" runat="server" Font-Underline="True">Versandart:</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left"><asp:label id="lblVersandart" runat="server"></asp:label></TD>
													</TR>
													<TR>
														<TD class="" vAlign="top" noWrap><asp:label id="lblVersandgrundText" runat="server" Font-Underline="True">Versandgrund:</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left"><asp:label id="lblVersandGrund" runat="server"></asp:label></TD>
													</TR>
													<TR>
														<TD vAlign="top" noWrap>
															<asp:label id="Label1" runat="server" Font-Underline="True">Formularart:</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left">
															<asp:label id="lblFormular" runat="server"></asp:label></TD>
													</TR>
													<TR>
														<TD vAlign="top" noWrap>
															<asp:label id="Label2" runat="server" Font-Underline="True">Bemerkung:</asp:label></TD>
														<TD class="TextLarge" vAlign="top" align="left">
															<asp:label id="lblBemerkung" runat="server"></asp:label></TD>
													</TR>
													<TR>
														...
														<TD class="StandardTableAlternate" vAlign="top" align="left"><asp:datagrid id="DataGrid1" runat="server" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="250" Width="100%" AutoGenerateColumns="False" AllowSorting="True">
																...
																<Columns>
																	...
																	<asp:BoundColumn DataField="LIZNR" SortExpression="LIZNR" HeaderText="Leasing-&lt;br&gt;vertrags-Nr."></asp:BoundColumn>
