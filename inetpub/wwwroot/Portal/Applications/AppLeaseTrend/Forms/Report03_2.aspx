...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report03_2.aspx.vb" Inherits="AppLeaseTrend.Report03_2" %>
							...
							<tr>
								...
								<td vAlign="top">
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle">&nbsp;
												<asp:hyperlink id="lnkKreditlimit" runat="server" CssClass="TaskTitle" NavigateUrl="Equipment.aspx" Visible="False">Abfragekriterien</asp:hyperlink></TD>
										</TR>
										<TR>
															...
															<TABLE id="Table10" cellSpacing="0" cellPadding="5" align="left" bgColor="white" border="0">
																<TR>
																	...
																	<TD class="" vAlign="center" align="right" colSpan="2" noWrap>
																		<asp:label id="lblVersandart" runat="server"><STRONG>Versandart:</STRONG>&nbsp;</asp:label>
																		<asp:label id="Label1" runat="server">   temporär</asp:label>
																		<asp:radiobutton id="rbTemporaer" runat="server" Enabled="False" GroupName="Versandart"></asp:radiobutton>
																...
																<TR>
																	<TD class="StandardTableAlternateDescription" vAlign="top" align="left" width="152">Lieferant:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right">
																		<asp:label id="lblLieferant" runat="server"></asp:label></TD>
																	<TD class="StandardTableAlternateDescription" vAlign="center" align="left"></TD>
																	<TD class="StandardTableAlternateDescription" vAlign="top" align="left">Leasingnehmer:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right">
																		<asp:label id="lblLeasingnehmer" runat="server"></asp:label></TD>
																</TR>
																<TR>
																	<TD class="StandardTableAlternateDescription" vAlign="top" align="left" width="152"></TD>
