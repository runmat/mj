...
Public Class Change01_2
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lnkKreditlimit.NavigateUrl = "Change01.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart
        Try
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
       ...
       Dim intFahrzeugBriefe As Int32 = tmpDataView.Count
        ...
        Else
            ...
            Response.Redirect("Change01_3.aspx?AppID=" & Session("AppID").ToString & "&art=" & versandart)
        End If
    End Sub
                        ...
                        If TypeOf control Is CheckBox Then
                            ...
                            If chkBox.ID = "chk0000" Then
                                ...
                                Else
                                    chkBox.Visible = False
                                    chkBox.Checked = False
                                    item.Cells(item.Cells.Count - 1).ForeColor = Color.Red
                                End If
                            End If
                        End If
                    Next
