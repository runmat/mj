...
Public Class LT_10
    REM § Status-Report, Kunde: LeaseTrend, BAPI: Z_M_Fehlende_Vertragsnummern,
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
        m_strClassAndMethod = "LT_10.FILL"
        m_strAppID = strAppID
        m_strSessionID = strSessionID

        Try

            S.AP.InitExecute("Z_M_Fehlende_Vertragsnummern", "I_AG, I_KONZS_ZK", Right("0000000000" & m_objUser.KUNNR, 10), m_objUser.Reference)
