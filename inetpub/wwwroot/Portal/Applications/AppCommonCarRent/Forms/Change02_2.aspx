<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change02_2.aspx.vb" Inherits="AppCommonCarRent.Change02_2" %>
                    ...
                    <tr>
                        <td valign="top" width="120px">
                            <table id="Table2" bordercolor="#ffffff" cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td valign="middle">
                                        <asp:LinkButton ID="lb_weiter" CssClass="StandardButton" runat="server">Speichern</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td valign="top">
                            <table id="Tablex1" runat="server" cellspacing="0" cellpadding="5" width="100%" bgcolor="white"
                                ...
                                <tr id="tr_Versandanschrift" class="TextLarge">
                                    <td align="left" nowrap="nowrap">
                                        <asp:RadioButton ID="rb_Versandanschrift" runat="server" AutoPostBack="true" 
                                            GroupName="AdressArt" Checked="True" />
                                    </td>
                                    <td align="left" width="100%">
                                    </td>
                                </tr>
                                    ...
                                    <td align="left" width="100%">
                                        <table id="tblVersandart" runat="server" cellspacing="0" cellpadding="5" width="100%"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="25%">
                                                    <asp:RadioButton ID="rb_5530" runat="server" AutoPostBack="false" GroupName="Versandart" />
                                                </td>
                                                <td>
                                                    &nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="50%">
                                                    <asp:RadioButton ID="rb_1390" runat="server" AutoPostBack="false" 
