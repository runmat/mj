...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If mObjZulassungsFaehigeFahrzeuge Is Nothing Then
                If Session("mObjZulassungsFaehigeFahrzeugeSession") Is Nothing Then
                    mObjZulassungsFaehigeFahrzeuge = New ZulassungsFaehigeFahrzeuge(m_User, m_App, "")
                    mObjZulassungsFaehigeFahrzeuge.Fill(Session("AppID").ToString, Me.Session.SessionID)
                    If Not mObjZulassungsFaehigeFahrzeuge.Status = 0 Then
                        lblError.Text = mObjZulassungsFaehigeFahrzeuge.Message
                        Exit Sub
                    End If
                    Session.Add("mObjZulassungsFaehigeFahrzeugeSession", mObjZulassungsFaehigeFahrzeuge)
                Else
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        If mObjZulassungsFaehigeFahrzeuge.Status = 0 Then

            If IsNothing(mObjZulassungsFaehigeFahrzeuge.Result) OrElse mObjZulassungsFaehigeFahrzeuge.Result.Rows.Count = 0 Then
            ...
            Else
                ...
                Dim tmpDataView As New DataView(mObjZulassungsFaehigeFahrzeuge.Fahrzeuge)
                tmpDataView.RowFilter = mObjZulassungsFaehigeFahrzeuge.Filter
    ...
    Protected Sub imgbExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbExcel.Click
        Try
            ...
            Dim FilterTable As DataTable = mObjZulassungsFaehigeFahrzeuge.Result.Copy

            Dim TempView As DataView = FilterTable.DefaultView

            TempView.RowFilter = mObjZulassungsFaehigeFahrzeuge.Filter

            tblTemp = TempView.ToTable()
...
' 
' *****************  Version 5  *****************
' User: Fassbenders  Date: 11.03.10   Time: 13:23
' Updated in $/CKAG/Applications/AppCommonCarRent/Forms
' ITA: 2918
' 
' *****************  Version 4  *****************
' User: Fassbenders  Date: 27.10.09   Time: 11:39
' Updated in $/CKAG/Applications/AppCommonCarRent/Forms
' ITA: 3238
' 
' *****************  Version 3  *****************
