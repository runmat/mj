...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report05.aspx.vb" Inherits="AppPorsche.Report05" %>
							...
							<TR>
								...
								<TD vAlign="top" width="100%">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD vAlign="top" width="100%">Zum Download der Datei den Dateinamen mit <U>rechter 
													Maustaste</U> anklicken und <U>"Ziel speichern unter..."</U> wählen.</TD>
										</TR>
										<TR>
											<TD vAlign="top" width="100%">&nbsp;</TD>
										</TR>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD vAlign="top" align="left" width="100%">
												<TABLE id="tblFiles" cellSpacing="1" cellPadding="1" border="0" runat="server">
													<TR>
														<TD></TD>
													</TR>
												</TABLE>
