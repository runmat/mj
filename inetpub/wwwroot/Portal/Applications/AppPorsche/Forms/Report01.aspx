<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report01.aspx.vb" Inherits="AppPorsche.Report01"%>
										...
										<TR>
											<TD vAlign="top" align="left" width="100">
												<TABLE class="BorderLeftBottom" id="Table1" cellSpacing="0" cellPadding="2" width="600" bgColor="white" border="0">
													<TR>
														<TD class="TextLarge" vAlign="center" noWrap colSpan="5"><asp:label id="lblError" runat="server" EnableViewState="False" CssClass="TextError"></asp:label>&nbsp;&nbsp;</TD>
													</TR>
													<TR>
													...
													<TR>
														<TD class="TextLarge" vAlign="center"></TD>
														<TD class="TextLarge" vAlign="center" colSpan="3"><asp:listbox id="lstHaendler" runat="server" Height="100px" Width="100%"></asp:listbox></TD>
														<TD class="TextLarge" vAlign="center"></TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="center"></TD>
														<TD class="TextLarge" vAlign="center" noWrap colSpan="2">
															<asp:CheckBox id="cbxAlle" runat="server" Text="Alle Händler anzeigen"></asp:CheckBox></TD>
