...
#Region " Methods"
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
        ...
        Try
            ...
            Dim myProxy As DynSapProxyObj = DynSapProxy.getProxy("Z_M_Unb_Haendler_Porsche", m_objApp, m_objUser, page)

            myProxy.setImportParameter("I_KUNNR", Right("0000000000" & m_objUser.KUNNR, 10))
            myProxy.setImportParameter("I_WEB_REPORT", "Report04.aspx")
    ...
    '        Try
    '            Dim SAPTable As New SAPProxy_PORSCHE.ZDAD_M_WEB_UNBEK_HAENDLERTable()

    '            intID = m_objlogApp.WriteStartDataAccessSAP(m_objUser.UserName, m_objUser.IsTestUser, "Z_M_Unb_Haendler_Porsche", strAppID, strSessionID, m_objUser.CurrentLogAccessASPXID)
    '            objSAP.Z_M_Unb_Haendler_Porsche(Right("0000000000" & m_objUser.KUNNR, 10), "Report04.aspx", SAPTable)
