...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report81_2.aspx.vb" Inherits="AppALD.Report81_2" %>
																...
																<TR>
																	<TD class="TextLargeDescription" vAlign="top" align="left" colspan="2">
																		<table border="0" width="100%" cellpadding="0" cellspacing="0">
																			...
																			<tr>
																				<td><asp:label id="lblVersandgrund" runat="server"> Versandgrund:</asp:label></td>
																				<td class="TextLarge" align="right"><asp:label id="lblVersandgrundShow" runat="server"></asp:label></td>
																			</tr>
																		</table>
																	</TD>
