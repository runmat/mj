...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change80_2.aspx.vb" Inherits="AppALD.Change80_2" %>
										...
										<TR>
											<TD vAlign="top" align="left" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="100%" BackColor="White" PageSize="50" headerCSS="tableHeader" bodyCSS="tableBody" cssclass="tableMain" bodyHeight="400" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False">
													...
													<Columns>
														...
														<asp:TemplateColumn SortExpression="SWITCH" HeaderText="Versandart&lt;br&gt;&#228;ndern">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
															<ItemTemplate>
																<asp:CheckBox id=chkSWITCH runat="server" Visible='<%# DataBinder.Eval(Container, "DataItem.STATUS")="Temporär versendet" %>' Checked='<%# DataBinder.Eval(Container, "DataItem.SWITCH") %>'>
																</asp:CheckBox>
															</ItemTemplate>
														</asp:TemplateColumn>
														...
														<asp:TemplateColumn HeaderText="Abmeldedatum">
															<ItemTemplate>
																<asp:Label id=Label1 runat="server" Visible='<%# DataBinder.Eval(Container, "DataItem.EXPIRY_DATE")<>"XX.XX.XXXX" %>' Text='<%# DataBinder.Eval(Container, "DataItem.EXPIRY_DATE") %>'>
																</asp:Label>
																<asp:Label id=Label2 runat="server" Font-Bold="True" Visible='<%# DataBinder.Eval(Container, "DataItem.EXPIRY_DATE")="XX.XX.XXXX" %>' Text='<%# DataBinder.Eval(Container, "DataItem.EXPIRY_DATE") %>' ForeColor="Red">
																</asp:Label>
															</ItemTemplate>
														</asp:TemplateColumn>
