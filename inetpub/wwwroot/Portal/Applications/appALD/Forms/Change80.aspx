<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change80.aspx.vb" Inherits="AppALD.Change80" %>
										...
										<tr>
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
													<TR>
														<TD class="TextLarge" noWrap align="right">Leasingvertrags-Nr.:&nbsp;&nbsp;</TD>
														<TD class="TextLarge"><asp:textbox id="txtOrdernummer" runat="server" MaxLength="7" Width="250px"></asp:textbox>&nbsp;(1234567)</TD>
													</TR>
													<TR>
														<TD class="StandardTableAlternate" noWrap align="right">Kfz-Kennzeichen*:&nbsp;&nbsp;</TD>
														<TD class="StandardTableAlternate"><asp:textbox id="txtAmtlKennzeichen" runat="server" MaxLength="9" Width="250px"></asp:textbox>&nbsp;(XX-Y1234)</TD>
													</TR>
													<TR>
														<TD>&nbsp;</TD>
													...
													<TR>
														...
														<TD class="StandardTableAlternate"><asp:textbox id="txtFahrgestellnummer" runat="server" MaxLength="17" Width="250px"></asp:textbox></TD>
													</TR>
													<TR>
														<TD>&nbsp;</TD>
													...
													<TR>
														<TD class="StandardTableAlternate" vAlign="top" noWrap align="right">Platzhaltersuche:&nbsp;&nbsp;&nbsp;</TD>
														<TD class="StandardTableAlternate"><asp:radiobutton id="cbxPlatzhaltersuche" runat="server" Text=" Platzhaltersuche möglich. Nur verwendbare Vorgänge werden angezeigt." GroupName="grpWeicheSuche" Checked="True"></asp:radiobutton><BR>
															<asp:radiobutton id="cbxOhnePlatzhalter" runat="server" Text=" Platzhalter werden ignoriert. Informationen zu dem Vorgang werden angezeigt, insofern er im System gefunden wurde." GroupName="grpWeicheSuche"></asp:radiobutton></TD>
													</TR>
												</TABLE>
												<br>
											</td>
