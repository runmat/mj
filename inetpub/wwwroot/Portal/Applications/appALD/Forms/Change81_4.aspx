...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change81_4.aspx.vb" Inherits="AppALD.Change81_4" %>
							...
							<tr>
								...
								<td vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" vAlign="top"><asp:hyperlink id="lnkFahrzeugsuche" runat="server" NavigateUrl="Change04.aspx" CssClass="TaskTitle">Fahrzeugsuche</asp:hyperlink>&nbsp;<asp:hyperlink id="lnkFahrzeugAuswahl" runat="server" NavigateUrl="Change04_2.aspx" CssClass="TaskTitle">Fahrzeugauswahl</asp:hyperlink>&nbsp;
												<asp:hyperlink id="lnkPrintView" runat="server" CssClass="TaskTitle" NavigateUrl="Change81_5.aspx" Target="_blank">Druckansicht</asp:hyperlink>&nbsp;</TD>
										</TR>
									</TABLE>
