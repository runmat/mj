...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change81_5.aspx.vb" Inherits="AppALD.Change81_5" %>
						...
						<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<td class="PageNavigation">
									<asp:label id="lblHead" runat="server"></asp:label><asp:label id="lblPageTitle" runat="server"> (Best‰tigung)</asp:label></td>
								<td class="PageNavigation" align="right"><asp:HyperLink id="HyperLink1" runat="server" NavigateUrl="javascript:window.close()">Fenster schlieﬂen</asp:HyperLink></td>
							</TR>
							<tr>
