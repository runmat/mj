...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report81.aspx.vb" Inherits="AppALD.Report81" %>
												...
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0" bgColor="white">
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">
															<P align="right">Leasingvertrags-Nr:&nbsp;&nbsp;
															</P>
														</TD>
														<TD class="TextLarge" vAlign="center">
															<asp:TextBox id="txtOrdernummer" runat="server" MaxLength="7"></asp:TextBox>&nbsp;(1234567)</TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="center" width="150">
													...
													<TR>
														...
														<TD class="TextLarge" vAlign="center">
															<asp:TextBox id="txtBriefnummer" runat="server" Visible="False"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD class="TextLarge" vAlign="center" width="150"></TD>
