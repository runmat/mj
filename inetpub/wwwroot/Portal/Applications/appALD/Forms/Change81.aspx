<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change81.aspx.vb" Inherits="AppALD.Change81" %>
											...
											<td vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="100%" border="0">
													<TR>
														...
														<TD class="TextLarge"><asp:textbox id="txtOrdernummer" runat="server" Width="250px" MaxLength="7"></asp:textbox>&nbsp;(1234567)</TD>
													</TR>
													<TR>
