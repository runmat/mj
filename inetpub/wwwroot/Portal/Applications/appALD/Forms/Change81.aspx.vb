    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If (Session("objHaendler") Is Nothing) OrElse (Not IsPostBack) Then
                objHaendler = New ALD_2(m_User, m_App, Session("AppID").ToString, Session.SessionID.ToString, "")
                'objHaendler.KUNNR = Right("0000000000" & m_User.KUNNR, 10)                 'Kunnr. ALD
            Else
        ...
        Try
            ...
            If Not (uFile Is Nothing) Then
                ...
                For Each rowData In objDataset1.Tables(0).Rows
                    i += 1
                    If TypeOf rowData(1) Is System.DBNull And TypeOf rowData(2) Is System.DBNull Then Exit For

                    Dim strLeasingvertragsNr As String = ""
                    If Not TypeOf rowData(1) Is System.DBNull Then
                        strLeasingvertragsNr = CStr(rowData(1)).Trim(" "c)
                    End If
                    Dim strKennzeichen As String = ""
                    If Not TypeOf rowData(2) Is System.DBNull Then
                        strKennzeichen = CStr(rowData(2)).Trim(" "c)
                    End If
                    Dim strSachbearbeiterNr As String = ""
                    If Not TypeOf rowData(3) Is System.DBNull Then
                        strSachbearbeiterNr = CStr(rowData(3)).Trim(" "c)
                    End If
                    ...
                    '§§§ JVE 20.04.2006: Beide Suchkriterien füllen!
                    ...
                    If Not objHaendler.Status = 0 Then
                        ...
                        rowNew("SACHBEARBEITER") = strSachbearbeiterNr
                        rowNew("SB_CHECK") = True
                    Else
