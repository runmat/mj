...
#Region " Methods"
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String)
        ...
        Try
            ...
            Dim tblTemp2 As DataTable = S.AP.GetExportTableWithInitExecute("Z_M_READ_FZGPOOL_ZUL_FZG_006.GT_WEB", "I_KUNNR_AG", m_objUser.KUNNR.ToSapKunnr())
    ...
    Public Sub createZulassungCount(ByVal Zuldatum As String)
        ...
        Try
            ...
            Dim tblTemp2 As DataTable = S.AP.GetExportTableWithInitExecute("Z_M_ANZ_BEAUFTR_ZUL_006.GT_WEB",
                                                         "I_KUNNR, I_ZULDAT",
