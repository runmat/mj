...
Public Class Change10_Beauftragung_2
...
#Region "Events"
    ...
    Private Sub Change10_Beauftragung_2_Unload(sender As Object, e As System.EventArgs) Handles Me.Unload
    ...
    Private Sub cmdBack_Click(sender As Object, e As System.EventArgs) Handles cmdBack.Click
        If CInt(Session("Step")) = 3 Then
            Session("Step") = 2
            Response.Redirect("Change10_Beauftragung.aspx?AppID=" & _mUser.Applications.Select("AppName='Change10_Beauftragung'")(0)("AppID").ToString)
        End If
    End Sub

    Private Sub cmdSend_Click(sender As Object, e As System.EventArgs) Handles cmdSend.Click
        If CInt(Session("Step")) = 3 Then
            If DoSubmit() And DoSubmitFinal() Then
...
#Region "Ansichtsänderungen"
    ...
    ''' <summary>
    ''' Löscht die Eingabefelder mit Stationsdaten
    ''' </summary>
    Private Sub ClearStationFields()
        rtbStationscode.Text = ""
        'rtbSpedition.Text = ""
        rcbSpediteur.SelectedValue = _mTransportbeauftragung.strFilterCarport
        rtbStation.Text = ""
        rtbStation2.Text = ""
        rtbStraße.Text = ""
        rtbHausnummer.Text = ""
...
#Region "Fill Methoden"
    ...
    Private Sub FillGrid(rebind As Boolean)
        rgResult.DataSource = _mTransportbeauftragung.GetFilterBestand()
        ...
        If ValidateInputFields() Then
            Try
                ...
                Else
                    ClearStationFields()
                    lblError.Text = ""
                    lblSuccess.Text = "Beauftragung erfolgreich!"
                End If
