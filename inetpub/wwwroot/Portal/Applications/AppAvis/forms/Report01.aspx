<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report01.aspx.vb" Inherits="AppAvis.Report01" %>
                                ...
                                <tr>
                                    <td valign="top" align="left">
                                        <table id="Table1" cellspacing="0" cellpadding="5" width="100%" bgcolor="white" border="0">
                                            <tr>
                                                <td class="style1" valign="center">
                                                    von:
                                                </td>
                                                <td class="TextLarge" valign="center">
                                                    <asp:TextBox ID="txtAbmeldedatumVon" runat="server"></asp:TextBox>&nbsp;<asp:ImageButton
                                            ...
                                            <tr>
                                                ...
                                                <td class="TextLarge" valign="center">
                                                    <asp:RadioButton ID="rdo_Ja" runat="server" GroupName="Erledigt"
                                                        Text="Ja" />
                                                    &nbsp;<asp:RadioButton ID="rdo_Nein" runat="server" GroupName="Erledigt"
                                                        Text="Nein" Checked="True" />
                                                </td>
                                            </tr>
                                        </table>
                                        <br>
