<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change10_Beauftragung_2.aspx.vb"
    Inherits="AppAvis.Change10_Beauftragung_2" EnableEventValidation="false" %>
                            ...
                            <table id="Table2" bordercolor="#ffffff" cellspacing="0" cellpadding="0" width="120"
                                ...
                                <tr>
                                    <td valign="center" width="150">
                                        <asp:LinkButton ID="cmdCreate" runat="server" CssClass="StandardButton" Visible="false"> &#149;&nbsp;Weiter</asp:LinkButton>
                                        <asp:LinkButton ID="cmdSend" runat="server" CssClass="StandardButton" Visible="True"> &#149;&nbsp;Beauftragen</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="center" width="150">
                                            ...
                                            <table id="tblTargetAdress" cellspacing="0" cellpadding="0" width="100%" border="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            Stationscode<br />
                                                            <telerik:RadTextBox ID="rtbStationscode" runat="server" MaxLength="12" Width="80px"
                                                                AutoPostBack="true">
                                                            </telerik:RadTextBox>
                                                        </td>
                                                        <td valign="top">
                                                        ...
                                                        <td rowspan="4" valign="top" width="100%">
                                                            ...
                                                            <telerik:RadGrid ID="rgAuslastung" runat="server" PageSize="10" AllowPaging="true"
                                                                ...
                                                                Visible="true" AllowColumnsReorder="false">
                                                    ...
                                                    <tr>
                                                        <td width="100%" height="100%">
                                                            <telerik:RadGrid ID="rgResult" runat="server" PageSize="200" AllowPaging="true" AllowSorting="true"
                                                                AutoGenerateColumns="False" GridLines="None" CellSpacing="0" AllowMultiRowSelection="true">
                                                                <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
                                                                <ClientSettings AllowKeyboardNavigation="True">
                                                                    <Scrolling AllowScroll="false" UseStaticHeaders="True" FrozenColumnsCount="0" />
                                                                    <Resizing AllowColumnResize="true" AllowResizeToFit="True" ResizeGridOnColumnResize="false" />
