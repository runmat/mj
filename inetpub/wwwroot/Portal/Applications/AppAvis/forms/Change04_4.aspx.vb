        ...
        For Each GridRow In grvRegeln.Rows
            ...
            If GridRow.Enabled = True Then
                ...
                Else
                    ...
                    If Not String.IsNullOrEmpty(txt.Text) AndAlso IsDate(txt.Text) Then
                        Row("DAT_SPERR_AB") = DateTime.Parse(txt.Text)
                    ElseIf Not String.IsNullOrEmpty(lbl.Text) AndAlso IsDate(lbl.Text) Then
                        Row("DAT_SPERR_AB") = DateTime.Parse(lbl.Text)
                    End If
                    ...
                    If Not String.IsNullOrEmpty(txt.Text) AndAlso IsDate(txt.Text) Then
                        Row("DAT_SPERR_BIS") = DateTime.Parse(txt.Text)
                    ElseIf Not String.IsNullOrEmpty(lbl.Text) AndAlso IsDate(lbl.Text) Then
                        Row("DAT_SPERR_BIS") = DateTime.Parse(lbl.Text)
                    End If
