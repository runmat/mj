																	...
																	<DIV align="center">
																		<TABLE id="Table3" cellSpacing="1" cellPadding="1" border="0" align="center">
																			<TR id="trDateiauswahl">
																				<TD><INPUT class="InfoBoxFlat" id="upFile" type="file" size="40" name="File1" runat="server">&nbsp;<A href="javascript:openinfo('Info02.htm');"><IMG src="/Portal/Images/fragezeichen.gif" border="0"></A>&nbsp;</TD>
