<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report03.aspx.vb" Inherits="AppEC.Report03" %>
							...
							<TR>
								...
								<TD vAlign="top">
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD vAlign="top">
												<TABLE class="BorderLeftBottom" id="Table5" cellSpacing="1" cellPadding="1">
													<TR>
														<TD></TD>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD vAlign="top" align="left">
												<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" bgColor="white" border="0">
													<TR id="rowResultate" runat="server">
														<TD class="TextLarge" vAlign="center"><asp:label id="lblResults" runat="server"></asp:label>&nbsp;&nbsp;
															<BR>
															<asp:datagrid id="DataGrid1" runat="server" Width="744px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False">
