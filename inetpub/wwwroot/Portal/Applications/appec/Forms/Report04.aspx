														...
														<TD class="TextLarge" vAlign="top" align="left">
															<TABLE class="BorderLeftBottom" id="Table5" cellSpacing="1" cellPadding="1" border="0">
																...
																<TR>
																	...
																	<TD>
																		<asp:textbox id="txtEingangsdatumVon" runat="server"></asp:textbox></TD>
																	<TD>
																...
																<TR>
																	...
																	<TD>
																		<asp:textbox id="txtEingangsdatumBis" runat="server"></asp:textbox></TD>
																	<TD>
																...
																<TR>
																	...
																	<TD>
																		<asp:textbox id="txtModell" runat="server"></asp:textbox></TD>
																	<TD></TD>
																</TR>
																<TR>
																	<TD>&nbsp;</TD>
																...
																<TR>
																	...
																	<TD></TD>
																	<TD>
																		<asp:linkbutton id="cmdDetails" runat="server" CssClass="StandardButton" Visible="False"> &#149;&nbsp;Detailanzeige&nbsp;&#187;</asp:linkbutton></TD>
																</TR>
															</TABLE>
