...
#End Region
    ...
    Private objFahrzeuge As change_06
    ...
    Private Sub DoSubmit()
        ...
        objFahrzeuge = New change_06(m_User, m_App, Session("AppID").ToString, Session.SessionID.ToString, strFileName)
        'objFahrzeuge.Customer = m_User.KUNNR
        objFahrzeuge.Show(Me)
