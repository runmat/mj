...
#End Region
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        ...
        Else
            ...
            Dim tmpDataView As DataView = ResultTable.DefaultView
    ...
    Private Sub btnSaveSAP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveSAP.Click
        ...
        Try
            ...
            objBatch.comitSapWorkAndCloseConnection(Session("AppID").ToString, Session.SessionID)
    ...
    Private Sub modifyGridInhalt(ByVal tmpDataView As DataView) 'je nach dem was in der Zeile Steht, die Checkbox modifizieren
        ...
        ' Debugausgabe
        'Dim dv As DataView = dataGrid.DataSource
        'Dim tbl As DataTable = dv.Table
        'GeneralTools.Services.XmlService.XmlSerializeToFile(tbl, "C:\\Temp\EC_DATA.xml")
