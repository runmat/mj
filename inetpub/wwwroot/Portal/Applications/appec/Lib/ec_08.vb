...
#Region " Methods"
    ...
    Public Overrides Sub Show()
        ...
        If Not m_blnGestartet Then
            ...
            Try
                ...
                If CarDetailTable.Rows.Count > 0 Then
                    ...
                    For Each tmpRow As DataRow In CarDetailTable.Rows
                        ...
                        '    datTemp = HelpProcedures.MakeDateStandard(tmpRow("Repla_Date").ToString)
                        ...
                        '    datTemp = HelpProcedures.MakeDateStandard(tmpRow("Vdatu").ToString)
                        '    If datTemp > CDate("01.01.1900") Then
                    ...
                    Next
                Else
                    RaiseError("-2202", "Keine Vorgangsinformationen vorhanden.")
                End If
            ...
            Catch ex As Exception
                ...
                End If
                WriteLogEntry(False, "KUNNR=" & m_objUser.KUNNR & " , " & m_strMessage, m_tblFahrzeuge)
            Finally
                If m_intIDSAP > -1 Then
    ...
    Public Overrides Sub Change()
        ...
        For i = 0 To tmpDataView.Count - 1
            ...
            Catch ex As Exception
                RaiseError("-9999", "Fehler bei der Speicherung der Vorgänge")
