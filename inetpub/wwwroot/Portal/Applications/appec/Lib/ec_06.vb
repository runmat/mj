...
#Region " Methods"
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal strPDI As String, ByVal datEingangsdatumVon As String, ByVal datEingangsdatumBis As String, ByVal strFahrgestellnummer As String, ByVal strModell As String, ByVal page As Page)
        ...
        Try
            ...
            S.AP.InitExecute("Z_M_Ec_Avm_Pdi_Bestand", "I_KUNNR,I_PDI,I_ZZDAT_EIN_VON,I_ZZDAT_EIN_BIS,I_ZZFAHRG,I_ZMODELL", _
                             Right("0000000000" & m_objUser.KUNNR, 10), strPDI, datEingangsdatumVon, datEingangsdatumBis, _
            ...
            WriteLogEntry(True, "ZZDAT_EIN_VON=" & datEingangsdatumVon & ", ZZDAT_EIN_BIS=" & datEingangsdatumBis & ", KUNNR=" & m_objUser.KUNNR & ", ZZKUNPDI=" & strPDI & ", ZZFAHRG=" & strFahrgestellnummer & ", ZZBEZEI=" & strModell, m_tblResult, False)
        Catch ex As Exception
            ...
            WriteLogEntry(False, "ZZDAT_EIN_VON=" & datEingangsdatumVon & ", ZZDAT_EIN_BIS=" & datEingangsdatumBis & ", KUNNR=" & m_objUser.KUNNR & ", ZZKUNPDI=" & strPDI & ", ZZFAHRG=" & strFahrgestellnummer & ", ZZBEZEI=" & strModell & ", " & Replace(m_strMessage, "<br>", " "), m_tblResult, False)
        End Try
    End Sub
