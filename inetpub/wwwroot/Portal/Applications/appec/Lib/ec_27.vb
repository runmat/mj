...
#Region " Methods"
    ...
    Public Sub GetMonatsbericht(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
        m_strClassAndMethod = "EC_27.GetMonatsbericht"
        m_strAppID = strAppID
        ...
        Try
            ...
            Dim tblTemp2 As DataTable = S.AP.GetExportTable("GT_HERSTELLER") 'myProxy.getExportTable("GT_HERSTELLER")
    ...
    Public Overloads Sub FILL(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
        m_strClassAndMethod = "EC_27.FILL"
        m_strAppID = strAppID
        m_strSessionID = strSessionID
        ...
        Try
            ...
            For Each drow In tblTemp2.Rows
                If CStr(drow("ZKLTXT_HERST")) = "Gruppe 1 PKW" Then
                    'Leerzeile einfügen
