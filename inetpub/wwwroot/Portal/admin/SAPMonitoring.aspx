										...
										<tr id="trSearch" runat="server">
											<td align="left">
												<table bgColor="white" border="0">
													...
													<TR>
														<TD vAlign="bottom" width="100">Kriterium</TD>
														<TD vAlign="bottom" width="160" colSpan="2"><asp:radiobutton id="rbBAPI" runat="server" Text="BAPI" GroupName="grpKriterium" AutoPostBack="True"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<asp:radiobutton id="rbASPX" runat="server" Text="ASPX-Seite" Checked="True" GroupName="grpKriterium" AutoPostBack="True"></asp:radiobutton></TD>
													</TR>
													<TR>
														<TD vAlign="bottom" width="100">Auswahl:</TD>
														<TD vAlign="bottom" width="160" colSpan="2"><asp:dropdownlist id="ddlAuswahl" runat="server"></asp:dropdownlist></TD>
													</TR>
												</table>
											</td>
										</tr>
															...
															<ItemTemplate>
																<TABLE id="Table18" cellSpacing="0" cellPadding="0" border="0">
																	<TR>
																		...
																		<TD width="125">
																			<asp:Label id="Label5" runat="server" Width='<%# System.Web.UI.WebControls.Unit.Pixel(CInt(DataBinder.Eval(Container, "DataItem.Dauer ASPX"))) %>' Height="10px" BackColor="#8080FF">
																			</asp:Label></TD>
																	</TR>
																	<TR>
																		<td width="25">SAP</td>
																		...
																		<TD width="125">
																			<asp:Label id="Label7" runat="server" Width='<%# System.Web.UI.WebControls.Unit.Pixel(CInt(DataBinder.Eval(Container, "DataItem.Dauer SAP"))) %>' Height="10px" BackColor="Highlight">
																			</asp:Label></TD>
																	</TR>
																</TABLE>
															</ItemTemplate>
