...
Public Class Columntranslation_Start
...
#End Region
        ...
        Try
            ...
            If Not IsPostBack Then
                If Not Me.Request.UrlReferrer Is Nothing Then
                    If Me.Request.UrlReferrer.ToString.Contains("ColumnTranslation") Then
    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If e.CommandName = "goToColumnTranslation" Then
...
' ************************************************
' $History: Columntranslation_Start.aspx.vb $
' 
' *****************  Version 2  *****************
