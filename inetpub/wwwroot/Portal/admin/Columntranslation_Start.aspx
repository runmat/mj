<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Columntranslation_Start.aspx.vb" Inherits="CKG.Admin.Columntranslation_Start" %>
                                        ...
                                        <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AllowPaging="True"
                                            ...
                                            <Columns>
                                               ...
                                               <ItemTemplate>
                                                ...
                                                <asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AppName")%>'
                                                    CommandName="goToColumnTranslation" ID="lbAppLink" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.AppID")%>'></asp:LinkButton>
