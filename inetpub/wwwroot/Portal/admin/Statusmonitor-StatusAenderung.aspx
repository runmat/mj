                        ...
                        <table id="Table4" cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                <td class="PageNavigation" colspan="2">
                                    <asp:Label ID="lblHead" runat="server">Administration</asp:Label><asp:Label ID="lblPageTitle" runat="server" Font-Bold="True">DAD-Statusmonitor</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:GridView AutoGenerateColumns="False" AllowSorting="true" BorderWidth="1" BorderStyle="Solid" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField SortExpression="Abteilung" >
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument="Abteilung"  CommandName="sort" Text="Kunde/Abteilung"></asp:LinkButton>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:Label  runat="server"  Text='<%# DataBinder.Eval(Container, "DataItem.Abteilung") %>' ID="lblAnzeigeKundenName"  Visible="true"> </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField >
                                                <HeaderTemplate >
                                            ...
                                            <asp:TemplateField >
                                                <HeaderTemplate >
                                                    <asp:Label  runat="server" Text="Informationstext" ID="lblAnzeigeTextInfoText"></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" MaxLength="50" Rows="3" Width="400" TextMode="MultiLine" ID="txtInfoText" Text='<%# DataBinder.Eval(Container, "DataItem.InfoText") %>'></asp:TextBox>
                                                    <asp:LinkButton runat="server"  CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ABT_ID") %>' CommandName="saveInfoText"  Text="speichern" ID="lbSaveInfoText"> </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderTemplate >
                                                    <asp:Label runat="server" Text="Status" ID="lblStatusHeader"></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate >
                                                    ...
                                                    <asp:LinkButton runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ABT_ID") %>' CommandName="change" Text="ändern" ID="lbChange"> </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
