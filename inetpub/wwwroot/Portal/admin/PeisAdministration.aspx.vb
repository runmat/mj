...
' ************************************************
' $History: PeisAdministration.aspx.vb $
' 
' *****************  Version 7  *****************
' User: Jungj        Date: 16.07.09   Time: 9:27
' Updated in $/CKAG/admin
' zur�ckbutton aktiviert
' 
' *****************  Version 6  *****************
' User: Jungj        Date: 16.07.09   Time: 8:45
' Updated in $/CKAG/admin
' nachbesserungen
' 
' *****************  Version 5  *****************
...
' Updated in $/CKAG/admin
' Anpassung peisadministration
' 
' *****************  Version 4  *****************
' User: Jungj        Date: 15.07.09   Time: 16:49
' Updated in $/CKAG/admin
' Peis admin nachbesserungen
' 
' *****************  Version 3  *****************
