...
#Region " Constructor "
        ...
        End Sub
        Public Sub New(ByVal strAppURL As String, ByVal strFieldType As String, ByVal strFieldName As String, ByVal intCustomerID As Integer, ByVal intLanguageID As Integer, ByVal cn As SqlClient.SqlConnection)
            m_strAppURL = strAppURL
            m_strFieldType = strFieldType
            m_strFieldName = strFieldName
            m_intCustomerID = intCustomerID
