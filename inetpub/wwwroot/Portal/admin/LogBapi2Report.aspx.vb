...
#End Region
    ...
    Private Sub FillGrid(ByVal intPageIndex As Int32, Optional ByVal strSort As String = "")
        ...
        Try
            ...
            If werteTable.Rows.Count > 0 Then
                ...
                lblAnzahl.Text = "Treffer: " & tmpDataView.Count
    ...
    Protected Sub ddlPageSize_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlPageSize.SelectedIndexChanged
        gvResult.PageSize = CInt(ddlPageSize.SelectedItem.Value)
        FillGrid(0)
    End Sub
    ...
    Protected Sub lnkCreateExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkCreateExcel.Click
        ...
        If Not (Session("LogwerteResultExcel") Is Nothing) Then
            ...
            ExcelTable.Columns(ExcelTable.Columns.Count - 1).ColumnName = "zuletzt verwendet"
...
' ************************************************
' $History: LogBapi2Report.aspx.vb $
' 
' *****************  Version 3  *****************
' User: Rudolpho     Date: 6.05.09    Time: 10:25
...
' 
' *****************  Version 1  *****************
' User: Rudolpho     Date: 25.03.09   Time: 11:41
