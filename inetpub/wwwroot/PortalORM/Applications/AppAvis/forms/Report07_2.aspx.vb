...
Partial Public Class Report07_2
    ...
    Private Grunddaten As DataTable
    Private Adressen As DataTable
    Private Lastchange As DataTable
    Private Equidaten As DataTable
        ...
        With m_Report.Equidaten
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If .Rows(i)("EQTYP").ToString = "T" Then
                    If MakeStandardDateString(.Rows(i)("ERDAT").ToString) = "00.00.0000" Then
                        lblEingangSchluessel.Text = ""
                    Else
                        lblEingangSchluessel.Text = MakeStandardDateString(.Rows(i)("ERDAT").ToString)
                    End If

                    'Datum
                    If MakeStandardDateString(.Rows(i)("ZZTMPDT").ToString) = "00.00.0000" Then
                        lblAngefordertAm0.Text = ""
                    Else
                        lblAngefordertAm0.Text = MakeStandardDateString(.Rows(i)("ZZTMPDT").ToString)
                    End If
                    'Versandanschrift
    ...
    Private Sub FillUebersicht()
        With m_Report.Grunddaten
            ...
            If .Rows.Count > 0 Then
                ...
                If MakeStandardDateString(.Rows(0)("DAT_SPERRE").ToString) = "00.00.0000" Then
                    lblSperrebis.Text = ""
                Else
                    lblSperrebis.Text = MakeStandardDateString(.Rows(0)("DAT_SPERRE").ToString)
                End If
                If MakeStandardDateString(.Rows(0)("REPLA_DATE").ToString) = "00.00.0000" Then
                    lblErstzulassungsdatumShow.Text = ""
                Else
                    lblErstzulassungsdatumShow.Text = MakeStandardDateString(.Rows(0)("REPLA_DATE").ToString)
                End If

                If MakeStandardDateString(.Rows(0)("ZZZLDAT").ToString) = "00.00.0000" Then
                    lblAktZulassungsdatumShow.Text = ""
                Else
                    lblAktZulassungsdatumShow.Text = MakeStandardDateString(.Rows(0)("ZZZLDAT").ToString)
                End If

                If MakeStandardDateString(.Rows(0)("EXPIRY_DATE").ToString) = "00.00.0000" Then
                    lblAbmeldedatumShow.Text = ""
                Else
                    lblAbmeldedatumShow.Text = MakeStandardDateString(.Rows(0)("EXPIRY_DATE").ToString)
                End If
                ...
                End Select
                If MakeStandardDateString(.Rows(0)("UDATE").ToString) = "00.00.0000" Then
                    lblUmgemeldetAmShow.Text = ""
                Else
                    lblUmgemeldetAmShow.Text = MakeStandardDateString(.Rows(0)("UDATE").ToString)
                End If
                If MakeStandardDateString(.Rows(0)("ZZDAT_EIN").ToString) = "00.00.0000" Then
                    lblEingangsdatum.Text = ""
                Else
                    lblEingangsdatum.Text = MakeStandardDateString(.Rows(0)("ZZDAT_EIN").ToString)
                End If

                If MakeStandardDateString(.Rows(0)("ZZDAT_BER").ToString) = "00.00.0000" Then
                    lblBereitdatum.Text = String.Empty
                Else
                    lblBereitdatum.Text = MakeStandardDateString(.Rows(0)("ZZDAT_BER").ToString)
                End If
                ...
                End If
                'If .Rows(0)("ABCKZ").ToString = "1" Then
                '    rbTemporaer.Checked = True
                '    rbEndgueltig.Checked = False
                'ElseIf .Rows(0)("ABCKZ").ToString = "2" Then
                ...
                '    rbEndgueltig.Checked = False
                'End If
                If MakeStandardDateString(.Rows(0)("CHECK_IN").ToString) = "00.00.0000" Then
                    lblCheckIn.Text = ""
                Else
                    lblCheckIn.Text = MakeStandardDateString(.Rows(0)("CHECK_IN").ToString)
                End If


                If MakeStandardDateString(.Rows(0)("ZZTMPDT").ToString) = "00.00.0000" Then
                    lblVersendetAm.Text = ""
                Else
                    lblVersendetAm.Text = MakeStandardDateString(.Rows(0)("ZZTMPDT").ToString)
    ...
    Private Function MakeStandardDateString(ByVal strSAPDate As String) As String
        ...
        Return strSAPDate.TruncateToShortDateString()
    End Function
