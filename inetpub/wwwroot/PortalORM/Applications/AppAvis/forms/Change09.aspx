<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change09.aspx.vb" Inherits="AppAvis.Change09" %>
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CHASSIS_NUM" HeaderText="Fahrgestellnummer" />
                                     <asp:TemplateField HeaderText="Status" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Middle">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMessage" Font-Bold = "true" Text ='<%# DataBinder.Eval(Container, "DataItem.RET_BEM") %>' runat="server" >
                                            </asp:Label>
                                          </ItemTemplate>
