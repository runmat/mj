...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change08_1.aspx.vb" Inherits="AppAvis.Change08_1" %>
											...
											<TD class="" vAlign="top" align="left" colSpan="3">
												<asp:datagrid id="DataGrid1" runat="server" AllowSorting="True" AllowPaging="True" Width="100%" PageSize="50" bodyHeight="400" cssclass="tableMain" bodyCSS="tableBody" headerCSS="tableHeader" BackColor="White" AutoGenerateColumns="False">
													...
													<Columns>
														...
														<asp:BoundColumn  HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="Kennzeichen" SortExpression="Kennzeichen" HeaderText="Kennzeichen"></asp:BoundColumn>
														<asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="Fahrgestellnummer" SortExpression="Fahrgestellnummer" HeaderText="Fahrgestellnummer"></asp:BoundColumn>
														<asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="HerstellerID" SortExpression="HerstellerID" HeaderText="Hersteller ID"></asp:BoundColumn>
														<asp:BoundColumn  HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="Hersteller" SortExpression="Hersteller" HeaderText="Hersteller"></asp:BoundColumn>
														 <asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataField="TypID" SortExpression="TypID" HeaderText="Typ ID"></asp:BoundColumn>
														 	 <asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="OwnerCode" SortExpression="OwnerCode" HeaderText="Owner Code" ></asp:BoundColumn>													<asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="Modellbezeichnung" SortExpression="Modellbezeichnung" HeaderText="Modellbezeichnung"></asp:BoundColumn>
														 <asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="Lieferant" SortExpression="Lieferant" HeaderText="Lieferant" ></asp:BoundColumn>
														
                                                         <asp:BoundColumn HeaderStyle-Wrap="false" ItemStyle-Wrap="TRUE" DataField="Zulassungsdatum" SortExpression="Zulassungsdatum" HeaderText="Zulassungsdatum" DataFormatString="{0:dd.MM.yyyy}"></asp:BoundColumn>
                                                         
                                                          
                                                            
                                                             <asp:BoundColumn ItemStyle-Wrap="false" DataField="DatumHaltefrist" SortExpression="DatumHaltefrist" DataFormatString="{0:dd.MM.yyyy}" HeaderText="Datum Haltefrist"></asp:BoundColumn>
                                                       	
                                                       	<asp:TemplateColumn ItemStyle-Wrap="false" HeaderText="Keine&lt;br&gt;Auswahl">
														...
														<asp:TemplateColumn ItemStyle-Wrap="false" Visible="False" HeaderText="Haltefrist einhalten &lt;br&gt; und ausblenden">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
															<ItemTemplate>
														...
														<asp:TemplateColumn ItemStyle-Wrap="false" HeaderText="Haltefrist ignorieren &lt;br&gt; und abmelden">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
															<ItemTemplate>
