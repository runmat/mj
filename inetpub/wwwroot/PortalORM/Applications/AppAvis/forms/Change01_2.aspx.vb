...
Partial Public Class Change01_2
    ...
    Private Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Unload
        SetEndASPXAccess(Me)
    End Sub
    Private Function MakeDateStandard(ByVal strInput As String) As Date
        ...
        End If
    End Function
    Private Function MakeDateSAP(ByVal datInput As String) As String
        Dim dat As Date
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdSave.Click
        ...
        'Dim TableToSave As New DataTable
        ...
        For Each item As DataGridItem In DataGrid1.Items
            ...
            For Each control In cell.Controls
                If TypeOf control Is CheckBox Then
                    ...
                    If chkBox.Enabled = True AndAlso chkBox.Checked = True Then
                        ...
                        'saverow("ZZDAT_BER") = MakeDateSAP(Now.ToString)
            ...
            Next
        Next
        m_report.Save(Session("AppID").ToString, Session.SessionID.ToString, TableToSave)
