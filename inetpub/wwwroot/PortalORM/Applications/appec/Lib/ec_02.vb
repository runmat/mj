...
#Region " Methods"
    ...
    Public Sub fillHerstellerDDL(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
        m_strAppID = AppID
    ...
    Public Sub comitSapWorkAndCloseConnection(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
