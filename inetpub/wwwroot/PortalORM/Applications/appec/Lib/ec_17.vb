...
#Region " Methods"
    ...
    Public Sub GiveCars(ByVal tblFahrzeuge As DataTable, ByVal page As Page)
        ...
        Try
            ...
            S.AP.Init("Z_M_Ec_Avm_Status_Greenway", "I_KUNNR", Right("0000000000" & m_objUser.KUNNR, 10))
    ...
    Public Sub SetAvis(ByVal page As Page)
        ...
        Try
            ...
            S.AP.Init("Z_DPM_IMP_MODELL_ID_01", "I_AG,I_WEB_USER", Right("0000000000" & m_objUser.KUNNR, 10), m_objUser.UserName)
    ...
    Public Sub LoadCars(ByVal page As Page)
        ...
        Try
            ...
            S.AP.InitExecute("Z_V_FAHRZEUG_STATUS_001", "I_KUNNR", Right("0000000000" & m_objUser.KUNNR, 10))
