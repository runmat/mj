...
#Region " Methods"
    ...
    Public Overloads Sub Show(ByVal page As Page)
        ...
        Try
            ...
            S.AP.InitExecute("Z_M_Schlue_Temp_Vers_Mahn_001", "I_KUNNR", Right("0000000000" & m_objUser.KUNNR, 10))
    ...
    Public Overloads Sub Change(ByVal strAppID As String, ByVal strSessionID As String, ByVal page As Page)
        ...
        For i = 0 To tmpDataView.Count - 1
            ...
            Try
                ...
                S.AP.InitExecute("Z_M_Schlue_Set_Mahnsp_001", "I_KUNNR,I_EQUNR,I_ZZMANSP", Right("0000000000" & m_objUser.KUNNR, 10), CType(tmpDataView.Item(i)("Equipmentnummer"), String), "X")
            Catch ex As Exception
                Select Case HelpProcedures.CastSapBizTalkErrorMessage(ex.Message)
                    Case "NO_DATA"
                        m_intStatus = -1234
