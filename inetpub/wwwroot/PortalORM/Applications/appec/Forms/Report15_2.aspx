...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report15_2.aspx.vb" Inherits="AppEC.Report15_2" %>
				...
				<tr>
					<td>
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<td class="PageNavigation" colSpan="2"><asp:label id="lblHead" runat="server"></asp:label><asp:label id="lblPageTitle" runat="server"> (Briefdaten)</asp:label></td>
							</TR>
							<tr>
								<TD vAlign="top" width="120">
									<TABLE id="Table2" borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="120" border="0">
										...
										<TR>
											<TD vAlign="center" width="150"><asp:linkbutton id="cmdBack" runat="server" 
								...
								<td vAlign="top">
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="TaskTitle" width="100%"><asp:hyperlink id="lnkKreditlimit" runat="server" Visible="False" CssClass="PageNavigation" NavigateUrl="Equipment.aspx">Abfragekriterien</asp:hyperlink>&nbsp;</TD>
										</TR>
										<TR>
											<TD class="" width="100%"><asp:label id="lblError" runat="server" CssClass="TextError" DESIGNTIMEDRAGDROP="163" EnableViewState="False"></asp:label></TD>
										</TR>
										<TR>
														...
														<TD vAlign="top" align="left" width="100%" colSpan="2">
															<TABLE id="Table10" cellSpacing="0" cellPadding="5" bgColor="white" border="0">
																<TR>
																	...
																	<TD class="PageNavigation" vAlign="center" align="right" colSpan="3"><asp:hyperlink id="lnkSchluesselinformationen" runat="server" NavigateUrl="Report15_3.aspx?chassisnum=" Target="_blank">Schlüsselinformationen</asp:hyperlink>&nbsp;&nbsp;
																...
																<TR>
																	<TD class="StandardTableAlternateDescription" vAlign="top" align="left">PDI-Nummer 
																		/ -Name:</TD>
																	<TD class="StandardTableAlternate" vAlign="top" align="right"><asp:label id="lblPDI" runat="server"></asp:label><asp:label id="lblPDIName" runat="server"></asp:label></TD>
																	<TD class="StandardTableAlternateDescription" vAlign="center" align="left"></TD>
																...
																<tr>
																	<TD class="" vAlign="top" colSpan="5"></TD>
																</tr>
																<TR>
																	<TD class="PageNavigation" vAlign="center" align="left">Briefdaten
																	</TD>
																	<TD class="PageNavigation" vAlign="top" noWrap align="right" colSpan="4">
																...
																<TR>
																	<TD class="PageNavigation" vAlign="top" colSpan="5">Abmeldedaten&nbsp;</TD>
																</TR>
																<TR>
																...
																<TR>
																	<TD class="PageNavigation" vAlign="top" colSpan="5">Letzte Versanddaten
																	</TD>
																</TR>
																<TR>
