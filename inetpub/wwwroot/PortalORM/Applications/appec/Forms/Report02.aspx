...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report02.aspx.vb" Inherits="AppEC.Report02"%>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD vAlign="top" align="left">
												...
												<asp:label id="lblInfo" runat="server" CssClass="TextInfo" EnableViewState="False"> Eingabe erforderlich. Format: TT.MM.JJJJ</asp:label>
											</TD>
										</TR>
									</TABLE>
								</TD>
