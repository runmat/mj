...
#End Region
    ...
    Private Sub DoSubmit()
        ...
        Try
            ...
            Dim m_Report As New ec_16(m_User, m_App, strFileName)
            ...
            If checkInput Then
                If (txtEingangsdatumVon.Text.Length > 0) And (txtEingangsdatumBis.Text.Length > 0) Then
                    If (Not IsDate(txtEingangsdatumVon.Text)) Or (Not IsDate(txtEingangsdatumBis.Text)) Then
                        checkInput = False
                    Else
                        If (CDate(txtEingangsdatumVon.Text) > CDate(txtEingangsdatumBis.Text)) Then
                            checkInput = False
            ...
            If checkInput Then
                ...
                m_Report.Fill(Session("AppID").ToString, Session.SessionID.ToString, strPDI, datEingangsdatumVon, datEingangsdatumBis, strFahrgestellnummer, strModell, Me)
