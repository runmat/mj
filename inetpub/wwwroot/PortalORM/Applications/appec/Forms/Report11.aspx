<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report11.aspx.vb" Inherits="AppEC.Report11" %>
						...
						<TABLE id="Table0" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD vAlign="top" width="120">
									...
									<asp:calendar id="calBis" runat="server" CellPadding="0" BorderColor="Black" BorderStyle="Solid" Width="120px" Visible="False">
										<TodayDayStyle Font-Bold="True"></TodayDayStyle>
										<NextPrevStyle ForeColor="White"></NextPrevStyle>
										<DayHeaderStyle Font-Bold="True" BackColor="Silver"></DayHeaderStyle>
										<SelectedDayStyle BackColor="#FF8080"></SelectedDayStyle>
											...
											<TD class="" vAlign="top">
												<TABLE class="BorderLeftBottom" id="Table5" cellSpacing="1" cellPadding="1" border="0">
													...
													<TR>
														...
														<TD>Hersteller:</TD>
														<TD>
															<asp:DropDownList id="ddlHersteller" runat="server"></asp:DropDownList></TD>
														<TD></TD>
													</TR>
													<TR>
														<TD>&nbsp;</TD>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD vAlign="top" align="left">
												...
												<asp:label id="lblInfo" runat="server" CssClass="TextInfo" EnableViewState="False"> Eingabe erforderlich. Format: TT.MM.JJJJ. Der Datumsbereich darf maximal einen Monat (30 Tage) umfassen.</asp:label></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
