												...
												<TABLE id="Table1" cellSpacing="0" cellPadding="2" bgColor="white" border="0">
													...
													<TR>
														...
														<TD vAlign="top" noWrap colSpan="4">
															<P><FONT color="red"><asp:image id="Image1" runat="server" ToolTip="Alphanumerisch, max. 7 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*</FONT></P>
														</TD>
													</TR>
													<TR>
														<TD vAlign="middle" noWrap></TD>
													...
													<TR>
														...
														<TD vAlign="top" colSpan="4"><FONT color="red"><asp:image id="Image2" runat="server" ToolTip="Alphanumerisch, max. 4 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*</FONT></TD>
													</TR>
													<TR>
														<TD vAlign="middle"></TD>
													...
													<TR>
														...
														<TD vAlign="top" colSpan="4"><FONT color="red"><asp:image id="Image4" runat="server" ToolTip="Numerisch, max. 8 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*</FONT></TD>
													</TR>
													<TR>
														<TD vAlign="middle"></TD>
														...
														<TD vAlign="top" colSpan="4"><FONT color="red"><asp:image id="Image6" runat="server" ToolTip="Datum, Format: MM.JJJJ" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*</FONT></TD>
													</TR>
													<TR>
														<TD vAlign="middle"></TD>
														...
														<TD vAlign="top" colSpan="4"><FONT color="red"><asp:image id="Image7" runat="server" ToolTip="Numerisch, max. 5 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*</FONT></TD>
													</TR>
													<TR>
														<TD vAlign="middle"></TD>
														...
														<TD class="" vAlign="top" colSpan="2"><FONT color="red"><asp:image id="Image8" runat="server" ToolTip="Numerisch, 8 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*</FONT></TD>
													</TR>
                                                    <tr>
                                                        <TD vAlign="middle"></TD>
														...
														<TD vAlign="top" colSpan="2"><asp:image id="Image10" runat="server" ToolTip="alternativ zu (von..bis): Datei im Excel-Format, Unit-Nummern in Spalte A (ohne Überschrift)" ImageUrl="/PortalORM/Images/info.gif"></asp:image></TD>
                                                    </tr>
													<TR>
														<TD vAlign="middle"></TD>
														...
														<TD vAlign="top" noWrap colSpan="4">
															<P align="left"><FONT color="red"><asp:image id="Image9" runat="server" ToolTip="Numerisch, max. 4 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image>&nbsp;*&nbsp;</FONT>
													...
													<TR>
														...
														<TD class="" vAlign="top" colSpan="2"><asp:image id="Image12" runat="server" ToolTip="Alphanumerisch, max. 60 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image></TD>
													</TR>
													<TR>
														<TD vAlign="middle"></TD>
														...
														<TD vAlign="top" colSpan="2"><asp:image id="Image3" runat="server" ToolTip="Alphanumerisch, max. 20 Stellen" ImageUrl="/PortalORM/Images/info.gif"></asp:image></TD>
													</TR>
													<TR>
														<TD vAlign="middle"></TD>
													...
													<TR>
														...
														<td><asp:image id="Image5" runat="server" ToolTip="Alphanumerisch, max. 20 Stellen" ImageUrl="/PortalORM/Images/info.gif" Visible="False"></asp:image></td>
													</TR>
												</TABLE>
