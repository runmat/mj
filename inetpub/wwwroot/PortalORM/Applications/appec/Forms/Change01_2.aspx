													...
													<asp:datagrid id="dataGrid" runat="server" CssClass="tableMain" BackColor="White" Width="100%" AutoGenerateColumns="False" AllowSorting="True" PageSize="50" headerCSS="tableHeader" bodyCSS="tableBody" bodyHeight="300">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="Bearbeiten">
																...
																<ItemTemplate>
																	<asp:ImageButton id=Imagebutton2 runat="server" ImageUrl="/PortalORM/Images/select.gif" CommandName="Select" Visible='<%# (typeof (DataBinder.Eval(Container, "DataItem.Status")) is System.DBNull) OrElse DataBinder.Eval(Container, "DataItem.Status")<>"Gespeichert." %>'>
																	</asp:ImageButton>
																</ItemTemplate>
															</asp:TemplateColumn>
														</Columns>
