...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Change06_2.aspx.vb" Inherits="AppEC.Change06_2" %>
										...
										<TR>
											<TD class="" vAlign="top" align="left" colSpan="3">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														<TD class="" width="100%">&nbsp;<strong><asp:label id="lblNoData" runat="server"></asp:label></strong></TD>
