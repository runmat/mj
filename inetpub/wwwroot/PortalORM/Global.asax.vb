...
#End Region
    ...
    Sub Application_Error(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Not System.Configuration.ConfigurationManager.AppSettings("enablePEIS") Is Nothing Then
            If CBool(System.Configuration.ConfigurationManager.AppSettings("enablePEIS")) Then
                Dim tmpP As CKG.Base.Common.PEIS
                If Not LastError Is Nothing Then
                    If Not LastError.InnerException Is Nothing Then
                        tmpP = New CKG.Base.Common.PEIS(LastError.InnerException, Context)
                    Else
                        tmpP = New CKG.Base.Common.PEIS(LastError, Context)
                    End If
                End If
            End If
        End If
