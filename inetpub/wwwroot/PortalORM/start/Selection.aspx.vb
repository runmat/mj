...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If User.Identity.Name = "IFrameLogon" Then
                ...
                Response.Redirect("/PortalORM/(S(" & Session.SessionID & "))/Start/IframeLogin.aspx")
            End If
            m_User = GetUser(Me)
            ...
            Try
                ...
                If m_User.Groups.HasGroups Then
                    ...
                    If blnStartMethod And (Not m_User.Groups(0).Message.Length = 0) And (m_User.ReadMessageCount <= m_User.Groups(0).MaxReadMessageCount) Then
                        ...
                        Literal1.Text &= "				 alert('" & HelpProcedures.TranslateHTML(m_User.Groups(0).Message, TranslationDirection.ReadHTML) & "');" & vbCrLf
                        Literal1.Text &= "			//-->" & vbCrLf
                        ...
                        For Each tmpRow In table.Rows
                            ...
                            If dvAppLinks.Count > 0 Then
                                ...
                                For intRows = 0 To dvAppLinks.Count - 1
                                    ...
                                    '§§§ JVE 26.01.2006: Link einfügen...
                                    'litApp.Text &= "<td class=""MainmenuItem"" nowrap=""nowrap"">&nbsp;<a href=""" & CStr(dvAppLinks(intRows)("AppURL")) & "?AppID=" & CStr(dvAppLinks(intRows)("AppID")) & """ target=""_self"">" & CStr(dvAppLinks(intRows)("AppFriendlyName")) & "</a>&nbsp;</td>" & vbCrLf
                                    ...
                                    If Not TypeOf dvAppLinks(intRows)("AppComment") Is System.DBNull Then
...
' Updated in $/CKAG/PortalORM/Start
' 
' *****************  Version 10  *****************
...
' Created in $/CKAG/PortalORM/start
' 
' *****************  Version 26  *****************
' User: Jungj        Date: 14.12.07   Time: 10:26
' Updated in $/CKG/PortalORM/Start
