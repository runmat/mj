...
{
    public class CocController : CkgDomainController
    {
        ...
        public CocController(IAppSettings appSettings, ILogonContextDataService logonContext,
        ...
        [CkgApplication]
        public ActionResult CocAnforderung()
        {
            ViewModel.DataInit();
