...
function checkPassword(length,lcase,ucase,num,special) {
    ...
    var pw = new Password(document.getElementById('ctl00_ContentPlaceHolder1_txtNewPwd').value,
                           special_chars);
...
//    if (pw.run_score <= 1) hint += "Avoid runs (e.g. 'aaaa', 'efghi', '1234'). ";
    ...
    pswdLen = document.getElementById('ctl00_ContentPlaceHolder1_txtNewPwd').value.length
