    ...
    function AgendaView(element, calendar, viewName) {
        ...
        function buildSkeleton() {
            ...
            for (i = 0; d < maxd; i++) {
                ...
                var identifier = "fc-" + d.toString("HH-mm");
                var divContentClass = " class='fc-slot-div " + identifier + "'";
                var divContentData = " data='" + identifier + "'";
				...
				"<div style='position:relative'" + divContentClass + divContentData + ">&nbsp;</div>" +
				"</td>" +
				"</tr>";
                //console.log(d);
