...
var App = function () {
    ...
    var handleResponsive = function () {
        ...
        var handleElements = function () {
            // reInitParametersialize core elements
            handleTooltip();
            _handleSidebar();
            ...
            // reInitParametersialize other subscribed elements
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar li > a.ajaxify').live('click', function (e) {
            ...
            $.post(url, {}, function (res) {
                ...
                App.initUniform(); // InitParametersialize uniform elements
            });
        });
    };
    ...
    var handlePortletTools = function () {
        ...
        jQuery('.portlet .tools .collapse, .portlet .tools .expand').live('click', function () {
            ExpandCollapse(jQuery(this));
        });

        // MJE, 04.12.2013:  Also let portlet expand + collapse be invoked by click on whole caption bar
        jQuery('.portlet-title').each(function () {
            var portletTitle = jQuery(this);
            if (portletTitle.find(".collapse,.expand").length > 0) {
                portletTitle.addClass('cursor-pointer');

                portletTitle.live('click', function () {
                    //alert('click caption');
                    portletTitle.find(".collapse,.expand").each(function () {
        ...
        function ExpandCollapse(item) {
            var el = item.parents(".portlet").children(".portlet-body");
    ...
    var handleUniform = function () {
        ...
        if (test.size() > 0) {
            test.each(function () {
                ...
                // bug fix Erweiterung für Radiobuttons, MCa 15.11.2013
                        && $(this).parents(".radio").size() < 2
                // bug fix MJE, 29.09.2013, 
                // bug in bootstrap here!! RadioButtons would be uniformed multiple times, because they don't have class name "checker"!!
                        && $(this).parents(".checked").size() == 0 && $(this).parents(".disabled").size() == 0) {
                    $(this).show();
                    $(this).uniform();
                }
            });
    ...
    return {
        ...
        //main function to InitParametersiate template pages
        init: function (isAjaxInitParam) {
            var isAjaxInit = typeof (isAjaxInitParam) !== 'undefined' && isAjaxInitParam == true;
            //core handlers
        ...
        // InitParametersializes uniform elements
        ...
        // InitParametersializes choosen dropdowns
