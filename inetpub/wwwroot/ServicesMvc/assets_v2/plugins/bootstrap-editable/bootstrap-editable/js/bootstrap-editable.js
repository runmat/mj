...
(function ($) {
    ...
    var EditableForm = function (div, options) {
        ...
        //nothing shown after InitParameters
    };
    ...
    EditableForm.prototype = {
        ...
        **/        
        render: function() {
            //InitParameters loader
            this.$loading = $($.fn.editableform.loading);        
            this.$div.empty().append(this.$loading);
            
            //InitParameters form template and buttons
            this.initTemplate();
...
(function ($) {
    ...
    /**
    jQuery method to InitParametersialize editableContainer.
...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            //create input of specified type. Input needed already here to convert value for InitParametersial display (e.g. show text by id for select)
            ...
            //if display is function it's far more convinient to have autotext = always to render correctly on InitParameters
            ...
            //depending on autotext run render() or just finilize InitParameters
            $.when(doAutotext ? this.render() : true).then($.proxy(function() {
               ...
               /**        
               Fired when element was InitParametersialized by `$().editable()` method. 
               Please note that you should setup `InitParameters` handler **before** applying `editable`. 
                              
               @event InitParameters 
               @param {Object} event event object
               @param {Object} editable editable instance (as here it cannot accessed via data('editable'))
               @since 1.2.0
               @example
               $('#username').on('InitParameters', function(e, editable) {
                   alert('InitParametersialized ' + editable.options.name);
               });
               $('#username').editable();
               **/                  
                this.$element.triggerHandler('InitParameters', this);
            }, this));
        },
        ...
        initLive: function() {
           ...
           this.$element.on(this.options.toggle + '.editable', selector, $.proxy(function(e){
               ...
               if(!$target.data('editable')) {
                   //if delegated element InitParametersially empty, we need to clear it's text (that was manually set to `empty` by user)
        ...
        **/  
        show: function (closeAll) {
            ...
            //InitParameters editableContainer: popover, tooltip, inline, etc..
            if(!this.container) {
    ...
    * ======================= */
    ...
    /**
    jQuery method to InitParametersialize editable element.
    ...
    **/
    ...
    $.fn.editable.defaults = {
        ...
        **Please note**, that delegated targets can't be InitParametersialized with `emptytext` and `autotext` options, 
...
(function ($) {
    ...
    AbstractInput.prototype = {
       ...
       /*
       this method called before render to InitParameters $tpl that is inserted in DOM
       */
       prerender: function() {
...
You need InitParametersially put both `data-value` and element's text youself:    
    ...
    $.extend(Constructor.prototype, {
       ...
       value2input: function(value) {
           ...
           if(this.isRemote) {
               ...
               //select2('data', ...) allows to set both id and text --> usefull for InitParametersial show when items are not loaded   
               this.$input.select2('data', item).trigger('change', true); //second argument needed to separate InitParametersial change from user's click (for autosubmit)
           } else {
               this.$input.val(value).trigger('change', true); //second argument needed to separate InitParametersial change from user's click (for autosubmit)
           }
       },
...
(function ($) {
    ...
    $.fn.combodate.defaults = {
        ...
        //InitParametersial value, can be `new Date()`    
        value: null,                       
        minYear: 1970,
        maxYear: 2015,
        yearDescending: true,
...
(function ($) {
    ...
    Constructor.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/         
        format:'YYYY-MM-DD',
        /**
        Format used for displaying date. Also applied when converting date from element's text on InitParameters.   
