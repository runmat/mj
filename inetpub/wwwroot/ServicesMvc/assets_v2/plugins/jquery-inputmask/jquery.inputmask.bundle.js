    ...
    if ($.fn.inputmask == undefined) {
        $.inputmask = {
            ...
            defaults: {
                ...
                aliases: {}, //aliases defInitParametersions => see jquery.inputmask.extensions.js
        ...
        $.fn.inputmask = function (fn, options) {
            ...
            function resolveAlias(aliasStr, options) {
                ...
                if (aliasDefinition) {
                    ...
                    $.extend(true, opts, aliasDefinition);  //merge alias defInitParametersion in the options
            ...
            //test defInitParametersion => {fn: RegExp/function, cardinality: int, optionality: bool, newBlockMarker: bool, offset: int, casing: null/upper/lower, def: defInitParametersionSymbol}
