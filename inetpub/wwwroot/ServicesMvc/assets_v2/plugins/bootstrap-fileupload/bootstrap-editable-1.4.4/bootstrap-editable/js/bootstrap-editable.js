...
(function ($) {
    ...
    var Constructor = function (options) {
       ...
       //if not `tags` mode, we need define InitParametersSelection to set data from source
       if(!options.select2.tags) {
            ...
            mixin.initSelection = function (element, callback) {
                ...
                if(options.select2 && options.select2.ajax) {
                  ...
                  $(element).data('select2').postprocessResults = function(data, InitParametersial) {
    ...
    $.extend(Constructor.prototype, {
        render: function() {
            ...
            if('ajax' in this.options.select2) {
              ...
              this.$input.data('select2').postprocessResults = function(data, InitParametersial) {
                  this.element.triggerHandler('loaded', [data]);
                  original.apply(this, arguments);  
              }
              */
       ...
       value2html: function(value, element) {
           ...
           } else { //on InitParameters (autotext)
