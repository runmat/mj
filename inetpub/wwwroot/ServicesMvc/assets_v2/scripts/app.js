...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            handleFixedSidebar(); // reInitParametersialize fixed sidebar
            handleFixedSidebarHoverable(); // reInitParametersialize fixed sidebar hover effect
        }

        // handle theme colors
        var setColor = function (color) {
            $('#style_color').attr("href", "assets_v2/css/themes/" + color + ".css");
    ...
    return {
        ...
        init: function () {
            ...
            App.addResponsiveHandler(handleChoosenSelect); // reInitParametersiate chosen dropdown on main content resize. disable this line if you don't really use chosen dropdowns.
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="./assets_v2/img/ajax-loading.gif" align="">',
