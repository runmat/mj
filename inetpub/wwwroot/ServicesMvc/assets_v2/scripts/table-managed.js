    ...
    return {
        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                // set the InitParametersial value
                "iDisplayLength": 5,
            ...
            //jQuery('#sample_1_wrapper .dataTables_length select').select2(); // InitParametersialize select2 dropdown
            ...
            jQuery('#sample_2_wrapper .dataTables_length select').select2(); // InitParametersialize select2 dropdown
            ...
            jQuery('#sample_3_wrapper .dataTables_length select').select2(); // InitParametersialize select2 dropdown
