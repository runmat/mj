var FormImageCrop = function () {
    ...
    var demo3 = function() {
        ...
        var jcrop_api,
            ...
            console.log('InitParameters',[xsize,ysize]);
    ...
    var demo5 = function() {
        ...
        $('#img1').click(function(e) {
          ...
          jcrop_api.setImage('assets_v2/plugins/jcrop/demos/demo_files/sago.jpg');
        ...
        $('#img2').click(function(e) {
          ...
          jcrop_api.setImage('assets_v2/plugins/jcrop/demos/demo_files/pool.jpg');
          jcrop_api.setOptions({ bgOpacity: .6 });
          return false;
        });
        $('#img3').click(function(e) {
          ...
          jcrop_api.setImage('assets_v2/plugins/jcrop/demos/demo_files/sago.jpg',function(){
            this.setOptions({
              bgOpacity: 1,
              outerImage: 'assets_v2/plugins/jcrop/demos/demo_files/sagomod.jpg'
            });
        ...
        // Also, to prevent strange behavior, they are InitParametersially checked
        // This matches the default InitParametersial state of Jcrop
