var Inbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["assets_v2/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: 'assets_v2/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    var loadReply = function (el) {
        ...
        $.ajax({
            ...
            success: function(res) 
            {
                ...
                initTags($('[name="to"]')); // InitParameters "TO" input field
                handleCCInput(); // InitParameters "CC" input field
