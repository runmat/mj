<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gebrauchtzulassung.aspx.cs"
    Inherits="AutohausPortal.forms.Gebrauchtzulassung"  MasterPageFile="/AutohausPortal/MasterPage/Form.Master" %>
                ...
                <div class="formularbereich">
                    ...
                    <div class="formlayer_plus_content">
                        ...
                        <div class="formulardaten">
                            ...
                            <div class="formfeld" id="Div6" style="width: 164px; margin-left: 0px;">
                                <div class="formfeld_start"></div>
                            ...
                            <div class="formname">
                                &nbsp;</div>
                            <div class="formselects">
                                <asp:CheckBox ID="chkMussRes" runat="server" /><div class="checklabel">
                                    muss noch reserviert werden</div>
                                <asp:CheckBox ID="chkSerie" runat="server" /><div class="checklabel">
                                    Serie
                                </div>
                                <asp:CheckBox ID="chkKennzVorhanden" runat="server" /><div class="checklabel">
                            ...
                            <div class="formfeld" id="formdiv9" style="margin-left: 10px; width: 100px;">
                                <div class="formfeld_start"></div>
                                <asp:TextBox CssClass="formtext" ID="txtTuvAU" runat="server" Text="MMJJ" Style="width: 40px;"
                                    MaxLength="4" /><div class="formfeld_end"></div>
                            </div>
                            <div class="formname" style="margin-left: 210px; margin-right: 12px; width: auto;">
                                Stillegungsdatum
                            </div>
                            <!--textinput-->
                            <!--datepicker-->
                            <div class="formfeld" id="divStillDate" runat="server" style="width: 210px; margin-left: 0px;">
                                <div class="formfeld_start"></div>
                                <div id="Div8" style="position: absolute; z-index: 100; margin-left: -180px; margin-top: -150px;">
                                </div>
                                <asp:TextBox ID="txtStillDatum" runat="server" CssClass="formtext jqcalendar" Width="125px"
                            ...
                            <div class="formfeld"  id="divKennz1" runat = "server" style="margin-left: 10px; width: 61px;">
                                ...
                                <asp:TextBox CssClass="formtext" ID="txtKennz1" runat="server" Style="width: 31px;
                                    text-transform: uppercase;" Text="CK" MaxLength="3"></asp:TextBox>
                                <div class="formfeld_end"></div>
                            </div>
                            <div class="formname" style="width: auto;">
                                -
                            </div>
                            <div class="formfeld" id="formdiv13" style="width: 132px;">
                                <div class="formfeld_start"></div>
                            ...
                            <!--textinput-->
                            <!--datepicker-->
                            <div class="formfeld" id="divZulDate" runat="server" style="width: 210px; margin-left: 0px;">
                                <div class="formfeld_start"></div>
                                <div id="Div10" style="position: absolute; z-index: 100; margin-left: -180px; margin-top: -150px;">
                                </div>
                                <asp:TextBox ID="txtZulDate" runat="server" CssClass="formtext jqcalendar jqcalendarWerktage" Width="125px"
                                    MaxLength="10"></asp:TextBox>
                                <div class="formfeld_end_wide">
                                    <img src="../images/icon_datepicker.gif" width="22" height="19" alt="Kalender" class="datepicker" /></div>
                            </div>
                            ...
                            <div class="helpbutton">
                                <div class="helplayer" id="Div12">
                                    <p>
                                        ...
                                        Wünschen Sie eine Sondergröße, setzen Sie dort eben- falls den Haken und wählen Sie diese aus dem Drop-Down-Menü aus.
                            ...
                            <!--formulardaten zeile7-->
                            <!--formulardaten zeile8-->
                            <div class="formname">
                            </div>
                            <div class="formselects">
                                <asp:CheckBox ID="chkSaison" runat="server" /><div class="checklabel" >
