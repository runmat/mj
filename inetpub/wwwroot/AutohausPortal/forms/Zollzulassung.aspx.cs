...
{
    /// <summary>
    /// Auftragseingabe für Zollzulassungen. Benutzte Klassen AHErfassung und objCommon.
    /// </summary>
    public partial class Zollzulassung : System.Web.UI.Page
    {
        #region Declarations
        private User m_User;
        private App m_App;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack != true)
            {
                ...
                {
                    objVorerf = new AHErfassung(ref m_User, m_App, "AZ");
                    objVorerf.NrMaterial = "600";
                    objVorerf.Material = "Zollzulassung";
                    fillForm();
        ...
        protected void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            if (lblError.Text.Length == 0)
            {
                ...
                objVorerf.ZollVers = rbZollVorh.Checked ? objVorerf.KurzZeitKennz = "V" : objVorerf.KurzZeitKennz = "E";
                objVorerf.ZollVersDauer = ddlDauer.SelectedValue == "0" ? objVorerf.ZollVersDauer = "" : objVorerf.ZollVersDauer = ddlDauer.SelectedValue;
    ...
    "<script type='text/javascript'>disableDefaultValue('" + txtBox.ClientID + "');</script>", false);
        ...
        private void SelectValues()
        {
            ...
            rbZollErw.Checked = objVorerf.ZollVers == "E" ? rbZollErw.Checked = true : rbZollErw.Checked = false;
            rbZollVorh.Checked = objVorerf.ZollVers == "V" ? rbZollVorh.Checked = true : rbZollVorh.Checked = false;
            chkEinKennz.Checked = objVorerf.EinKennz;

            if (objVorerf.ZollVersDauer != null && objVorerf.ZollVersDauer != "")
            { 
                foreach(ListItem Item in ddlDauer.Items)
                {
                    if (Item.Value == objVorerf.ZollVersDauer) 
                    {
                        Item.Selected = true;
                    }
                } 
            ...
            if (tmpDView.Count > 0)
            {
                ...
                {
                    DataRow[] kennzRow = objCommon.tblKennzGroesse.Select("Groesse ='" + objVorerf.KennzForm + "' AND Matnr= '600'");
        ...
        private void ValidateData()
        {
            ...
            else if (rbZollErw.Checked && ddlDauer.SelectedValue=="0")
            {
                lblError.Text += "Bitte geben Sie die Dauer der Versicherung an!";
                divDauer.Attributes["class"] = "formbereich error";
            }
        ...
        private void ClearForm()
        {
            ...
            if (!chkHoldData.Checked)
            {
                ...
                ddlDauer.SelectedValue = "0";
                rbZollErw.Checked = true;
                rbZollVorh.Checked = false;
