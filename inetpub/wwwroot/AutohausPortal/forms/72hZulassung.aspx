<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="72hZulassung.aspx.cs" Inherits="AutohausPortal.forms._72hZulassung"
                        ...
                        <div class="formulardaten">
                            ...
                            <div class="formbereich" id="divStVa" runat="server">
                              <telerik:RadComboBox ID="ddlStVa1" Width="604px" runat="server" LoadingMessage="Laden..."
                                    ...
                                    ShowMoreResultsBox="True" EnableVirtualScrolling="True" Height="200px" ItemsPerRequest="10" EnableTextSelection="true" EnableViewState="False">
                                    <Localization NoMatches="Keine Treffer" ShowMoreFormatString="Eintrag &lt;b&gt;1&lt;/b&gt;-&lt;b&gt;{0}&lt;/b&gt; von &lt;b&gt;{1}&lt;/b&gt;" />
                                </telerik:RadComboBox>
                            </div>
                            <!--dropdown-->
                            ...
                            <div class="formfeld" id="divKennz2" runat = "server" style="width: 132px;">
                                <div class="formfeld_start"></div>
