...
namespace AutohausPortal.forms
{
    ...
    /// </summary>
    public partial class Gebrauchtzulassung : Page
    {
        private User m_User;
        private App m_App;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    objVorerf = new AHErfassung(ref m_User, m_App, "AG", "588");
                    fillForm();
                }
                Session["objVorerf"] = objVorerf;
    ...
    "<script type='text/javascript'>disableDefaultValue('" + txtBox.ClientID + "');</script>", false);
        ...
        private void SelectValues()
        {
            ...
            if (objVorerf.StillDate.IsDate())
                txtStillDatum.Text = objVorerf.StillDate;
        ...
        private Boolean checkStillDate()
        {
            Boolean bReturn = true;
            DateTime StillDat;
            String sStillDat = txtStillDatum.Text;
