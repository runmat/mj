<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Umkennzeichnung.aspx.cs" Inherits="AutohausPortal.forms.Umkennzeichnung"     MasterPageFile="/AutohausPortal/MasterPage/Form.Master" %>
                ...
                <div class="formularbereich">
                    ...
                    <div class="formlayer_plus_content">
                        ...
                        <div class="formulardaten">
                            ...
                            <div class="formfeld"   style="width: 132px;">
                                <div class="formfeld_start"></div>
                            ...
                            <div class="formname" style="margin-left: 45px; width: auto;">
                                Altkennzeichen
                            </div>
                            <!--textinput-->
                            <div class="formfeld" id="formdiv30" style="width: 61px;">
                                <div class="formfeld_start"></div>
                                <asp:TextBox CssClass="formtext" ID="txtAltKennz1" runat="server" Style="width: 31px;
                                    text-transform: uppercase;" Text="CK" MaxLength="3"></asp:TextBox>
                                <div class="formfeld_end"></div>
                            </div>
                            <div class="formname" style="width: auto;">
                            ...
                            <div class="formfeld" id="formdiv31" style="width: 162px;">
                                <div class="formfeld_start"></div>
                                <asp:TextBox CssClass="formtext" ID="txtAltKennz2" runat="server" Style="width: 90px;
                                    text-transform: uppercase;" Text="XX9999" MaxLength="6"></asp:TextBox>
                                <div class="formfeld_end"></div>
                            </div>
                            <div class="helpbutton">
                                <div class="helplayer" id="Div2">
                                    <p>
                Geben Sie bei einem Wunsch oder einem reservierten Kennzeichen das entsprechende Kennzeichen an. Das Ortskennzeichen wird vom Zulassungskreis übernommen. Geben Sie zusätzlich das bisherige Kennzeichen des Fahrzeuges ein.
                                    </p>
                                </div>
                                <img src="../images/button_help.gif" width="27" height="26" alt="Hilfe" class="helpicon" />
                            </div>
