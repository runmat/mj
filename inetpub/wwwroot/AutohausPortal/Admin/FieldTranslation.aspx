                            ...
                            <div id="QueryFooter" runat="server">
                                <div id="dataQueryFooter">
                                    <asp:LinkButton class="Tablebutton" ID="lnkBack" runat="server"
                                        Text="zurück&amp;nbsp;&amp;#187; " CssClass="Tablebutton" Height="16px"
                                        Width="78px" Font-Names="Verdana,sans-serif" Font-Size="10px"></asp:LinkButton>
                                    &nbsp;<asp:LinkButton ID="lbtnNew" runat="server" Text="Neu&amp;nbsp;&amp;#187; "
                                        CssClass="Tablebutton" ToolTip="Neue Übersetzung" Height="16px" Width="78px" Font-Names="Verdana,sans-serif"
                        ...
                        <div id="Result" runat="Server">
                            ...
                            <div id="data">
                                <asp:GridView ID="dgSearchResult" Width="100%" runat="server" AllowSorting="True"
                                    ...
                                    AllowPaging="True" GridLines="None" PageSize="20" EditRowStyle-Wrap="False" CssClass="GridView">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField  Visible="False" DataField="Field" SortExpression="Field" HeaderText="Seitenelement">
                                        </asp:BoundField>
										...
										<asp:TemplateField>
											<ItemTemplate>
												<asp:LinkButton id="lbAnlegen" runat="server"  CommandArgument='<%# CType(Container, GridViewRow).RowIndex %>' Visible='<%# CInt(DataBinder.Eval(Container, "DataItem.ApplicationFieldID")) = -1 %>' Text="Anlegen" CausesValidation="False" CommandName="Create" Font-Underline="true" ForeColor="#595959">Anlegen</asp:LinkButton>
												<asp:LinkButton id="lbAendern" runat="server" CommandArgument='<%# CType(Container, GridViewRow).RowIndex %>' Visible='<%# Not (CInt(DataBinder.Eval(Container, "DataItem.ApplicationFieldID")) = -1) %>' Text="Ändern" CausesValidation="False" CommandName="Edit" ForeColor="#595959">Ändern</asp:LinkButton>
											</ItemTemplate>
										</asp:TemplateField>
                                    ...
                                    <tr id="trEditUser" runat="server">
                                        <td align="left">
                                            ...
                                            <table id="tblLeft" style="border-color: #ffffff" cellspacing="0" cellpadding="0"
                                                ...
                                                <tr id="trEingabeSpalte" visible = "False" runat="server">
                                                    <td height="22" class="firstLeft active">
                                                        Eingabefeld</td>
                                                    <td align="left" height="22" class="cellBorderGray active" width="100%">
                                                        <asp:CheckBox ID="chkEingabe" runat="server" TextAlign="Right" Text="(Eingabefeld in Spalten dürfen nicht ausgeblendet werden) "></asp:CheckBox> </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
