...
Partial Public Class UserHistory
    ...
    '''<summary>
    '''rbTestUserAll-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents rbTestUserAll As Global.System.Web.UI.WebControls.RadioButton

    '''<summary>
    '''rbTestUserProd-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents rbTestUserProd As Global.System.Web.UI.WebControls.RadioButton

    '''<summary>
    '''rbTestUserTest-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents rbTestUserTest As Global.System.Web.UI.WebControls.RadioButton
    ...
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents dataQueryFooter As Global.System.Web.UI.HtmlControls.HtmlGenericControl
