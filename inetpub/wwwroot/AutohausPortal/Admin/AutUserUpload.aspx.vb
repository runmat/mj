    ...
    Protected Sub lbtnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbtnSave.Click
        ...
        For Each TempRow In TempTable.Rows
            ...
            _User = New User(-1, _
                              ...
                              False, _
                              IIf(TempRow(UploadExcelColumns.ValidFrom) Is System.DBNull.Value, String.Empty, TempRow(UploadExcelColumns.ValidFrom)), _
                              0)
...
#Region "Methods"
    ...
    Private Sub CheckTableData(ByVal TempTable As DataTable)
        ...
        For Each TempRow In TempTable.Rows
            ...
            If TempRow(UploadExcelColumns.Username) Is DBNull.Value AndAlso TempRow(UploadExcelColumns.Groupname) IsNot DBNull.Value Then
        ...
        For Each GridRow In grvAusgabe.Rows
            ...
            If CType(Session("Checked"), Boolean) = True Then
                ...
                If Trim(txt.Text).Length = 0 Then
                    If Not CustomerNameInputOptional(ddlFilterCustomer.SelectedValue) Then
