                                            ...
                                            <EmptyDataRowStyle BackColor="#DFDFDF" />
                                                    <Columns>
                                                       ...
                                                       <asp:TemplateField Visible="False">
                                                        ...
                                                        <asp:ButtonField CommandName="Del" HeaderStyle-ForeColor="White"  HeaderText="Löschen" ButtonType="Image" ImageUrl="/AutohausPortal/Admin/Images/Papierkorb_01.gif" ControlStyle-Height="16px" ControlStyle-Width="16px">
                                                        </asp:ButtonField>                                                    
                                        ...
                                        <ContentTemplate>
                                            <table id="Table3" style="border-color: #FFFFFF; font-size: 10px;" cellspacing="0"
                                                ...
                                                <tr class="formquery">
                                                    ...
                                                    <td class="active">
                                                        <asp:TextBox ID="txtMessage" runat="server" Width="500px" MaxLength="500" Height="150px"
                                        ...
                                        <ContentTemplate>
                                            <table id="tblApp" cellspacing="0" cellpadding="0" width="100%" style="border-color: #FFFFFF;
                                                ...
                                                <tr class="formquery">
                                                    ...
                                                    <td>
                                                        <asp:ImageButton Style="margin-left: 20px" ID="btnAssign" runat="server" ImageUrl="/AutohausPortal/Admin/Images/Pfeil_vor_01.jpg"
                                        ...
                                        <ContentTemplate>
                                            <table id="tblArchiv" cellspacing="0" cellpadding="0" width="100%" style="border-color: #FFFFFF;
                                                ...
                                                <tr class="formquery">
                                                    ...
                                                    <td>
                                                        <asp:ImageButton ID="btnAssignArchiv" Style="margin-left: 40px" runat="server" ImageUrl="/AutohausPortal/Admin/Images/Pfeil_vor_01.jpg"
                                                            ToolTip="Zuweisen" Height="37px" Width="37px" />
                                                    </td>
                                                    <td>
