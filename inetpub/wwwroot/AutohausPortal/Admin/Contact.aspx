                                                ...
                                                <asp:GridView ID="dgSearchResult" Width="100%" runat="server" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:ButtonField CommandName="Group" ButtonType="Image" Text="Direkt zur Kunden-/Gruppenzuweisung"
                                                            ImageUrl="Images/EditTableHS.png" ControlStyle-Height="16px" ControlStyle-Width="16px"
                                                        ...
                                                        <asp:ButtonField CommandName="Del" ButtonType="Image" ImageUrl="Images/del.png"
                                        ...
                                        <td valign="top">
                                            <table id="tblLeft" style="border-color: #ffffff; padding-right: 50px;" cellspacing="0"
                                                ...
                                                <tr class="formquery" id="trPhone" runat="server">
                                                    ...
                                                    <td class="active">
                                                        <asp:ImageButton ID="ibtSetGroup" runat="server" ImageUrl="images/EditTableHS.png"
                                        ...
                                        <td valign="top">
                                            <table id="tblRight" cellspacing="0" style="border-color: #ffffff" cellpadding="0"
                                                ...
                                                <tr id="trEmployee07" runat="server" class="formquery">
                                                    <td class="firstLeft active">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="images/placeholder.png"
                                                            Height="66px" Width="200px" EnableViewState="False" />
                                                    </td>
                                                    <td align="left" class="active" valign="top">
                                                        ...
                                                        &nbsp;<br />
                                                        Darstellung auf 200 x 66 Pixeln.
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr id="trCutomerGroups" runat="server">
                                        <td valign="top">
                                            <table cellspacing="0" style="border-color: #ffffff" cellpadding="0" width="100%">
                                                <tr class="formquery">
                                                    <td class="firstLeft active">
                                                        <asp:ImageButton ID="ibtnFilter" runat="server" Height="16px" ImageUrl="images/Filter.gif"
                                                            Width="16px" />
                                                        &nbsp;Firma (setzen für&nbsp;
