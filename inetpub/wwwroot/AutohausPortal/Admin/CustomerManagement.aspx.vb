...
#Region " Data and Function "
    ...
    Private Function FillEdit(ByVal intCustomerId As Integer) As Boolean
        ...
        Try
            ...
            'Startmeldung
            txtMessage.Text = _Customer.Message
            txtMessageOld.Text = _Customer.Message
            txtMaxReadMessageCount.Text = _Customer.MaxReadMessageCount.ToString
            'Kontaktdaten
    ...
    Private Sub lbtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbtnSave.Click
        ...
        Catch ex As Exception
            If HelpProcedures.CastSapBizTalkErrorMessage(ex.Message) = "NO_DATA" Then
                blnNoData = True
            Else
                lblError.Text = HelpProcedures.CastSapBizTalkErrorMessage(ex.Message)
            End If
    ...
    Private Sub lbtnConfirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbtnConfirm.Click
        ...
        Try
            ...
            If Not IsNumeric(txtMaxReadMessageCount.Text) Then
                lblError.Text = "Bitte geben Sie einen Zahlenwert für die Häufigkeit ein."
                Exit Sub
            End If
            ...
            Dim _customer As New Customer(intCustomerId, _
                                                ...
                                                CInt(txtMaxReadMessageCount.Text)) 'txtCAddress.Text, _
            ...
            If (Not (txtMessage.Text = txtMessageOld.Text)) OrElse (Not blnNew) Then
                ...
                Dim cmdGetUser As New SqlClient.SqlCommand("SELECT UserID FROM WebUser WHERE CustomerID=@CustomerID", cn)
                cmdGetUser.Parameters.AddWithValue("@CustomerID", intCustomerId)
                ...
                For Each dr In dt.Rows
                    cmdUpdateUser = New SqlClient.SqlCommand("UPDATE WebUser SET ReadCustomerMessageCount=@ReadCustomerMessageCount WHERE UserID=@UserID", cn)
                    Dim intReadCustomerMessageCount As Int32 = 0
                    cmdUpdateUser.Parameters.AddWithValue("@ReadCustomerMessageCount", intReadCustomerMessageCount)
