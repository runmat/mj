...
Partial Public Class Groupmanagement
    ...
    '''<summary>
    '''lstEmployeeUnAssigned-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents lstEmployeeUnAssigned As Global.System.Web.UI.WebControls.ListBox

    '''<summary>
    '''btnAssignEmployee-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents btnAssignEmployee As Global.System.Web.UI.WebControls.ImageButton

    '''<summary>
    '''btnUnAssignEmployee-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents btnUnAssignEmployee As Global.System.Web.UI.WebControls.ImageButton

    '''<summary>
    '''lstEmployeeAssigned-Steuerelement
    '''</summary>
    '''<remarks>
    '''Automatisch generiertes Feld
    '''Um dies zu ändern, verschieben Sie die Felddeklaration aus der Designerdatei in eine Code-Behind-Datei.
    '''</remarks>
    Protected WithEvents lstEmployeeAssigned As Global.System.Web.UI.WebControls.ListBox
