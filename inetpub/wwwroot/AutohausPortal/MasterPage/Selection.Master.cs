...
{
    public partial class Selection : System.Web.UI.MasterPage
    {
        private User m_User;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (m_User == null)
            {
                Response.Redirect("/AutohausPortal/(S(" + Session.SessionID + "))/Start/Login.aspx");
            }
            ...
            lnkKontakt.NavigateUrl = "/AutohausPortal/(S(" + Session.SessionID + "))/Info/Kontakt.aspx";
