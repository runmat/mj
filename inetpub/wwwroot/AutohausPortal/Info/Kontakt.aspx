<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kontakt.aspx.cs" Inherits="AutohausPortal.Info.Kontakt"
                    ...
                    <td width="50%" valign="top">
                        ...
                        <p>
                            <table>
                                <tr>
                                    <td colspan="2">
                                        <asp:Label runat="server" ID="lblAnsprechpartner" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td style="padding-left:3px;">
                                        <asp:Label runat="server" ID="lblTelefon" Text="+49 (0)4102 804-170"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td style="padding-left:3px;">
                                        <asp:Label runat="server" ID="lblFax" Text="+49 (0)4102 804-300"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td style="padding-left:3px;">
                                        <a runat="server" id="lnkMail" href="mailto:service@kroschke.de">service@kroschke.de</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
