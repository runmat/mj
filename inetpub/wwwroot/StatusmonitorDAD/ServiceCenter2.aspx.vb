Public Partial Class ServiceCenter2
    ...
    Private Sub getDataSource()
        ...
        Try
            ...
            cmdAg = New SqlClient.SqlCommand("SELECT * FROM vwStatusmonitorDAD WHERE Platzierung='L' AND ServiceCenterID=2 ORDER BY Abteilung ", cn)
            cmdAg.CommandType = CommandType.Text

            ad.SelectCommand = cmdAg
            ad.Fill(ds, "Links")

            cmdAg.CommandText = "SELECT * FROM vwStatusmonitorDAD WHERE Platzierung='R' AND ServiceCenterID=2 ORDER BY Abteilung "
            ad.SelectCommand = cmdAg
            ad.Fill(ds, "Rechts")
