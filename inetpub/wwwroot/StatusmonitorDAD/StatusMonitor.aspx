<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StatusMonitor.aspx.vb"
    Inherits="StatusmonitorDAD.StatusMonitor" %>
                                        ...
                                        <asp:GridView AutoGenerateColumns="False" BorderWidth="0" BorderStyle="None" runat="server"
                                            ...
                                            <RowStyle Height="60px" Width="120px" BorderWidth="0" BorderStyle="none" VerticalAlign="Middle"
                                              ...
                                              <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Image ID="ImgGut" runat="server" ImageUrl="~/Images/AllesOK2.JPG" Visible='<%# DataBinder.Eval(Container, "DataItem.Status")=0 %>' />
                                                        <asp:Image ID="ImgSchlecht" runat="server" ImageUrl="~/Images/Problem.jpg" Visible='<%# DataBinder.Eval(Container, "DataItem.Status")=1 %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
